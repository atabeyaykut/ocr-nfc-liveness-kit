...
struct [[deprecated("Use RNPermissionsModuleNotificationsResponse instead.")]] RNPermissionsModuleBaseNotificationsResponse {
  P0 status;
  P1 settings;
...
template <typename P0, typename P1>
struct [[deprecated("Use RNPermissionsModuleNotificationsResponseBridging instead.")]] RNPermissionsModuleBaseNotificationsResponseBridging {
...
#pragma mark - RNPermissionsModuleNotificationsResponse

template <typename P0, typename P1>
struct RNPermissionsModuleNotificationsResponse {
  P0 status;
  P1 settings;
  bool operator==(const RNPermissionsModuleNotificationsResponse &other) const {
    return status == other.status && settings == other.settings;
  }
};

template <typename T>
struct RNPermissionsModuleNotificationsResponseBridging {
  static T types;
