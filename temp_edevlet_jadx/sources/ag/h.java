...
@r9.e(c = "tr.gov.turkiye.edevlet.kapisi.institution.InstitutionDetailViewModel$unFavoriteOperation$2", f = "InstitutionDetailViewModel.kt", l = {}, m = "invokeSuspend")
/* loaded from: classes3.dex */
public final class h extends r9.i implements p<kotlinx.coroutines.flow.f<? extends Result<ServiceModelRealm>>, p9.d<? super m>, Object> {
    ...
    public static final class a extends kotlin.jvm.internal.j implements p<c, r0.b<? extends Result<ServiceModelRealm>>, c> {
        ...
        public final c mo7invoke(c cVar, r0.b<? extends Result<ServiceModelRealm>> bVar) {
            ...
            try {
                ...
                return orThrow != null ? c.copy$default(execute, null, null, result, false, true, orThrow, 3, null) : c.copy$default(execute, null, null, result, true, false, null, 35, null);
            } catch (Throwable th2) {
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        w.F(obj);
        z.a(this.f327b, (kotlinx.coroutines.flow.f) this.f326a, a.f328a);
        return m.f9594a;
    }
}
