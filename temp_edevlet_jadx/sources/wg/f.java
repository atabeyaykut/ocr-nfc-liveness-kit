...
@r9.e(c = "tr.gov.turkiye.edevlet.kapisi.services.municipality.MunicipalityListViewModel$provideInstitutionList$2", f = "MunicipalityListViewModel.kt", l = {}, m = "invokeSuspend")
...
public final class f extends i implements p<kotlinx.coroutines.flow.f<? extends Result<List<? extends InstitutionModelRealm>>>, p9.d<? super m>, Object> {
    ...
    public final p9.d<m> create(Object obj, p9.d<?> dVar) {
        f fVar = new f(this.f18925b, dVar);
        fVar.f18924a = obj;
        return fVar;
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        w.F(obj);
        z.a(this.f18925b, (kotlinx.coroutines.flow.f) this.f18924a, a.f18926a);
        return m.f9594a;
    }
}
