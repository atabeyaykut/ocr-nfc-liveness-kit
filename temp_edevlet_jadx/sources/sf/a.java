...
public final class a {
    ...
    @r9.e(c = "tr.gov.turkiye.edevlet.kapisi.dashboard.mostused.MostUsedServicesRepository", f = "MostUsedServicesRepository.kt", l = {73, 96}, m = "fetchMostUsedServices")
    /* renamed from: sf.a$a, reason: collision with other inner class name */
    public static final class C0248a extends r9.c {

        /* renamed from: a, reason: collision with root package name */
        public /* synthetic */ Object f15394a;

        /* renamed from: c, reason: collision with root package name */
        public int f15396c;

        public C0248a(p9.d<? super C0248a> dVar) {
            super(dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            this.f15394a = obj;
            this.f15396c |= Integer.MIN_VALUE;
            return a.this.b(this);
        }
    }

    @r9.e(c = "tr.gov.turkiye.edevlet.kapisi.dashboard.mostused.MostUsedServicesRepository$fetchMostUsedServices$2", f = "MostUsedServicesRepository.kt", l = {}, m = "invokeSuspend")
    ...
    @r9.e(c = "tr.gov.turkiye.edevlet.kapisi.dashboard.mostused.MostUsedServicesRepository$fetchMostUsedServices$3", f = "MostUsedServicesRepository.kt", l = {}, m = "invokeSuspend")
    ...
    public static final ArrayList a(a aVar) {
        ...
        g0 g0VarT = g0.t();
        g0VarT.m();
        RealmQuery realmQueryJ = g0VarT.J(MostUsedServiceModelRealm.class);
        realmQueryJ.h("serviceInsertion");
        y0 y0VarD = realmQueryJ.d();
        ArrayList arrayList = new ArrayList();
        d0.c cVar = new d0.c();
        while (cVar.hasNext()) {
            MostUsedServiceModelRealm mostUsedServiceModelRealm = (MostUsedServiceModelRealm) cVar.next();
            RealmQuery realmQueryJ2 = g0VarT.J(ServiceModelRealm.class);
            realmQueryJ2.b(mostUsedServiceModelRealm.getServiceCode(), "serviceCode");
    ...
    */
    public final java.lang.Object b(p9.d<? super tr.gov.turkiye.edevlet.kapisi.data.extension.Result<java.util.List<tr.gov.turkiye.edevlet.kapisi.data.service.ServiceModelRealm>>> r17) throws java.lang.Throwable {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: sf.a.b(p9.d):java.lang.Object");
    }
}
