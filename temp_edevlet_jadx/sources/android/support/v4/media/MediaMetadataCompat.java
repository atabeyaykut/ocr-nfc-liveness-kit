...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public static class a implements Parcelable.Creator<MediaMetadataCompat> {
        ...
        @Override // android.os.Parcelable.Creator
        public final MediaMetadataCompat[] newArray(int r12) {
            return new MediaMetadataCompat[r12];
        }
    }
    ...
    public MediaMetadataCompat(Parcel parcel) {
        this.f387a = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
