...
public class ChipAuthenticationPublicKeyInfo extends SecurityInfo {
    ...
    @Deprecated
    public ASN1Primitive getDERObject() throws IOException {
    ...
    public int hashCode() {
        int r02 = this.oid.hashCode();
        BigInteger bigInteger = this.keyId;
        int r03 = r02 + (bigInteger == null ? 111 : bigInteger.hashCode());
        PublicKey publicKey = this.publicKey;
        return ((r03 + (publicKey != null ? publicKey.hashCode() : 111)) * 1337) + 123;
    }
    ...
    public String toString() {
        ...
        sb2.append(", keyId: ");
        BigInteger bigInteger = this.keyId;
        return c.h(sb2, bigInteger == null ? "-" : bigInteger.toString(), "]");
    }
}
