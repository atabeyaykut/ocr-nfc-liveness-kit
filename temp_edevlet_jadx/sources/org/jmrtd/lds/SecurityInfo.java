    ...
    public static SecurityInfo getInstance(ASN1Primitive aSN1Primitive) {
        try {
            ...
            if (ActiveAuthenticationInfo.checkRequiredIdentifier(id2)) {
                int r02 = ((ASN1Integer) aSN1Primitive2).getValue().intValue();
                return aSN1Primitive3 == null ? new ActiveAuthenticationInfo(id2, r02, null) : new ActiveAuthenticationInfo(id2, r02, ((ASN1ObjectIdentifier) aSN1Primitive3).getId());
            }
            ...
            if (ChipAuthenticationInfo.checkRequiredIdentifier(id2)) {
                int r03 = ((ASN1Integer) aSN1Primitive2).getValue().intValue();
                return aSN1Primitive3 == null ? new ChipAuthenticationInfo(id2, r03) : new ChipAuthenticationInfo(id2, r03, ((ASN1Integer) aSN1Primitive3).getValue());
            }
            if (TerminalAuthenticationInfo.checkRequiredIdentifier(id2)) {
                int r04 = ((ASN1Integer) aSN1Primitive2).getValue().intValue();
                return aSN1Primitive3 == null ? new TerminalAuthenticationInfo(id2, r04) : new TerminalAuthenticationInfo(id2, r04, (ASN1Sequence) aSN1Primitive3);
            }
            ...
            if (PACEDomainParameterInfo.checkRequiredIdentifier(id2)) {
                ...
                return aSN1Primitive3 != null ? new PACEDomainParameterInfo(id2, algorithmIdentifier, ((ASN1Integer) aSN1Primitive3).getValue()) : new PACEDomainParameterInfo(id2, algorithmIdentifier);
            }
