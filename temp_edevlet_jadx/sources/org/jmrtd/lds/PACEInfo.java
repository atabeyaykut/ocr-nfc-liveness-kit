...
public class PACEInfo extends SecurityInfo {
    ...
    public PACEInfo(String str, int r42, int r52) {
        this(str, r42, BigInteger.valueOf(r52));
    }

    public PACEInfo(String str, int r42, BigInteger bigInteger) {
    ...
    public static String toCipherAlgorithm(String str) {
        ...
        throw new NumberFormatException(a.a("Unknown OID: \"", str, "\""));
    }
    ...
    public static AlgorithmParameterSpec toParameterSpec(int r22) {
        if (r22 == 0) {
        ...
        switch (r22) {
            ...
            default:
                throw new NumberFormatException(android.support.v4.media.a.d("Unknown standardized domain parameters ", r22));
        }
    }
    ...
    public int hashCode() {
        int r12 = (this.version * 5) + (this.protocolOID.hashCode() * 7) + 1234567891;
        BigInteger bigInteger = this.parameterId;
        return ((bigInteger == null ? 1991 : bigInteger.hashCode()) * 3) + r12;
    }
