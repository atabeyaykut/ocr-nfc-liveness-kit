...
public class TerminalAuthenticationInfo extends SecurityInfo {
    ...
    public TerminalAuthenticationInfo(String str, int r32) {
        this(str, r32, null);
    }

    public TerminalAuthenticationInfo(String str, int r22, ASN1Sequence aSN1Sequence) {
        this.oid = str;
        this.version = r22;
    ...
    public TerminalAuthenticationInfo(short s7, byte b10) {
        this(SecurityInfo.ID_TA, 1, constructEFCVCA(s7, b10));
    }
    ...
    private static ASN1Sequence constructEFCVCA(short s7, byte b10) {
        return b10 != -1 ? new DLSequence(new ASN1Encodable[]{new DEROctetString(new byte[]{(byte) ((65280 & s7) >> 8), (byte) (s7 & 255)}), new DEROctetString(new byte[]{(byte) (b10 & 255)})}) : new DLSequence(new ASN1Encodable[]{new DEROctetString(new byte[]{(byte) ((65280 & s7) >> 8), (byte) (s7 & 255)})});
    }
    ...
    public int hashCode() {
        String str = this.oid;
        int r12 = (this.version * 5) + ((str == null ? 0 : str.hashCode()) * 7) + 123;
        ASN1Sequence aSN1Sequence = this.efCVCA;
        return ((aSN1Sequence == null ? 1 : aSN1Sequence.hashCode()) * 3) + r12;
    }
