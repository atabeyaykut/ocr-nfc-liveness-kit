...
public class EACCAResult implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        SecureMessagingWrapper secureMessagingWrapper2 = eACCAResult.wrapper;
    ...
    public int hashCode() {
        int r02 = (Arrays.hashCode(this.keyHash) + 31) * 31;
        BigInteger bigInteger = this.keyId;
        int r03 = (r02 + (bigInteger == null ? 0 : bigInteger.hashCode())) * 31;
        PublicKey publicKey = this.piccPublicKey;
        int r04 = (r03 + (publicKey == null ? 0 : publicKey.hashCode())) * 31;
        PublicKey publicKey2 = this.pcdPublicKey;
        int r05 = (r04 + (publicKey2 == null ? 0 : publicKey2.hashCode())) * 31;
        PrivateKey privateKey = this.pcdPrivateKey;
        int r06 = (r05 + (privateKey == null ? 0 : privateKey.hashCode())) * 31;
        SecureMessagingWrapper secureMessagingWrapper = this.wrapper;
        return r06 + (secureMessagingWrapper != null ? secureMessagingWrapper.hashCode() : 0);
    }
