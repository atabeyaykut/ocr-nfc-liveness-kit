...
public class EACCAProtocol {
    ...
    public EACCAProtocol(APDULevelEACCACapable aPDULevelEACCACapable, SecureMessagingWrapper secureMessagingWrapper, int r32, boolean z10) {
        this.service = aPDULevelEACCACapable;
        this.wrapper = secureMessagingWrapper;
        this.maxTranceiveLength = r32;
    ...
    private static byte[] getKeyData(String str, PublicKey publicKey) {
        ...
        throw new IllegalArgumentException(b.e("Unsupported agreement algorithm ", str));
    }
    ...
    public static SecureMessagingWrapper restartSecureMessaging(String str, byte[] bArr, int r11, boolean z10) throws GeneralSecurityException {
        ...
        if (cipherAlgorithm.startsWith("DESede")) {
            return new DESedeSecureMessagingWrapper(secretKeyDeriveKey, secretKeyDeriveKey2, r11, z10, 0L);
        }
        if (cipherAlgorithm.startsWith("AES")) {
            return new AESSecureMessagingWrapper(secretKeyDeriveKey, secretKeyDeriveKey2, r11, z10, 0L);
        }
    ...
    private static void sendGeneralAuthenticate(APDULevelEACCACapable aPDULevelEACCACapable, SecureMessagingWrapper secureMessagingWrapper, byte[] bArr) throws CardServiceException {
        try {
            ...
            while (it.hasNext()) {
                r32++;
                aPDULevelEACCACapable.sendGeneralAuthenticate(secureMessagingWrapper, it.next(), r32 >= listPartition.size());
            }
        }
    }
    ...
    public EACCAResult doCA(BigInteger bigInteger, String str, String str2, PublicKey publicKey) throws NoSuchAlgorithmException, CardServiceException, InvalidAlgorithmParameterException {
        ...
        try {
            ...
            LOGGER.log(Level.WARNING, "Unknown object identifier " + str, (Throwable) e10);
            keyAgreementAlgorithm = null;
        }
        if (!"ECDH".equals(keyAgreementAlgorithm) && !"DH".equals(keyAgreementAlgorithm)) {
            throw new IllegalArgumentException(b.e("Unsupported agreement algorithm, expected ECDH or DH, found ", keyAgreementAlgorithm));
        }
        try {
            ...
            SecureMessagingWrapper secureMessagingWrapperRestartSecureMessaging = restartSecureMessaging(str, computeSharedSecret(keyAgreementAlgorithm, publicKey, privateKey), this.maxTranceiveLength, this.shouldCheckMAC);
            this.wrapper = secureMessagingWrapperRestartSecureMessaging;
            return new EACCAResult(bigInteger, publicKey, keyHash, publicKey2, privateKey, secureMessagingWrapperRestartSecureMessaging);
