...
public class EACTAResult implements Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        PrivateKey privateKey2 = eACTAResult.terminalKey;
    ...
    public int hashCode() {
        CVCPrincipal cVCPrincipal = this.caReference;
        int r32 = (Arrays.hashCode(this.cardChallenge) + (((cVCPrincipal == null ? 0 : cVCPrincipal.hashCode()) + 31) * 31)) * 31;
        EACCAResult eACCAResult = this.chipAuthenticationResult;
        int r33 = (r32 + (eACCAResult == null ? 0 : eACCAResult.hashCode())) * 31;
        String str = this.documentNumber;
        int r34 = (r33 + (str == null ? 0 : str.hashCode())) * 31;
        List<CardVerifiableCertificate> list = this.terminalCertificates;
        int r35 = (r34 + (list == null ? 0 : list.hashCode())) * 31;
        PrivateKey privateKey = this.terminalKey;
        return r35 + (privateKey != null ? privateKey.hashCode() : 0);
    }
