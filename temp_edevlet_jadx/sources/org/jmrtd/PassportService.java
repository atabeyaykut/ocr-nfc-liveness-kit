...
public class PassportService extends AbstractMRTDCardService {
    ...
    public PassportService(CardService cardService, int r32, int r42, int r52, boolean z10, boolean z11) {
        ...
        this.maxTranceiveLengthForPACEProtocol = r32;
        this.maxTranceiveLengthForSecureMessaging = r42;
        this.maxBlockSize = r52;
    ...
    public PassportService(CardService cardService, int r92, int r10, boolean z10, boolean z11) {
        this(cardService, 256, r92, r10, z10, z11);
    }
    ...
    @Deprecated
    public synchronized CardFileInputStream getInputStream(short s7) throws CardServiceException {
        return getInputStream(s7, this.maxBlockSize);
    }

    @Override // org.jmrtd.FileSystemCardService
    public synchronized CardFileInputStream getInputStream(short s7, int r42) throws CardServiceException {
        ...
        if (this.isAppletSelected) {
            synchronized (this.appletFileSystem) {
                this.appletFileSystem.selectFile(s7);
                cardFileInputStream = new CardFileInputStream(r42, this.appletFileSystem);
            }
            return cardFileInputStream;
        }
        synchronized (this.rootFileSystem) {
            this.rootFileSystem.selectFile(s7);
            cardFileInputStream2 = new CardFileInputStream(r42, this.rootFileSystem);
        }
    ...
    @Override // org.jmrtd.AbstractMRTDCardService
    public void sendSelectApplet(boolean z10) throws CardServiceException {
        if (this.isAppletSelected) {
