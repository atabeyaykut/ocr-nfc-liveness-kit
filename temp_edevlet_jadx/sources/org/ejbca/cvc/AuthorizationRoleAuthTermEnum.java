...
public enum AuthorizationRoleAuthTermEnum implements AuthorizationRole {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            int[] r02 = new int[AuthorizationRoleAuthTermEnum.values().length];
            $SwitchMap$org$ejbca$cvc$AuthorizationRoleAuthTermEnum = r02;
            try {
                r02[AuthorizationRoleAuthTermEnum.CVCA.ordinal()] = 1;
    ...
    AuthorizationRoleAuthTermEnum(int r32) {
        this.value = (byte) r32;
    }
    ...
    public String toString() {
        int r02 = AnonymousClass1.$SwitchMap$org$ejbca$cvc$AuthorizationRoleAuthTermEnum[ordinal()];
        if (r02 == 1) {
            return "CVCA";
        }
        if (r02 == 2) {
