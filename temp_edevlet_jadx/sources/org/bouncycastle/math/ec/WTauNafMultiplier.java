...
public class WTauNafMultiplier extends AbstractECMultiplier {
    ...
    private static ECPoint.AbstractF2m multiplyFromWTnaf(final ECPoint.AbstractF2m abstractF2m, byte[] bArr) {
        ...
        for (int r32 = 0; r32 < preComp.length; r32++) {
            abstractF2mArr[r32] = (ECPoint.AbstractF2m) preComp[r32].negate();
        }
        ...
        for (int length = bArr.length - 1; length >= 0; length--) {
            ...
            if (b10 != 0) {
                abstractF2m3 = (ECPoint.AbstractF2m) abstractF2m3.tauPow(r42).add(b10 > 0 ? preComp[b10 >>> 1] : abstractF2mArr[(-b10) >>> 1]);
                r42 = 0;
            }
        }
        return r42 > 0 ? abstractF2m3.tauPow(r42) : abstractF2m3;
    }
