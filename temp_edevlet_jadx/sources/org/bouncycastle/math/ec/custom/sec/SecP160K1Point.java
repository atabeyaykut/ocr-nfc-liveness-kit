...
public class SecP160K1Point extends ECPoint.AbstractFp {
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160K1Point(this.curve, this.f11727x, this.f11728y.negate(), this.zs);
    }
    ...
    public ECPoint twice() {
        ...
        SecP160R2Field.square(secP160R2FieldElement.f11741x, r52);
        int[] r6 = Nat160.create();
        SecP160R2Field.square(r52, r6);
        int[] r72 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement2.f11741x, r72);
        SecP160R2Field.reduce32(Nat160.addBothTo(r72, r72, r72), r72);
        SecP160R2Field.multiply(r52, secP160R2FieldElement2.f11741x, r52);
        SecP160R2Field.reduce32(Nat.shiftUpBits(5, r52, 2, 0), r52);
        int[] r22 = Nat160.create();
        SecP160R2Field.reduce32(Nat.shiftUpBits(5, r6, 3, 0, r22), r22);
        SecP160R2FieldElement secP160R2FieldElement4 = new SecP160R2FieldElement(r6);
        SecP160R2Field.square(r72, secP160R2FieldElement4.f11741x);
        int[] r62 = secP160R2FieldElement4.f11741x;
        SecP160R2Field.subtract(r62, r52, r62);
        int[] r63 = secP160R2FieldElement4.f11741x;
        SecP160R2Field.subtract(r63, r52, r63);
        SecP160R2FieldElement secP160R2FieldElement5 = new SecP160R2FieldElement(r52);
        SecP160R2Field.subtract(r52, secP160R2FieldElement4.f11741x, secP160R2FieldElement5.f11741x);
        int[] r53 = secP160R2FieldElement5.f11741x;
        SecP160R2Field.multiply(r53, r72, r53);
        int[] r54 = secP160R2FieldElement5.f11741x;
        SecP160R2Field.subtract(r54, r22, r54);
        SecP160R2FieldElement secP160R2FieldElement6 = new SecP160R2FieldElement(r72);
