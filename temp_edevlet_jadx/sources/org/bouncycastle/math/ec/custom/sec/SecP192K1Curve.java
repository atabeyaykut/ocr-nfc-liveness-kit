...
public class SecP192K1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f11742q = SecP192K1FieldElement.Q;
    ...
    public SecP192K1Curve() {
        ...
        this.f11715b = fromBigInteger(BigInteger.valueOf(3L));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int r82, final int r92) {
        ...
        for (int r22 = 0; r22 < r92; r22++) {
            ...
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawXCoord()).f11743x, 0, r02, r32);
            int r33 = r32 + 6;
            Nat192.copy(((SecP192K1FieldElement) eCPoint.getRawYCoord()).f11743x, 0, r02, r33);
            r32 = r33 + 6;
        }
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecP192K1Curve.1
            private ECPoint createPoint(int[] r34, int[] r42) {
                return SecP192K1Curve.this.createRawPoint(new SecP192K1FieldElement(r34), new SecP192K1FieldElement(r42), SecP192K1Curve.SECP192K1_AFFINE_ZS);
            }
    ...
    public ECFieldElement randomFieldElement(SecureRandom secureRandom) {
        ...
        SecP192K1Field.random(secureRandom, r02);
    ...
    public ECFieldElement randomFieldElementMult(SecureRandom secureRandom) {
        int[] r02 = Nat192.create();
        SecP192K1Field.randomMult(secureRandom, r02);
        return new SecP192K1FieldElement(r02);
    }
