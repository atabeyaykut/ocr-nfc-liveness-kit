...
public class SecT283R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        ECFieldElement eCFieldElementG = a.g(eCFieldElement, eCFieldElementMultiply2, eCFieldElementSquare);
        if (eCFieldElementG.isZero()) {
            return new SecT283R1Point(curve, eCFieldElementG, curve.getB().sqrt());
        }
        ...
        return new SecT283R1Point(curve, eCFieldElementSquare2, eCFieldElementMultiply.squarePlusProduct(eCFieldElementG, eCFieldElementMultiply2).add(eCFieldElementSquare2).add(eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3});
    }
