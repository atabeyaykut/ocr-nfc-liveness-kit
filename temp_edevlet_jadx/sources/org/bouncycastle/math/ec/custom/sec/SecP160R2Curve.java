...
public class SecP160R2Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f11740q = SecP160R2FieldElement.Q;
    ...
    public SecP160R2Curve() {
        ...
        this.f11714a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70")));
        this.f11715b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B4E134D3FB59EB8BAB57274904664D5AF50388BA")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int r82, final int r92) {
        final int[] r02 = new int[r92 * 5 * 2];
        int r32 = 0;
        for (int r22 = 0; r22 < r92; r22++) {
            ECPoint eCPoint = eCPointArr[r82 + r22];
            Nat160.copy(((SecP160R2FieldElement) eCPoint.getRawXCoord()).f11741x, 0, r02, r32);
            int r33 = r32 + 5;
            Nat160.copy(((SecP160R2FieldElement) eCPoint.getRawYCoord()).f11741x, 0, r02, r33);
            r32 = r33 + 5;
        }
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecP160R2Curve.1
            private ECPoint createPoint(int[] r34, int[] r42) {
                return SecP160R2Curve.this.createRawPoint(new SecP160R2FieldElement(r34), new SecP160R2FieldElement(r42), SecP160R2Curve.SECP160R2_AFFINE_ZS);
            }
            ...
            public ECPoint lookup(int r11) {
                ...
                for (int r34 = 0; r34 < r92; r34++) {
                    ...
                    for (int r6 = 0; r6 < 5; r6++) {
                        ...
                        r12[r6] = r12[r6] ^ (r83[(r42 + 5) + r6] & r52);
                    }
                    r42 += 10;
                }
            ...
            public ECPoint lookupVar(int r72) {
                ...
                int[] r12 = Nat160.create();
                int r73 = r72 * 5 * 2;
                for (int r34 = 0; r34 < 5; r34++) {
                    int[] r42 = r02;
                    r03[r34] = r42[r73 + r34];
                    r12[r34] = r42[r73 + 5 + r34];
                }
                return createPoint(r03, r12);
            }
        };
    ...
    public ECFieldElement randomFieldElement(SecureRandom secureRandom) {
        ...
        SecP160R2Field.random(secureRandom, r02);
    ...
    public ECFieldElement randomFieldElementMult(SecureRandom secureRandom) {
        int[] r02 = Nat160.create();
        SecP160R2Field.randomMult(secureRandom, r02);
        return new SecP160R2FieldElement(r02);
    }
