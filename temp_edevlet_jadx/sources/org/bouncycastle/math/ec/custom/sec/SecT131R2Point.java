...
public class SecT131R2Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementMultiply8.isZero()) {
                return new SecT131R2Point(curve, eCFieldElementMultiply8, curve.getB().sqrt());
            }
        ...
        return new SecT131R2Point(curve, eCFieldElementAdd, eCFieldElementSquarePlusProduct, new ECFieldElement[]{eCFieldElementMultiply4});
    }
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElementG.isZero()) {
            return new SecT131R2Point(curve, eCFieldElementG, curve.getB().sqrt());
        }
        ...
        return new SecT131R2Point(curve, eCFieldElementSquare2, eCFieldElementMultiply.squarePlusProduct(eCFieldElementG, eCFieldElementMultiply2).add(eCFieldElementSquare2).add(eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3});
    }
