...
public class SecT163K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        ECFieldElement eCFieldElementMultiply4 = this.f11727x;
    ...
    public ECPoint twice() {
        ...
        ECFieldElement eCFieldElementG = a.g(eCFieldElement2, eCFieldElementMultiply, eCFieldElementSquare);
        if (eCFieldElementG.isZero()) {
            return new SecT163K1Point(curve, eCFieldElementG, curve.getB());
        }
        ECFieldElement eCFieldElementSquare2 = eCFieldElementG.square();
        ECFieldElement eCFieldElementMultiply2 = zIsOne ? eCFieldElementG : eCFieldElementG.multiply(eCFieldElementSquare);
        ECFieldElement eCFieldElementSquare3 = eCFieldElement2.add(eCFieldElement).square();
        return new SecT163K1Point(curve, eCFieldElementSquare2, eCFieldElementSquare3.add(eCFieldElementG).add(eCFieldElementSquare).multiply(eCFieldElementSquare3).add(eCFieldElementSquare2), new ECFieldElement[]{eCFieldElementMultiply2});
    }
