...
public class SecP256R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f11752q = SecP256R1FieldElement.Q;
    ...
    public SecP256R1Curve() {
        ...
        this.f11714a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFF00000001000000000000000000000000FFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f11715b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("5AC635D8AA3A93E7B3EBBD55769886BC651D06B0CC53B0F63BCE3C3E27D2604B")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int r82, final int r92) {
        ...
        for (int r22 = 0; r22 < r92; r22++) {
            ...
            Nat256.copy(((SecP256R1FieldElement) eCPoint.getRawXCoord()).f11753x, 0, r02, r32);
            int r33 = r32 + 8;
            Nat256.copy(((SecP256R1FieldElement) eCPoint.getRawYCoord()).f11753x, 0, r02, r33);
            r32 = r33 + 8;
        }
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecP256R1Curve.1
            private ECPoint createPoint(int[] r34, int[] r42) {
                return SecP256R1Curve.this.createRawPoint(new SecP256R1FieldElement(r34), new SecP256R1FieldElement(r42), SecP256R1Curve.SECP256R1_AFFINE_ZS);
            }
    ...
    public ECFieldElement randomFieldElement(SecureRandom secureRandom) {
        ...
        SecP256R1Field.random(secureRandom, r02);
    ...
    public ECFieldElement randomFieldElementMult(SecureRandom secureRandom) {
        int[] r02 = Nat256.create();
        SecP256R1Field.randomMult(secureRandom, r02);
        return new SecP256R1FieldElement(r02);
    }
