...
public class DiscoverEndomorphisms {
    ...
    private static BigInteger firstNonResidue(BigInteger bigInteger, BigInteger bigInteger2) {
        for (int r02 = 2; r02 < 1000; r02++) {
            BigInteger bigIntegerValueOf = BigInteger.valueOf(r02);
    ...
    private static boolean isLessThanSqrt(BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        int r02 = bigIntegerAbs2.bitLength();
        int r12 = bigIntegerAbs.bitLength() * 2;
        return r12 + (-1) <= r02 && (r12 < r02 || bigIntegerAbs.multiply(bigIntegerAbs).compareTo(bigIntegerAbs2) < 0);
    }
    ...
    private static void printGLVTypeAParameters(X9ECParameters x9ECParameters) {
        ...
        BigInteger[] bigIntegerArrSolveQuadraticEquation = solveQuadraticEquation(n10, bigInteger, ECConstants.ZERO, bigInteger);
    ...
    private static void printGLVTypeBParameters(X9ECParameters x9ECParameters) {
        BigInteger n10 = x9ECParameters.getN();
        BigInteger bigInteger = ECConstants.ONE;
        BigInteger[] bigIntegerArrSolveQuadraticEquation = solveQuadraticEquation(n10, bigInteger, bigInteger, bigInteger);
    ...
    private static void printScalarDecompositionParameters(BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        int r12 = (bigInteger.bitLength() + 16) - (bigInteger.bitLength() & 7);
        BigInteger bigIntegerRoundQuotient = roundQuotient(bigIntegerArrChooseShortest[1].shiftLeft(r12), bigIntegerSubtract3);
        BigInteger bigIntegerNegate5 = roundQuotient(bigIntegerArr[1].shiftLeft(r12), bigIntegerSubtract3).negate();
        ...
        printProperty("(OPT) bits", Integer.toString(r12));
    }
