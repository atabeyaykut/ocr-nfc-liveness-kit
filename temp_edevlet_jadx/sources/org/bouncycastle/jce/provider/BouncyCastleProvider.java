...
public final class BouncyCastleProvider extends Provider implements ConfigurableProvider {
    ...
    public static class JcaCryptoService implements CryptoServiceProperties {
        ...
        public JcaCryptoService(String str, int r22) {
            this.name = str;
    ...
    private void loadAlgorithms(String str, String[] strArr) {
        for (int r02 = 0; r02 != strArr.length; r02++) {
            loadServiceClass(str, strArr[r02]);
        }
    }

    private void loadAlgorithms(String str, CryptoServiceProperties[] cryptoServicePropertiesArr) {
        for (int r02 = 0; r02 != cryptoServicePropertiesArr.length; r02++) {
            CryptoServiceProperties cryptoServiceProperties = cryptoServicePropertiesArr[r02];
            try {
    ...
    private void loadPQCKeys() {
        a.l(this, BCObjectIdentifiers.sphincsPlus);
        a.l(this, BCObjectIdentifiers.sphincsPlus_sha2_128s_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_sha2_128f_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_shake_128s_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_shake_128f_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_haraka_128s_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_haraka_128f_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_sha2_192s_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_sha2_192f_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_shake_192s_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_shake_192f_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_haraka_192s_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_haraka_192f_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_sha2_256s_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_sha2_256f_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_shake_256s_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_shake_256f_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_haraka_256s_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_haraka_256f_r3);
        a.l(this, BCObjectIdentifiers.sphincsPlus_sha2_128s_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_sha2_128f_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_shake_128s_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_shake_128f_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_haraka_128s_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_haraka_128f_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_sha2_192s_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_sha2_192f_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_shake_192s_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_shake_192f_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_haraka_192s_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_haraka_192f_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_sha2_256s_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_sha2_256f_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_shake_256s_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_shake_256f_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_haraka_256s_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_haraka_256f_r3_simple);
        a.l(this, BCObjectIdentifiers.sphincsPlus_sha2_128s);
        a.l(this, BCObjectIdentifiers.sphincsPlus_sha2_192s);
        addKeyInfoConverter(BCObjectIdentifiers.sphincsPlus_sha2_256s, new SPHINCSPlusKeyFactorySpi());
        a.l(this, new ASN1ObjectIdentifier("1.3.9999.6.4.10"));
        a.l(this, BCObjectIdentifiers.sphincsPlus_shake_128f);
        a.l(this, BCObjectIdentifiers.sphincsPlus_shake_192f);
        a.l(this, BCObjectIdentifiers.sphincsPlus_shake_256f);
    ...
    private static CryptoServiceProperties service(String str, int r22) {
        return new JcaCryptoService(str, r22);
    }
    ...
    public void addAlgorithm(String str, String str2) {
        if (containsKey(str)) {
            throw new IllegalStateException(androidx.browser.browseractions.a.a("duplicate provider key (", str, ") found"));
        }
        put(str, str2);
    }
    ...
    public void addAttributes(String str, Map<String, String> map) {
        ...
        for (String str2 : map.keySet()) {
            ...
            if (containsKey(strG)) {
                throw new IllegalStateException(androidx.browser.browseractions.a.a("duplicate provider attribute key (", strG, ") found"));
            }
            put(strG, map.get(str2));
        }
    }
    ...
    public final Provider.Service getService(final String str, final String str2) {
        final String strG = f.g(str, ".", Strings.toUpperCase(str2));
        Provider.Service service = this.serviceMap.get(strG);
        if (service == null) {
            synchronized (this) {
                service = (Provider.Service) (!this.serviceMap.containsKey(strG) ? AccessController.doPrivileged(new PrivilegedAction<Provider.Service>() { // from class: org.bouncycastle.jce.provider.BouncyCastleProvider.2
                    @Override // java.security.PrivilegedAction
