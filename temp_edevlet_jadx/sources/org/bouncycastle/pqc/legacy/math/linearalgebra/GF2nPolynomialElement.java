...
public class GF2nPolynomialElement extends GF2nElement {
    ...
    public GF2nPolynomialElement(GF2nPolynomialField gF2nPolynomialField, int[] r42) {
        this.mField = gF2nPolynomialField;
        this.mDegree = gF2nPolynomialField.getDegree();
        GF2Polynomial gF2Polynomial = new GF2Polynomial(this.mDegree, r42);
        this.polynomial = gF2Polynomial;
    ...
    private GF2nPolynomialElement halfTrace() throws RuntimeException {
        ...
        for (int r22 = 1; r22 <= ((this.mDegree - 1) >> 1); r22++) {
    ...
    private void reducePentanomialBitwise(int[] r6) throws RuntimeException {
        ...
        for (int length = this.polynomial.getLength() - 1; length >= this.mDegree; length--) {
            if (this.polynomial.testBit(length)) {
                ...
                this.polynomial.xorBit(length - r12);
                this.polynomial.xorBit(length - r32);
                this.polynomial.xorBit(length - r03);
    ...
    private void reduceThis() throws RuntimeException {
        ...
        if (((GF2nPolynomialField) this.mField).isTrinomial()) {
            try {
                ...
                if (this.mDegree - tc2 > 32) {
                    ...
                    int r22 = this.mDegree;
                    if (length2 <= (r22 << 1)) {
                        this.polynomial.reduceTrinomial(r22, tc2);
                        return;
                    }
                }
        ...
        try {
            ...
            if (this.mDegree - pc2[2] > 32) {
                ...
                if (length3 <= (r23 << 1)) {
                    this.polynomial.reducePentanomial(r23, pc2);
                    return;
                }
            }
    ...
    private void reduceTrinomialBitwise(int r42) throws RuntimeException {
        int r02 = this.mDegree - r42;
        int length = this.polynomial.getLength();
        while (true) {
            length--;
            if (length < this.mDegree) {
                ...
                this.polynomial.xorBit(length);
                this.polynomial.xorBit(length - r02);
                this.polynomial.xorBit(length - this.mDegree);
            }
        }
    }
    ...
    public GF2nPolynomialElement invertSquare() throws RuntimeException {
        ...
        int r42 = 1;
        for (int r32 = IntegerFunctions.floorLog(degree) - 1; r32 >= 0; r32--) {
    ...
    public GF2nPolynomialElement power(int r6) throws RuntimeException {
        if (r6 == 1) {
            return new GF2nPolynomialElement(this);
        }
    ...
    public void squareRootThis() throws RuntimeException {
        ...
        this.polynomial.reduceN();
        for (int r02 = 0; r02 < this.mField.getDegree() - 1; r02++) {
            squareThis();
        }
    }
    ...
    public void squareThisMatrix() throws RuntimeException {
        ...
        while (true) {
            if (r12 >= this.mDegree) {
                ...
                if (this.polynomial.vectorMult(((GF2nPolynomialField) this.mField).squaringMatrix[(r2 - r12) - 1])) {
                    gF2Polynomial.setBit(r12);
                }
                r12++;
            }
        }
    ...
    @Override // org.bouncycastle.pqc.legacy.math.linearalgebra.GF2nElement
    public boolean testBit(int r22) {
        return this.polynomial.testBit(r22);
    }
    ...
    @Override // org.bouncycastle.pqc.legacy.math.linearalgebra.GFElement
    public String toString(int r22) {
        return this.polynomial.toString(r22);
    }

    @Override // org.bouncycastle.pqc.legacy.math.linearalgebra.GF2nElement
    public int trace() throws RuntimeException {
        GF2nPolynomialElement gF2nPolynomialElement = new GF2nPolynomialElement(this);
        for (int r22 = 1; r22 < this.mDegree; r22++) {
            gF2nPolynomialElement.squareThis();
            gF2nPolynomialElement.addToThis(this);
        }
