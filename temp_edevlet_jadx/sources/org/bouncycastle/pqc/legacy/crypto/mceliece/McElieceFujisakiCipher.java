...
public class McElieceFujisakiCipher implements MessageEncryptor {
    ...
    private void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f11998n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f11999t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        this.messDigest = Utils.getDigest(mcElieceCCA2PublicKeyParameters.getDigest());
        this.f11998n = mcElieceCCA2PublicKeyParameters.getN();
        this.f11997k = mcElieceCCA2PublicKeyParameters.getK();
        this.f11999t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException, ArrayIndexOutOfBoundsException {
        ...
        int r02 = (this.f11998n + 7) >> 3;
        int length = bArr.length - r02;
        byte[][] bArrSplit = ByteUtils.split(bArr, r02);
        byte[] bArr2 = bArrSplit[0];
        byte[] bArr3 = bArrSplit[1];
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f11998n, bArr2));
        ...
        if (Conversions.encode(this.f11998n, this.f11999t, bArr5).equals(gF2Vector)) {
            return bArr4;
        }
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        GF2Vector gF2Vector = new GF2Vector(this.f11997k, this.sr);
        ...
        byte[] encoded2 = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, gF2Vector, Conversions.encode(this.f11998n, this.f11999t, bArr2)).getEncoded();
        DigestRandomGenerator digestRandomGenerator = new DigestRandomGenerator(new SHA1Digest());
        digestRandomGenerator.addSeedMaterial(encoded);
        byte[] bArr3 = new byte[bArr.length];
        digestRandomGenerator.nextBytes(bArr3);
        for (int r52 = 0; r52 < bArr.length; r52++) {
            bArr3[r52] = (byte) (bArr3[r52] ^ bArr[r52]);
        }
