...
public class GMSSPublicKey extends ASN1Object {
    ...
    private GMSSPublicKey(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() != 2) {
            throw new IllegalArgumentException(a.g(aSN1Sequence, new StringBuilder("size of seq = ")));
        }
        this.version = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(0));
        this.publicKey = androidx.appcompat.graphics.drawable.a.k(aSN1Sequence, 1);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        return a.j(aSN1EncodableVector, new DEROctetString(this.publicKey), aSN1EncodableVector);
    }
}
