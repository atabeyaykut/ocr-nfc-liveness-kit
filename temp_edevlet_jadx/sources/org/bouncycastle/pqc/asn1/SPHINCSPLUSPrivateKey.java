...
public class SPHINCSPLUSPrivateKey extends ASN1Object {
    ...
    public SPHINCSPLUSPrivateKey(int r22, byte[] bArr, byte[] bArr2) {
        this(r22, bArr, bArr2, null);
    }

    public SPHINCSPLUSPrivateKey(int r12, byte[] bArr, byte[] bArr2, SPHINCSPLUSPublicKey sPHINCSPLUSPublicKey) {
        this.version = r12;
        this.skseed = bArr;
        this.skprf = bArr2;
    ...
    public SPHINCSPLUSPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.skseed = a.i(aSN1Sequence, 1);
        this.skprf = a.i(aSN1Sequence, 2);
