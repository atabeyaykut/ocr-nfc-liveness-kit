...
final class WOTSPlusParameters {
    ...
    public WOTSPlusParameters(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        int r22 = (int) Math.ceil((digestSize * 8) / XMSSUtil.log2(16));
        this.len1 = r22;
        int r42 = ((int) Math.floor(XMSSUtil.log2((16 - 1) * r22) / XMSSUtil.log2(16))) + 1;
        this.len2 = r42;
        int r23 = r22 + r42;
        this.len = r23;
        WOTSPlusOid wOTSPlusOidLookup = WOTSPlusOid.lookup(digest.getAlgorithmName(), digestSize, 16, r23);
