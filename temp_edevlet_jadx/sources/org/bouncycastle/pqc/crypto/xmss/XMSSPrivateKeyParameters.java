...
public final class XMSSPrivateKeyParameters extends XMSSKeyParameters implements XMSSStoreableObjectInterface, Encodable {
    ...
    public static class Builder {
        ...
        public Builder withMaxIndex(int r12) {
            this.maxIndex = r12;
            return this;
        }
    ...
    private XMSSPrivateKeyParameters(Builder builder) {
        ...
        if (bArr != null) {
            ...
            int r32 = Pack.bigEndianToInt(bArr, 0);
            if (!XMSSUtil.isIndexValid(height, r32)) {
                throw new IllegalArgumentException("index out of bounds");
            }
            this.secretKeySeed = XMSSUtil.extractBytesAtOffset(bArr, 4, treeDigestSize);
            int r12 = 4 + treeDigestSize;
            this.secretKeyPRF = XMSSUtil.extractBytesAtOffset(bArr, r12, treeDigestSize);
            int r13 = r12 + treeDigestSize;
            this.publicSeed = XMSSUtil.extractBytesAtOffset(bArr, r13, treeDigestSize);
            int r14 = r13 + treeDigestSize;
            this.root = XMSSUtil.extractBytesAtOffset(bArr, r14, treeDigestSize);
            int r15 = r14 + treeDigestSize;
            try {
                BDS bds = (BDS) XMSSUtil.deserialize(XMSSUtil.extractBytesAtOffset(bArr, r15, bArr.length - r15), BDS.class);
                if (bds.getIndex() != r32) {
    ...
    public XMSSPrivateKeyParameters extractKeyShard(int r72) {
        ...
        synchronized (this) {
            ...
            xMSSPrivateKeyParametersBuild = new Builder(this.params).withSecretKeySeed(this.secretKeySeed).withSecretKeyPRF(this.secretKeyPRF).withPublicSeed(this.publicSeed).withRoot(this.root).withIndex(getIndex()).withBDSState(this.bdsState.withMaxIndex((this.bdsState.getIndex() + r72) - 1, this.params.getTreeDigestOID())).build();
            if (j10 == getUsagesRemaining()) {
                this.bdsState = new BDS(this.params, this.bdsState.getMaxIndex(), getIndex() + r72);
            } else {
    ...
    public byte[] toByteArray() {
        ...
        synchronized (this) {
            ...
            XMSSUtil.copyBytesAtOffset(bArr, this.secretKeyPRF, r42);
            int r43 = r42 + treeDigestSize;
            XMSSUtil.copyBytesAtOffset(bArr, this.publicSeed, r43);
            XMSSUtil.copyBytesAtOffset(bArr, this.root, r43 + treeDigestSize);
            try {
