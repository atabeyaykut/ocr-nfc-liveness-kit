...
public class LMSigParameters {
    ...
    public static LMSigParameters getParametersForType(int r12) {
        return paramBuilders.get(Integer.valueOf(r12));
    }
