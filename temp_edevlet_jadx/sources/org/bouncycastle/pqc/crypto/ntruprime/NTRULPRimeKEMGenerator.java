...
public class NTRULPRimeKEMGenerator implements EncapsulatedSecretGenerator {
    ...
    public SecretWithEncapsulation generateEncapsulated(AsymmetricKeyParameter asymmetricKeyParameter) throws DataLengthException, IllegalArgumentException {
        ...
        Utils.getRoundedDecodedPolynomial(sArr, nTRULPRimePublicKeyParameters.getRoundEncA(), p10, q10);
        short[] sArr2 = new short[p10];
        Utils.generatePolynomialInRQFromSeed(sArr2, nTRULPRimePublicKeyParameters.getSeed(), p10, q10);
        byte[] hashWithPrefix2 = Utils.getHashWithPrefix(new byte[]{5}, bArr2);
        int[] r10 = new int[p10];
        Utils.expand(r10, Arrays.copyOfRange(hashWithPrefix2, 0, hashWithPrefix2.length / 2));
        byte[] bArr3 = new byte[p10];
        Utils.sortGenerateShortPolynomial(bArr3, r10, p10, w);
        short[] sArr3 = new short[p10];
        Utils.multiplicationInRQ(sArr3, sArr2, bArr3, p10, q10);
        short[] sArr4 = new short[p10];
        Utils.roundPolynomial(sArr4, sArr3);
        byte[] bArr4 = new byte[roundedPolynomialBytes];
        Utils.getRoundedEncodedPolynomial(bArr4, sArr4, p10, q10);
        short[] sArr5 = new short[p10];
        Utils.multiplicationInRQ(sArr5, sArr, bArr3, p10, q10);
        ...
        int r42 = roundedPolynomialBytes + 128;
        int length = (hashWithPrefix3.length / 2) + r42;
        byte[] bArr8 = new byte[length];
        System.arraycopy(bArr4, 0, bArr8, 0, roundedPolynomialBytes);
        System.arraycopy(bArr6, 0, bArr8, roundedPolynomialBytes, 128);
        System.arraycopy(hashWithPrefix3, 0, bArr8, r42, hashWithPrefix3.length / 2);
