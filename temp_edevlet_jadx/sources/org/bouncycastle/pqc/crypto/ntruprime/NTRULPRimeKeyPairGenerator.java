...
public class NTRULPRimeKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public AsymmetricCipherKeyPair generateKeyPair() throws DataLengthException, IllegalArgumentException {
        int p10 = this.params.getNtrulprParams().getP();
        ...
        Utils.generatePolynomialInRQFromSeed(sArr, bArr, p10, q10);
        byte[] bArr2 = new byte[p10];
        Utils.getRandomShortPolynomial(this.params.getRandom(), bArr2, p10, w);
        ...
        Utils.getRoundedEncodedPolynomial(bArr3, sArr3, p10, q10);
        ...
        Utils.getEncodedSmallPolynomial(bArr4, bArr2, p10);
