...
public class SNTRUPrimeKEMGenerator implements EncapsulatedSecretGenerator {
    ...
    public SecretWithEncapsulation generateEncapsulated(AsymmetricKeyParameter asymmetricKeyParameter) {
        ...
        Utils.getRandomShortPolynomial(this.random, bArr, p10, w);
        byte[] bArr2 = new byte[(p10 + 3) / 4];
        Utils.getEncodedSmallPolynomial(bArr2, bArr, p10);
        short[] sArr = new short[p10];
        Utils.getDecodedPolynomial(sArr, sNTRUPrimePublicKeyParameters.getEncH(), p10, q10);
