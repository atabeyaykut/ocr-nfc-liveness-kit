...
public class HQCKeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    private AsymmetricCipherKeyPair genKeyPair(byte[] bArr) {
        ...
        int r12 = this.N_BYTE;
        byte[] bArr2 = new byte[r12 + 40];
        byte[] bArr3 = new byte[r12 + 80];
    ...
    public void init(KeyGenerationParameters keyGenerationParameters) {
        ...
        this.f11902n = this.hqcKeyGenerationParameters.getParameters().getN();
        this.f11901k = this.hqcKeyGenerationParameters.getParameters().getK();
        ...
        this.f11903we = this.hqcKeyGenerationParameters.getParameters().getWe();
        this.N_BYTE = (this.f11902n + 7) / 8;
    }
}
