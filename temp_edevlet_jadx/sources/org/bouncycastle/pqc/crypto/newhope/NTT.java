...
class NTT {
    ...
    public static void core(short[] sArr, short[] sArr2) {
        for (int r12 = 0; r12 < 10; r12 += 2) {
            int r22 = 1 << r12;
            for (int r32 = 0; r32 < r22; r32++) {
                int r72 = r32;
                int r82 = 0;
                while (r72 < 1023) {
                    int r92 = sArr[r72] & HPKE.aead_EXPORT_ONLY;
                    int r10 = r72 + r22;
                    int r11 = sArr[r10] & HPKE.aead_EXPORT_ONLY;
                    int r122 = r82 + 1;
                    short s7 = sArr2[r82];
                    sArr[r72] = (short) (r92 + r11);
                    sArr[r10] = Reduce.montgomery(((r92 + 36867) - r11) * s7);
                    r72 += r22 * 2;
                    r82 = r122;
                }
            }
            ...
            for (int r33 = 0; r33 < r23; r33++) {
                ...
                int r83 = 0;
                while (r73 < 1023) {
                    int r93 = sArr[r73] & HPKE.aead_EXPORT_ONLY;
                    int r102 = r73 + r23;
                    int r112 = sArr[r102] & HPKE.aead_EXPORT_ONLY;
                    int r123 = r83 + 1;
                    short s10 = sArr2[r83];
                    sArr[r73] = Reduce.barrett((short) (r93 + r112));
                    sArr[r102] = Reduce.montgomery(((r93 + 36867) - r112) * s10);
                    r73 += r23 * 2;
                    r83 = r123;
                }
            }
    ...
    public static void mulCoefficients(short[] sArr, short[] sArr2) {
        for (int r02 = 0; r02 < 1024; r02++) {
            sArr[r02] = Reduce.montgomery((sArr[r02] & HPKE.aead_EXPORT_ONLY) * (65535 & sArr2[r02]));
        }
    }
}
