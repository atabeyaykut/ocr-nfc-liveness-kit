...
public class PrivateKeyFactory {
    private static short[] convert(byte[] bArr) {
        ...
        for (int r22 = 0; r22 != length; r22++) {
            sArr[r22] = Pack.littleEndianToShort(bArr, r22 * 2);
        }
        return sArr;
    }
    ...
    public static AsymmetricKeyParameter createKey(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if (algorithm.on(BCObjectIdentifiers.pqc_kem_ntrulprime)) {
            ...
            return new NTRULPRimePrivateKeyParameters(Utils.ntrulprimeParamsLookup(algorithm), a.k(aSN1Sequence, 0), a.k(aSN1Sequence, 1), a.k(aSN1Sequence, 2), a.k(aSN1Sequence, 3));
        }
        if (algorithm.on(BCObjectIdentifiers.pqc_kem_sntruprime)) {
            ...
            return new SNTRUPrimePrivateKeyParameters(Utils.sntruprimeParamsLookup(algorithm), a.k(aSN1Sequence2, 0), a.k(aSN1Sequence2, 1), a.k(aSN1Sequence2, 2), a.k(aSN1Sequence2, 3), a.k(aSN1Sequence2, 4));
        }
        if (algorithm.equals((ASN1Primitive) BCObjectIdentifiers.dilithium2) || algorithm.equals((ASN1Primitive) BCObjectIdentifiers.dilithium3) || algorithm.equals((ASN1Primitive) BCObjectIdentifiers.dilithium5)) {
            ...
            int r12 = f.f(aSN1Sequence3, 0);
            if (r12 != 0) {
                throw new IOException(android.support.v4.media.a.d("unknown private key version: ", r12));
            }
