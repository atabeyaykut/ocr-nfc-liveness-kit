...
class ADRS {
    ...
    public void changeType(int r32) {
        Pack.intToBigEndian(r32, this.value, 16);
    }
    ...
    public void setChainAddress(int r32) {
        Pack.intToBigEndian(r32, this.value, 24);
    }

    public void setHashAddress(int r32) {
        Pack.intToBigEndian(r32, this.value, 28);
    }

    public void setKeyPairAddress(int r32) {
        Pack.intToBigEndian(r32, this.value, 20);
    }

    public void setLayerAddress(int r32) {
        Pack.intToBigEndian(r32, this.value, 0);
    }

    public void setTreeAddress(long j10) {
        Pack.longToBigEndian(j10, this.value, 8);
    }

    public void setTreeHeight(int r32) {
        Pack.intToBigEndian(r32, this.value, 24);
    }

    public void setTreeIndex(int r32) {
        Pack.intToBigEndian(r32, this.value, 28);
    }

    public void setType(int r42) {
        Pack.intToBigEndian(r42, this.value, 16);
