...
class FalconVrfy {
    ...
    public boolean complete_private(byte[] bArr, int r16, byte[] bArr2, int r18, byte[] bArr3, int r20, byte[] bArr4, int r22, int r23, short[] sArr, int r25) {
        int r11 = 1 << r23;
        int r12 = r25 + r11;
        for (int r02 = 0; r02 < r11; r02++) {
            sArr[r25 + r02] = (short) mq_conv_small(bArr3[r20 + r02]);
            sArr[r12 + r02] = (short) mq_conv_small(bArr4[r22 + r02]);
        }
        mq_NTT(sArr, r25, r23);
        mq_NTT(sArr, r12, r23);
        mq_poly_tomonty(sArr, r25, r23);
        mq_poly_montymul_ntt(sArr, r25, sArr, r12, r23);
        for (int r03 = 0; r03 < r11; r03++) {
            sArr[r12 + r03] = (short) mq_conv_small(bArr2[r18 + r03]);
        }
        mq_NTT(sArr, r12, r23);
        boolean z10 = true;
        for (int r04 = 0; r04 < r11; r04++) {
            short s7 = sArr[r12 + r04];
            z10 &= s7 != 0;
            int r32 = r25 + r04;
            sArr[r32] = (short) mq_div_12289(sArr[r32], s7);
        }
        mq_iNTT(sArr, r25, r23);
        for (int r05 = 0; r05 < r11; r05++) {
            int r24 = sArr[r25 + r05] & HPKE.aead_EXPORT_ONLY;
            int r26 = r24 - ((~(-((r24 - 6144) >>> 31))) & 12289);
            z10 &= r26 >= -127 && r26 <= 127;
            bArr[r16 + r05] = (byte) r26;
        }
        return z10;
    }

    public int compute_public(short[] sArr, int r82, byte[] bArr, int r10, byte[] bArr2, int r12, int r13, short[] sArr2, int r15) {
        int r14 = 1 << r13;
        for (int r32 = 0; r32 < r14; r32++) {
            sArr2[r15 + r32] = (short) mq_conv_small(bArr[r10 + r32]);
            sArr[r82 + r32] = (short) mq_conv_small(bArr2[r12 + r32]);
        }
        mq_NTT(sArr, r82, r13);
        mq_NTT(sArr2, r15, r13);
        for (int r92 = 0; r92 < r14; r92++) {
            short s7 = sArr2[r15 + r92];
            if (s7 == 0) {
                return 0;
            }
            int r11 = r82 + r92;
            sArr[r11] = (short) mq_div_12289(sArr[r11], s7);
        }
        mq_iNTT(sArr, r82, r13);
        return 1;
    }

    public int count_nttzero(short[] sArr, int r82, int r92, short[] sArr2, int r11) {
        int r12 = 1 << r92;
        for (int r32 = 0; r32 < r12; r32++) {
            short s7 = sArr[r82 + r32];
            sArr2[r11 + r32] = (short) (s7 + ((-(s7 >>> 31)) & 12289));
        }
        mq_NTT(sArr2, r11, r92);
        int r72 = 0;
        for (int r22 = 0; r22 < r12; r22++) {
            r72 += ((sArr2[r11 + r22] & HPKE.aead_EXPORT_ONLY) - 1) >>> 31;
        }
        return r72;
    }

    public int is_invertible(short[] sArr, int r82, int r92, short[] sArr2, int r11) {
        int r12 = 1 << r92;
        for (int r32 = 0; r32 < r12; r32++) {
            short s7 = sArr[r82 + r32];
            sArr2[r11 + r32] = (short) (s7 + ((-(s7 >>> 31)) & 12289));
        ...
        int r72 = 0;
        for (int r22 = 0; r22 < r12; r22++) {
            r72 |= (sArr2[r11 + r22] & HPKE.aead_EXPORT_ONLY) - 1;
        }
        return 1 - (r72 >>> 31);
    }

    public void mq_NTT(short[] sArr, int r17, int r18) {
        int r12 = 1;
        int r22 = 1 << r18;
        int r32 = r22;
        while (r12 < r22) {
            ...
            int r6 = 0;
            while (r52 < r12) {
                short s7 = this.GMb[r12 + r52];
                int r82 = r6 + r42;
                for (int r92 = r6; r92 < r82; r92++) {
                    int r10 = r17 + r92;
                    int r11 = sArr[r10] & HPKE.aead_EXPORT_ONLY;
                    int r122 = r10 + r42;
                    int r13 = mq_montymul(sArr[r122], s7);
                    sArr[r10] = (short) mq_add(r11, r13);
                    sArr[r122] = (short) mq_sub(r11, r13);
                }
                r52++;
                r6 += r32;
            }
    ...
    public int mq_add(int r12, int r22) {
        int r13 = (r12 + r22) - 12289;
        return r13 + ((-(r13 >>> 31)) & 12289);
    }

    public int mq_conv_small(int r22) {
        return r22 + ((-(r22 >>> 31)) & 12289);
    }

    public int mq_div_12289(int r42, int r52) {
        int r53 = mq_montymul(r52, 10952);
        int r02 = mq_montysqr(r53);
        int r12 = mq_montymul(r02, r53);
        int r03 = mq_montysqr(mq_montysqr(mq_montysqr(mq_montysqr(mq_montysqr(mq_montymul(r12, r02))))));
        int r13 = mq_montymul(r03, r12);
        int r04 = mq_montymul(r13, r03);
        return mq_montymul(mq_montymul(mq_montysqr(mq_montymul(mq_montysqr(mq_montysqr(mq_montymul(mq_montysqr(mq_montysqr(r04)), r13))), r04)), r53), r42);
    }

    public void mq_iNTT(short[] sArr, int r18, int r19) {
        int r52;
        int r22 = 1 << r19;
        int r32 = r22;
        int r42 = 1;
        while (true) {
            ...
            while (r52 < r32) {
                int r82 = r72 + r42;
                short s7 = this.iGMb[r32 + r52];
                for (int r10 = r72; r10 < r82; r10++) {
                    int r11 = r18 + r10;
                    int r12 = sArr[r11] & HPKE.aead_EXPORT_ONLY;
                    int r14 = r11 + r42;
                    int r13 = 65535 & sArr[r14];
                    sArr[r11] = (short) mq_add(r12, r13);
                    sArr[r14] = (short) mq_montymul(mq_sub(r12, r13), s7);
                }
                r52++;
                r72 += r6;
            }
        ...
        int r33 = 4091;
        for (int r43 = r22; r43 > 1; r43 >>= 1) {
            r33 = mq_rshift1(r33);
        }
        while (r52 < r22) {
            int r15 = r18 + r52;
            sArr[r15] = (short) mq_montymul(sArr[r15], r33);
            r52++;
        }
    }

    public int mq_montymul(int r22, int r32) {
        int r23 = r22 * r32;
        int r24 = (((((r23 * 12287) & 65535) * 12289) + r23) >>> 16) - 12289;
        return r24 + ((-(r24 >>> 31)) & 12289);
    }

    public int mq_montysqr(int r12) {
        return mq_montymul(r12, r12);
    }

    public void mq_poly_montymul_ntt(short[] sArr, int r6, short[] sArr2, int r82, int r92) {
        int r93 = 1 << r92;
        for (int r02 = 0; r02 < r93; r02++) {
            int r12 = r6 + r02;
            sArr[r12] = (short) mq_montymul(sArr[r12], sArr2[r82 + r02]);
        }
    }

    public void mq_poly_sub(short[] sArr, int r6, short[] sArr2, int r82, int r92) {
        int r93 = 1 << r92;
        for (int r02 = 0; r02 < r93; r02++) {
            int r12 = r6 + r02;
            sArr[r12] = (short) mq_sub(sArr[r12], sArr2[r82 + r02]);
        }
    }

    public void mq_poly_tomonty(short[] sArr, int r6, int r72) {
        int r73 = 1 << r72;
        for (int r02 = 0; r02 < r73; r02++) {
            int r12 = r6 + r02;
            sArr[r12] = (short) mq_montymul(sArr[r12], 10952);
        }
    }

    public int mq_rshift1(int r22) {
        return (r22 + ((-(r22 & 1)) & 12289)) >>> 1;
    }

    public int mq_sub(int r12, int r22) {
        int r13 = r12 - r22;
        return r13 + ((-(r13 >>> 31)) & 12289);
    }

    public void to_ntt_monty(short[] sArr, int r22, int r32) {
        mq_NTT(sArr, r22, r32);
        mq_poly_tomonty(sArr, r22, r32);
    }

    public int verify_raw(short[] sArr, int r14, short[] sArr2, int r16, short[] sArr3, int r18, int r19, short[] sArr4, int r21) {
        int r10 = 1 << r19;
        for (int r02 = 0; r02 < r10; r02++) {
            short s7 = sArr2[r16 + r02];
            sArr4[r21 + r02] = (short) (s7 + ((-(s7 >>> 31)) & 12289));
        }
        mq_NTT(sArr4, r21, r19);
        mq_poly_montymul_ntt(sArr4, r21, sArr3, r18, r19);
        mq_iNTT(sArr4, r21, r19);
        mq_poly_sub(sArr4, r21, sArr, r14, r19);
        for (int r11 = 0; r11 < r10; r11++) {
            int r03 = r21 + r11;
            int r12 = sArr4[r03] & HPKE.aead_EXPORT_ONLY;
            sArr4[r03] = (short) (r12 - ((-((6144 - r12) >>> 31)) & 12289));
        }
        return this.common.is_short(sArr4, r21, sArr2, r16, r19);
    }

    public int verify_recover(short[] sArr, int r16, short[] sArr2, int r18, short[] sArr3, int r20, short[] sArr4, int r22, int r23, short[] sArr5, int r25) {
        int r72 = 1 << r23;
        for (int r92 = 0; r92 < r72; r92++) {
            short s7 = sArr4[r22 + r92];
            sArr5[r25 + r92] = (short) (s7 + ((-(s7 >> 31)) & 12289));
            short s10 = sArr3[r20 + r92];
            sArr[r16 + r92] = (short) mq_sub(sArr2[r18 + r92], 65535 & (s10 + ((-(s10 >>> 31)) & 12289)));
        }
        mq_NTT(sArr5, r25, r23);
        mq_NTT(sArr5, r16, r23);
        int r93 = 0;
        for (int r82 = 0; r82 < r72; r82++) {
            short s11 = sArr5[r25 + r82];
            r93 |= (s11 & HPKE.aead_EXPORT_ONLY) - 1;
            int r12 = r16 + r82;
            sArr[r12] = (short) mq_div_12289(sArr[r12] & HPKE.aead_EXPORT_ONLY, s11 & HPKE.aead_EXPORT_ONLY);
        }
        mq_iNTT(sArr, r16, r23);
        return ((-this.common.is_short(sArr3, r20, sArr4, r22, r23)) & (~r93)) >>> 31;
    }
}
