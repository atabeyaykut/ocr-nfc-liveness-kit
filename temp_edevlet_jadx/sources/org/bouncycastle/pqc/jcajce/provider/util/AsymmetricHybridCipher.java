...
public abstract class AsymmetricHybridCipher extends CipherSpiExt {
    ...
    public abstract int decryptOutputSize(int r12);

    @Override // org.bouncycastle.pqc.jcajce.provider.util.CipherSpiExt
    public final int doFinal(byte[] bArr, int r42, int r52, byte[] bArr2, int r72) throws BadPaddingException, ShortBufferException {
    ...
    @Override // org.bouncycastle.pqc.jcajce.provider.util.CipherSpiExt
    public abstract byte[] doFinal(byte[] bArr, int r22, int r32) throws BadPaddingException;

    public abstract int encryptOutputSize(int r12);
    ...
    @Override // org.bouncycastle.pqc.jcajce.provider.util.CipherSpiExt
    public final int getOutputSize(int r32) {
        return this.opMode == 1 ? encryptOutputSize(r32) : decryptOutputSize(r32);
    }
    ...
    @Override // org.bouncycastle.pqc.jcajce.provider.util.CipherSpiExt
    public final int update(byte[] bArr, int r42, int r52, byte[] bArr2, int r72) throws ShortBufferException {
        if (bArr2.length < getOutputSize(r52)) {
            throw new ShortBufferException("output");
        }
        byte[] bArrUpdate = update(bArr, r42, r52);
        System.arraycopy(bArrUpdate, 0, bArr2, r72, bArrUpdate.length);
