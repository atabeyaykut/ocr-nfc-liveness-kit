...
public class BCMcElieceCCA2PublicKey implements CipherParameters, PublicKey {
    ...
    public String toString() {
        StringBuilder sbI = b.i("McEliecePublicKey:\n length of the code         : " + this.params.getN() + "\n", " error correction capability: ");
        sbI.append(this.params.getT());
        sbI.append("\n");
        StringBuilder sbI2 = b.i(sbI.toString(), " generator matrix           : ");
        sbI2.append(this.params.getG().toString());
