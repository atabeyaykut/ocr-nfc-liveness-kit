...
public class DESedeKeyGenerator extends DESKeyGenerator {
    ...
    public byte[] generateKey() {
        ...
        while (true) {
            ...
            r32++;
            if (r32 >= 20 || (!DESedeParameters.isWeakKey(bArr, 0, r02) && DESedeParameters.isRealEDEKey(bArr, 0))) {
                break;
            }
        }
        if (DESedeParameters.isWeakKey(bArr, 0, r02) || !DESedeParameters.isRealEDEKey(bArr, 0)) {
