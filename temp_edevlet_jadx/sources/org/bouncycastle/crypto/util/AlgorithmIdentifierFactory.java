...
public class AlgorithmIdentifierFactory {
    static final ASN1ObjectIdentifier IDEA_CBC = c.j("1.3.6.1.4.1.188.7.1.1.2");
    static final ASN1ObjectIdentifier CAST5_CBC = c.j("1.2.840.113533.7.66.10");
    ...
    public static AlgorithmIdentifier generateEncryptionAlgID(ASN1ObjectIdentifier aSN1ObjectIdentifier, int r42, SecureRandom secureRandom) throws IllegalArgumentException {
        ...
        if (aSN1ObjectIdentifier.equals((ASN1Primitive) CAST5_CBC)) {
            ...
            return new AlgorithmIdentifier(aSN1ObjectIdentifier, new CAST5CBCParameters(bArr5, r42));
        }
