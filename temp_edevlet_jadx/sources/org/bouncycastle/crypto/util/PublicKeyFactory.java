...
public class PublicKeyFactory {
    ...
    public static class DHAgreementConverter extends SubjectPublicKeyInfoConverter {
        ...
        public AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo subjectPublicKeyInfo, Object obj) throws IOException {
            ...
            BigInteger l5 = dHParameter.getL();
            return new DHPublicKeyParameters(aSN1Integer.getValue(), new DHParameters(dHParameter.getP(), dHParameter.getG(), null, l5 == null ? 0 : l5.intValue()));
        }
    }
    ...
    public static class DHPublicNumberConverter extends SubjectPublicKeyInfoConverter {
        ...
        public AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo subjectPublicKeyInfo, Object obj) throws IOException {
            ...
            BigInteger g9 = domainParameters.getG();
            ...
            return new DHPublicKeyParameters(y10, new DHParameters(p10, g9, q10, j10, validationParams != null ? new DHValidationParameters(validationParams.getSeed(), validationParams.getPgenCounter().intValue()) : null));
        }
    }
        ...
        public AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo subjectPublicKeyInfo, Object obj) throws IOException {
            ...
            try {
                ...
                if (dSTU4145Params.isNamedCurve()) {
                    ...
                    byte[] g9 = eCBinary.getG();
                    if (algorithm2.equals((ASN1Primitive) aSN1ObjectIdentifier)) {
                        reverseBytes(g9);
                    }
                    eCDomainParameters = new ECDomainParameters(f2m, DSTU4145PointEncoder.decodePoint(f2m, g9), eCBinary.getN());
                }
    ...
    public static class GOST3410_2001Converter extends SubjectPublicKeyInfoConverter {
        ...
        public AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo subjectPublicKeyInfo, Object obj) {
            ...
            try {
                ...
                bArr[0] = 4;
                for (int r02 = 1; r02 <= 32; r02++) {
                    bArr[r02] = octets[32 - r02];
                    bArr[r02 + 32] = octets[64 - r02];
                }
    ...
    public static class GOST3410_2012Converter extends SubjectPublicKeyInfoConverter {
        ...
        public AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo subjectPublicKeyInfo, Object obj) {
            ...
            try {
                ...
                int r82 = algorithm2.equals((ASN1Primitive) RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512) ? 64 : 32;
                int r02 = r82 * 2;
                byte[] octets = aSN1OctetString.getOctets();
                if (octets.length != r02) {
                    throw new IllegalArgumentException("invalid length for GOST3410_2012 public key");
                }
                byte[] bArr = new byte[r02 + 1];
                bArr[0] = 4;
                for (int r32 = 1; r32 <= r82; r32++) {
                    bArr[r32] = octets[r82 - r32];
                    bArr[r32 + r82] = octets[r02 - r32];
                }
                return new ECPublicKeyParameters(eCGOST3410Parameters.getCurve().decodePoint(bArr), eCGOST3410Parameters);
            } catch (IOException unused) {
