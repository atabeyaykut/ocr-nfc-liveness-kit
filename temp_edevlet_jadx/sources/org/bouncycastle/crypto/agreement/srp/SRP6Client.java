...
public class SRP6Client {
    ...
    protected BigInteger f11431a;
    protected Digest digest;

    /* renamed from: g, reason: collision with root package name */
    protected BigInteger f11432g;
    protected SecureRandom random;

    /* renamed from: u, reason: collision with root package name */
    protected BigInteger f11433u;

    /* renamed from: x, reason: collision with root package name */
    protected BigInteger f11434x;

    private BigInteger calculateS() {
        BigInteger bigIntegerCalculateK = SRP6Util.calculateK(this.digest, this.N, this.f11432g);
        return this.B.subtract(this.f11432g.modPow(this.f11434x, this.N).multiply(bigIntegerCalculateK).mod(this.N)).mod(this.N).modPow(this.f11433u.multiply(this.f11434x).add(this.f11431a), this.N);
    }
    ...
    public BigInteger calculateSecret(BigInteger bigInteger) throws CryptoException {
        ...
        this.f11433u = SRP6Util.calculateU(this.digest, this.N, this.A, bigIntegerValidatePublicValue);
    ...
    public BigInteger generateClientCredentials(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        this.f11434x = SRP6Util.calculateX(this.digest, this.N, bArr, bArr2, bArr3);
        BigInteger bigIntegerSelectPrivateValue = selectPrivateValue();
        this.f11431a = bigIntegerSelectPrivateValue;
        BigInteger bigIntegerModPow = this.f11432g.modPow(bigIntegerSelectPrivateValue, this.N);
    ...
    public BigInteger selectPrivateValue() {
        return SRP6Util.generatePrivateValue(this.digest, this.N, this.f11432g, this.random);
    }
