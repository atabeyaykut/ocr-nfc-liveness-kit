...
public class XDHUnifiedAgreement implements RawAgreement {
    ...
    public void calculateAgreement(CipherParameters cipherParameters, byte[] bArr, int r52) {
        ...
        this.xAgreement.calculateAgreement(xDHUPublicParameters.getEphemeralPublicKey(), bArr, r52);
        this.xAgreement.init(this.privParams.getStaticPrivateKey());
        this.xAgreement.calculateAgreement(xDHUPublicParameters.getStaticPublicKey(), bArr, this.xAgreement.getAgreementSize() + r52);
    }
