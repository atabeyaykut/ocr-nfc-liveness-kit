...
public final class X25519Agreement implements RawAgreement {
    ...
    public void calculateAgreement(CipherParameters cipherParameters, byte[] bArr, int r42) {
        this.privateKey.generateSecret((X25519PublicKeyParameters) cipherParameters, bArr, r42);
    }
