...
public class JPAKEExample {
    ...
    public static void main(String[] strArr) throws IllegalStateException, DataLengthException, CryptoException {
        ...
        BigInteger g9 = jPAKEPrimeOrderGroup.getG();
        ...
        System.out.println("g (" + p10.bitLength() + " bits): " + g9.toString(16));
        PrintStream printStream = System.out;
        StringBuilder sb2 = new StringBuilder("p mod q = ");
        sb2.append(p10.mod(q10).toString(16));
        printStream.println(sb2.toString());
        System.out.println("g^{q} mod p = " + g9.modPow(q10, p10).toString(16));
        System.out.println("");
