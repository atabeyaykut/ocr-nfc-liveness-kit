...
public class ECNRSigner implements DSAExt {
    ...
    private BigInteger extractT(ECPublicKeyParameters eCPublicKeyParameters, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        return bigInteger.subtract(eCPointNormalize.getAffineXCoord().toBigInteger()).mod(n10);
    }
    ...
    public void init(boolean z10, CipherParameters cipherParameters) {
        ...
        CryptoServicesRegistrar.checkConstraints(Utils.getDefaultProperties("ECNR", this.key, z10));
    }
    ...
    public boolean verifySignature(byte[] bArr, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        BigInteger n10 = eCPublicKeyParameters.getParameters().getN();
        int r22 = n10.bitLength();
        BigInteger bigInteger3 = new BigInteger(1, bArr);
        if (bigInteger3.bitLength() > r22) {
            throw new DataLengthException("input too large for ECNR key.");
        }
        BigInteger bigIntegerExtractT = extractT(eCPublicKeyParameters, bigInteger, bigInteger2);
        return bigIntegerExtractT != null && bigIntegerExtractT.equals(bigInteger3.mod(n10));
    }
}
