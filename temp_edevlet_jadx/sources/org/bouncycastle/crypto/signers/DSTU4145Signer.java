...
public class DSTU4145Signer implements DSAExt {
    ...
    private static BigInteger truncate(BigInteger bigInteger, int r22) {
        return bigInteger.bitLength() > r22 ? bigInteger.mod(ONE.shiftLeft(r22)) : bigInteger;
    }
    ...
    public BigInteger[] generateSignature(byte[] bArr) {
        ...
        while (true) {
            BigInteger bigIntegerGenerateRandomInteger = generateRandomInteger(n10, this.random);
            ...
            if (!affineXCoord.isZero()) {
                BigInteger bigIntegerFieldElement2Integer = fieldElement2Integer(n10, eCFieldElementHash2FieldElement.multiply(affineXCoord));
                if (bigIntegerFieldElement2Integer.signum() != 0) {
                    BigInteger bigIntegerMod = bigIntegerFieldElement2Integer.multiply(d10).add(bigIntegerGenerateRandomInteger).mod(n10);
    ...
    public void init(boolean z10, CipherParameters cipherParameters) {
        ...
        CryptoServicesRegistrar.checkConstraints(Utils.getDefaultProperties("DSTU4145", this.key, z10));
    }
    ...
    public boolean verifySignature(byte[] bArr, BigInteger bigInteger, BigInteger bigInteger2) {
        ...
        return !eCPointNormalize.isInfinity() && fieldElement2Integer(n10, eCFieldElementHash2FieldElement.multiply(eCPointNormalize.getAffineXCoord())).compareTo(bigInteger) == 0;
    }
}
