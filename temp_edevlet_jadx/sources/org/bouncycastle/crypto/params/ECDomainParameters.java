...
public class ECDomainParameters implements ECConstants {
    ...
    private final BigInteger f11619h;
    private BigInteger hInv;

    /* renamed from: n, reason: collision with root package name */
    private final BigInteger f11620n;
    ...
    public ECDomainParameters(ECCurve eCCurve, ECPoint eCPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        ...
        this.f11620n = bigInteger;
        this.f11619h = bigInteger2;
    ...
    public boolean equals(Object obj) {
        ...
        return this.curve.equals(eCDomainParameters.curve) && this.G.equals(eCDomainParameters.G) && this.f11620n.equals(eCDomainParameters.f11620n);
    }
    ...
    public synchronized BigInteger getHInv() {
        if (this.hInv == null) {
            this.hInv = BigIntegers.modOddInverseVar(this.f11620n, this.f11619h);
        }
        return this.hInv;
    }
    ...
    public int hashCode() {
        return ((((this.curve.hashCode() ^ 1028) * 257) ^ this.G.hashCode()) * 257) ^ this.f11620n.hashCode();
    }
