...
public class CTSBlockCipher extends DefaultBufferedBlockCipher {
    ...
    public int doFinal(byte[] bArr, int r11) throws InvalidCipherTextException, IllegalStateException, DataLengthException {
        ...
        if (((DefaultBufferedBlockCipher) this).forEncryption) {
            ...
            int r13 = ((DefaultBufferedBlockCipher) this).bufOff;
            if (r13 > blockSize) {
                while (true) {
                    ...
                    bArr3[r13] = bArr2[r13 - blockSize];
                    r13++;
                }
                for (int r14 = blockSize; r14 != ((DefaultBufferedBlockCipher) this).bufOff; r14++) {
                    byte[] bArr4 = ((DefaultBufferedBlockCipher) this).buf;
                    bArr4[r14] = (byte) (bArr4[r14] ^ bArr2[r14 - blockSize]);
                }
                BlockCipher blockCipher = ((DefaultBufferedBlockCipher) this).cipher;
                if (blockCipher instanceof CBCModeCipher) {
                    ((CBCModeCipher) blockCipher).getUnderlyingCipher().processBlock(((DefaultBufferedBlockCipher) this).buf, blockSize, bArr, r11);
                } else {
            ...
            if (r12 > blockSize) {
                ...
                for (int r15 = blockSize; r15 != ((DefaultBufferedBlockCipher) this).bufOff; r15++) {
                    int r52 = r15 - blockSize;
                    bArr5[r52] = (byte) (bArr2[r52] ^ ((DefaultBufferedBlockCipher) this).buf[r15]);
                }
                ...
                System.arraycopy(bArr5, 0, bArr, r11 + blockSize, r22);
            } else {
                ((DefaultBufferedBlockCipher) this).cipher.processBlock(((DefaultBufferedBlockCipher) this).buf, 0, bArr2, 0);
                System.arraycopy(bArr2, 0, bArr, r11, blockSize);
            }
