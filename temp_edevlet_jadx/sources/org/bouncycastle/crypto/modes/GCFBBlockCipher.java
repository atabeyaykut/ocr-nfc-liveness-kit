...
public class GCFBBlockCipher extends StreamBlockCipher {
    ...
    public byte calculateByte(byte b10) throws IllegalStateException, DataLengthException, IllegalArgumentException {
    ...
    public int processBlock(byte[] bArr, int r92, byte[] bArr2, int r11) throws IllegalStateException, DataLengthException {
        processBytes(bArr, r92, this.cfbEngine.getBlockSize(), bArr2, r11);
        return this.cfbEngine.getBlockSize();
    }
