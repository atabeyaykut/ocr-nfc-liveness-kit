...
public class KGCMUtil_256 {
    ...
    public static void square(long[] jArr, long[] jArr2) {
        ...
        for (int r22 = 0; r22 < 4; r22++) {
            Interleave.expand64To128(jArr[r22], jArr3, r22 << 1);
        }
        while (true) {
            r02--;
            if (r02 < 4) {
            ...
            long j10 = jArr3[r02];
            int r12 = r02 - 4;
            jArr3[r12] = jArr3[r12] ^ ((((j10 << 2) ^ j10) ^ (j10 << 5)) ^ (j10 << 10));
            int r122 = r12 + 1;
            jArr3[r122] = ((j10 >>> 54) ^ ((j10 >>> 62) ^ (j10 >>> 59))) ^ jArr3[r122];
        }
    }
