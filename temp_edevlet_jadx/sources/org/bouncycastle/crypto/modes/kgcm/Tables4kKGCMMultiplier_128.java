...
public class Tables4kKGCMMultiplier_128 implements KGCMMultiplier {
    ...
    public void init(long[] jArr) {
        ...
        for (int r12 = 2; r12 < 256; r12 += 2) {
            long[][] jArr3 = this.T;
            KGCMUtil_128.multiplyX(jArr3[r12 >> 1], jArr3[r12]);
            long[][] jArr4 = this.T;
            KGCMUtil_128.add(jArr4[r12], jArr4[1], jArr4[r12 + 1]);
        }
    }
    ...
    public void multiplyH(long[] jArr) {
        ...
        for (int r12 = 14; r12 >= 0; r12--) {
            ...
            KGCMUtil_128.add(this.T[((int) (jArr[r12 >>> 3] >>> ((r12 & 7) << 3))) & 255], jArr2, jArr2);
        }
