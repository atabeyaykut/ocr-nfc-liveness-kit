...
public class X931RNG {
    ...
    private static boolean isTooLarge(byte[] bArr, int r12) {
    ...
    private void process(byte[] bArr, byte[] bArr2, byte[] bArr3) throws IllegalStateException, DataLengthException {
        for (int r12 = 0; r12 != bArr.length; r12++) {
            bArr[r12] = (byte) (bArr2[r12] ^ bArr3[r12]);
        }
        this.engine.processBlock(bArr, 0, bArr, 0);
    }

    public int generate(byte[] bArr, boolean z10) throws IllegalStateException, DataLengthException {
        int length = this.R.length;
        long j10 = this.reseedCounter;
        if (length == 8) {
            if (j10 > BLOCK64_RESEED_MAX) {
                return -1;
            }
        ...
        for (int r12 = 0; r12 < length2; r12++) {
            ...
            byte[] bArr2 = this.R;
            System.arraycopy(bArr2, 0, bArr, bArr2.length * r12, bArr2.length);
            increment(this.DT);
        }
