...
public class DualECSP800DRBG implements SP80090DRBG {
    ...
    public DualECSP800DRBG(Digest digest, int r92, EntropySource entropySource, byte[] bArr, byte[] bArr2) {
        this(nistPoints, digest, r92, entropySource, bArr, bArr2);
    }
    ...
    */
    public DualECSP800DRBG(org.bouncycastle.crypto.prng.drbg.DualECPoints[] r2, org.bouncycastle.crypto.Digest r3, int r4, org.bouncycastle.crypto.prng.EntropySource r5, byte[] r6, byte[] r7) {
        ...
        L92:
            ...
            java.lang.String r3 = androidx.appcompat.graphics.drawable.a.f(r3, r4, r5)
            r2.<init>(r3)
            throw r2
        La0:
            java.lang.IllegalArgumentException r2 = new java.lang.IllegalArgumentException
    ...
    private byte[] pad8(byte[] bArr, int r72) {
        int r73 = r72 % 8;
        if (r73 == 0) {
            return bArr;
        }
        ...
        while (length >= 0) {
            ...
            bArr[length] = (byte) ((r12 >> (8 - r74)) | (r22 << r74));
            length--;
            r12 = r22;
        }
        return bArr;
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z10) {
        ...
        for (int r12 = 0; r12 < length2; r12++) {
            ...
            int r82 = this._outlen;
            if (length3 > r82) {
                System.arraycopy(byteArray, byteArray.length - r82, bArr, r32, r82);
            } else {
                System.arraycopy(byteArray, 0, bArr, (r82 - byteArray.length) + r32, byteArray.length);
            }
            r32 += this._outlen;
            this._reseedCounter++;
        }
        if (r32 < bArr.length) {
            ...
            int length4 = bArr.length - r32;
            int length5 = byteArray2.length;
            int r72 = this._outlen;
            if (length5 > r72) {
                System.arraycopy(byteArray2, byteArray2.length - r72, bArr, r32, length4);
            } else {
                System.arraycopy(byteArray2, 0, bArr, (r72 - byteArray2.length) + r32, length4);
            }
            this._reseedCounter++;
        }
