...
public class HashSP800DRBG implements SP80090DRBG {
    ...
    public HashSP800DRBG(Digest digest, int r32, EntropySource entropySource, byte[] bArr, byte[] bArr2) {
        if (r32 > Utils.getMaxSecurityStrength(digest)) {
    ...
    private void addTo(byte[] bArr, byte[] bArr2) {
        int r32 = 0;
        for (int r22 = 1; r22 <= bArr2.length; r22++) {
            int r42 = (bArr[bArr.length - r22] & 255) + (bArr2[bArr2.length - r22] & 255) + r32;
            r32 = r42 > 255 ? 1 : 0;
            bArr[bArr.length - r22] = (byte) r42;
        }
        for (int length = bArr2.length + 1; length <= bArr.length; length++) {
            int r23 = (bArr[bArr.length - length] & 255) + r32;
            r32 = r23 > 255 ? 1 : 0;
            bArr[bArr.length - length] = (byte) r23;
        }
    }
    ...
    private byte[] hashgen(byte[] bArr, int r10) {
        ...
        for (int r52 = 0; r52 <= digestSize; r52++) {
            doHash(bArr2, bArr4);
            int r6 = r52 * digestSize2;
            int r72 = r102 - r6;
            if (r72 > digestSize2) {
                r72 = digestSize2;
            }
            System.arraycopy(bArr4, 0, bArr3, r6, r72);
            addTo(bArr2, ONE);
        }
        return bArr3;
    }
