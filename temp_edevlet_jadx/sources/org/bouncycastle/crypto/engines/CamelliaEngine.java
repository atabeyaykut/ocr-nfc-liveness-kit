...
public class CamelliaEngine implements BlockCipher {
    ...
    private int[] f11504ke = new int[12];
    ...
    private void camelliaF2(int[] r13, int[] r14, int r15) {
        int r12 = r13[0] ^ r14[r15 + 0];
        int[] r22 = SBOX4_4404;
        int r32 = r22[r12 & 255];
        int[] r42 = SBOX3_3033;
        int r33 = r32 ^ r42[(r12 >>> 8) & 255];
        int[] r52 = SBOX2_0222;
        int r34 = r33 ^ r52[(r12 >>> 16) & 255];
        int[] r6 = SBOX1_1110;
        int r16 = r6[(r12 >>> 24) & 255] ^ r34;
        int r72 = r13[1] ^ r14[r15 + 1];
        int r73 = (r52[(r72 >>> 24) & 255] ^ ((r6[r72 & 255] ^ r22[(r72 >>> 8) & 255]) ^ r42[(r72 >>> 16) & 255])) ^ r16;
        r13[2] = r13[2] ^ r73;
        int r17 = (rightRotate(r16, 8) ^ r73) ^ r13[3];
        r13[3] = r17;
        int r74 = r13[2] ^ r14[r15 + 2];
        int r75 = r6[(r74 >>> 24) & 255] ^ ((r22[r74 & 255] ^ r42[(r74 >>> 8) & 255]) ^ r52[(r74 >>> 16) & 255]);
        int r142 = r14[r15 + 3] ^ r17;
        int r143 = (r52[(r142 >>> 24) & 255] ^ ((r6[r142 & 255] ^ r22[(r142 >>> 8) & 255]) ^ r42[(r142 >>> 16) & 255])) ^ r75;
        r13[0] = r13[0] ^ r143;
        r13[1] = (r143 ^ rightRotate(r75, 8)) ^ r13[1];
    }
    ...
    private int processBlock192or256(byte[] bArr, int r10, byte[] bArr2, int r12) {
        ...
        camelliaF2(r13, this.subkey, 28);
        camelliaF2(r13, this.subkey, 32);
        camelliaFLs(r13, this.f11504ke, 8);
    ...
    private void setKey(boolean z10, byte[] bArr) {
        ...
        if (length == 16) {
            r32[0] = bytes2int(bArr, 0);
            r32[1] = bytes2int(bArr, 4);
            r32[2] = bytes2int(bArr, 8);
            r32[3] = bytes2int(bArr, 12);
            r32[7] = 0;
            r32[6] = 0;
            r32[5] = 0;
            r32[4] = 0;
            ...
            r32[2] = bytes2int(bArr, 8);
            r32[3] = bytes2int(bArr, 12);
            r32[4] = bytes2int(bArr, 16);
            int r12 = bytes2int(bArr, 20);
            r32[5] = r12;
            r32[6] = ~r32[4];
            r32[7] = ~r12;
        } else {
            ...
            r32[3] = bytes2int(bArr, 12);
            r32[4] = bytes2int(bArr, 16);
            r32[5] = bytes2int(bArr, 20);
            r32[6] = bytes2int(bArr, 24);
            r32[7] = bytes2int(bArr, 28);
        }
        for (int r13 = 0; r13 < 4; r13++) {
            r52[r13] = r32[r13] ^ r32[r13 + 4];
        }
        camelliaF2(r52, SIGMA, 0);
        for (int r14 = 0; r14 < 4; r14++) {
            r52[r14] = r52[r14] ^ r32[r14];
        }
        camelliaF2(r52, SIGMA, 4);
        if (this._keySize == 16) {
            int[] r92 = this.kw;
            if (z10) {
                r92[0] = r32[0];
                ...
                r92[2] = r32[2];
                r92[3] = r32[3];
                roldq(15, r32, 0, this.subkey, 4);
                roldq(30, r32, 0, this.subkey, 12);
                roldq(15, r32, 0, r72, 0);
                int[] r93 = this.subkey;
                r93[18] = r72[2];
                r93[19] = r72[3];
                roldq(17, r32, 0, this.f11504ke, 4);
                roldq(17, r32, 0, this.subkey, 24);
                roldq(17, r32, 0, this.subkey, 32);
                int[] r15 = this.subkey;
                r15[0] = r52[0];
                r15[1] = r52[1];
                r15[2] = r52[2];
                r15[3] = r52[3];
                roldq(15, r52, 0, r15, 8);
                roldq(15, r52, 0, this.f11504ke, 0);
                roldq(15, r52, 0, r72, 0);
                int[] r16 = this.subkey;
                r16[16] = r72[0];
                r16[17] = r72[1];
                roldq(15, r52, 0, r16, 20);
                roldqo32(34, r52, 0, this.subkey, 28);
                roldq(17, r52, 0, this.kw, 4);
                return;
            }
            r92[4] = r32[0];
            r92[5] = r32[1];
            r92[6] = r32[2];
            r92[7] = r32[3];
            decroldq(15, r32, 0, this.subkey, 28);
            decroldq(30, r32, 0, this.subkey, 20);
            decroldq(15, r32, 0, r72, 0);
            int[] r94 = this.subkey;
            r94[16] = r72[0];
            r94[17] = r72[1];
            decroldq(17, r32, 0, this.f11504ke, 0);
            decroldq(17, r32, 0, this.subkey, 8);
            decroldq(17, r32, 0, this.subkey, 0);
            int[] r22 = this.subkey;
            r22[34] = r52[0];
            r22[35] = r52[1];
            r22[32] = r52[2];
            r22[33] = r52[3];
            decroldq(15, r52, 0, r22, 24);
            decroldq(15, r52, 0, this.f11504ke, 4);
            decroldq(15, r52, 0, r72, 0);
            int[] r23 = this.subkey;
            r23[18] = r72[2];
            r23[19] = r72[3];
            decroldq(15, r52, 0, r23, 12);
            decroldqo32(34, r52, 0, this.subkey, 4);
            roldq(17, r52, 0, this.kw, 0);
            return;
        }
        for (int r17 = 0; r17 < 4; r17++) {
            r6[r17] = r52[r17] ^ r32[r17 + 4];
        }
        ...
        if (z10) {
            ...
            r73[2] = r32[2];
            r73[3] = r32[3];
            roldqo32(45, r32, 0, this.subkey, 16);
            roldq(15, r32, 0, this.f11504ke, 4);
            roldq(17, r32, 0, this.subkey, 32);
            roldqo32(34, r32, 0, this.subkey, 44);
            roldq(15, r32, 4, this.subkey, 4);
            roldq(15, r32, 4, this.f11504ke, 0);
            roldq(30, r32, 4, this.subkey, 24);
            roldqo32(34, r32, 4, this.subkey, 36);
            roldq(15, r52, 0, this.subkey, 8);
            roldq(30, r52, 0, this.subkey, 20);
            int[] r18 = this.f11504ke;
            r18[8] = r52[1];
            r18[9] = r52[2];
            r18[10] = r52[3];
            r18[11] = r52[0];
            roldqo32(49, r52, 0, this.subkey, 40);
            int[] r19 = this.subkey;
            r19[0] = r6[0];
            r19[1] = r6[1];
            r19[2] = r6[2];
            r19[3] = r6[3];
            roldq(30, r6, 0, r19, 12);
            roldq(30, r6, 0, this.subkey, 28);
            roldqo32(51, r6, 0, this.kw, 4);
            return;
        }
        r73[4] = r32[0];
        r73[5] = r32[1];
        r73[6] = r32[2];
        r73[7] = r32[3];
        decroldqo32(45, r32, 0, this.subkey, 28);
        decroldq(15, r32, 0, this.f11504ke, 4);
        decroldq(17, r32, 0, this.subkey, 12);
        decroldqo32(34, r32, 0, this.subkey, 0);
        decroldq(15, r32, 4, this.subkey, 40);
        decroldq(15, r32, 4, this.f11504ke, 8);
        decroldq(30, r32, 4, this.subkey, 20);
        decroldqo32(34, r32, 4, this.subkey, 8);
        decroldq(15, r52, 0, this.subkey, 36);
        decroldq(30, r52, 0, this.subkey, 24);
        int[] r24 = this.f11504ke;
        r24[2] = r52[1];
        r24[3] = r52[2];
        r24[0] = r52[3];
        r24[1] = r52[0];
        decroldqo32(49, r52, 0, this.subkey, 4);
        int[] r25 = this.subkey;
        r25[46] = r6[0];
        r25[47] = r6[1];
        r25[44] = r6[2];
        r25[45] = r6[3];
        decroldq(30, r6, 0, r25, 32);
        decroldq(30, r6, 0, this.subkey, 16);
        roldqo32(51, r6, 0, this.kw, 0);
    }
