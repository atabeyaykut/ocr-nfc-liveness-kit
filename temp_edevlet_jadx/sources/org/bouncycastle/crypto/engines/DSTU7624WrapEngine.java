...
public class DSTU7624WrapEngine implements Wrapper {
    ...
    public DSTU7624WrapEngine(int r22) {
        DSTU7624Engine dSTU7624Engine = new DSTU7624Engine(r22);
    ...
    @Override // org.bouncycastle.crypto.Wrapper
    public byte[] unwrap(byte[] bArr, int r12, int r13) throws InvalidCipherTextException, IllegalStateException, DataLengthException {
        if (this.forWrapping) {
        ...
        for (int r52 = 0; r52 < r22; r52++) {
            ...
            intToBytes(r22 - r52, this.intArray, 0);
            ...
            for (int r62 = 2; r62 < blockSize; r62++) {
                int r82 = blockSize - r62;
                System.arraycopy(this.Btemp.get(r82 - 1), 0, this.Btemp.get(r82), 0, this.engine.getBlockSize() / 2);
            }
        ...
        for (int r02 = 0; r02 < r14; r02++) {
            System.arraycopy(this.Btemp.get(r02), 0, bArr2, blockSize5, this.engine.getBlockSize() / 2);
    ...
    @Override // org.bouncycastle.crypto.Wrapper
    public byte[] wrap(byte[] bArr, int r10, int r11) throws IllegalStateException, DataLengthException {
        if (!this.forWrapping) {
        ...
        while (r92 < r32) {
            ...
            this.engine.processBlock(bArr2, 0, bArr2, 0);
            r92++;
            intToBytes(r92, this.intArray, 0);
