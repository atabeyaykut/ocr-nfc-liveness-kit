...
public class GOST28147WrapEngine implements Wrapper {
    ...
    @Override // org.bouncycastle.crypto.Wrapper
    public byte[] unwrap(byte[] bArr, int r82, int r92) throws InvalidCipherTextException, IllegalStateException, DataLengthException {
        int macSize = r92 - this.mac.getMacSize();
        byte[] bArr2 = new byte[macSize];
        this.cipher.processBlock(bArr, r82, bArr2, 0);
        this.cipher.processBlock(bArr, r82 + 8, bArr2, 8);
        this.cipher.processBlock(bArr, r82 + 16, bArr2, 16);
        this.cipher.processBlock(bArr, r82 + 24, bArr2, 24);
        ...
        System.arraycopy(bArr, (r82 + r92) - 4, bArr4, 0, this.mac.getMacSize());
    ...
    @Override // org.bouncycastle.crypto.Wrapper
    public byte[] wrap(byte[] bArr, int r6, int r72) throws IllegalStateException, DataLengthException {
        this.mac.update(bArr, r6, r72);
        byte[] bArr2 = new byte[this.mac.getMacSize() + r72];
