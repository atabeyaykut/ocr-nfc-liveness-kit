...
public class DSTU7624Engine implements BlockCipher {
    ...
    public DSTU7624Engine(int r22) throws IllegalArgumentException {
        if (r22 != 128 && r22 != 256 && r22 != 512) {
            throw new IllegalArgumentException("unsupported block length: only 128/256/512 are allowed");
        }
        int r23 = r22 >>> 6;
        this.wordsInBlock = r23;
        this.internalState = new long[r23];
    }

    private void addRoundKey(int r72) {
        long[] jArr = this.roundKeys[r72];
        for (int r02 = 0; r02 < this.wordsInBlock; r02++) {
    ...
    private void decryptBlock_128(byte[] bArr, int r23, byte[] bArr2, int r25) {
        long jLittleEndianToLong = Pack.littleEndianToLong(bArr, r23);
        long jLittleEndianToLong2 = Pack.littleEndianToLong(bArr, r23 + 8);
        long[][] jArr = this.roundKeys;
        int r82 = this.roundsAmount;
        long[] jArr2 = jArr[r82];
        long j10 = jLittleEndianToLong - jArr2[0];
        long j11 = jLittleEndianToLong2 - jArr2[1];
        while (true) {
            long jMixColumnInv = mixColumnInv(j10);
            long jMixColumnInv2 = mixColumnInv(j11);
            int r72 = (int) jMixColumnInv;
            int r42 = (int) (jMixColumnInv >>> 32);
            int r32 = (int) jMixColumnInv2;
            int r6 = (int) (jMixColumnInv2 >>> 32);
            byte[] bArr3 = T0;
            byte b10 = bArr3[r72 & 255];
            byte[] bArr4 = T1;
            byte b11 = bArr4[(r72 >>> 8) & 255];
            byte[] bArr5 = T2;
            byte b12 = bArr5[(r72 >>> 16) & 255];
            byte[] bArr6 = T3;
            int r73 = (bArr6[r72 >>> 24] << 24) | ((b12 & 255) << 16) | (b10 & 255) | ((b11 & 255) << 8);
            byte b13 = bArr3[r6 & 255];
            byte b14 = bArr4[(r6 >>> 8) & 255];
            byte b15 = bArr5[(r6 >>> 16) & 255];
            long j12 = (((bArr6[r6 >>> 24] << 24) | (((b13 & 255) | ((b14 & 255) << 8)) | ((b15 & 255) << 16))) << 32) | (r73 & BodyPartID.bodyIdMax);
            int r33 = (bArr6[r32 >>> 24] << 24) | (bArr3[r32 & 255] & 255) | ((bArr4[(r32 >>> 8) & 255] & 255) << 8) | ((bArr5[(r32 >>> 16) & 255] & 255) << 16);
            long j13 = (((bArr6[r42 >>> 24] << 24) | (((bArr3[r42 & 255] & 255) | ((bArr4[(r42 >>> 8) & 255] & 255) << 8)) | ((bArr5[(r42 >>> 16) & 255] & 255) << 16))) << 32) | (r33 & BodyPartID.bodyIdMax);
            r82--;
            if (r82 == 0) {
                long[] jArr3 = this.roundKeys[0];
                long j14 = j12 - jArr3[0];
                long j15 = j13 - jArr3[1];
                Pack.longToLittleEndian(j14, bArr2, r25);
                Pack.longToLittleEndian(j15, bArr2, r25 + 8);
                return;
            }
            long[] jArr4 = this.roundKeys[r82];
    ...
    private void encryptBlock_128(byte[] bArr, int r23, byte[] bArr2, int r25) {
        ...
        long j10 = jLittleEndianToLong + jArr[0];
        ...
        while (true) {
            ...
            int r6 = (int) (j11 >>> 32);
            byte[] bArr3 = S0;
            byte b10 = bArr3[r10 & 255];
            byte[] bArr4 = S1;
            byte b11 = bArr4[(r10 >>> 8) & 255];
            byte[] bArr5 = S2;
            byte b12 = bArr5[(r10 >>> 16) & 255];
            byte[] bArr6 = S3;
            int r82 = ((b12 & 255) << 16) | (b10 & 255) | ((b11 & 255) << 8) | (bArr6[r10 >>> 24] << 24);
            byte b13 = bArr3[r6 & 255];
            byte b14 = bArr4[(r6 >>> 8) & 255];
            byte b15 = bArr5[(r6 >>> 16) & 255];
            long j12 = (((bArr6[r6 >>> 24] << 24) | (((b13 & 255) | ((b14 & 255) << 8)) | ((b15 & 255) << 16))) << 32) | (r82 & BodyPartID.bodyIdMax);
            int r33 = (bArr6[r32 >>> 24] << 24) | (bArr3[r32 & 255] & 255) | ((bArr4[(r32 >>> 8) & 255] & 255) << 8) | ((bArr5[(r32 >>> 16) & 255] & 255) << 16);
            int r43 = (bArr6[r42 >>> 24] << 24) | (bArr3[r42 & 255] & 255) | ((bArr4[(r42 >>> 8) & 255] & 255) << 8) | ((bArr5[(r42 >>> 16) & 255] & 255) << 16);
            long j13 = r33 & BodyPartID.bodyIdMax;
            long jMixColumn = mixColumn(j12);
            long jMixColumn2 = mixColumn((r43 << 32) | j13);
            r72++;
            int r62 = this.roundsAmount;
            if (r72 == r62) {
                long[] jArr2 = this.roundKeys[r62];
                long j14 = jMixColumn + jArr2[0];
                long j15 = jMixColumn2 + jArr2[1];
                Pack.longToLittleEndian(j14, bArr2, r25);
                Pack.longToLittleEndian(j15, bArr2, r25 + 8);
                return;
            }
            long[] jArr3 = this.roundKeys[r72];
            long j16 = jMixColumn ^ jArr3[0];
            j11 = jMixColumn2 ^ jArr3[1];
            j10 = j16;
        }
    }

    private void invShiftRows() {
        int r12 = this.wordsInBlock;
        if (r12 == 2) {
    ...
    private void invSubBytes() {
        for (int r02 = 0; r02 < this.wordsInBlock; r02++) {
            ...
            int r32 = (int) (j10 >>> 32);
            byte b10 = T0[r42 & 255];
            byte b11 = T1[(r42 >>> 8) & 255];
            byte b12 = T2[(r42 >>> 16) & 255];
            byte[] bArr = T3;
            jArr[r02] = (((bArr[r42 >>> 24] << 24) | (b10 & 255) | ((b11 & 255) << 8) | ((b12 & 255) << 16)) & BodyPartID.bodyIdMax) | (((((r2[r32 & 255] & 255) | ((r7[(r32 >>> 8) & 255] & 255) << 8)) | ((r9[(r32 >>> 16) & 255] & 255) << 16)) | (bArr[r32 >>> 24] << 24)) << 32);
        }
    }
    ...
    private static long mixColumn(long j10) {
        ...
        return ((rotate(32, mulX2((j10 ^ jRotate2) ^ jMulX)) ^ jRotate2) ^ rotate(40, jMulX)) ^ rotate(48, jMulX);
    }

    private static long mixColumnInv(long j10) {
        long jRotate = rotate(8, j10) ^ j10;
        long jRotate2 = (jRotate ^ rotate(32, jRotate)) ^ rotate(48, j10);
        long j11 = jRotate2 ^ j10;
        long jRotate3 = rotate(48, j10);
        long jRotate4 = rotate(56, j10);
        long jMulX = mulX(j11 ^ jRotate4) ^ rotate(56, j11);
        long jMulX2 = mulX(rotate(40, mulX(jMulX) ^ j10) ^ (rotate(16, j11) ^ j10)) ^ (j11 ^ jRotate3);
        return mulX(rotate(40, ((j10 ^ rotate(32, j11)) ^ jRotate4) ^ mulX(((jRotate3 ^ (rotate(24, j10) ^ j11)) ^ jRotate4) ^ mulX(mulX(jMulX2) ^ rotate(16, jRotate2))))) ^ jRotate2;
    }
    ...
    private void mixColumnsInv() {
        for (int r02 = 0; r02 < this.wordsInBlock; r02++) {
            long[] jArr = this.internalState;
            jArr[r02] = mixColumnInv(jArr[r02]);
        }
    }
    ...
    private void subBytes() {
        for (int r02 = 0; r02 < this.wordsInBlock; r02++) {
            ...
            int r32 = (int) (j10 >>> 32);
            byte b10 = S0[r42 & 255];
            byte b11 = S1[(r42 >>> 8) & 255];
            byte b12 = S2[(r42 >>> 16) & 255];
            byte[] bArr = S3;
            jArr[r02] = (((bArr[r42 >>> 24] << 24) | (b10 & 255) | ((b11 & 255) << 8) | ((b12 & 255) << 16)) & BodyPartID.bodyIdMax) | (((((r2[r32 & 255] & 255) | ((r7[(r32 >>> 8) & 255] & 255) << 8)) | ((r9[(r32 >>> 16) & 255] & 255) << 16)) | (bArr[r32 >>> 24] << 24)) << 32);
        }
    }

    private void subRoundKey(int r72) {
        long[] jArr = this.roundKeys[r72];
        for (int r02 = 0; r02 < this.wordsInBlock; r02++) {
            long[] jArr2 = this.internalState;
            jArr2[r02] = jArr2[r02] - jArr[r02];
    ...
    private void workingKeyExpandEven(long[] jArr, long[] jArr2) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                jArr6[r85] = jArr6[r85] + jArr4[r85];
                r85++;
            }
            System.arraycopy(this.internalState, 0, this.roundKeys[r72], 0, r92);
            if (this.roundsAmount == r72) {
                return;
            }
            if (this.wordsInBlock != this.wordsInKey) {
                r72 += 2;
                j10 <<= 1;
                for (int r86 = 0; r86 < this.wordsInBlock; r86++) {
                    jArr4[r86] = jArr2[r86] + j10;
                }
                int r87 = 0;
                while (true) {
                    int r94 = this.wordsInBlock;
                    if (r87 >= r94) {
                        break;
                    }
                    this.internalState[r87] = jArr3[r94 + r87] + jArr4[r87];
                    r87++;
                }
                subBytes();
                shiftRows();
                mixColumns();
                for (int r88 = 0; r88 < this.wordsInBlock; r88++) {
                    long[] jArr7 = this.internalState;
                    jArr7[r88] = jArr7[r88] ^ jArr4[r88];
                }
                subBytes();
                shiftRows();
                mixColumns();
                int r89 = 0;
                while (true) {
                    r93 = this.wordsInBlock;
                    if (r89 >= r93) {
                        break;
                    }
                    long[] jArr8 = this.internalState;
                    jArr8[r89] = jArr8[r89] + jArr4[r89];
                    r89++;
                }
                System.arraycopy(this.internalState, 0, this.roundKeys[r72], 0, r93);
                if (this.roundsAmount == r72) {
                    return;
                }
            }
    ...
    private void workingKeyExpandKT(long[] jArr, long[] jArr2) {
        ...
        long[] jArr4 = new long[r02];
        long[] jArr5 = new long[r02];
        this.internalState = jArr5;
        long j10 = jArr5[0];
        int r72 = this.wordsInKey;
        jArr5[0] = j10 + r02 + r72 + 1;
        System.arraycopy(jArr, 0, jArr3, 0, r02);
        if (r02 == r72) {
            System.arraycopy(jArr, 0, jArr4, 0, r02);
        } else {
            int r03 = this.wordsInBlock;
            System.arraycopy(jArr, r03, jArr4, 0, r03);
        }
        int r11 = 0;
        while (true) {
            long[] jArr6 = this.internalState;
    ...
    private void workingKeyExpandOdd() {
        for (int r02 = 1; r02 < this.roundsAmount; r02 += 2) {
            long[][] jArr = this.roundKeys;
            rotateLeft(jArr[r02 - 1], jArr[r02]);
        }
    }

    private void xorRoundKey(int r72) {
        long[] jArr = this.roundKeys[r72];
        for (int r02 = 0; r02 < this.wordsInBlock; r02++) {
            long[] jArr2 = this.internalState;
            jArr2[r02] = jArr2[r02] ^ jArr[r02];
    ...
    */
    ...
    public int processBlock(byte[] bArr, int r52, byte[] bArr2, int r72) throws IllegalStateException, DataLengthException {
        ...
        if (getBlockSize() + r52 > bArr.length) {
            throw new DataLengthException("Input buffer too short");
        }
        if (getBlockSize() + r72 > bArr2.length) {
            throw new OutputLengthException("Output buffer too short");
        }
        int r22 = 0;
        if (this.forEncryption) {
            if (this.wordsInBlock != 2) {
                Pack.littleEndianToLong(bArr, r52, this.internalState);
                addRoundKey(0);
                while (true) {
                    subBytes();
                    shiftRows();
                ...
                addRoundKey(r42);
                Pack.longToLittleEndian(this.internalState, bArr2, r72);
            } else {
                encryptBlock_128(bArr, r52, bArr2, r72);
            }
        } else if (this.wordsInBlock != 2) {
            Pack.littleEndianToLong(bArr, r52, this.internalState);
            subRoundKey(this.roundsAmount);
            int r43 = this.roundsAmount;
            while (true) {
                mixColumnsInv();
                invShiftRows();
                invSubBytes();
            ...
            decryptBlock_128(bArr, r52, bArr2, r72);
        }
        return getBlockSize();
    }
