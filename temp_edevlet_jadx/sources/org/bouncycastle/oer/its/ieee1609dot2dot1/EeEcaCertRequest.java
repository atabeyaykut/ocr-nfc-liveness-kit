...
public class EeEcaCertRequest extends ASN1Object {
    ...
    public EeEcaCertRequest(UINT8 r12, Time32 time32, CertificateType certificateType, ToBeSignedCertificate toBeSignedCertificate, ASN1IA5String aSN1IA5String) {
        this.version = r12;
        this.generationTime = time32;
        this.type = certificateType;
        this.tbsCert = toBeSignedCertificate;
