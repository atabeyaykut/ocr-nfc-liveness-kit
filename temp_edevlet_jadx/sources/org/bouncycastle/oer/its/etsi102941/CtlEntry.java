...
public class CtlEntry extends ASN1Object implements ASN1Choice {
    ...
    public static final int f11797aa = 2;

    /* renamed from: dc, reason: collision with root package name */
    public static final int f11798dc = 3;

    /* renamed from: ea, reason: collision with root package name */
    public static final int f11799ea = 1;
    public static final int rca = 0;
    public static final int tlm = 4;
    private final int choice;
    private final ASN1Encodable ctlEntry;

    public CtlEntry(int r12, ASN1Encodable aSN1Encodable) {
        this.choice = r12;
