...
public class CtlFormat extends ASN1Object {
    ...
    public static class Builder {
        ...
        public Builder setCtlSequence(UINT8 r12) {
            this.ctlSequence = r12;
            return this;
        }
    ...
    public CtlFormat(Version version, Time32 time32, ASN1Boolean aSN1Boolean, UINT8 r42, SequenceOfCtlCommand sequenceOfCtlCommand) {
        this.version = version;
        this.nextUpdate = time32;
        this.isFullCtl = aSN1Boolean;
        this.ctlSequence = r42;
        this.ctlCommands = sequenceOfCtlCommand;
    }
