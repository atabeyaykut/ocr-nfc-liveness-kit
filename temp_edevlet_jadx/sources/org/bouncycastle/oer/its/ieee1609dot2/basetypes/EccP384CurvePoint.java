...
public class EccP384CurvePoint extends EccCurvePoint implements ASN1Choice {
    ...
    public EccP384CurvePoint(int r12, ASN1Encodable aSN1Encodable) {
        this.choice = r12;
    ...
    */
    private EccP384CurvePoint(org.bouncycastle.asn1.ASN1TaggedObject r4) {
        ...
        L24:
            ...
            r1.<init>(r2)
            java.lang.String r4 = androidx.browser.browseractions.b.h(r4, r1)
            r0.<init>(r4)
            throw r0
        L35:
            org.bouncycastle.asn1.ASN1Object r4 = r4.getExplicitBaseObject()
    ...
    public byte[] getEncodedPoint() {
        ...
        if (r02 == 2) {
            ...
            if (r02 != 3) {
                ...
                return Arrays.concatenate(new byte[]{4}, a.k(aSN1Sequence, 0), a.k(aSN1Sequence, 1));
            }
