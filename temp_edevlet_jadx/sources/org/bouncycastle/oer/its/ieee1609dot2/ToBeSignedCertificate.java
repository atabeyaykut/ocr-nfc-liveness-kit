...
public class ToBeSignedCertificate extends ASN1Object {
    ...
    private final CertificateId f11803id;
    ...
    public static class Builder {
        ...
        /* renamed from: id, reason: collision with root package name */
        private CertificateId f11804id;
        ...
        public Builder(Builder builder) {
            this.f11804id = builder.f11804id;
        ...
        public Builder(ToBeSignedCertificate toBeSignedCertificate) {
            this.f11804id = toBeSignedCertificate.f11803id;
        ...
        public ToBeSignedCertificate createToBeSignedCertificate() {
            return new ToBeSignedCertificate(this.f11804id, this.cracaId, this.crlSeries, this.validityPeriod, this.region, this.assuranceLevel, this.appPermissions, this.certIssuePermissions, this.certRequestPermissions, this.canRequestRollover, this.encryptionKey, this.verifyKeyIndicator);
        }
    ...
    private ToBeSignedCertificate(ASN1Sequence aSN1Sequence) {
        ...
        this.f11803id = CertificateId.getInstance(it.next());
