...
public class ExplicitCertificate extends CertificateBase {
    ...
    public ExplicitCertificate(UINT8 r72, IssuerIdentifier issuerIdentifier, ToBeSignedCertificate toBeSignedCertificate, Signature signature) {
        super(r72, CertificateType.explicit, issuerIdentifier, toBeSignedCertificate, signature);
    }
