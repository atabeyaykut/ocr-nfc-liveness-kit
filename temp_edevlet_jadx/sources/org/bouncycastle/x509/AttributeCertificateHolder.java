...
public class AttributeCertificateHolder implements CertSelector, Selector {
    ...
    public AttributeCertificateHolder(int r52, String str, String str2, byte[] bArr) {
        this.holder = new Holder(new ObjectDigestInfo(r52, new ASN1ObjectIdentifier(str2), new AlgorithmIdentifier(new ASN1ObjectIdentifier(str)), Arrays.clone(bArr)));
    }
    ...
    private Object[] getNames(GeneralName[] generalNameArr) {
        ...
        for (int r12 = 0; r12 != generalNameArr.length; r12++) {
            if (generalNameArr[r12].getTagNo() == 4) {
                try {
                    arrayList.add(new X500Principal(generalNameArr[r12].getName().toASN1Primitive().getEncoded()));
    ...
    private boolean matchesDN(X509Principal x509Principal, GeneralNames generalNames) {
        ...
        for (int r12 = 0; r12 != names.length; r12++) {
            GeneralName generalName = names[r12];
