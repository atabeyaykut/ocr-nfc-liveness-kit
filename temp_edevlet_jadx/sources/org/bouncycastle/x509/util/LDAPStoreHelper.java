    ...
    */
    private java.util.List attrCertSubjectSerialSearch(org.bouncycastle.x509.X509AttributeCertStoreSelector r6, java.lang.String[] r7, java.lang.String[] r8, java.lang.String[] r9) throws org.bouncycastle.util.StoreException {
        ...
        L98:
            ...
            java.lang.String r2 = androidx.browser.browseractions.a.a(r6, r2, r6)
    ...
    private List cRLIssuerSearch(X509CRLStoreSelector x509CRLStoreSelector, String[] strArr, String[] strArr2, String[] strArr3) throws StoreException {
        ...
        while (it.hasNext()) {
            ...
            for (String str : strArr3) {
                arrayList.addAll(search(strArr2, a.a("*", parseDN(name, str), "*"), strArr));
            }
        }
        if (name == null) {
    ...
    private List certSubjectSerialSearch(X509CertStoreSelector x509CertStoreSelector, String[] strArr, String[] strArr2, String[] strArr3) throws IOException, StoreException {
        ...
        if (subjectAsString != null) {
            for (String str : strArr3) {
                arrayList.addAll(search(strArr2, a.a("*", parseDN(subjectAsString, str), "*"), strArr));
            }
        }
        ...
        while (r12 < list.size()) {
            try {
                try {
                    ...
                    x509CertPairParser.engineInit(new ByteArrayInputStream((byte[]) list.get(r12)));
                ...
                int r32 = r12 + 1;
                r12 = r32;
                x509CertificatePair = new X509CertificatePair(new CertificatePair(Certificate.getInstance(new ASN1InputStream((byte[]) list.get(r12)).readObject()), Certificate.getInstance(new ASN1InputStream((byte[]) list.get(r32)).readObject())));
            }
    ...
    private String getSubjectAsString(X509CertStoreSelector x509CertStoreSelector) throws IOException {
        try {
            ...
            throw new StoreException(android.support.v4.media.a.c(e10, new StringBuilder("exception processing name: ")), e10);
        }
    }

    private String parseDN(String str, String str2) {
        int r02 = Strings.toLowerCase(str).indexOf(Strings.toLowerCase(str2) + "=");
        if (r02 == -1) {
            return "";
        }
        String strSubstring = str.substring(str2.length() + r02);
    ...
    private List search(String[] strArr, String str, String[] strArr2) throws StoreException {
        ...
        for (String str3 : strArr2) {
            strH = c.h(b.i(strH, "("), str3, "=*)");
        }
        String strA2 = a.a("(|", strH, ")");
        String str4 = "(&" + strA + "" + strA2 + ")";
        if (strA != null) {
            strA2 = str4;
        }
        List fromCache = getFromCache(strA2);
        if (fromCache != null) {
            return fromCache;
        }
        ArrayList arrayList = new ArrayList();
        try {
            ...
            NamingEnumeration namingEnumerationSearch = dirContextConnectLDAP.search(this.params.getBaseDN(), strA2, searchControls);
