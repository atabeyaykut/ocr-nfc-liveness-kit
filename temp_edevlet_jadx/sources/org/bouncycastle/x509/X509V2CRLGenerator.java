...
public class X509V2CRLGenerator {
    ...
    public void addCRLEntry(BigInteger bigInteger, Date date, int r52) {
        this.tbsGen.addCRLEntry(new ASN1Integer(bigInteger), new Time(date), r52);
    }

    public void addCRLEntry(BigInteger bigInteger, Date date, int r52, Date date2) {
        this.tbsGen.addCRLEntry(new ASN1Integer(bigInteger), new Time(date), r52, new ASN1GeneralizedTime(date2));
    }
    ...
    public void setIssuerDN(X500Principal x500Principal) {
        try {
            ...
            throw new IllegalArgumentException(a.c("can't process principal: ", e10));
        }
    }
