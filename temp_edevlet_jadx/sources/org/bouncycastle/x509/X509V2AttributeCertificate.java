...
public class X509V2AttributeCertificate implements X509AttributeCertificate {
    ...
    private static AttributeCertificate getObject(InputStream inputStream) throws IOException {
        try {
            ...
            throw new IOException(a.b(e11, new StringBuilder("exception decoding certificate structure: ")));
        }
    }
    ...
    public X509Attribute[] getAttributes() {
        ...
        for (int r22 = 0; r22 != attributes.size(); r22++) {
            x509AttributeArr[r22] = new X509Attribute(attributes.getObjectAt(r22));
        }
    ...
    public X509Attribute[] getAttributes(String str) {
        ...
        for (int r22 = 0; r22 != attributes.size(); r22++) {
            X509Attribute x509Attribute = new X509Attribute(attributes.getObjectAt(r22));
