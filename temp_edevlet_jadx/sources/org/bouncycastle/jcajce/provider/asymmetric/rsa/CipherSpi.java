...
public class CipherSpi extends BaseCipherSpi {
    ...
    private int getInputLimit() {
        ...
        boolean z10 = asymmetricBlockCipher instanceof RSABlindedEngine;
        int inputBlockSize = asymmetricBlockCipher.getInputBlockSize();
        return z10 ? inputBlockSize + 1 : inputBlockSize;
    }
    ...
    public int engineDoFinal(byte[] bArr, int r52, int r6, byte[] bArr2, int r82) throws BadPaddingException, IllegalBlockSizeException, IOException, ShortBufferException {
        if (r82 > bArr2.length - engineGetOutputSize(bArr == null ? 0 : r6)) {
            throw new ShortBufferException("output buffer too short for input.");
        }
        byte[] bArrEngineDoFinal = engineDoFinal(bArr, r52, r6);
        System.arraycopy(bArrEngineDoFinal, 0, bArr2, r82, bArrEngineDoFinal.length);
        return bArrEngineDoFinal.length;
    }

    @Override // javax.crypto.CipherSpi
    public byte[] engineDoFinal(byte[] bArr, int r22, int r32) throws BadPaddingException, IllegalBlockSizeException, IOException {
        if (bArr != null) {
            engineUpdate(bArr, r22, r32);
        }
        return getOutput();
    }
    ...
    public void engineInit(int r52, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        this.param = new ParametersWithRandom(cipherParameters2, secureRandom);
        this.bOut.reset();
        if (r52 != 1) {
            if (r52 != 2) {
                if (r52 != 3) {
                    if (r52 != 4) {
                        throw new InvalidParameterException(a.f("unknown opmode ", r52, " passed to RSA"));
                    }
                }
            }
            ...
            if (!upperCase.equals("ISO9796-1PADDING")) {
                if (upperCase.equals("OAEPWITHMD5ANDMGF1PADDING")) {
                    ...
                    if (!upperCase.equals("OAEPWITHSHA3-512ANDMGF1PADDING")) {
                        throw new NoSuchPaddingException(android.support.v4.media.a.f(str, " unavailable with RSA."));
                    }
    ...
    @Override // javax.crypto.CipherSpi
    public byte[] engineUpdate(byte[] bArr, int r42, int r52) throws IOException {
        if (r52 > getInputLimit() - this.bOut.size()) {
