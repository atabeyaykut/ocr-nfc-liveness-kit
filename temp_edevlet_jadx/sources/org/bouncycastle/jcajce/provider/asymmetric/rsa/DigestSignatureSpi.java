...
public class DigestSignatureSpi extends SignatureSpi {
    ...
    public void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        if (!(privateKey instanceof RSAPrivateKey)) {
            throw new InvalidKeyException(c.h(new StringBuilder("Supplied key ("), getType(privateKey), ") is not a RSAPrivateKey instance"));
        }
    ...
    public void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        if (!(publicKey instanceof RSAPublicKey)) {
            throw new InvalidKeyException(c.h(new StringBuilder("Supplied key ("), getType(publicKey), ") is not a RSAPublicKey instance"));
        }
    ...
    public boolean engineVerify(byte[] bArr) throws SignatureException {
        ...
        int r32 = r42 + 2;
        int r6 = 0;
        for (int r52 = 0; r52 < bArrDerEncode.length - r32; r52++) {
            r6 |= bArrProcessBlock[r42 + r52] ^ bArrDerEncode[r32 + r52];
        }
        for (int r33 = 0; r33 < r42; r33++) {
            r6 |= bArrProcessBlock[r33] ^ bArrDerEncode[r33];
        }
        return r6 == 0;
    }
}
