...
public abstract class AlgorithmParametersSpi extends java.security.AlgorithmParametersSpi {
    ...
    public static class OAEP extends AlgorithmParametersSpi {
        ...
        public byte[] engineGetEncoded() {
            ASN1ObjectIdentifier aSN1ObjectIdentifier = DigestFactory.getOID(this.currentSpec.getDigestAlgorithm());
            DERNull dERNull = DERNull.INSTANCE;
            try {
                return new RSAESOAEPparams(new AlgorithmIdentifier(aSN1ObjectIdentifier, dERNull), new AlgorithmIdentifier(PKCSObjectIdentifiers.id_mgf1, new AlgorithmIdentifier(DigestFactory.getOID(((MGF1ParameterSpec) this.currentSpec.getMGFParameters()).getDigestAlgorithm()), dERNull)), new AlgorithmIdentifier(PKCSObjectIdentifiers.id_pSpecified, new DEROctetString(((PSource.PSpecified) this.currentSpec.getPSource()).getValue()))).getEncoded(ASN1Encoding.DER);
    ...
    public static class PSS extends AlgorithmParametersSpi {
        ...
        public byte[] engineGetEncoded() throws IOException {
            ...
            ASN1ObjectIdentifier aSN1ObjectIdentifier2 = NISTObjectIdentifiers.id_shake128;
            AlgorithmIdentifier algorithmIdentifier = (aSN1ObjectIdentifier2.equals((ASN1Primitive) aSN1ObjectIdentifier) || NISTObjectIdentifiers.id_shake256.equals((ASN1Primitive) aSN1ObjectIdentifier)) ? new AlgorithmIdentifier(aSN1ObjectIdentifier) : new AlgorithmIdentifier(aSN1ObjectIdentifier, DERNull.INSTANCE);
            ...
            if (!pSSParameterSpec.getMGFAlgorithm().equals("SHAKE128")) {
                aSN1ObjectIdentifier2 = NISTObjectIdentifiers.id_shake256;
            }
            return new RSASSAPSSparams(algorithmIdentifier, new AlgorithmIdentifier(aSN1ObjectIdentifier2), new ASN1Integer(pSSParameterSpec.getSaltLength()), new ASN1Integer(pSSParameterSpec.getTrailerField())).getEncoded(ASN1Encoding.DER);
        }
