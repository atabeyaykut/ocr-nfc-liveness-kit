    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            for (int r22 = 1; r22 <= 36; r22++) {
                ...
                configurableProvider.addAlgorithm("Alg.Alias.Signature.OID." + aSN1ObjectIdentifier + "." + r22, "SPHINCSPLUS");
            }
            ...
            for (int r72 = 0; r72 != 12; r72++) {
                StringBuilder sbE = a.e(new StringBuilder("Alg.Alias.Signature."), aSN1ObjectIdentifierArr[r72], configurableProvider, "SPHINCSPLUS", "Alg.Alias.Signature.OID.");
                sbE.append(aSN1ObjectIdentifierArr[r72]);
                configurableProvider.addAlgorithm(sbE.toString(), "SPHINCSPLUS");
            }
