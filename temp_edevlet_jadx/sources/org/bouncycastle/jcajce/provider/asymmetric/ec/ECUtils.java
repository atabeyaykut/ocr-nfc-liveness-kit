...
class ECUtils {
    ...
    public static X962Parameters getDomainParametersFromName(ECParameterSpec eCParameterSpec, boolean z10) {
        if (!(eCParameterSpec instanceof ECNamedCurveSpec)) {
            ...
            return new X962Parameters(new X9ECParameters(eCCurveConvertCurve, new X9ECPoint(EC5Util.convertPoint(eCCurveConvertCurve, eCParameterSpec.getGenerator()), z10), eCParameterSpec.getOrder(), BigInteger.valueOf(eCParameterSpec.getCofactor()), eCParameterSpec.getCurve().getSeed()));
        }
    ...
    public static X9ECParameters getDomainParametersFromName(String str, ProviderConfiguration providerConfiguration) {
        ...
        return (namedCurveByOid != null || providerConfiguration == null) ? namedCurveByOid : (X9ECParameters) providerConfiguration.getAdditionalECParameters().get(aSN1ObjectIdentifier);
    }
