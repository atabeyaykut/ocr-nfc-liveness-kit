...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    public PrivateKey generatePrivate(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        try {
            ...
            for (int r32 = 0; r32 < aSN1Sequence.size(); r32++) {
                privateKeyArr[r32] = keyFactoriesFromIdentifier.get(r32).generatePrivate(new PKCS8EncodedKeySpec(PrivateKeyInfo.getInstance(aSN1Sequence.getObjectAt(r32)).getEncoded()));
            }
    ...
    public PublicKey generatePublic(SubjectPublicKeyInfo subjectPublicKeyInfo) throws IOException {
        ...
        try {
            ...
            for (int r42 = 0; r42 < aSN1Sequence.size(); r42++) {
                if (aSN1Sequence.getObjectAt(r42) instanceof DEROctetString) {
                    aSN1BitStringArr[r42] = new DERBitString(((DEROctetString) aSN1Sequence.getObjectAt(r42)).getOctets());
                } else {
                    aSN1BitStringArr[r42] = (DERBitString) aSN1Sequence.getObjectAt(r42);
                }
            }
            ...
            for (int r32 = 0; r32 < aSN1Sequence.size(); r32++) {
                publicKeyArr[r32] = keyFactoriesFromIdentifier.get(r32).generatePublic(keysSpecs[r32]);
            }
