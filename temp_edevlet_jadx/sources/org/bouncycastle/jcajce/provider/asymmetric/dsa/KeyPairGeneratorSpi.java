...
public class KeyPairGeneratorSpi extends KeyPairGenerator {
            ...
            if (params.containsKey(numValueOf)) {
                ...
                synchronized (lock) {
                    if (params.containsKey(numValueOf)) {
                        ...
                        int r32 = this.strength;
                        if (r32 == 1024) {
                            dSAParametersGenerator = new DSAParametersGenerator();
                            if (Properties.isOverrideSet("org.bouncycastle.dsa.FIPS186-2for1024bits")) {
                                r42 = this.strength;
                                secureRandom = this.random;
                                dSAParametersGenerator.init(r42, defaultCertainty, secureRandom);
                            ...
                            DSAParameterGenerationParameters dSAParameterGenerationParameters = new DSAParameterGenerationParameters(r32, 256, defaultCertainty, this.random);
    ...
    @Override // java.security.KeyPairGenerator, java.security.KeyPairGeneratorSpi
    public void initialize(int r52, SecureRandom secureRandom) {
        boolean z10;
        if (r52 < 512 || r52 > 4096 || ((r52 < 1024 && r52 % 64 != 0) || (r52 >= 1024 && r52 % 1024 != 0))) {
            throw new InvalidParameterException("strength must be from 512 - 4096 and a multiple of 1024 above 1024");
        }
        DSAParameterSpec dSADefaultParameters = BouncyCastleProvider.CONFIGURATION.getDSADefaultParameters(r52);
