...
public class EXTERNAL {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            StringBuilder sbD = androidx.fragment.app.a.d(configurableProvider, "KeyFactory.EXTERNAL", "org.bouncycastle.jcajce.provider.asymmetric.EXTERNAL$KeyFactory", "KeyFactory.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier = BCObjectIdentifiers.external_value;
            StringBuilder sbE = androidx.room.util.a.e(sbD, aSN1ObjectIdentifier, configurableProvider, "org.bouncycastle.jcajce.provider.asymmetric.EXTERNAL$KeyFactory", "KeyFactory.OID.");
            sbE.append(aSN1ObjectIdentifier);
            configurableProvider.addAlgorithm(sbE.toString(), "org.bouncycastle.jcajce.provider.asymmetric.EXTERNAL$KeyFactory");
