...
public class CertificateFactory extends CertificateFactorySpi {
    ...
    private CRL doGenerateCRL(InputStream inputStream, boolean z10) throws IOException, CRLException {
        ...
        try {
            ...
            inputStream.reset();
            return r12 != 48 ? readPEMCRL(inputStream, z10) : readDERCRL(new ASN1InputStream(inputStream, true));
    ...
    private Certificate doGenerateCertificate(InputStream inputStream, boolean z10) throws IOException, CertificateException {
        ...
        try {
            ...
            inputStream.reset();
            return r02 != 48 ? readPEMCertificate(inputStream, z10) : readDERCertificate(new ASN1InputStream(inputStream));
        } catch (Exception e10) {
            throw new ExCertificateException(a.j(e10, new StringBuilder("parsing issue: ")), e10);
        }
    }
    ...
    private CRL getCRL() throws CRLException {
        ...
        int r12 = this.sCrlDataObjectCount;
        this.sCrlDataObjectCount = r12 + 1;
        return createCRL(CertificateList.getInstance(aSN1Set2.getObjectAt(r12)));
    }
    ...
    private Certificate getCertificate() throws CertificateParsingException {
        ...
        while (this.sDataObjectCount < this.sData.size()) {
            ASN1Set aSN1Set = this.sData;
            int r12 = this.sDataObjectCount;
            this.sDataObjectCount = r12 + 1;
            ASN1Encodable objectAt = aSN1Set.getObjectAt(r12);
    ...
    private Certificate readPEMCertificate(InputStream inputStream, boolean z10) throws CertificateParsingException, IOException {
