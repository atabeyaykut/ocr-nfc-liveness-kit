...
class X509CRLObject extends X509CRLImpl {
    ...
    private static String createSigAlgName(CertificateList certificateList) throws CRLException {
        try {
            ...
            throw new X509CRLException(a.j(e10, new StringBuilder("CRL contents invalid: ")), e10);
        }
    }
    ...
    private static byte[] createSigAlgParams(CertificateList certificateList) throws CRLException {
        try {
            ...
            throw new CRLException(android.support.v4.media.a.e("CRL contents invalid: ", e10));
        }
    }
    ...
    private X509CRLInternal getInternalCRL() throws IOException {
        ...
        synchronized (this.cacheLock) {
            ...
            try {
                ...
                encoded = this.f11674c.getEncoded(ASN1Encoding.DER);
            } catch (IOException e10) {
                encoded = null;
                x509CRLException = new X509CRLException(e10);
            }
            X509CRLInternal x509CRLInternal3 = new X509CRLInternal(this.bcHelper, this.f11674c, this.sigAlgName, this.sigAlgParams, this.isIndirect, encoded, x509CRLException);
            synchronized (this.cacheLock) {
    ...
    public boolean equals(Object obj) throws IOException {
        ...
        if (obj instanceof X509CRLObject) {
            ...
            } else if ((this.internalCRLValue == null || x509CRLObject.internalCRLValue == null) && (signature = this.f11674c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CRLObject.f11674c.getSignature())) {
                return false;
            }
