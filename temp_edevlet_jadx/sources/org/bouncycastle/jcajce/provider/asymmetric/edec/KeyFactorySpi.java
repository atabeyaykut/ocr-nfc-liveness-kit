...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    public KeyFactorySpi(String str, boolean z10, int r32) {
        this.algorithm = str;
        this.isXdh = z10;
        this.specificBase = r32;
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        if (keySpec instanceof X509EncodedKeySpec) {
            ...
            int r12 = this.specificBase;
            if (r12 == 0 || r12 == encoded[8]) {
                if (encoded[9] == 5 && encoded[10] == 0) {
                    ...
                    try {
                        ...
                        throw new InvalidKeySpecException(a.c(e10, new StringBuilder("attempt to reconstruct key failed: ")));
                    }
                }
                switch (encoded[8]) {
                    case 110:
    ...
    public PrivateKey generatePrivate(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if (this.isXdh) {
            int r12 = this.specificBase;
            if ((r12 == 0 || r12 == 111) && algorithm.equals((ASN1Primitive) EdECObjectIdentifiers.id_X448)) {
                return new BCXDHPrivateKey(privateKeyInfo);
            }
            int r13 = this.specificBase;
            if ((r13 == 0 || r13 == 110) && algorithm.equals((ASN1Primitive) EdECObjectIdentifiers.id_X25519)) {
                return new BCXDHPrivateKey(privateKeyInfo);
            }
        } else {
            ...
            if (algorithm.equals((ASN1Primitive) aSN1ObjectIdentifier) || algorithm.equals((ASN1Primitive) EdECObjectIdentifiers.id_Ed25519)) {
                int r22 = this.specificBase;
                if ((r22 == 0 || r22 == 113) && algorithm.equals((ASN1Primitive) aSN1ObjectIdentifier)) {
                    return new BCEdDSAPrivateKey(privateKeyInfo);
                }
                int r14 = this.specificBase;
                if ((r14 == 0 || r14 == 112) && algorithm.equals((ASN1Primitive) EdECObjectIdentifiers.id_Ed25519)) {
                    return new BCEdDSAPrivateKey(privateKeyInfo);
                }
            }
        }
        throw new IOException(v.d("algorithm identifier ", algorithm, " in key not recognized"));
    }
