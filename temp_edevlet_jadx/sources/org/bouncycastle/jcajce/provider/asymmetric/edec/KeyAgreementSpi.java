...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    private RawAgreement getAgreement(String str) throws InvalidKeyException {
        if (this.kaAlgorithm.equals("XDH") || this.kaAlgorithm.startsWith(str)) {
            int r02 = this.kaAlgorithm.indexOf(85);
            boolean zStartsWith = str.startsWith(XDHParameterSpec.X448);
            return r02 > 0 ? zStartsWith ? new XDHUnifiedAgreement(new X448Agreement()) : new XDHUnifiedAgreement(new X25519Agreement()) : zStartsWith ? new X448Agreement() : new X25519Agreement();
        }
