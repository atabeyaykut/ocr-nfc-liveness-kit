...
public class Blake2b {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            StringBuilder sbH = a.h(new StringBuilder("Alg.Alias.MessageDigest."), MiscObjectIdentifiers.id_blake2b512, configurableProvider, "BLAKE2B-512", str);
            sbH.append("$Blake2b384");
            configurableProvider.addAlgorithm("MessageDigest.BLAKE2B-384", sbH.toString());
            StringBuilder sbH2 = a.h(new StringBuilder("Alg.Alias.MessageDigest."), MiscObjectIdentifiers.id_blake2b384, configurableProvider, "BLAKE2B-384", str);
            sbH2.append("$Blake2b256");
            configurableProvider.addAlgorithm("MessageDigest.BLAKE2B-256", sbH2.toString());
            StringBuilder sbH3 = a.h(new StringBuilder("Alg.Alias.MessageDigest."), MiscObjectIdentifiers.id_blake2b256, configurableProvider, "BLAKE2B-256", str);
            sbH3.append("$Blake2b160");
            configurableProvider.addAlgorithm("MessageDigest.BLAKE2B-160", sbH3.toString());
            androidx.browser.browseractions.a.g(new StringBuilder("Alg.Alias.MessageDigest."), MiscObjectIdentifiers.id_blake2b160, configurableProvider, "BLAKE2B-160");
        }
    }
