...
public class Whirlpool {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.i(sb2, str, "$Digest", configurableProvider, "MessageDigest.WHIRLPOOL");
            configurableProvider.addAlgorithm("MessageDigest", ISOIECObjectIdentifiers.whirlpool, str + "$Digest");
            addHMACAlgorithm(configurableProvider, "WHIRLPOOL", c.h(new StringBuilder(), str, "$HashMac"), android.support.v4.media.a.f(str, "$KeyGenerator"));
        }
    }
