...
public class RIPEMD256 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            StringBuilder sbH = a.h(new StringBuilder("Alg.Alias.MessageDigest."), TeleTrusTObjectIdentifiers.ripemd256, configurableProvider, "RIPEMD256", str);
            sbH.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "RIPEMD256", sbH.toString(), android.support.v4.media.a.f(str, "$KeyGenerator"));
        }
    }
