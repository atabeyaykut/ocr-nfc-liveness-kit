...
class BcFKSKeyStoreSpi extends KeyStoreSpi {
    ...
    public static class SharedKeyStoreSpi extends BcFKSKeyStoreSpi implements PKCSObjectIdentifiers, X509ObjectIdentifiers {
        ...
        public Key engineGetKey(String str, char[] cArr) throws InvalidKeySpecException, NoSuchAlgorithmException, UnrecoverableKeyException {
            try {
                ...
                StringBuilder sbL = android.support.v4.media.a.l("unable to recover key (", str, "): ");
                sbL.append(e10.getMessage());
                throw new UnrecoverableKeyException(sbL.toString());
            }
        }
    ...
    private EncryptedPrivateKeyData createPrivateKeySequence(EncryptedPrivateKeyInfo encryptedPrivateKeyInfo, Certificate[] certificateArr) throws CertificateEncodingException {
        ...
        for (int r12 = 0; r12 != certificateArr.length; r12++) {
            certificateArr2[r12] = org.bouncycastle.asn1.x509.Certificate.getInstance(certificateArr[r12].getEncoded());
        }
    ...
    private byte[] generateKey(KeyDerivationFunc keyDerivationFunc, String str, char[] cArr, int r10) throws IOException {
        ...
        if (MiscObjectIdentifiers.id_scrypt.equals((ASN1Primitive) keyDerivationFunc.getAlgorithm())) {
            ...
            if (scryptParams.getKeyLength() != null) {
                r10 = scryptParams.getKeyLength().intValue();
            } else if (r10 == -1) {
                throw new IOException("no keyLength found in ScryptParams");
            }
            return SCrypt.generate(Arrays.concatenate(bArrPKCS12PasswordToBytes, bArrPKCS12PasswordToBytes2), scryptParams.getSalt(), scryptParams.getCostParameter().intValue(), scryptParams.getBlockSize().intValue(), scryptParams.getBlockSize().intValue(), r10);
        }
        ...
        if (pBKDF2Params.getKeyLength() != null) {
            r10 = pBKDF2Params.getKeyLength().intValue();
        } else if (r10 == -1) {
        ...
        if (pBKDF2Params.getPrf().getAlgorithm().equals((ASN1Primitive) PKCSObjectIdentifiers.id_hmacWithSHA512)) {
            ...
            return ((KeyParameter) pKCS5S2ParametersGenerator.generateDerivedParameters(r10 * 8)).getKey();
        }
        if (pBKDF2Params.getPrf().getAlgorithm().equals((ASN1Primitive) NISTObjectIdentifiers.id_hmacWithSHA3_512)) {
            ...
            return ((KeyParameter) pKCS5S2ParametersGenerator2.generateDerivedParameters(r10 * 8)).getKey();
        }
        throw new IOException("BCFKS KeyStore: unrecognized MAC PBKD PRF: " + pBKDF2Params.getPrf().getAlgorithm());
    }

    private KeyDerivationFunc generatePkbdAlgorithmIdentifier(ASN1ObjectIdentifier aSN1ObjectIdentifier, int r82) {
        ...
        if (aSN1ObjectIdentifier2.equals((ASN1Primitive) aSN1ObjectIdentifier)) {
            return new KeyDerivationFunc(aSN1ObjectIdentifier2, new PBKDF2Params(bArr, 51200, r82, new AlgorithmIdentifier(PKCSObjectIdentifiers.id_hmacWithSHA512, DERNull.INSTANCE)));
        }
        throw new IllegalStateException(android.support.v4.media.a.g("unknown derivation algorithm: ", aSN1ObjectIdentifier));
    }

    private KeyDerivationFunc generatePkbdAlgorithmIdentifier(KeyDerivationFunc keyDerivationFunc, int r10) {
        ...
        if (zEquals) {
            ...
            getDefaultSecureRandom().nextBytes(bArr);
            return new KeyDerivationFunc(aSN1ObjectIdentifier, new ScryptParams(bArr, scryptParams.getCostParameter(), scryptParams.getBlockSize(), scryptParams.getParallelizationParameter(), BigInteger.valueOf(r10)));
        }
        PBKDF2Params pBKDF2Params = PBKDF2Params.getInstance(parameters);
        byte[] bArr2 = new byte[pBKDF2Params.getSalt().length];
        getDefaultSecureRandom().nextBytes(bArr2);
        return new KeyDerivationFunc(PKCSObjectIdentifiers.id_PBKDF2, new PBKDF2Params(bArr2, pBKDF2Params.getIterationCount().intValue(), r10, pBKDF2Params.getPrf()));
    }

    private KeyDerivationFunc generatePkbdAlgorithmIdentifier(PBKDFConfig pBKDFConfig, int r10) {
        ASN1ObjectIdentifier aSN1ObjectIdentifier = MiscObjectIdentifiers.id_scrypt;
        if (aSN1ObjectIdentifier.equals((ASN1Primitive) pBKDFConfig.getAlgorithm())) {
            ...
            getDefaultSecureRandom().nextBytes(bArr);
            return new KeyDerivationFunc(aSN1ObjectIdentifier, new ScryptParams(bArr, scryptConfig.getCostParameter(), scryptConfig.getBlockSize(), scryptConfig.getParallelizationParameter(), r10));
        }
        PBKDF2Config pBKDF2Config = (PBKDF2Config) pBKDFConfig;
        byte[] bArr2 = new byte[pBKDF2Config.getSaltLength()];
        getDefaultSecureRandom().nextBytes(bArr2);
        return new KeyDerivationFunc(PKCSObjectIdentifiers.id_PBKDF2, new PBKDF2Params(bArr2, pBKDF2Config.getIterationCount(), r10, pBKDF2Config.getPRF()));
    }
    ...
    public Certificate[] engineGetCertificateChain(String str) {
        ...
        for (int r22 = 0; r22 != length; r22++) {
            x509CertificateArr[r22] = decodeCertificate(certificateChain[r22]);
        }
    ...
    public Key engineGetKey(String str, char[] cArr) throws InvalidKeySpecException, UnrecoverableKeyException, NoSuchAlgorithmException {
        ...
        if (!objectData.getType().equals(PRIVATE_KEY) && !objectData.getType().equals(PROTECTED_PRIVATE_KEY)) {
            ...
            try {
                ...
                throw new UnrecoverableKeyException(androidx.constraintlayout.core.a.j(e10, android.support.v4.media.a.l("BCFKS KeyStore unable to recover secret key (", str, "): ")));
            }
        }
        ...
        try {
            ...
            throw new UnrecoverableKeyException(androidx.constraintlayout.core.a.j(e11, android.support.v4.media.a.l("BCFKS KeyStore unable to recover private key (", str, "): ")));
        }
    }
                ...
                try {
                    ...
                    if (this.validator == null) {
                        ...
                        for (int r72 = 0; r72 != length; r72++) {
                            x509CertificateArr[r72] = (X509Certificate) certificateFactoryCreateCertificateFactory.generateCertificate(new ByteArrayInputStream(certificates[r72].getEncoded()));
                        }
    ...
    public void engineSetCertificateEntry(String str, Certificate certificate) throws KeyStoreException {
        ...
        if (objectData == null) {
            ...
            if (!objectData.getType().equals(CERTIFICATE)) {
                throw new KeyStoreException(b.e("BCFKS KeyStore already has a key entry with alias ", str));
            }
    ...
    public void engineSetKeyEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) throws KeyStoreException {
        ...
        if (key instanceof PrivateKey) {
            ...
            try {
                ...
                throw new ExtKeyStoreException(androidx.constraintlayout.core.a.b(e10, new StringBuilder("BCFKS KeyStore exception storing private key: ")), e10);
            }
        } else {
            ...
            try {
                ...
                throw new ExtKeyStoreException(androidx.constraintlayout.core.a.b(e11, new StringBuilder("BCFKS KeyStore exception storing private key: ")), e11);
            }
        }
        this.lastModifiedDate = date;
    }
        ...
        try {
            ...
            if (storeCertificates != null) {
                ...
                for (int r52 = 0; r52 != length; r52++) {
                    certificateArr[r52] = org.bouncycastle.asn1.x509.Certificate.getInstance(storeCertificates[r52].getEncoded());
                }
        ...
        if (certificateArr != null) {
            try {
                ...
                try {
                    ...
                    throw new ExtKeyStoreException(androidx.constraintlayout.core.a.b(e10, new StringBuilder("BCFKS KeyStore exception storing protected private key: ")), e10);
                }
            } catch (Exception e11) {
            ...
            try {
                ...
                throw new ExtKeyStoreException(androidx.constraintlayout.core.a.b(e12, new StringBuilder("BCFKS KeyStore exception storing protected private key: ")), e12);
            }
        }
        this.lastModifiedDate = date;
    }
