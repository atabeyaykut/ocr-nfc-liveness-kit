...
public class BcKeyStoreSpi extends KeyStoreSpi implements BCKeyStore {
    ...
    public static class BouncyCastleStore extends BcKeyStoreSpi {
        ...
        public void engineLoad(InputStream inputStream, char[] cArr) throws IOException {
            ...
            int r72 = dataInputStream.readInt();
            if (r72 < 0 || r72 > 65536) {
                throw new IOException("Key store corrupted.");
            }
            CipherInputStream cipherInputStream = new CipherInputStream(dataInputStream, makePBECipher(r92 == 0 ? "OldPBEWithSHAAndTwofish-CBC" : BcKeyStoreSpi.STORE_CIPHER, 2, cArr, bArr, r72));
        ...
        public void engineStore(OutputStream outputStream, char[] cArr) throws BadPaddingException, IllegalBlockSizeException, IOException, CertificateEncodingException {
            ...
            int r6 = (this.random.nextInt() & 1023) + 1024;
            this.random.nextBytes(bArr);
            dataOutputStream.writeInt(this.version);
            dataOutputStream.writeInt(20);
            dataOutputStream.write(bArr);
            dataOutputStream.writeInt(r6);
            CipherOutputStream cipherOutputStream = new CipherOutputStream(dataOutputStream, makePBECipher(BcKeyStoreSpi.STORE_CIPHER, 1, cArr, bArr, r6));
    ...
    public class StoreEntry {
        ...
        public StoreEntry(String str, Key key, char[] cArr, Certificate[] certificateArr) throws Exception {
            ...
            int r52 = (BcKeyStoreSpi.this.random.nextInt() & 1023) + 1024;
            ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
            DataOutputStream dataOutputStream = new DataOutputStream(byteArrayOutputStream);
            dataOutputStream.writeInt(20);
            dataOutputStream.write(bArr);
            dataOutputStream.writeInt(r52);
            DataOutputStream dataOutputStream2 = new DataOutputStream(new CipherOutputStream(dataOutputStream, BcKeyStoreSpi.this.makePBECipher(BcKeyStoreSpi.KEY_CIPHER, 1, cArr, bArr, r52)));
        ...
        public StoreEntry(String str, Date date, int r42, Object obj) {
            new Date();
            this.alias = str;
            this.date = date;
            this.type = r42;
        ...
        public StoreEntry(String str, Date date, int r42, Object obj, Certificate[] certificateArr) {
            new Date();
            this.alias = str;
            this.date = date;
            this.type = r42;
        ...
        public Object getObject(char[] cArr) throws UnrecoverableKeyException, NoSuchAlgorithmException, IOException {
            ...
            try {
                ...
                try {
                    ...
                    int r92 = dataInputStream2.readInt();
                    try {
                        keyDecodeKey = BcKeyStoreSpi.this.decodeKey(new DataInputStream(new CipherInputStream(dataInputStream2, BcKeyStoreSpi.this.makePBECipher("BrokenPBEWithSHAAnd3-KeyTripleDES-CBC", 2, cArr, bArr2, r92))));
                        ...
                        r92 = dataInputStream3.readInt();
                        keyDecodeKey = BcKeyStoreSpi.this.decodeKey(new DataInputStream(new CipherInputStream(dataInputStream3, BcKeyStoreSpi.this.makePBECipher("OldPBEWithSHAAnd3-KeyTripleDES-CBC", 2, cArr, bArr2, r92))));
                    }
                    byte[] bArr3 = bArr2;
                    int r82 = r92;
                    ...
                    dataOutputStream.writeInt(r82);
                    DataOutputStream dataOutputStream2 = new DataOutputStream(new CipherOutputStream(dataOutputStream, BcKeyStoreSpi.this.makePBECipher(BcKeyStoreSpi.KEY_CIPHER, 1, cArr, bArr3, r82)));
    ...
    public Key decodeKey(DataInputStream dataInputStream) throws IOException {
        ...
        if (utf.equals("PKCS#8") || utf.equals("PKCS8")) {
            ...
            if (!utf.equals("X.509") && !utf.equals("X509")) {
                ...
                throw new IOException(a.a("Key format ", utf, " not recognised!"));
            }
        ...
        try {
            ...
            throw new IOException("Key type " + r12 + " not recognised!");
        } catch (Exception e10) {
            throw new IOException(androidx.constraintlayout.core.a.b(e10, new StringBuilder("Exception creating key: ")));
        }
    }
    ...
    public void engineLoad(InputStream inputStream, char[] cArr) throws IOException {
        ...
        DataInputStream dataInputStream = new DataInputStream(inputStream);
        int r82 = dataInputStream.readInt();
        if (r82 != 2 && r82 != 0 && r82 != 1) {
            throw new IOException("Wrong version of key store.");
        }
        ...
        pKCS12ParametersGenerator.init(bArrPKCS12PasswordToBytes, bArr, r32);
        CipherParameters cipherParametersGenerateDerivedMacParameters = pKCS12ParametersGenerator.generateDerivedMacParameters(r82 != 2 ? hMac.getMacSize() : hMac.getMacSize() * 8);
    ...
    public void engineSetCertificateEntry(String str, Certificate certificate) throws KeyStoreException {
        StoreEntry storeEntry = (StoreEntry) this.table.get(str);
        if (storeEntry != null && storeEntry.getType() != 1) {
            throw new KeyStoreException(b.e("key store already has a key entry with alias ", str));
        }
    ...
    public void engineStore(OutputStream outputStream, char[] cArr) throws IOException, CertificateEncodingException {
        DataOutputStream dataOutputStream = new DataOutputStream(outputStream);
        byte[] bArr = new byte[20];
        int r22 = (this.random.nextInt() & 1023) + 1024;
        this.random.nextBytes(bArr);
        dataOutputStream.writeInt(this.version);
        dataOutputStream.writeInt(20);
        dataOutputStream.write(bArr);
        dataOutputStream.writeInt(r22);
        HMac hMac = new HMac(new SHA1Digest());
        MacOutputStream macOutputStream = new MacOutputStream(hMac);
        PKCS12ParametersGenerator pKCS12ParametersGenerator = new PKCS12ParametersGenerator(new SHA1Digest());
        byte[] bArrPKCS12PasswordToBytes = PBEParametersGenerator.PKCS12PasswordToBytes(cArr);
        pKCS12ParametersGenerator.init(bArrPKCS12PasswordToBytes, bArr, r22);
        hMac.init(pKCS12ParametersGenerator.generateDerivedMacParameters(this.version < 2 ? hMac.getMacSize() : hMac.getMacSize() * 8));
        for (int r23 = 0; r23 != bArrPKCS12PasswordToBytes.length; r23++) {
            bArrPKCS12PasswordToBytes[r23] = 0;
        }
    ...
    public void loadStore(InputStream inputStream) throws IOException {
        ...
        DataInputStream dataInputStream = new DataInputStream(inputStream);
        for (int r52 = dataInputStream.read(); r52 > 0; r52 = dataInputStream.read()) {
            String utf = dataInputStream.readUTF();
            Date date = new Date(dataInputStream.readLong());
            int r12 = dataInputStream.readInt();
            if (r12 != 0) {
                Certificate[] certificateArr2 = new Certificate[r12];
                for (int r32 = 0; r32 != r12; r32++) {
                    certificateArr2[r32] = decodeCertificate(dataInputStream);
                }
            ...
            if (r52 == 1) {
                ...
                byte[] bArr = new byte[dataInputStream.readInt()];
                dataInputStream.readFully(bArr);
                this.table.put(utf, new StoreEntry(utf, date, r52, bArr, certificateArr));
            }
            hashtable.put(utf, storeEntry);
        }
    }

    public Cipher makePBECipher(String str, int r42, char[] cArr, byte[] bArr, int r72) throws InvalidKeyException, IOException, InvalidAlgorithmParameterException {
        try {
            PBEKeySpec pBEKeySpec = new PBEKeySpec(cArr);
            SecretKeyFactory secretKeyFactoryCreateSecretKeyFactory = this.helper.createSecretKeyFactory(str);
            PBEParameterSpec pBEParameterSpec = new PBEParameterSpec(bArr, r72);
            Cipher cipherCreateCipher = this.helper.createCipher(str);
            cipherCreateCipher.init(r42, secretKeyFactoryCreateSecretKeyFactory.generateSecret(pBEKeySpec), pBEParameterSpec);
            return cipherCreateCipher;
        } catch (Exception e10) {
            throw new IOException(android.support.v4.media.a.e("Error initialising store of key store: ", e10));
        }
    }
    ...
    public void saveStore(OutputStream outputStream) throws IOException, CertificateEncodingException {
        ...
        while (true) {
            ...
            if (certificateChain == null) {
                ...
                for (int r22 = 0; r22 != certificateChain.length; r22++) {
                    encodeCertificate(certificateChain[r22], dataOutputStream);
                }
            }
