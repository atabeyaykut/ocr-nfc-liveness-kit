    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            if (propertyValue != null) {
                StringBuilder sbE = a.e(configurableProvider, "Alg.Alias.KeyStore.PKCS12", propertyValue, "Alg.Alias.KeyStore.BCPKCS12", propertyValue);
                sbE.append(propertyValue.substring(0, 5));
                sbE.append("-DEF");
                sbE.append(propertyValue.substring(6));
                configurableProvider.addAlgorithm("Alg.Alias.KeyStore.PKCS12-DEF", sbE.toString());
            } else {
