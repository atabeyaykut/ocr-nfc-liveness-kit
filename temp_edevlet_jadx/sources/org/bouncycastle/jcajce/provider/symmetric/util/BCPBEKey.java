...
public class BCPBEKey implements PBEKey, Destroyable {
    ...
    public BCPBEKey(String str, ASN1ObjectIdentifier aSN1ObjectIdentifier, int r52, int r6, int r72, int r82, PBEKeySpec pBEKeySpec, CipherParameters cipherParameters) {
    ...
    public byte[] getEncoded() {
        ...
        if (parameters != null) {
            ...
            int r02 = this.type;
            bArrPKCS12PasswordToBytes = r02 == 2 ? PBEParametersGenerator.PKCS12PasswordToBytes(this.password) : r02 == 5 ? PBEParametersGenerator.PKCS5PasswordToUTF8Bytes(this.password) : PBEParametersGenerator.PKCS5PasswordToBytes(this.password);
        }
        checkDestroyed(this);
