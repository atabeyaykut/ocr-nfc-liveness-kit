...
public interface PBE {
    ...
    public static class Util {
        private static byte[] convertPassword(int r12, PBEKeySpec pBEKeySpec) {
            return r12 == 2 ? PBEParametersGenerator.PKCS12PasswordToBytes(pBEKeySpec.getPassword()) : (r12 == 5 || r12 == 4) ? PBEParametersGenerator.PKCS5PasswordToUTF8Bytes(pBEKeySpec.getPassword()) : PBEParametersGenerator.PKCS5PasswordToBytes(pBEKeySpec.getPassword());
        }

        private static PBEParametersGenerator makePBEGenerator(int r32, int r42) {
            if (r32 == 0 || r32 == 4) {
                if (r42 == 0) {
        ...
        public static CipherParameters makePBEMacParameters(SecretKey secretKey, int r22, int r32, int r42, PBEParameterSpec pBEParameterSpec) {
            PBEParametersGenerator pBEParametersGeneratorMakePBEGenerator = makePBEGenerator(r22, r32);
            ...
            CipherParameters cipherParametersGenerateDerivedMacParameters = pBEParametersGeneratorMakePBEGenerator.generateDerivedMacParameters(r42);
        ...
        public static CipherParameters makePBEMacParameters(PBEKeySpec pBEKeySpec, int r22, int r32, int r42) {
            PBEParametersGenerator pBEParametersGeneratorMakePBEGenerator = makePBEGenerator(r22, r32);
            byte[] bArrConvertPassword = convertPassword(r22, pBEKeySpec);
            pBEParametersGeneratorMakePBEGenerator.init(bArrConvertPassword, pBEKeySpec.getSalt(), pBEKeySpec.getIterationCount());
            CipherParameters cipherParametersGenerateDerivedMacParameters = pBEParametersGeneratorMakePBEGenerator.generateDerivedMacParameters(r42);
            for (int r43 = 0; r43 != bArrConvertPassword.length; r43++) {
                bArrConvertPassword[r43] = 0;
            }
            return cipherParametersGenerateDerivedMacParameters;
        }
        ...
        public static CipherParameters makePBEParameters(PBEKeySpec pBEKeySpec, int r22, int r32, int r42, int r52) {
            PBEParametersGenerator pBEParametersGeneratorMakePBEGenerator = makePBEGenerator(r22, r32);
            byte[] bArrConvertPassword = convertPassword(r22, pBEKeySpec);
            pBEParametersGeneratorMakePBEGenerator.init(bArrConvertPassword, pBEKeySpec.getSalt(), pBEKeySpec.getIterationCount());
            CipherParameters cipherParametersGenerateDerivedParameters = r52 != 0 ? pBEParametersGeneratorMakePBEGenerator.generateDerivedParameters(r42, r52) : pBEParametersGeneratorMakePBEGenerator.generateDerivedParameters(r42);
            for (int r43 = 0; r43 != bArrConvertPassword.length; r43++) {
                bArrConvertPassword[r43] = 0;
            }
        ...
        public static CipherParameters makePBEParameters(byte[] bArr, int r22, int r32, int r42, int r52, AlgorithmParameterSpec algorithmParameterSpec, String str) throws InvalidAlgorithmParameterException {
            if (algorithmParameterSpec == null || !(algorithmParameterSpec instanceof PBEParameterSpec)) {
