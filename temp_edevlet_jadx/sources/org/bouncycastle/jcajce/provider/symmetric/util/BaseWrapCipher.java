...
public abstract class BaseWrapCipher extends CipherSpi implements PBE {
    ...
    public BaseWrapCipher(Wrapper wrapper, int r72) {
        this.availableSpecs = new Class[]{GOST28147WrapParameterSpec.class, PBEParameterSpec.class, RC2ParameterSpec.class, RC5ParameterSpec.class, IvParameterSpec.class};
        this.pbeType = 2;
        this.pbeHash = 1;
        this.engineParams = null;
    ...
    public int engineDoFinal(byte[] bArr, int r32, int r42, byte[] bArr2, int r6) throws BadPaddingException, IllegalBlockSizeException, IOException, ShortBufferException {
        byte[] bArrUnwrap;
        ErasableOutputStream erasableOutputStream = this.wrapStream;
        if (erasableOutputStream == null) {
            throw new IllegalStateException("not supported in a wrapping mode");
        }
        erasableOutputStream.write(bArr, r32, r42);
        try {
            if (this.forWrapping) {
                try {
            ...
            if (bArrUnwrap.length + r6 > bArr2.length) {
                throw new ShortBufferException("output buffer too short for input.");
            }
            System.arraycopy(bArrUnwrap, 0, bArr2, r6, bArrUnwrap.length);
    ...
    @Override // javax.crypto.CipherSpi
    public void engineInit(int r42, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if ((keyParameter instanceof KeyParameter) && (r6 = this.ivSize) != 0 && (r42 == 3 || r42 == 1)) {
    ...
    public Key engineUnwrap(byte[] bArr, String str, int r82) throws NoSuchAlgorithmException, InvalidKeyException {
        try {
            ...
            try {
                ...
                throw new InvalidKeyException(android.support.v4.media.a.d("Unknown key type ", r82));
    ...
    @Override // javax.crypto.CipherSpi
    public int engineUpdate(byte[] bArr, int r22, int r32, byte[] bArr2, int r52) throws IOException, ShortBufferException {
        ErasableOutputStream erasableOutputStream = this.wrapStream;
        if (erasableOutputStream == null) {
            throw new IllegalStateException("not supported in a wrapping mode");
        }
        erasableOutputStream.write(bArr, r22, r32);
        return 0;
    }
