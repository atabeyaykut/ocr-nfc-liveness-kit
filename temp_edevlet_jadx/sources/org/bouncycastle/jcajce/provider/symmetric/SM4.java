...
public final class SM4 {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addCMacAlgorithm(configurableProvider, "SM4", c.h(c.i(c.i(c.i(c.i(sb2, str, "$AlgParams", configurableProvider, "AlgorithmParameters.SM4"), str, "$AlgParamGen", configurableProvider, "AlgorithmParameterGenerator.SM4"), str, "$ECB", configurableProvider, "Cipher.SM4"), str, "$KeyGen", configurableProvider, "KeyGenerator.SM4"), str, "$CMAC"), a.f(str, "$KeyGen"));
            addGMacAlgorithm(configurableProvider, "SM4", a.f(str, "$GMAC"), a.f(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "SM4", a.f(str, "$Poly1305"), a.f(str, "$Poly1305KeyGen"));
        }
    }
