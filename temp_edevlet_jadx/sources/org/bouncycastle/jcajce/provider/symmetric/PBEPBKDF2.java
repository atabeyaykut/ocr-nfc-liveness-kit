...
public class PBEPBKDF2 {
    ...
    public static class BasePBKDF2 extends BaseSecretKeyFactory {
        ...
        public BasePBKDF2(String str, int r32, int r42) {
            super(str, PKCSObjectIdentifiers.id_PBKDF2);
            this.scheme = r32;
            this.defaultDigest = r42;
        }
        ...
        private int getDigestCode(ASN1ObjectIdentifier aSN1ObjectIdentifier) throws InvalidKeySpecException {
            ...
            throw new InvalidKeySpecException(a.g("Invalid KeySpec: unknown PRF algorithm ", aSN1ObjectIdentifier));
        }
        ...
        public SecretKey engineGenerateSecret(KeySpec keySpec) throws InvalidKeySpecException {
            ...
            int r52 = this.defaultDigest;
            int keyLength2 = pBEKeySpec.getKeyLength();
            return new BCPBEKey(this.algName, this.algOid, this.scheme, r52, keyLength2, -1, pBEKeySpec, PBE.Util.makePBEMacParameters(pBEKeySpec, this.scheme, r52, keyLength2));
        }
    }
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            b.i(androidx.appcompat.graphics.drawable.a.h(sb3, aSN1ObjectIdentifier, configurableProvider, "PBKDF2", str), "$PBKDF2withUTF8", configurableProvider, "SecretKeyFactory.PBKDF2");
