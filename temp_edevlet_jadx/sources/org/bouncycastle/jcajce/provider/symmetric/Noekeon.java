...
public final class Noekeon {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addGMacAlgorithm(configurableProvider, "NOEKEON", c.h(c.i(c.i(c.i(c.i(sb2, str, "$AlgParams", configurableProvider, "AlgorithmParameters.NOEKEON"), str, "$AlgParamGen", configurableProvider, "AlgorithmParameterGenerator.NOEKEON"), str, "$ECB", configurableProvider, "Cipher.NOEKEON"), str, "$KeyGen", configurableProvider, "KeyGenerator.NOEKEON"), str, "$GMAC"), a.f(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "NOEKEON", a.f(str, "$Poly1305"), a.f(str, "$Poly1305KeyGen"));
        }
    }
