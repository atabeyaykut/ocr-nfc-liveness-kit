...
public final class RC6 {
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            addGMacAlgorithm(configurableProvider, "RC6", c.h(c.i(c.i(c.i(sb2, str, "$ECB", configurableProvider, "Cipher.RC6"), str, "$KeyGen", configurableProvider, "KeyGenerator.RC6"), str, "$AlgParams", configurableProvider, "AlgorithmParameters.RC6"), str, "$GMAC"), a.f(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "RC6", a.f(str, "$Poly1305"), a.f(str, "$Poly1305KeyGen"));
        }
    }
