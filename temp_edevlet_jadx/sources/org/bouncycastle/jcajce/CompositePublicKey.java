...
public class CompositePublicKey implements PublicKey {
    ...
    public byte[] getEncoded() {
        ...
        for (int r12 = 0; r12 < this.keys.size(); r12++) {
            aSN1EncodableVector.add(this.algorithmIdentifier.equals((ASN1Primitive) MiscObjectIdentifiers.id_composite_key) ? SubjectPublicKeyInfo.getInstance(this.keys.get(r12).getEncoded()) : SubjectPublicKeyInfo.getInstance(this.keys.get(r12).getEncoded()).getPublicKeyData());
        }
        try {
            ...
            throw new IllegalStateException(a.c(e10, new StringBuilder("unable to encode composite public key: ")));
        }
    }
