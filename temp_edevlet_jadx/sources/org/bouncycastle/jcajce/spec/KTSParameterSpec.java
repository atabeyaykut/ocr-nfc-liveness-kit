...
public class KTSParameterSpec implements AlgorithmParameterSpec {
    ...
    public static final class Builder {
        ...
        public Builder(String str, int r32) {
            this(str, r32, null);
        }

        public Builder(String str, int r42, byte[] bArr) {
            this.algorithmName = str;
            this.keySizeInBits = r42;
    ...
    public KTSParameterSpec(String str, int r22, AlgorithmParameterSpec algorithmParameterSpec, AlgorithmIdentifier algorithmIdentifier, byte[] bArr) {
