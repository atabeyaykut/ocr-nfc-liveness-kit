...
public class BufferedEncoder {
    ...
    public BufferedEncoder(Translator translator, int r22) {
    ...
    public int processByte(byte b10, byte[] bArr, int r10) {
        ...
        int r82 = this.translator.encode(bArr2, 0, bArr2.length, bArr, r10);
        this.bufOff = 0;
        return r82;
    }
    ...
    public int processBytes(byte[] bArr, int r12, int r13, byte[] bArr2, int r15) {
        ...
        if (r13 > r14) {
            ...
            byte[] bArr4 = this.buf;
            int r02 = translator.encode(bArr4, 0, bArr4.length, bArr2, r15) + 0;
            this.bufOff = 0;
            int r132 = r13 - r14;
            int r122 = r12 + r14;
            int r72 = r15 + r02;
            int length2 = r132 - (r132 % this.buf.length);
            r32 = r02 + this.translator.encode(bArr, r122, length2, bArr2, r72);
            r13 = r132 - length2;
            r12 = r122 + length2;
        }
        if (r13 != 0) {
