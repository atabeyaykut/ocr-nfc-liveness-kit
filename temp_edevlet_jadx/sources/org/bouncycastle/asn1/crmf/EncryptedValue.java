...
public class EncryptedValue extends ASN1Object {
    ...
    private EncryptedValue(ASN1Sequence aSN1Sequence) {
        int r12 = 0;
        while (aSN1Sequence.getObjectAt(r12) instanceof ASN1TaggedObject) {
        ...
        this.encValue = ASN1BitString.getInstance(aSN1Sequence.getObjectAt(r12));
    }
    ...
    private void addOptional(ASN1EncodableVector aSN1EncodableVector, int r42, ASN1Encodable aSN1Encodable) {
        if (aSN1Encodable != null) {
            aSN1EncodableVector.add(new DERTaggedObject(false, r42, aSN1Encodable));
        }
    }
