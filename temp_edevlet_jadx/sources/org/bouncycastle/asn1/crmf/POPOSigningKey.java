...
public class POPOSigningKey extends ASN1Object {
    ...
    private POPOSigningKey(ASN1Sequence aSN1Sequence) {
        ...
        this.algorithmIdentifier = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(r02));
        this.signature = ASN1BitString.getInstance(aSN1Sequence.getObjectAt(r02 + 1));
    }
