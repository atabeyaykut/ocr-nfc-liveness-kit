...
public class ArchiveTimeStampSequence extends ASN1Object {
    ...
    public ArchiveTimeStampSequence append(ArchiveTimeStampChain archiveTimeStampChain) {
        ...
        for (int r12 = 0; r12 != this.archiveTimeStampChains.size(); r12++) {
            aSN1EncodableVector.add(this.archiveTimeStampChains.getObjectAt(r12));
        }
    ...
    public ArchiveTimeStampChain[] getArchiveTimeStampChains() {
        ...
        for (int r22 = 0; r22 != size; r22++) {
            archiveTimeStampChainArr[r22] = ArchiveTimeStampChain.getInstance(this.archiveTimeStampChains.getObjectAt(r22));
        }
