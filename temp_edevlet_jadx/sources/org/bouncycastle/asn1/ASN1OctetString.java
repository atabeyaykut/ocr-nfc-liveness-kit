...
public abstract class ASN1OctetString extends ASN1Primitive implements ASN1OctetStringParser {
    ...
    public static ASN1OctetString getInstance(Object obj) {
        ...
        if (obj instanceof ASN1Encodable) {
            ...
            try {
                ...
                throw new IllegalArgumentException(a.c(e10, new StringBuilder("failed to construct OCTET STRING from byte[]: ")));
            }
        }
    ...
    public static ASN1OctetString getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z10) {
        return (ASN1OctetString) TYPE.getContextInstance(aSN1TaggedObject, z10);
    }
