...
public class RequestedCertificate extends ASN1Object implements ASN1Choice {
    ...
    public RequestedCertificate(int r32, byte[] bArr) {
        this(new DERTaggedObject(r32, new DEROctetString(bArr)));
    }
    ...
    public byte[] getCertificateBytes() {
        ...
        try {
            ...
            throw new IllegalStateException(a.c("can't decode certificate: ", e10));
        }
    }
