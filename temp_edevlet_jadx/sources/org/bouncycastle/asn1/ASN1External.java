...
public abstract class ASN1External extends ASN1Primitive {
    ...
    public ASN1External(ASN1ObjectIdentifier aSN1ObjectIdentifier, ASN1Integer aSN1Integer, ASN1Primitive aSN1Primitive, int r42, ASN1Primitive aSN1Primitive2) {
        this.directReference = aSN1ObjectIdentifier;
        this.indirectReference = aSN1Integer;
        this.dataValueDescriptor = aSN1Primitive;
        this.encoding = checkEncoding(r42);
        this.externalContent = checkExternalContent(r42, aSN1Primitive2);
    }
    ...
    public ASN1External(ASN1Sequence aSN1Sequence) {
        ...
        if (objFromSequence instanceof ASN1Integer) {
            ...
            r02++;
            objFromSequence = getObjFromSequence(aSN1Sequence, r02);
        }
    ...
    private static int checkEncoding(int r22) {
        if (r22 < 0 || r22 > 2) {
            throw new IllegalArgumentException(a.d("invalid encoding value: ", r22));
        }
        return r22;
    }

    private static ASN1Primitive checkExternalContent(int r12, ASN1Primitive aSN1Primitive) {
    ...
    public static ASN1External getInstance(Object obj) {
        ...
        if (obj instanceof ASN1Encodable) {
            ...
            try {
                ...
                throw new IllegalArgumentException(a.c(e10, new StringBuilder("failed to construct external from byte[]: ")));
            }
        }
    ...
    private static ASN1Primitive getObjFromSequence(ASN1Sequence aSN1Sequence, int r22) {
        if (aSN1Sequence.size() > r22) {
            return aSN1Sequence.getObjectAt(r22).toASN1Primitive();
        }
