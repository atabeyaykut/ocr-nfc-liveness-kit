...
public class ESSCertIDv2 extends ASN1Object {
    ...
    private ESSCertIDv2(ASN1Sequence aSN1Sequence) {
        ...
        int r12 = r02 + 1;
        this.certHash = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(r02).toASN1Primitive()).getOctets();
        if (aSN1Sequence.size() > r12) {
            this.issuerSerial = IssuerSerial.getInstance(aSN1Sequence.getObjectAt(r12));
        }
    }
