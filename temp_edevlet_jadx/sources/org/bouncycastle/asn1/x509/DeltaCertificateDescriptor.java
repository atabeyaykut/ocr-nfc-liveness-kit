...
public class DeltaCertificateDescriptor extends ASN1Object {
    ...
    private DeltaCertificateDescriptor(ASN1Sequence aSN1Sequence) {
        ...
        while (objectAt instanceof ASN1TaggedObject) {
            ...
            int r22 = r32 + 1;
            ASN1Encodable objectAt2 = aSN1Sequence.getObjectAt(r32);
            r32 = r22;
            objectAt = objectAt2;
        }
        this.subjectPublicKeyInfo = SubjectPublicKeyInfo.getInstance(objectAt);
        ASN1Encodable objectAt3 = aSN1Sequence.getObjectAt(r32);
        while (objectAt3 instanceof ASN1TaggedObject) {
            ...
            ASN1Encodable objectAt4 = aSN1Sequence.getObjectAt(r32);
            r32++;
            objectAt3 = objectAt4;
        }
    ...
    private void addOptional(ASN1EncodableVector aSN1EncodableVector, int r32, boolean z10, ASN1Object aSN1Object) {
        if (aSN1Object != null) {
            aSN1EncodableVector.add(new DERTaggedObject(z10, r32, aSN1Object));
        }
    }
