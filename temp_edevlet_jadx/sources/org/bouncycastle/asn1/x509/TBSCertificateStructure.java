...
public class TBSCertificateStructure extends ASN1Object implements X509ObjectIdentifiers, PKCSObjectIdentifiers {
    ...
    public TBSCertificateStructure(ASN1Sequence aSN1Sequence) {
        ...
        this.serialNumber = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(r12 + 1));
        this.signature = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(r12 + 2));
        this.issuer = X500Name.getInstance(aSN1Sequence.getObjectAt(r12 + 3));
        ASN1Sequence aSN1Sequence2 = (ASN1Sequence) aSN1Sequence.getObjectAt(r12 + 4);
        this.startDate = Time.getInstance(aSN1Sequence2.getObjectAt(0));
        this.endDate = Time.getInstance(aSN1Sequence2.getObjectAt(1));
        this.subject = X500Name.getInstance(aSN1Sequence.getObjectAt(r12 + 5));
        int r13 = r12 + 6;
        this.subjectPublicKeyInfo = SubjectPublicKeyInfo.getInstance(aSN1Sequence.getObjectAt(r13));
        for (int size = (aSN1Sequence.size() - r13) - 1; size > 0; size--) {
            ASN1TaggedObject aSN1TaggedObject = ASN1TaggedObject.getInstance(aSN1Sequence.getObjectAt(r13 + size));
