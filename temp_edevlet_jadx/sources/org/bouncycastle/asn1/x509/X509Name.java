...
public class X509Name extends ASN1Object {
    ...
    public X509Name(Vector vector, Hashtable hashtable, X509NameEntryConverter x509NameEntryConverter) {
        ...
        if (vector != null) {
            for (int r02 = 0; r02 != vector.size(); r02++) {
                this.ordering.addElement(vector.elementAt(r02));
    ...
    public X509Name(Vector vector, Vector vector2, X509NameEntryConverter x509NameEntryConverter) {
        ...
        for (int r52 = 0; r52 < vector.size(); r52++) {
            this.ordering.addElement(vector.elementAt(r52));
            this.values.addElement(vector2.elementAt(r52));
            this.added.addElement(FALSE);
        }
    }
    ...
    public X509Name(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            ...
            int r22 = 0;
            while (r22 < aSN1Set.size()) {
                ASN1Sequence aSN1Sequence2 = ASN1Sequence.getInstance(aSN1Set.getObjectAt(r22).toASN1Primitive());
                ...
                this.added.addElement(r22 != 0 ? TRUE : FALSE);
                r22++;
            }
        }
    }
    ...
    public X509Name(boolean z10, Hashtable hashtable, String str, X509NameEntryConverter x509NameEntryConverter) throws NumberFormatException {
        this.converter = null;
        this.ordering = new Vector();
        this.values = new Vector();
        this.added = new Vector();
        ...
        if (z10) {
            ...
            int r22 = 1;
            for (int r12 = 0; r12 < this.ordering.size(); r12++) {
                if (((Boolean) this.added.elementAt(r12)).booleanValue()) {
                    vector.insertElementAt(this.ordering.elementAt(r12), r22);
                    vector2.insertElementAt(this.values.elementAt(r12), r22);
                    vector3.insertElementAt(this.added.elementAt(r12), r22);
                    r22++;
                } else {
                    vector.insertElementAt(this.ordering.elementAt(r12), 0);
                    vector2.insertElementAt(this.values.elementAt(r12), 0);
                    vector3.insertElementAt(this.added.elementAt(r12), 0);
                    r22 = 1;
                }
            }
    ...
    private void addEntry(Hashtable hashtable, String str, Boolean bool) throws NumberFormatException {
        X509NameTokenizer x509NameTokenizer = new X509NameTokenizer(str, '=');
        String strNextToken = x509NameTokenizer.nextToken();
    ...
    private ASN1ObjectIdentifier decodeOID(String str, Hashtable hashtable) throws NumberFormatException {
        ...
        throw new IllegalArgumentException(a.a("Unknown object id - ", strTrim, " - passed to distinguished name"));
    }
    ...
    private String unescape(String str) {
        ...
        boolean z11 = false;
        boolean z12 = false;
        while (r42 != charArray.length) {
            char c10 = charArray[r42];
            if (c10 != ' ') {
                z12 = true;
            }
            if (c10 == '\"') {
    ...
    public boolean equals(Object obj) {
        ...
        try {
            ...
            while (r42 != r52) {
                ASN1ObjectIdentifier aSN1ObjectIdentifier = (ASN1ObjectIdentifier) this.ordering.elementAt(r42);
                String str = (String) this.values.elementAt(r42);
                int r92 = 0;
                while (true) {
                    if (r92 >= size) {
                        z10 = false;
                    ...
                    if (!zArr[r92] && aSN1ObjectIdentifier.equals((ASN1Primitive) x509Name.ordering.elementAt(r92)) && equivalentStrings(str, (String) x509Name.values.elementAt(r92))) {
                        zArr[r92] = true;
                        z10 = true;
                        break;
                    }
    ...
    public boolean equals(Object obj, boolean z10) {
        ...
        try {
            ...
            for (int r22 = 0; r22 < size; r22++) {
                if (!((ASN1ObjectIdentifier) this.ordering.elementAt(r22)).equals((ASN1Primitive) x509Name.ordering.elementAt(r22)) || !equivalentStrings((String) this.values.elementAt(r22), (String) x509Name.values.elementAt(r22))) {
                    return false;
                }
            }
            return true;
    ...
    public Vector getOIDs() {
        Vector vector = new Vector();
        for (int r12 = 0; r12 != this.ordering.size(); r12++) {
            vector.addElement(this.ordering.elementAt(r12));
        }
        return vector;
    }
    ...
    public Vector getValues() {
        Vector vector = new Vector();
        for (int r12 = 0; r12 != this.values.size(); r12++) {
            vector.addElement(this.values.elementAt(r12));
        }
        return vector;
    }
    ...
    public Vector getValues(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Vector vector = new Vector();
        for (int r22 = 0; r22 != this.values.size(); r22++) {
            if (this.ordering.elementAt(r22).equals(aSN1ObjectIdentifier)) {
                String strSubstring = (String) this.values.elementAt(r22);
    ...
    public int hashCode() {
        ...
        for (int r02 = 0; r02 != this.ordering.size(); r02++) {
            String strStripInternalSpaces = stripInternalSpaces(canonicalize((String) this.values.elementAt(r02)));
            int r22 = this.hashCodeValue ^ this.ordering.elementAt(r02).hashCode();
            this.hashCodeValue = r22;
            this.hashCodeValue = strStripInternalSpaces.hashCode() ^ r22;
        }
        return this.hashCodeValue;
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (this.seq == null) {
            ...
            int r32 = 0;
            while (r32 != this.ordering.size()) {
                ASN1EncodableVector aSN1EncodableVector3 = new ASN1EncodableVector(2);
                ASN1ObjectIdentifier aSN1ObjectIdentifier2 = (ASN1ObjectIdentifier) this.ordering.elementAt(r32);
                aSN1EncodableVector3.add(aSN1ObjectIdentifier2);
                aSN1EncodableVector3.add(this.converter.getConvertedValue(aSN1ObjectIdentifier2, (String) this.values.elementAt(r32)));
                if (aSN1ObjectIdentifier == null || ((Boolean) this.added.elementAt(r32)).booleanValue()) {
    ...
    public String toString(boolean z10, Hashtable hashtable) {
        ...
        for (int r42 = 0; r42 < this.ordering.size(); r42++) {
            if (((Boolean) this.added.elementAt(r42)).booleanValue()) {
                stringBuffer2.append('+');
                appendValue(stringBuffer2, hashtable, (ASN1ObjectIdentifier) this.ordering.elementAt(r42), (String) this.values.elementAt(r42));
            } else {
        ...
        if (z10) {
            ...
            for (int r82 = 0; r82 < vector.size(); r82++) {
                if (z11) {
                    z11 = false;
                } else {
                    stringBuffer.append(',');
                }
                stringBuffer.append(vector.elementAt(r82).toString());
            }
        }
        return stringBuffer.toString();
    }
