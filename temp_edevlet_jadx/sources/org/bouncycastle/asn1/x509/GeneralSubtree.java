        ...
        if (size != 1) {
            if (size == 2) {
                ...
                if (aSN1TaggedObject2.getTagNo() != 0) {
                    throw new IllegalArgumentException(b.h(aSN1TaggedObject2, new StringBuilder("Bad tag number for 'minimum': ")));
                }
                ...
                if (aSN1TaggedObject.getTagNo() != 1) {
                    throw new IllegalArgumentException(b.h(aSN1TaggedObject, new StringBuilder("Bad tag number for 'maximum': ")));
                }
            }
