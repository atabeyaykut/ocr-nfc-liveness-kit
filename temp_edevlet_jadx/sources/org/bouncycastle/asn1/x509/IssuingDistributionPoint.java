...
public class IssuingDistributionPoint extends ASN1Object {
    ...
    private IssuingDistributionPoint(ASN1Sequence aSN1Sequence) {
        ...
        for (int r12 = 0; r12 != aSN1Sequence.size(); r12++) {
            ASN1TaggedObject aSN1TaggedObject = ASN1TaggedObject.getInstance(aSN1Sequence.getObjectAt(r12));
    ...
    public String toString() {
        ...
        if (z10) {
            appendObject(stringBuffer, strLineSeparator, "onlyContainsUserCerts", booleanToString(z10));
        }
        boolean z11 = this.onlyContainsCACerts;
        if (z11) {
            appendObject(stringBuffer, strLineSeparator, "onlyContainsCACerts", booleanToString(z11));
        }
        ...
        if (z12) {
            appendObject(stringBuffer, strLineSeparator, "onlyContainsAttributeCerts", booleanToString(z12));
        }
        boolean z13 = this.indirectCRL;
        if (z13) {
            appendObject(stringBuffer, strLineSeparator, "indirectCRL", booleanToString(z13));
        }
        stringBuffer.append("]");
        stringBuffer.append(strLineSeparator);
