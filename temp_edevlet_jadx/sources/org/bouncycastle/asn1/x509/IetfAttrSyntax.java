    ...
    */
    ...
    public Object[] getValues() {
        ...
        if (getValueType() == 1) {
            ...
            while (r22 != size) {
                aSN1OctetStringArr[r22] = (ASN1OctetString) this.values.elementAt(r22);
                r22++;
            }
        ...
        if (getValueType() == 2) {
            ...
            while (r22 != size2) {
                aSN1ObjectIdentifierArr[r22] = (ASN1ObjectIdentifier) this.values.elementAt(r22);
                r22++;
            }
        ...
        while (r22 != size3) {
            aSN1UTF8StringArr[r22] = (ASN1UTF8String) this.values.elementAt(r22);
            r22++;
        }
