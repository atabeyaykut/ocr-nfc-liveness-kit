...
public class X509Extensions extends ASN1Object {
    ...
    public X509Extensions(Vector vector, Vector vector2) {
        ...
        while (enumerationElements2.hasMoreElements()) {
            this.extensions.put((ASN1ObjectIdentifier) enumerationElements2.nextElement(), (X509Extension) vector2.elementAt(r02));
            r02++;
        }
    }
        ...
        while (objects.hasMoreElements()) {
            ...
            if (aSN1Sequence2.size() == 3) {
                ...
                if (aSN1Sequence2.size() != 2) {
                    throw new IllegalArgumentException(a.g(aSN1Sequence2, new StringBuilder("Bad sequence size: ")));
                }
    ...
    private ASN1ObjectIdentifier[] getExtensionOIDs(boolean z10) {
        ...
        for (int r12 = 0; r12 != this.ordering.size(); r12++) {
            Object objElementAt = this.ordering.elementAt(r12);
            if (((X509Extension) this.extensions.get(objElementAt)).isCritical() == z10) {
