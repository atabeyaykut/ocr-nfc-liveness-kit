...
public class ObjectDigestInfo extends ASN1Object {
    ...
    public ObjectDigestInfo(int r22, ASN1ObjectIdentifier aSN1ObjectIdentifier, AlgorithmIdentifier algorithmIdentifier, byte[] bArr) {
        this.digestedObjectType = new ASN1Enumerated(r22);
        if (r22 == 2) {
    ...
    private ObjectDigestInfo(ASN1Sequence aSN1Sequence) {
        ...
        this.digestAlgorithm = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(r02 + 1));
        this.objectDigest = ASN1BitString.getInstance(aSN1Sequence.getObjectAt(r02 + 2));
    }
