...
public abstract class X509NameEntryConverter {
    ...
    public ASN1Primitive convertHexEncoded(String str, int r32) throws IOException {
        return ASN1Primitive.fromByteArray(Hex.decodeStrict(str, r32, str.length() - r32));
    }
