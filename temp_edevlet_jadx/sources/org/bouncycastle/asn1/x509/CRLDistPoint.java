...
public class CRLDistPoint extends ASN1Object {
    ...
    public DistributionPoint[] getDistributionPoints() {
        ...
        for (int r12 = 0; r12 != this.seq.size(); r12++) {
            distributionPointArr[r12] = DistributionPoint.getInstance(this.seq.getObjectAt(r12));
        }
    ...
    public String toString() {
        ...
        for (int r32 = 0; r32 != distributionPoints.length; r32++) {
            stringBuffer.append("    ");
            stringBuffer.append(distributionPoints[r32]);
            stringBuffer.append(strLineSeparator);
        }
