...
public class TBSCertList extends ASN1Object {
    ...
    public TBSCertList(ASN1Sequence aSN1Sequence) {
        ...
        int r12 = r02 + 1;
        this.signature = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(r02));
        int r03 = r12 + 1;
        this.issuer = X500Name.getInstance(aSN1Sequence.getObjectAt(r12));
        int r13 = r03 + 1;
        this.thisUpdate = Time.getInstance(aSN1Sequence.getObjectAt(r03));
        if (r13 < aSN1Sequence.size() && ((aSN1Sequence.getObjectAt(r13) instanceof ASN1UTCTime) || (aSN1Sequence.getObjectAt(r13) instanceof ASN1GeneralizedTime) || (aSN1Sequence.getObjectAt(r13) instanceof Time))) {
            this.nextUpdate = Time.getInstance(aSN1Sequence.getObjectAt(r13));
            r13++;
        }
        if (r13 < aSN1Sequence.size() && !(aSN1Sequence.getObjectAt(r13) instanceof ASN1TaggedObject)) {
            this.revokedCertificates = ASN1Sequence.getInstance(aSN1Sequence.getObjectAt(r13));
            r13++;
        }
        if (r13 >= aSN1Sequence.size() || !(aSN1Sequence.getObjectAt(r13) instanceof ASN1TaggedObject)) {
            return;
        }
        this.crlExtensions = Extensions.getInstance(ASN1Sequence.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(r13), true));
    }
    ...
    public CRLEntry[] getRevokedCertificates() {
        ...
        for (int r12 = 0; r12 < size; r12++) {
            cRLEntryArr[r12] = CRLEntry.getInstance(this.revokedCertificates.getObjectAt(r12));
        }
        return cRLEntryArr;
    }
