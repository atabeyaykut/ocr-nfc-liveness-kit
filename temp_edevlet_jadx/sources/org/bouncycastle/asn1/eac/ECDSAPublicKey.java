...
public class ECDSAPublicKey extends PublicKeyDataObject {
    ...
    public ECDSAPublicKey(ASN1ObjectIdentifier aSN1ObjectIdentifier, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, byte[] bArr, BigInteger bigInteger4, byte[] bArr2, int r82) throws IllegalArgumentException {
        ...
        setCofactorF(BigInteger.valueOf(r82));
    }
