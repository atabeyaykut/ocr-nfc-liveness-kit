...
public class CertEtcToken extends ASN1Object implements ASN1Choice {
    ...
    public CertEtcToken(int r12, ASN1Encodable aSN1Encodable) {
        this.tagNo = r12;
    ...
    public static CertEtcToken[] arrayFromSequence(ASN1Sequence aSN1Sequence) {
        ...
        for (int r22 = 0; r22 != size; r22++) {
            certEtcTokenArr[r22] = getInstance(aSN1Sequence.getObjectAt(r22));
        }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        int r22 = this.tagNo;
        return new DERTaggedObject(zArr[r22], r22, this.value);
    }
