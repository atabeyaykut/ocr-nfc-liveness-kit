...
public class Data extends ASN1Object implements ASN1Choice {
    ...
    public static Data getInstance(Object obj) {
        ...
        throw new IllegalArgumentException(b.f(obj, "Unknown object submitted to getInstance: "));
    }
    ...
    public TargetEtcChain[] getCerts() {
        ...
        for (int r22 = 0; r22 != size; r22++) {
            targetEtcChainArr[r22] = TargetEtcChain.getInstance(this.certs.getObjectAt(r22));
        }
