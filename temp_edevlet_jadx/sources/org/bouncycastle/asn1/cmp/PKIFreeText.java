...
public class PKIFreeText extends ASN1Object {
    ...
    public DERUTF8String getStringAt(int r22) {
        ASN1UTF8String stringAtUTF8 = getStringAtUTF8(r22);
    ...
    public ASN1UTF8String getStringAtUTF8(int r22) {
        return (ASN1UTF8String) this.strings.getObjectAt(r22);
    }
