    ...
    private CertifiedKeyPair(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() >= 2) {
            if (aSN1Sequence.size() == 2) {
                ...
                explicitBaseObject = aSN1TaggedObject.getExplicitBaseObject();
                if (tagNo == 0) {
                ...
                explicitBaseObject = ASN1TaggedObject.getInstance(aSN1Sequence.getObjectAt(2), 128).getExplicitBaseObject();
            }
