...
public class GetCRL extends ASN1Object {
    ...
    private GetCRL(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() > r12 && (aSN1Sequence.getObjectAt(r12).toASN1Primitive() instanceof ASN1GeneralizedTime)) {
            this.time = ASN1GeneralizedTime.getInstance(aSN1Sequence.getObjectAt(r12));
            r12++;
        }
        if (aSN1Sequence.size() <= r12 || !(aSN1Sequence.getObjectAt(r12).toASN1Primitive() instanceof ASN1BitString)) {
            return;
        }
        this.reasons = new ReasonFlags(ASN1BitString.getInstance(aSN1Sequence.getObjectAt(r12)));
    }
