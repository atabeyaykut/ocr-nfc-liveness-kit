...
public abstract class ASN1Sequence extends ASN1Primitive implements Iterable<ASN1Encodable> {
    ...
    public boolean asn1Equals(ASN1Primitive aSN1Primitive) {
        ...
        for (int r22 = 0; r22 < size; r22++) {
            ASN1Primitive aSN1Primitive2 = this.elements[r22].toASN1Primitive();
            ASN1Primitive aSN1Primitive3 = aSN1Sequence.elements[r22].toASN1Primitive();
    ...
    public ASN1BitString[] getConstructedBitStrings() {
        ...
        for (int r22 = 0; r22 < size; r22++) {
            aSN1BitStringArr[r22] = ASN1BitString.getInstance(this.elements[r22]);
        }
    ...
    public ASN1OctetString[] getConstructedOctetStrings() {
        ...
        for (int r22 = 0; r22 < size; r22++) {
            aSN1OctetStringArr[r22] = ASN1OctetString.getInstance(this.elements[r22]);
        }
    ...
    public int hashCode() {
        ...
        while (true) {
            ...
            r12 = (r12 * 257) ^ this.elements[length].toASN1Primitive().hashCode();
        }
    }
