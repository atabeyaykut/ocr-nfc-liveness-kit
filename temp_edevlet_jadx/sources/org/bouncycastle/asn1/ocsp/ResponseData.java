...
public class ResponseData extends ASN1Object {
    ...
    private ResponseData(ASN1Sequence aSN1Sequence) {
        ...
        int r12 = r02 + 1;
        this.responderID = ResponderID.getInstance(aSN1Sequence.getObjectAt(r02));
        int r03 = r12 + 1;
        this.producedAt = ASN1GeneralizedTime.getInstance(aSN1Sequence.getObjectAt(r12));
        int r13 = r03 + 1;
        this.responses = (ASN1Sequence) aSN1Sequence.getObjectAt(r03);
        if (aSN1Sequence.size() > r13) {
            this.responseExtensions = Extensions.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(r13), true);
        }
    }
