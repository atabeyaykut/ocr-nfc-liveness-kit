...
public class DLExternal extends ASN1External {
    ...
    public DLExternal(ASN1ObjectIdentifier aSN1ObjectIdentifier, ASN1Integer aSN1Integer, ASN1Primitive aSN1Primitive, int r42, ASN1Primitive aSN1Primitive2) {
    ...
    public ASN1Sequence buildSequence() {
        ...
        aSN1EncodableVector.add(new DLTaggedObject(r22 == 0, r22, this.externalContent));
