        ...
        while (objects.hasMoreElements()) {
            ...
            if (aSN1TaggedObject.getTagNo() == 0) {
                ...
                for (int r42 = 0; r42 != size; r42++) {
                    attributeArr[r42] = Attribute.getInstance(aSN1Sequence2.getObjectAt(r42));
                }
                this.values[r02] = attributeArr;
            } else {
                if (aSN1TaggedObject.getTagNo() != 1) {
                    throw new IllegalArgumentException(b.h(aSN1TaggedObject, new StringBuilder("illegal tag: ")));
                }
                this.values[r02] = AttributeCertificate.getInstance(ASN1Sequence.getInstance(aSN1TaggedObject, true));
            }
            r02++;
        }
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        while (true) {
            ...
            if (obj instanceof Attribute[]) {
                aSN1EncodableVector.add(new DERTaggedObject(0, new DERSequence((Attribute[]) this.values[r22])));
            } else {
