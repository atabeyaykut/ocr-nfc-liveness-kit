...
public class RevocationValues extends ASN1Object {
    ...
    private RevocationValues(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (tagNo == 0) {
                ...
                if (tagNo != 2) {
                    throw new IllegalArgumentException(b.h(aSN1TaggedObject, new StringBuilder("invalid tag: ")));
                }
    ...
    public CertificateList[] getCrlVals() {
        ...
        for (int r12 = 0; r12 < size; r12++) {
            certificateListArr[r12] = CertificateList.getInstance(this.crlVals.getObjectAt(r12));
        }
    ...
    public BasicOCSPResponse[] getOcspVals() {
        ...
        for (int r12 = 0; r12 < size; r12++) {
            basicOCSPResponseArr[r12] = BasicOCSPResponse.getInstance(this.ocspVals.getObjectAt(r12));
        }
