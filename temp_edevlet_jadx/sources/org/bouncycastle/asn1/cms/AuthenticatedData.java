...
public class AuthenticatedData extends ASN1Object {
    ...
    private AuthenticatedData(ASN1Sequence aSN1Sequence) {
        ...
        int r12 = r32 + 1;
        this.macAlgorithm = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(r32));
        int r22 = r12 + 1;
        ASN1Encodable objectAt2 = aSN1Sequence.getObjectAt(r12);
        if (objectAt2 instanceof ASN1TaggedObject) {
            ...
            int r13 = r22 + 1;
            ASN1Encodable objectAt3 = aSN1Sequence.getObjectAt(r22);
            r22 = r13;
            objectAt2 = objectAt3;
        }
        this.encapsulatedContentInfo = ContentInfo.getInstance(objectAt2);
        int r14 = r22 + 1;
        ASN1Encodable objectAt4 = aSN1Sequence.getObjectAt(r22);
        if (objectAt4 instanceof ASN1TaggedObject) {
            this.authAttrs = ASN1Set.getInstance((ASN1TaggedObject) objectAt4, false);
            objectAt4 = aSN1Sequence.getObjectAt(r14);
            r14++;
        }
        this.mac = ASN1OctetString.getInstance(objectAt4);
        if (aSN1Sequence.size() > r14) {
            this.unauthAttrs = ASN1Set.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(r14), false);
        }
    }
