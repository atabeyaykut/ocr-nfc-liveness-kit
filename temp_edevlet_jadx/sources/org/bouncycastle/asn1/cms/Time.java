...
public class Time extends ASN1Object implements ASN1Choice {
    ...
    public Time(Date date) throws NumberFormatException {
        ...
        int r02 = Integer.parseInt(str.substring(0, 4));
        this.time = (r02 < 1950 || r02 > 2049) ? new DERGeneralizedTime(str) : new DERUTCTime(str.substring(2));
    }
    ...
    public Time(Date date, Locale locale) throws NumberFormatException {
        ...
        simpleDateFormat.setTimeZone(simpleTimeZone);
        String str = simpleDateFormat.format(date) + "Z";
        int r72 = Integer.parseInt(str.substring(0, 4));
        this.time = (r72 < 1950 || r72 > 2049) ? new DERGeneralizedTime(str) : new DERUTCTime(str.substring(2));
    }
    ...
    public static Time getInstance(Object obj) {
        ...
        throw new IllegalArgumentException(b.f(obj, "unknown object in factory: "));
    }
