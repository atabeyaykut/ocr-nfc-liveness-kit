...
public class KeyAgreeRecipientInfo extends ASN1Object {
    ...
    private KeyAgreeRecipientInfo(ASN1Sequence aSN1Sequence) {
        ...
        this.keyEncryptionAlgorithm = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(r12));
        this.recipientEncryptedKeys = (ASN1Sequence) aSN1Sequence.getObjectAt(r12 + 1);
    }
    ...
    public static KeyAgreeRecipientInfo getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z10) {
