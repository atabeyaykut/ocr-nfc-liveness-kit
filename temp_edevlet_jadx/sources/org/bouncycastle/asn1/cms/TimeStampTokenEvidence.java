...
public class TimeStampTokenEvidence extends ASN1Object {
    ...
    private TimeStampTokenEvidence(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            this.timeStampAndCRLs[r02] = TimeStampAndCRL.getInstance(objects.nextElement());
            r02++;
        }
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        while (true) {
            ...
            if (r12 == timeStampAndCRLArr.length) {
                return new DERSequence(aSN1EncodableVector);
            }
            aSN1EncodableVector.add(timeStampAndCRLArr[r12]);
            r12++;
        }
    }
