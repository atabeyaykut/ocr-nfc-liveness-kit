...
public class MetaData extends ASN1Object {
    ...
    private MetaData(ASN1Sequence aSN1Sequence) {
        ...
        if (r12 < aSN1Sequence.size() && (aSN1Sequence.getObjectAt(r12) instanceof ASN1IA5String)) {
            this.mediaType = ASN1IA5String.getInstance(aSN1Sequence.getObjectAt(r12));
            r12++;
        }
        if (r12 < aSN1Sequence.size()) {
            this.otherMetaData = Attributes.getInstance(aSN1Sequence.getObjectAt(r12));
        }
    }
