...
public class TimeStampedData extends ASN1Object {
    ...
    private TimeStampedData(ASN1Sequence aSN1Sequence) {
        ...
        if ((aSN1Sequence.getObjectAt(r02) instanceof MetaData) || (aSN1Sequence.getObjectAt(r02) instanceof ASN1Sequence)) {
            this.metaData = MetaData.getInstance(aSN1Sequence.getObjectAt(r02));
            r02++;
        }
        if (aSN1Sequence.getObjectAt(r02) instanceof ASN1OctetString) {
            this.content = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(r02));
            r02++;
        }
        this.temporalEvidence = Evidence.getInstance(aSN1Sequence.getObjectAt(r02));
    }
