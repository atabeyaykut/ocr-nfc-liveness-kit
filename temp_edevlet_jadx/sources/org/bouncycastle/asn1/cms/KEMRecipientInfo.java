...
public class KEMRecipientInfo extends ASN1Object {
    ...
    private KEMRecipientInfo(ASN1Sequence aSN1Sequence) {
        ...
        this.wrap = AlgorithmIdentifier.getInstance(aSN1Sequence.getObjectAt(r12));
        this.encryptedKey = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(r12 + 1));
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        return b.l(aSN1EncodableVector, this.encryptedKey, aSN1EncodableVector);
    }
}
