...
public class Gost2814789EncryptedKey extends ASN1Object {
    ...
    private Gost2814789EncryptedKey(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 2) {
            this.encryptedKey = a.i(aSN1Sequence, 0);
            this.macKey = a.i(aSN1Sequence, 1);
            this.maskKey = null;
        } else {
            if (aSN1Sequence.size() != 3) {
                throw new IllegalArgumentException(androidx.camera.core.impl.a.g(aSN1Sequence, new StringBuilder("unknown sequence length: ")));
            }
            this.encryptedKey = a.i(aSN1Sequence, 0);
            ...
            this.macKey = a.i(aSN1Sequence, 2);
        }
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        return androidx.camera.core.impl.a.j(aSN1EncodableVector, new DEROctetString(this.macKey), aSN1EncodableVector);
    }
}
