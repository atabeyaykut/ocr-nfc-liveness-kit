...
public class LDSSecurityObject extends ASN1Object implements ICAOObjectIdentifiers {
    ...
    private LDSSecurityObject(ASN1Sequence aSN1Sequence) {
        ...
        for (int r42 = 0; r42 < aSN1Sequence2.size(); r42++) {
            this.datagroupHash[r42] = DataGroupHash.getInstance(aSN1Sequence2.getObjectAt(r42));
        }
    }
    ...
    private void checkDatagroupHashSeqSize(int r22) {
        if (r22 < 2 || r22 > 16) {
