...
public class ECPrivateKey extends ASN1Object {
    ...
    public ECPrivateKey(int r42, BigInteger bigInteger) {
        byte[] bArrAsUnsignedByteArray = BigIntegers.asUnsignedByteArray((r42 + 7) / 8, bigInteger);
    ...
    public ECPrivateKey(int r42, BigInteger bigInteger, ASN1BitString aSN1BitString, ASN1Encodable aSN1Encodable) {
        byte[] bArrAsUnsignedByteArray = BigIntegers.asUnsignedByteArray((r42 + 7) / 8, bigInteger);
    ...
    public ECPrivateKey(int r22, BigInteger bigInteger, ASN1Encodable aSN1Encodable) {
        this(r22, bigInteger, null, aSN1Encodable);
    }
    ...
    private ASN1Object getObjectInTag(int r42, int r52) {
        Enumeration objects = this.seq.getObjects();
        while (objects.hasMoreElements()) {
            ASN1Encodable aSN1Encodable = (ASN1Encodable) objects.nextElement();
            if (aSN1Encodable instanceof ASN1TaggedObject) {
                ASN1TaggedObject aSN1TaggedObject = (ASN1TaggedObject) aSN1Encodable;
                if (aSN1TaggedObject.hasContextTag(r42)) {
                    return r52 < 0 ? aSN1TaggedObject.getExplicitBaseObject().toASN1Primitive() : aSN1TaggedObject.getBaseUniversal(true, r52);
                }
            }
        }
        return null;
