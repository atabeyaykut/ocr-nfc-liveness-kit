...
public class EmojiCompat {
    ...
    public static class CompatInternal {
        ...
        public int getEmojiMatch(CharSequence charSequence, int r22) {
            return 0;
        }
        ...
        public boolean hasEmojiGlyph(@NonNull CharSequence charSequence, int r22) {
            return false;
        }
        ...
        public CharSequence process(@NonNull CharSequence charSequence, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r22, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r32, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r42, boolean z10) {
            return charSequence;
        }
    ...
    public static final class CompatInternal19 extends CompatInternal {
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public int getEmojiMatch(CharSequence charSequence, int r32) {
            return this.mProcessor.getEmojiMatch(charSequence, r32);
        }
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public boolean hasEmojiGlyph(@NonNull CharSequence charSequence, int r32) {
            return this.mProcessor.getEmojiMatch(charSequence, r32) == 1;
        }
        ...
        @Override // androidx.emoji2.text.EmojiCompat.CompatInternal
        public CharSequence process(@NonNull CharSequence charSequence, int r82, int r92, int r10, boolean z10) {
            return this.mProcessor.process(charSequence, r82, r92, r10, z10);
        }
    ...
    public static abstract class Config {
        ...
        @NonNull
        public Config setEmojiSpanIndicatorColor(@ColorInt int r12) {
            this.mEmojiSpanIndicatorColor = r12;
            return this;
        }
        ...
        @NonNull
        public Config setMetadataLoadStrategy(int r12) {
            this.mMetadataLoadStrategy = r12;
            return this;
        }
        ...
        public Config setUseEmojiAsDefaultStyle(boolean z10, @Nullable List<Integer> list) {
            ...
            if (!z10 || list == null) {
                ...
                int r52 = 0;
                while (it.hasNext()) {
                    this.mEmojiAsDefaultStyleExceptions[r52] = it.next().intValue();
                    r52++;
                }
    ...
    public interface GlyphChecker {
        boolean hasGlyph(@NonNull CharSequence charSequence, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r22, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r32, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r42);
    }
    ...
    public static class ListenerDispatcher implements Runnable {
        ...
        public ListenerDispatcher(@NonNull InitCallback initCallback, int r42) {
            this(Arrays.asList((InitCallback) Preconditions.checkNotNull(initCallback, "initCallback cannot be null")), r42, null);
        }

        public ListenerDispatcher(@NonNull Collection<InitCallback> collection, int r32) {
            this(collection, r32, null);
        }

        public ListenerDispatcher(@NonNull Collection<InitCallback> collection, int r32, @Nullable Throwable th2) {
        ...
        public void run() {
            ...
            if (this.mLoadState != 1) {
                while (r32 < size) {
                    this.mInitCallbacks.get(r32).onFailed(this.mThrowable);
                    r32++;
                }
            } else {
                while (r32 < size) {
                    this.mInitCallbacks.get(r32).onInitialized();
                    r32++;
                }
            }
        }
    ...
    public static boolean handleDeleteSurroundingText(@NonNull InputConnection inputConnection, @NonNull Editable editable, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r22, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r32, boolean z10) {
        return EmojiProcessor.handleDeleteSurroundingText(inputConnection, editable, r22, r32, z10);
    }

    public static boolean handleOnKeyDown(@NonNull Editable editable, int r12, @NonNull KeyEvent keyEvent) {
        return EmojiProcessor.handleOnKeyDown(editable, r12, keyEvent);
    }
    ...
    public int getEmojiMatch(@NonNull CharSequence charSequence, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r42) {
        Preconditions.checkState(isInitialized(), "Not initialized yet");
        Preconditions.checkNotNull(charSequence, "sequence cannot be null");
        return this.mHelper.getEmojiMatch(charSequence, r42);
    }
    ...
    @Deprecated
    public boolean hasEmojiGlyph(@NonNull CharSequence charSequence, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r42) {
        Preconditions.checkState(isInitialized(), "Not initialized yet");
        Preconditions.checkNotNull(charSequence, "sequence cannot be null");
        return this.mHelper.hasEmojiGlyph(charSequence, r42);
    }
    ...
    @Nullable
    @CheckResult
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r32, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r42) {
        return process(charSequence, r32, r42, Integer.MAX_VALUE);
    }

    @Nullable
    @CheckResult
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r82, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r92, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r10) {
        return process(charSequence, r82, r92, r10, 0);
    }

    @Nullable
    @CheckResult
    public CharSequence process(@Nullable CharSequence charSequence, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r92, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r10, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r11, int r12) {
        Preconditions.checkState(isInitialized(), "Not initialized yet");
        Preconditions.checkArgumentNonnegative(r92, "start cannot be negative");
        Preconditions.checkArgumentNonnegative(r10, "end cannot be negative");
        Preconditions.checkArgumentNonnegative(r11, "maxEmojiCount cannot be negative");
        Preconditions.checkArgument(r92 <= r10, "start should be <= than end");
        if (charSequence == null) {
            return null;
        }
        Preconditions.checkArgument(r92 <= charSequence.length(), "start should be < than charSequence length");
        Preconditions.checkArgument(r10 <= charSequence.length(), "end should be < than charSequence length");
        if (charSequence.length() == 0 || r92 == r10) {
            return charSequence;
        }
        return this.mHelper.process(charSequence, r92, r10, r11, r12 != 1 ? r12 != 2 ? this.mReplaceAll : false : true);
    }
