...
public class EmojiMetadata {
    ...
    public EmojiMetadata(@NonNull MetadataRepo metadataRepo, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r32) {
    ...
    public int getCodepointAt(int r22) {
        return getMetadataItem().codepoints(r22);
    }
    ...
    public String toString() {
        ...
        for (int r22 = 0; r22 < codepointsLength; r22++) {
            sb2.append(Integer.toHexString(getCodepointAt(r22)));
            sb2.append(" ");
        }
        return sb2.toString();
    }
