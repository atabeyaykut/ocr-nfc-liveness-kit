...
public final class DefaultEmojiCompatConfig {
    ...
    public static class DefaultEmojiCompatConfigHelper {
        ...
        @NonNull
        public List<ResolveInfo> queryIntentContentProviders(@NonNull PackageManager packageManager, @NonNull Intent intent, int r32) {
    ...
    public static class DefaultEmojiCompatConfigHelper_API19 extends DefaultEmojiCompatConfigHelper {
        ...
        @NonNull
        public List<ResolveInfo> queryIntentContentProviders(@NonNull PackageManager packageManager, @NonNull Intent intent, int r32) {
            return packageManager.queryIntentContentProviders(intent, r32);
        }
    }
