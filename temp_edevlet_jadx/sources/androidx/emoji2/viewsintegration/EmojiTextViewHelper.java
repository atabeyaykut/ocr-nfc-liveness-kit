...
public final class EmojiTextViewHelper {
    ...
    public static class HelperInternal19 extends HelperInternal {
        ...
        private SparseArray<InputFilter> getEmojiInputFilterPositionArray(@NonNull InputFilter[] inputFilterArr) {
            ...
            for (int r12 = 0; r12 < inputFilterArr.length; r12++) {
                InputFilter inputFilter = inputFilterArr[r12];
                if (inputFilter instanceof EmojiInputFilter) {
                    sparseArray.put(r12, inputFilter);
                }
            }
            return sparseArray;
        }
        ...
        private InputFilter[] removeEmojiInputFilterIfPresent(@NonNull InputFilter[] inputFilterArr) {
            ...
            for (int r32 = 0; r32 < length; r32++) {
                if (emojiInputFilterPositionArray.indexOfKey(r32) < 0) {
                    inputFilterArr2[r42] = inputFilterArr[r32];
                    r42++;
                }
            }
            return inputFilterArr2;
    ...
    public EmojiTextViewHelper(@NonNull TextView textView, boolean z10) {
        ...
        this.mHelper = !z10 ? new SkippingHelper19(textView) : new HelperInternal19(textView);
    }
