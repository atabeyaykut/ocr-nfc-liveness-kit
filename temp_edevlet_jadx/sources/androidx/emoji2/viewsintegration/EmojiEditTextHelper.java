...
public final class EmojiEditTextHelper {
    ...
    public static class HelperInternal19 extends HelperInternal {
        ...
        @Override // androidx.emoji2.viewsintegration.EmojiEditTextHelper.HelperInternal
        public void setEmojiReplaceStrategy(int r22) {
            this.mTextWatcher.setEmojiReplaceStrategy(r22);
        }
        ...
        @Override // androidx.emoji2.viewsintegration.EmojiEditTextHelper.HelperInternal
        public void setMaxEmojiCount(int r22) {
            this.mTextWatcher.setMaxEmojiCount(r22);
        }
    }
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public void setEmojiReplaceStrategy(int r22) {
        this.mEmojiReplaceStrategy = r22;
        this.mHelper.setEmojiReplaceStrategy(r22);
    }
    ...
    public void setMaxEmojiCount(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int r22) {
        Preconditions.checkArgumentNonnegative(r22, "maxEmojiCount should be greater than 0");
        this.mMaxEmojiCount = r22;
        this.mHelper.setMaxEmojiCount(r22);
    }
}
