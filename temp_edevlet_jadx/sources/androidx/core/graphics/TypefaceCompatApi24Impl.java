...
class TypefaceCompatApi24Impl extends TypefaceCompatBaseImpl {
    ...
    private static boolean addFontWeightStyle(Object obj, ByteBuffer byteBuffer, int r52, int r6, boolean z10) {
        try {
            return ((Boolean) sAddFontWeightStyle.invoke(obj, byteBuffer, Integer.valueOf(r52), null, Integer.valueOf(r6), Boolean.valueOf(z10))).booleanValue();
    ...
    @Nullable
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int r11) {
    ...
    @Override // androidx.core.graphics.TypefaceCompatBaseImpl
    @Nullable
    public Typeface createFromFontInfo(Context context, @Nullable CancellationSignal cancellationSignal, @NonNull FontsContractCompat.FontInfo[] fontInfoArr, int r13) throws IOException, ArrayIndexOutOfBoundsException, IllegalArgumentException, NegativeArraySizeException {
        Object objNewFamily = newFamily();
        if (objNewFamily == null) {
            return null;
        }
        ...
        return Typeface.create(typefaceCreateFromFamiliesWithDefault, r13);
    }
