...
public final class MatrixKt {
    ...
    public static /* synthetic */ Matrix rotationMatrix$default(float f, float f10, float f11, int r42, Object obj) {
        if ((r42 & 2) != 0) {
            f10 = 0.0f;
        }
        if ((r42 & 4) != 0) {
    ...
    public static /* synthetic */ Matrix scaleMatrix$default(float f, float f10, int r32, Object obj) {
        if ((r32 & 1) != 0) {
            f = 1.0f;
        }
        if ((r32 & 2) != 0) {
    ...
    public static /* synthetic */ Matrix translationMatrix$default(float f, float f10, int r32, Object obj) {
        if ((r32 & 1) != 0) {
            f = 0.0f;
        }
        if ((r32 & 2) != 0) {
