...
public class FingerprintManagerCompat {
    ...
    public static class Api23Impl {
        ...
        @DoNotInline
        public static void authenticate(Object obj, Object obj2, CancellationSignal cancellationSignal, int r92, Object obj3, Handler handler) {
            ((FingerprintManager) obj).authenticate((FingerprintManager.CryptoObject) obj2, cancellationSignal, r92, (FingerprintManager.AuthenticationCallback) obj3, handler);
        }
        ...
        public static FingerprintManager getFingerprintManagerOrNull(Context context) {
            ...
            if (r02 == 23) {
                ...
                if (r02 <= 23 || !context.getPackageManager().hasSystemFeature("android.hardware.fingerprint")) {
                    return null;
                }
                systemService = context.getSystemService((Class<Object>) FingerprintManager.class);
            }
    ...
    public static abstract class AuthenticationCallback {
        public void onAuthenticationError(int r12, CharSequence charSequence) {
        }

        public void onAuthenticationFailed() {
        }

        public void onAuthenticationHelp(int r12, CharSequence charSequence) {
        }
    ...
    private static FingerprintManager.AuthenticationCallback wrapCallback(final AuthenticationCallback authenticationCallback) {
        return new FingerprintManager.AuthenticationCallback() { // from class: androidx.core.hardware.fingerprint.FingerprintManagerCompat.1
            ...
            public void onAuthenticationError(int r22, CharSequence charSequence) {
                authenticationCallback.onAuthenticationError(r22, charSequence);
            }
            ...
            @Override // android.hardware.fingerprint.FingerprintManager.AuthenticationCallback
            public void onAuthenticationHelp(int r22, CharSequence charSequence) {
                authenticationCallback.onAuthenticationHelp(r22, charSequence);
            }
    ...
    @RequiresPermission("android.permission.USE_FINGERPRINT")
    public void authenticate(@Nullable CryptoObject cryptoObject, int r92, @Nullable androidx.core.os.CancellationSignal cancellationSignal, @NonNull AuthenticationCallback authenticationCallback, @Nullable Handler handler) {
        FingerprintManager fingerprintManagerOrNull;
        if (Build.VERSION.SDK_INT < 23 || (fingerprintManagerOrNull = getFingerprintManagerOrNull(this.mContext)) == null) {
            return;
        }
        Api23Impl.authenticate(fingerprintManagerOrNull, wrapCryptoObject(cryptoObject), cancellationSignal != null ? (CancellationSignal) cancellationSignal.getCancellationSignalObject() : null, r92, wrapCallback(authenticationCallback), handler);
    }
