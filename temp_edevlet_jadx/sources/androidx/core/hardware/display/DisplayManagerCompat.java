...
public final class DisplayManagerCompat {
    ...
    public static class Api17Impl {
        ...
        @DoNotInline
        public static Display getDisplay(DisplayManager displayManager, int r12) {
            return displayManager.getDisplay(r12);
        }
    ...
    @Nullable
    public Display getDisplay(int r32) {
        return Api17Impl.getDisplay((DisplayManager) this.mContext.getSystemService("display"), r32);
    }
