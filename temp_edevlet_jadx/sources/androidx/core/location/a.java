...
public final /* synthetic */ class a {
    public static void a(LocationListenerCompat locationListenerCompat, int r12) {
    }

    public static void b(LocationListenerCompat locationListenerCompat, @NonNull List list) {
        int size = list.size();
        for (int r12 = 0; r12 < size; r12++) {
            locationListenerCompat.onLocationChanged((Location) list.get(r12));
        }
    }
    ...
    public static void e(LocationListenerCompat locationListenerCompat, @NonNull String str, int r22, @Nullable Bundle bundle) {
    }
}
