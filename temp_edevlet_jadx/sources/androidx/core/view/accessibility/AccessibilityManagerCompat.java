...
public final class AccessibilityManagerCompat {
    ...
    @Deprecated
    public static List<AccessibilityServiceInfo> getEnabledAccessibilityServiceList(AccessibilityManager accessibilityManager, int r12) {
        return accessibilityManager.getEnabledAccessibilityServiceList(r12);
    }
