...
public final class AccessibilityClickableSpanCompat extends ClickableSpan {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public AccessibilityClickableSpanCompat(int r12, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat, int r32) {
        this.mOriginalClickableSpanId = r12;
        this.mNodeInfoCompat = accessibilityNodeInfoCompat;
        this.mClickableSpanActionId = r32;
    }
