...
public final class WindowCompat {
    ...
    public static class Api28Impl {
        ...
        @DoNotInline
        public static <T> T requireViewById(Window window, int r12) {
            return (T) window.requireViewById(r12);
        }
    }
    ...
    @NonNull
    public static <T extends View> T requireViewById(@NonNull Window window, @IdRes int r32) {
        if (Build.VERSION.SDK_INT >= 28) {
            return (T) Api28Impl.requireViewById(window, r32);
        }
        T t10 = (T) window.findViewById(r32);
        if (t10 != null) {
            return t10;
        }
