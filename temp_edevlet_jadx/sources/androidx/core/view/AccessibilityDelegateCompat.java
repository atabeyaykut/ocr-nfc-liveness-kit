...
public class AccessibilityDelegateCompat {
    ...
    public static final class AccessibilityDelegateAdapter extends View.AccessibilityDelegate {
        ...
        public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
            ...
            for (int r42 = 0; r42 < actionList.size(); r42++) {
                accessibilityNodeInfoCompatWrap.addAction(actionList.get(r42));
            }
        }
        ...
        public boolean performAccessibilityAction(View view, int r32, Bundle bundle) {
            return this.mCompat.performAccessibilityAction(view, r32, bundle);
        }

        @Override // android.view.View.AccessibilityDelegate
        public void sendAccessibilityEvent(View view, int r32) {
            this.mCompat.sendAccessibilityEvent(view, r32);
        }
    ...
    public static class Api16Impl {
        ...
        @DoNotInline
        public static boolean performAccessibilityAction(View.AccessibilityDelegate accessibilityDelegate, View view, int r22, Bundle bundle) {
            return accessibilityDelegate.performAccessibilityAction(view, r22, bundle);
        }
    }
    ...
    private boolean isSpanStillValid(ClickableSpan clickableSpan, View view) {
        if (clickableSpan != null) {
            ...
            for (int r12 = 0; clickableSpans != null && r12 < clickableSpans.length; r12++) {
                if (clickableSpan.equals(clickableSpans[r12])) {
                    return true;
                }
            }
        }
    ...
    private boolean performClickableSpanAction(int r22, View view) {
        WeakReference weakReference;
        SparseArray sparseArray = (SparseArray) view.getTag(R.id.tag_accessibility_clickable_spans);
        if (sparseArray == null || (weakReference = (WeakReference) sparseArray.get(r22)) == null) {
            return false;
        }
    ...
    public boolean performAccessibilityAction(@NonNull View view, int r72, @Nullable Bundle bundle) {
        List<AccessibilityNodeInfoCompat.AccessibilityActionCompat> actionList = getActionList(view);
        boolean zPerformAccessibilityAction = false;
        int r22 = 0;
        while (true) {
            if (r22 >= actionList.size()) {
                break;
            }
            AccessibilityNodeInfoCompat.AccessibilityActionCompat accessibilityActionCompat = actionList.get(r22);
            if (accessibilityActionCompat.getId() == r72) {
        ...
        if (!zPerformAccessibilityAction) {
            zPerformAccessibilityAction = Api16Impl.performAccessibilityAction(this.mOriginalDelegate, view, r72, bundle);
        }
        return (zPerformAccessibilityAction || r72 != R.id.accessibility_action_clickable_span || bundle == null) ? zPerformAccessibilityAction : performClickableSpanAction(bundle.getInt(AccessibilityClickableSpanCompat.SPAN_ID, -1), view);
    }

    public void sendAccessibilityEvent(@NonNull View view, int r32) {
        this.mOriginalDelegate.sendAccessibilityEvent(view, r32);
    }
