...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl {
        ...
        public Impl(int r12, @Nullable Interpolator interpolator, long j10) {
            this.mTypeMask = r12;
    ...
    public static class Impl21 extends Impl {
            ...
            public WindowInsets onApplyWindowInsets(final View view, WindowInsets windowInsets) {
                ...
                if (view.isLaidOut()) {
                    ...
                    if (this.mLastInsets != null) {
                        ...
                        if ((callback == null || !Objects.equals(callback.mDispachedInsets, windowInsets)) && (r52 = Impl21.buildAnimationMask(windowInsetsCompat, this.mLastInsets)) != 0) {
                            final WindowInsetsCompat windowInsetsCompat2 = this.mLastInsets;
                            final WindowInsetsAnimationCompat windowInsetsAnimationCompat = new WindowInsetsAnimationCompat(r52, new DecelerateInterpolator(), 160L);
                            ...
                            final BoundsCompat boundsCompatComputeAnimationBounds = Impl21.computeAnimationBounds(windowInsetsCompat, windowInsetsCompat2, r52);
                            ...
                            duration.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: androidx.core.view.WindowInsetsAnimationCompat.Impl21.Impl21OnApplyWindowInsetsListener.1
                                ...
                                public void onAnimationUpdate(ValueAnimator valueAnimator) {
                                    ...
                                    Impl21.dispatchOnProgress(view, Impl21.interpolateInsets(windowInsetsCompat, windowInsetsCompat2, windowInsetsAnimationCompat.getInterpolatedFraction(), r52), Collections.singletonList(windowInsetsAnimationCompat));
                                }
                            });
        ...
        public Impl21(int r12, @Nullable Interpolator interpolator, long j10) {
            super(r12, interpolator, j10);
        }
        ...
        public static int buildAnimationMask(@NonNull WindowInsetsCompat windowInsetsCompat, @NonNull WindowInsetsCompat windowInsetsCompat2) {
            ...
            for (int r12 = 1; r12 <= 256; r12 <<= 1) {
                if (!windowInsetsCompat.getInsets(r12).equals(windowInsetsCompat2.getInsets(r12))) {
                    r02 |= r12;
                }
            }
            return r02;
        ...
        @NonNull
        public static BoundsCompat computeAnimationBounds(@NonNull WindowInsetsCompat windowInsetsCompat, @NonNull WindowInsetsCompat windowInsetsCompat2, int r6) {
            Insets insets = windowInsetsCompat.getInsets(r6);
            Insets insets2 = windowInsetsCompat2.getInsets(r6);
        ...
        public static void dispatchOnEnd(@NonNull View view, @NonNull WindowInsetsAnimationCompat windowInsetsAnimationCompat) {
            ...
            if (view instanceof ViewGroup) {
                ...
                for (int r02 = 0; r02 < viewGroup.getChildCount(); r02++) {
                    dispatchOnEnd(viewGroup.getChildAt(r02), windowInsetsAnimationCompat);
                }
            }
        }
        ...
        public static void dispatchOnPrepare(View view, WindowInsetsAnimationCompat windowInsetsAnimationCompat, WindowInsets windowInsets, boolean z10) {
            ...
            if (view instanceof ViewGroup) {
                ...
                for (int r12 = 0; r12 < viewGroup.getChildCount(); r12++) {
                    dispatchOnPrepare(viewGroup.getChildAt(r12), windowInsetsAnimationCompat, windowInsets, z10);
                }
            }
        }
        ...
        public static void dispatchOnProgress(@NonNull View view, @NonNull WindowInsetsCompat windowInsetsCompat, @NonNull List<WindowInsetsAnimationCompat> list) {
            ...
            if (view instanceof ViewGroup) {
                ViewGroup viewGroup = (ViewGroup) view;
                for (int r02 = 0; r02 < viewGroup.getChildCount(); r02++) {
                    dispatchOnProgress(viewGroup.getChildAt(r02), windowInsetsCompat, list);
                }
            }
        }
        ...
        public static void dispatchOnStart(View view, WindowInsetsAnimationCompat windowInsetsAnimationCompat, BoundsCompat boundsCompat) {
            ...
            if (view instanceof ViewGroup) {
                ViewGroup viewGroup = (ViewGroup) view;
                for (int r02 = 0; r02 < viewGroup.getChildCount(); r02++) {
                    dispatchOnStart(viewGroup.getChildAt(r02), windowInsetsAnimationCompat, boundsCompat);
                }
            }
        }
        ...
        @SuppressLint({"WrongConstant"})
        public static WindowInsetsCompat interpolateInsets(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f, int r15) {
            Insets insetsInsetInsets;
            WindowInsetsCompat.Builder builder = new WindowInsetsCompat.Builder(windowInsetsCompat);
            for (int r12 = 1; r12 <= 256; r12 <<= 1) {
                if ((r15 & r12) == 0) {
                    insetsInsetInsets = windowInsetsCompat.getInsets(r12);
                } else {
                    Insets insets = windowInsetsCompat.getInsets(r12);
                    Insets insets2 = windowInsetsCompat2.getInsets(r12);
                    float f10 = 1.0f - f;
                    insetsInsetInsets = WindowInsetsCompat.insetInsets(insets, (int) (((insets.left - insets2.left) * f10) + 0.5d), (int) (((insets.top - insets2.top) * f10) + 0.5d), (int) (((insets.right - insets2.right) * f10) + 0.5d), (int) (((insets.bottom - insets2.bottom) * f10) + 0.5d));
                }
                builder.setInsets(r12, insetsInsetInsets);
            }
    ...
    public static class Impl30 extends Impl {
        ...
        public Impl30(int r22, Interpolator interpolator, long j10) {
            this(new WindowInsetsAnimation(r22, interpolator, j10));
        }
    ...
    public WindowInsetsAnimationCompat(int r32, @Nullable Interpolator interpolator, long j10) {
        this.mImpl = Build.VERSION.SDK_INT >= 30 ? new Impl30(r32, interpolator, j10) : new Impl21(r32, interpolator, j10);
    }
