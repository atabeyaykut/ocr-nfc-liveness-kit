...
public final class DisplayCompat {
    ...
    public static class Api23Impl {
        ...
        public static ModeCompat[] getSupportedModes(@NonNull Context context, @NonNull Display display) throws ClassNotFoundException {
            ...
            if (currentDisplaySizeFromWorkarounds == null || physicalSizeEquals(mode, currentDisplaySizeFromWorkarounds)) {
                for (int r72 = 0; r72 < supportedModes.length; r72++) {
                    modeCompatArr[r72] = new ModeCompat(supportedModes[r72], physicalSizeEquals(supportedModes[r72], mode));
                }
            } else {
                for (int r32 = 0; r32 < supportedModes.length; r32++) {
                    modeCompatArr[r32] = physicalSizeEquals(supportedModes[r32], mode) ? new ModeCompat(supportedModes[r32], currentDisplaySizeFromWorkarounds) : new ModeCompat(supportedModes[r32], false);
                }
            }
    ...
    @NonNull
    private static Point getDisplaySize(@NonNull Context context, @NonNull Display display) throws ClassNotFoundException {
    ...
    private static Point parseDisplaySize(@NonNull String str) throws NumberFormatException {
        ...
        if (strArrSplit.length == 2) {
            int r02 = Integer.parseInt(strArrSplit[0]);
            int r22 = Integer.parseInt(strArrSplit[1]);
            if (r02 > 0 && r22 > 0) {
                return new Point(r02, r22);
            }
        }
