...
public final class MenuItemCompat {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static MenuItem setAlphabeticShortcut(MenuItem menuItem, char c10, int r22) {
            return menuItem.setAlphabeticShortcut(c10, r22);
        }
        ...
        @DoNotInline
        public static MenuItem setNumericShortcut(MenuItem menuItem, char c10, int r22) {
            return menuItem.setNumericShortcut(c10, r22);
        }

        @DoNotInline
        public static MenuItem setShortcut(MenuItem menuItem, char c10, char c11, int r32, int r42) {
            return menuItem.setShortcut(c10, c11, r32, r42);
        }
    ...
    @Deprecated
    public static MenuItem setActionView(MenuItem menuItem, int r12) {
        return menuItem.setActionView(r12);
    }
    ...
    public static void setAlphabeticShortcut(@NonNull MenuItem menuItem, char c10, int r42) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setAlphabeticShortcut(c10, r42);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setAlphabeticShortcut(menuItem, c10, r42);
        }
    }
    ...
    public static void setNumericShortcut(@NonNull MenuItem menuItem, char c10, int r42) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setNumericShortcut(c10, r42);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setNumericShortcut(menuItem, c10, r42);
        }
    }
    ...
    public static void setShortcut(@NonNull MenuItem menuItem, char c10, char c11, int r52, int r6) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setShortcut(c10, c11, r52, r6);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setShortcut(menuItem, c10, c11, r52, r6);
        }
    }

    @Deprecated
    public static void setShowAsAction(MenuItem menuItem, int r12) {
        menuItem.setShowAsAction(r12);
    }
