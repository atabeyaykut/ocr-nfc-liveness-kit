...
public final class ViewGroupCompat {
    ...
    public static class Api18Impl {
        ...
        @DoNotInline
        public static void setLayoutMode(ViewGroup viewGroup, int r12) {
            viewGroup.setLayoutMode(r12);
        }
    }
    ...
    public static void setLayoutMode(@NonNull ViewGroup viewGroup, int r12) {
        Api18Impl.setLayoutMode(viewGroup, r12);
    }
