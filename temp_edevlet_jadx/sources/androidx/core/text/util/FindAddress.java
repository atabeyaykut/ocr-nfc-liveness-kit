...
class FindAddress {
    ...
    public static class ZipRange {
        ...
        public ZipRange(int r12, int r22, int r32, int r42) {
            this.mLow = r12;
            this.mHigh = r22;
            this.mException1 = r32;
            this.mException2 = r42;
        }

        public boolean matches(String str) throws NumberFormatException {
            int r32 = Integer.parseInt(str.substring(0, 2));
            return (this.mLow <= r32 && r32 <= this.mHigh) || r32 == this.mException1 || r32 == this.mException2;
        }
    }
    ...
    */
    ...
    private static boolean checkHouseNumber(String str) throws NumberFormatException {
        ...
        for (int r12 = 0; r12 < str.length(); r12++) {
            if (Character.isDigit(str.charAt(r12))) {
                r22++;
            }
        }
        if (r22 > 5) {
        ...
        int r13 = Integer.parseInt(matcher.group(1));
        if (r13 == 0) {
            return false;
        }
        ...
        int r32 = r13 % 10;
        if (r32 == 1) {
            return lowerCase.equals(r13 % 100 != 11 ? "st" : "th");
        }
        if (r32 == 2) {
            return lowerCase.equals(r13 % 100 != 12 ? "nd" : "th");
        }
        if (r32 != 3) {
            return lowerCase.equals("th");
        }
        return lowerCase.equals(r13 % 100 != 13 ? "rd" : "th");
    }

    public static String findAddress(String str) {
        Matcher matcher = sHouseNumberRe.matcher(str);
        int r22 = 0;
        while (matcher.find(r22)) {
            if (checkHouseNumber(matcher.group(0))) {
                int r23 = matcher.start();
                int r32 = attemptMatch(str, matcher);
                if (r32 > 0) {
                    return str.substring(r23, r32);
                }
                r22 = -r32;
            } else {
                r22 = matcher.end();
    ...
    private static boolean isValidZipCode(String str, MatchResult matchResult) {
        ...
        int r12 = matchResult.groupCount();
        while (true) {
            if (r12 <= 0) {
                break;
            }
            int r22 = r12 - 1;
            if (matchResult.group(r12) != null) {
                r12 = r22;
                break;
            }
            r12 = r22;
        }
        return sZipCodeRe.matcher(str).matches() && sStateZipCodeRanges[r12].matches(str);
    }

    @VisibleForTesting
    public static MatchResult matchHouseNumber(String str, int r42) {
        if (r42 > 0 && HOUSE_PRE_DELIM.indexOf(str.charAt(r42 - 1)) == -1) {
            return null;
        }
        Matcher matcherRegion = sHouseNumberRe.matcher(str).region(r42, str.length());
    ...
    @VisibleForTesting
    public static MatchResult matchState(String str, int r42) {
        if (r42 > 0 && WORD_DELIM.indexOf(str.charAt(r42 - 1)) == -1) {
            return null;
        }
        Matcher matcherRegion = sStateRe.matcher(str).region(r42, str.length());
        if (matcherRegion.lookingAt()) {
