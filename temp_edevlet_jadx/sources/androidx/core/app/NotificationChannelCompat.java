...
public class NotificationChannelCompat {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull String str, int r32) {
            this.mChannel = new NotificationChannelCompat(str, r32);
        }
        ...
        @NonNull
        public Builder setImportance(int r22) {
            this.mChannel.mImportance = r22;
            return this;
        }

        @NonNull
        public Builder setLightColor(int r22) {
            this.mChannel.mLightColor = r22;
            return this;
        }
    ...
    public NotificationChannelCompat(@NonNull String str, int r32) {
        this.mShowBadge = DEFAULT_SHOW_BADGE;
        this.mSound = Settings.System.DEFAULT_NOTIFICATION_URI;
        this.mLightColor = 0;
        this.mId = (String) Preconditions.checkNotNull(str);
        this.mImportance = r32;
    ...
    public NotificationChannel getNotificationChannel() {
        ...
        if (r02 >= 30 && (str = this.mParentId) != null && (str2 = this.mConversationId) != null) {
