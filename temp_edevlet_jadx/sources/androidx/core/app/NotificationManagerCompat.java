...
public final class NotificationManagerCompat {
    ...
    public static class CancelTask implements Task {
        ...
        public CancelTask(String str, int r22, String str2) {
            this.packageName = str;
            this.f889id = r22;
            this.tag = str2;
            this.all = false;
        ...
        public void send(android.support.v4.app.a aVar) throws RemoteException {
            if (this.all) {
                ...
                aVar.cancel(this.packageName, this.f889id, this.tag);
            }
        }

        @NonNull
        public String toString() {
            return "CancelTask[packageName:" + this.packageName + ", id:" + this.f889id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
    }
    ...
    public static class NotifyTask implements Task {
        ...
        public NotifyTask(String str, int r22, String str2, Notification notification) {
            this.packageName = str;
            this.f890id = r22;
            this.tag = str2;
        ...
        @Override // androidx.core.app.NotificationManagerCompat.Task
        public void send(android.support.v4.app.a aVar) throws RemoteException {
            aVar.notify(this.packageName, this.f890id, this.tag, this.notif);
        }
        ...
        public String toString() {
            ...
            sb2.append(", id:");
            sb2.append(this.f890id);
            sb2.append(", tag:");
            return androidx.camera.camera2.internal.c.h(sb2, this.tag, "]");
        }
    }
    ...
    public static class SideChannelManager implements Handler.Callback, ServiceConnection {
        ...
        private void scheduleListenerRetry(ListenerRecord listenerRecord) {
            ...
            int r02 = listenerRecord.retryCount + 1;
            listenerRecord.retryCount = r02;
            if (r02 <= 6) {
                int r03 = (1 << (r02 - 1)) * 1000;
                if (Log.isLoggable(NotificationManagerCompat.TAG, 3)) {
                    Log.d(NotificationManagerCompat.TAG, "Scheduling retry for " + r03 + " ms");
                }
                this.mHandler.sendMessageDelayed(this.mHandler.obtainMessage(3, listenerRecord.componentName), r03);
                return;
            }
    ...
    public boolean areNotificationsEnabled() throws ClassNotFoundException {
        ...
        int r12 = applicationInfo.uid;
        try {
            Class<?> cls = Class.forName(AppOpsManager.class.getName());
            Class<?> cls2 = Integer.TYPE;
            return ((Integer) cls.getMethod(CHECK_OP_NO_THROW, cls2, cls2, String.class).invoke(appOpsManager, Integer.valueOf(((Integer) cls.getDeclaredField(OP_POST_NOTIFICATION).get(Integer.class)).intValue()), Integer.valueOf(r12), packageName)).intValue() == 0;
        } catch (ClassNotFoundException | IllegalAccessException | NoSuchFieldException | NoSuchMethodException | RuntimeException | InvocationTargetException unused) {
            return true;
        }
    }

    public void cancel(int r22) {
        cancel(null, r22);
    }

    public void cancel(@Nullable String str, int r32) {
        this.mNotificationManager.cancel(str, r32);
    }
    ...
    public NotificationChannelGroupCompat getNotificationChannelGroupCompat(@NonNull String str) {
        ...
        if (r02 < 26 || (notificationChannelGroup = getNotificationChannelGroup(str)) == null) {
            return null;
        }
    ...
    public List<NotificationChannelGroupCompat> getNotificationChannelGroupsCompat() {
        ...
        if (r02 >= 26) {
            ...
            if (!notificationChannelGroups.isEmpty()) {
                List<NotificationChannel> listEmptyList = r02 >= 28 ? Collections.emptyList() : getNotificationChannels();
    ...
    public void notify(int r22, @NonNull Notification notification) {
        notify(null, r22, notification);
    }

    @RequiresPermission("android.permission.POST_NOTIFICATIONS")
    public void notify(@Nullable String str, int r42, @NonNull Notification notification) {
        if (!useSideChannelForNotification(notification)) {
            this.mNotificationManager.notify(str, r42, notification);
        } else {
            pushSideChannelQueue(new NotifyTask(this.mContext.getPackageName(), r42, str, notification));
            this.mNotificationManager.cancel(str, r42);
        }
    }
}
