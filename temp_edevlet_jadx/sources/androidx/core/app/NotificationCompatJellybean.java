...
class NotificationCompatJellybean {
    ...
    private static RemoteInput[] fromBundleArray(Bundle[] bundleArr) {
        ...
        for (int r12 = 0; r12 < bundleArr.length; r12++) {
            remoteInputArr[r12] = fromBundle(bundleArr[r12]);
        }
    ...
    public static NotificationCompat.Action readAction(int r13, CharSequence charSequence, PendingIntent pendingIntent, Bundle bundle) {
        ...
        return new NotificationCompat.Action(r13, charSequence, pendingIntent, bundle, remoteInputArrFromBundleArray, remoteInputArrFromBundleArray2, z10, 0, true, false, false);
    }
    ...
    private static Bundle[] toBundleArray(RemoteInput[] remoteInputArr) {
        ...
        for (int r12 = 0; r12 < remoteInputArr.length; r12++) {
            bundleArr[r12] = toBundle(remoteInputArr[r12]);
        }
        return bundleArr;
    }
