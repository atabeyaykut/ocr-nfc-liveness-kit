...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    public NotificationCompatBuilder(NotificationCompat.Builder builder) {
        ...
        Notification.Builder builder2 = Build.VERSION.SDK_INT >= 26 ? new Notification.Builder(builder.mContext, builder.mChannelId) : new Notification.Builder(builder.mContext);
        ...
        List listCombineLists = r02 < 28 ? combineLists(getPeople(builder.mPersonList), builder.mPeople) : builder.mPeople;
        ...
        if (builder.mInvisibleActions.size() > 0) {
            ...
            for (int r10 = 0; r10 < builder.mInvisibleActions.size(); r10++) {
                bundle4.putBundle(Integer.toString(r10), NotificationCompatJellybean.getBundleForAction(builder.mInvisibleActions.get(r10)));
            }
        ...
        if (r03 >= 23 && (icon = builder.mSmallIcon) != null) {
        ...
        if (r04 >= 31 && (r32 = builder.mFgsDeferBehavior) != 0) {
            this.mBuilder.setForegroundServiceBehavior(r32);
        }
        if (builder.mSilent) {
            ...
            int r14 = notification.defaults & (-2) & (-3);
            notification.defaults = r14;
            this.mBuilder.setDefaults(r14);
            if (r04 >= 26) {
    ...
    private void addAction(NotificationCompat.Action action) {
        ...
        Notification.Action.Builder builder = r02 >= 23 ? new Notification.Action.Builder(iconCompat != null ? iconCompat.toIcon() : null, action.getTitle(), action.getActionIntent()) : new Notification.Action.Builder(iconCompat != null ? iconCompat.getResId() : 0, action.getTitle(), action.getActionIntent());
