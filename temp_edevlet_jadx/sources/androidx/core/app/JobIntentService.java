...
public abstract class JobIntentService extends Service {
    ...
    public final class CompatWorkItem implements GenericWorkItem {
        ...
        public CompatWorkItem(Intent intent, int r32) {
            this.mIntent = intent;
            this.mStartId = r32;
        }
    ...
    public static final class JobWorkEnqueuer extends WorkEnqueuer {
        ...
        public JobWorkEnqueuer(Context context, ComponentName componentName, int r52) {
            super(componentName);
            ensureJobId(r52);
            this.mJobInfo = new JobInfo.Builder(r52, this.mComponentName).setOverrideDeadline(0L).build();
    ...
    public static abstract class WorkEnqueuer {
        ...
        public void ensureJobId(int r42) {
            if (!this.mHasJobId) {
                this.mHasJobId = true;
                this.mJobId = r42;
            } else {
                ...
                StringBuilder sbE = v.e("Given job ID ", r42, " is different than previous ");
                sbE.append(this.mJobId);
    ...
    public static void enqueueWork(@NonNull Context context, @NonNull ComponentName componentName, int r42, @NonNull Intent intent) {
        if (intent == null) {
            throw new IllegalArgumentException("work must not be null");
        }
        synchronized (sLock) {
            WorkEnqueuer workEnqueuer = getWorkEnqueuer(context, componentName, true, r42);
            workEnqueuer.ensureJobId(r42);
            workEnqueuer.enqueueWork(intent);
        }
    }

    public static void enqueueWork(@NonNull Context context, @NonNull Class<?> cls, int r32, @NonNull Intent intent) {
        enqueueWork(context, new ComponentName(context, cls), r32, intent);
    }

    public static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z10, int r6) {
        ...
        if (Build.VERSION.SDK_INT < 26) {
            ...
            compatWorkEnqueuer = new JobWorkEnqueuer(context, componentName, r6);
        }
    ...
    @Override // android.app.Service
    public int onStartCommand(@Nullable Intent intent, int r42, int r52) {
        ...
        synchronized (this.mCompatQueue) {
            ...
            arrayList.add(new CompatWorkItem(intent, r52));
