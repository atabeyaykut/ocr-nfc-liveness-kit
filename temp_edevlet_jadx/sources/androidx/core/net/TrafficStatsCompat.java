...
public final class TrafficStatsCompat {
    ...
    @Deprecated
    public static void incrementOperationCount(int r02) {
        TrafficStats.incrementOperationCount(r02);
    }

    @Deprecated
    public static void incrementOperationCount(int r02, int r12) {
        TrafficStats.incrementOperationCount(r02, r12);
    }

    @Deprecated
    public static void setThreadStatsTag(int r02) {
        TrafficStats.setThreadStatsTag(r02);
    }
