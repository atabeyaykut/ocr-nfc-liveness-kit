...
final class GradientColorInflaterCompat {
    ...
    public static final class ColorStops {
        ...
        public ColorStops(@ColorInt int r42, @ColorInt int r52) {
            this.mColors = new int[]{r42, r52};
            this.mOffsets = new float[]{0.0f, 1.0f};
        }

        public ColorStops(@ColorInt int r42, @ColorInt int r52, @ColorInt int r6) {
            this.mColors = new int[]{r42, r52, r6};
        ...
        public ColorStops(@NonNull List<Integer> list, @NonNull List<Float> list2) {
            ...
            for (int r12 = 0; r12 < size; r12++) {
                this.mColors[r12] = list.get(r12).intValue();
                this.mOffsets[r12] = list2.get(r12).floatValue();
            }
        }
    }
    ...
    private static ColorStops checkColors(@Nullable ColorStops colorStops, @ColorInt int r12, @ColorInt int r22, boolean z10, @ColorInt int r42) {
        return colorStops != null ? colorStops : z10 ? new ColorStops(r12, r42, r22) : new ColorStops(r12, r22);
    }
    ...
    */
    ...
    private static Shader.TileMode parseTileMode(int r12) {
        return r12 != 1 ? r12 != 2 ? Shader.TileMode.CLAMP : Shader.TileMode.MIRROR : Shader.TileMode.REPEAT;
    }
}
