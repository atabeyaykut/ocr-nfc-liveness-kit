...
public class ShortcutManagerCompat {
    ...
    public static boolean convertUriIconToBitmapIcon(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
        ...
        shortcutInfoCompat.mIcon = r22 == 6 ? IconCompat.createWithAdaptiveBitmap(bitmapDecodeStream) : IconCompat.createWithBitmap(bitmapDecodeStream);
        return true;
    }
    ...
    private static int getIconDimensionInternal(@NonNull Context context, boolean z10) {
        ...
        int r02 = Math.max(1, activityManager == null || activityManager.isLowRamDevice() ? 48 : 96);
        DisplayMetrics displayMetrics = context.getResources().getDisplayMetrics();
        return (int) (r02 * ((z10 ? displayMetrics.xdpi : displayMetrics.ydpi) / 160.0f));
    }
    ...
    @NonNull
    public static List<ShortcutInfoCompat> getShortcuts(@NonNull Context context, int r42) {
        int r02 = Build.VERSION.SDK_INT;
        if (r02 >= 30) {
            return ShortcutInfoCompat.fromShortcuts(context, ((ShortcutManager) context.getSystemService(ShortcutManager.class)).getShortcuts(r42));
        }
        if (r02 < 25) {
            if ((r42 & 2) != 0) {
                try {
    ...
    public static boolean pushDynamicShortcut(@NonNull Context context, @NonNull ShortcutInfoCompat shortcutInfoCompat) {
        ...
        int r02 = Build.VERSION.SDK_INT;
        if (r02 <= 31 && shortcutInfoCompat.isExcludedFromSurfaces(1)) {
            Iterator<ShortcutInfoChangeListener> it = getShortcutInfoListeners(context).iterator();
            while (it.hasNext()) {
    ...
    @NonNull
    private static List<ShortcutInfoCompat> removeShortcutsExcludedFromSurface(@NonNull List<ShortcutInfoCompat> list, int r42) {
        ...
        for (ShortcutInfoCompat shortcutInfoCompat : list) {
            if (shortcutInfoCompat.isExcludedFromSurfaces(r42)) {
