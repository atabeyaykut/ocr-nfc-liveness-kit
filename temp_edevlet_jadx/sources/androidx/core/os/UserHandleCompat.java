...
public class UserHandleCompat {
    ...
    public static class Api24Impl {
        ...
        @NonNull
        public static UserHandle getUserHandleForUid(int r02) {
            return UserHandle.getUserHandleForUid(r02);
        }
    }
    ...
    @NonNull
    public static UserHandle getUserHandleForUid(int r42) {
        if (Build.VERSION.SDK_INT >= 24) {
            return Api24Impl.getUserHandleForUid(r42);
        }
        try {
            return getUserHandleConstructor().newInstance((Integer) getGetUserIdMethod().invoke(null, Integer.valueOf(r42)));
