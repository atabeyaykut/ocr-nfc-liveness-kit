...
public class BuildCompat {
    ...
    public static boolean isAtLeastS() {
        ...
        return r02 >= 31 || (r02 >= 30 && isAtLeastPreReleaseCodename(ExifInterface.LATITUDE_SOUTH, Build.VERSION.CODENAME));
    }
    ...
    public static boolean isAtLeastSv2() {
        int r02 = Build.VERSION.SDK_INT;
        return r02 >= 32 || (r02 >= 31 && isAtLeastPreReleaseCodename("Sv2", Build.VERSION.CODENAME));
    }
    ...
    public static boolean isAtLeastT() {
        int r02 = Build.VERSION.SDK_INT;
        return r02 >= 33 || (r02 >= 32 && isAtLeastPreReleaseCodename("Tiramisu", Build.VERSION.CODENAME));
    }
