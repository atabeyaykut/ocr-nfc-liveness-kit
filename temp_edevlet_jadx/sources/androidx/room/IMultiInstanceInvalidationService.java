...
public interface IMultiInstanceInvalidationService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMultiInstanceInvalidationService {
        ...
        public static class Proxy implements IMultiInstanceInvalidationService {
            ...
            public void broadcastInvalidation(int r42, String[] strArr) throws RemoteException {
            ...
            @Override // androidx.room.IMultiInstanceInvalidationService
            public void unregisterCallback(IMultiInstanceInvalidationCallback iMultiInstanceInvalidationCallback, int r52) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    parcelObtain.writeStrongBinder(iMultiInstanceInvalidationCallback != null ? iMultiInstanceInvalidationCallback.asBinder() : null);
                    parcelObtain.writeInt(r52);
        ...
        public boolean onTransact(int r42, Parcel parcel, Parcel parcel2, int r72) throws RemoteException {
            if (r42 == 1) {
                ...
                int r43 = registerCallback(IMultiInstanceInvalidationCallback.Stub.asInterface(parcel.readStrongBinder()), parcel.readString());
                parcel2.writeNoException();
                parcel2.writeInt(r43);
                return true;
            }
            if (r42 == 2) {
                parcel.enforceInterface(DESCRIPTOR);
    ...
    void broadcastInvalidation(int r12, String[] strArr) throws RemoteException;
    ...
    void unregisterCallback(IMultiInstanceInvalidationCallback iMultiInstanceInvalidationCallback, int r22) throws RemoteException;
}
