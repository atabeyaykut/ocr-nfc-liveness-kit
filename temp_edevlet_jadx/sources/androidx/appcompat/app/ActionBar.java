...
public abstract class ActionBar {
    ...
    public interface OnNavigationListener {
        boolean onNavigationItemSelected(int r12, long j10);
    }
    ...
    public static abstract class Tab {
        ...
        public abstract Tab setContentDescription(@StringRes int r12);

        public abstract Tab setContentDescription(CharSequence charSequence);

        public abstract Tab setCustomView(int r12);

        public abstract Tab setCustomView(View view);

        public abstract Tab setIcon(@DrawableRes int r12);
        ...
        public abstract Tab setText(int r12);
    ...
    @Deprecated
    public abstract void addTab(Tab tab, int r22);

    @Deprecated
    public abstract void addTab(Tab tab, int r22, boolean z10);
    ...
    @Deprecated
    public abstract Tab getTabAt(int r12);
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public boolean onKeyShortcut(int r12, KeyEvent keyEvent) {
        return false;
    }
    ...
    @Deprecated
    public abstract void removeTabAt(int r12);
    ...
    public abstract void setCustomView(int r12);
    ...
    public abstract void setDisplayOptions(int r12);

    public abstract void setDisplayOptions(int r12, int r22);
    ...
    public void setHomeActionContentDescription(@StringRes int r12) {
    }

    public void setHomeActionContentDescription(@Nullable CharSequence charSequence) {
    }

    public void setHomeAsUpIndicator(@DrawableRes int r12) {
    }
    ...
    public abstract void setIcon(@DrawableRes int r12);
    ...
    public abstract void setLogo(@DrawableRes int r12);

    public abstract void setLogo(Drawable drawable);

    @Deprecated
    public abstract void setNavigationMode(int r12);

    @Deprecated
    public abstract void setSelectedNavigationItem(int r12);
    ...
    public abstract void setSubtitle(int r12);

    public abstract void setSubtitle(CharSequence charSequence);

    public abstract void setTitle(@StringRes int r12);
