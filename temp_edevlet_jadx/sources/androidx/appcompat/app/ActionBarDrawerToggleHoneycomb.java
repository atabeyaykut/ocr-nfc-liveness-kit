...
class ActionBarDrawerToggleHoneycomb {
    ...
    public static SetIndicatorInfo setActionBarDescription(SetIndicatorInfo setIndicatorInfo, Activity activity, int r52) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (setIndicatorInfo == null) {
            setIndicatorInfo = new SetIndicatorInfo(activity);
        }
        if (setIndicatorInfo.setHomeAsUpIndicator != null) {
            try {
                setIndicatorInfo.setHomeActionContentDescription.invoke(activity.getActionBar(), Integer.valueOf(r52));
            } catch (Exception e10) {
    ...
    public static SetIndicatorInfo setActionBarUpIndicator(Activity activity, Drawable drawable, int r82) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (setIndicatorInfo.setHomeAsUpIndicator != null) {
            try {
                ...
                setIndicatorInfo.setHomeActionContentDescription.invoke(actionBar, Integer.valueOf(r82));
            } catch (Exception e10) {
