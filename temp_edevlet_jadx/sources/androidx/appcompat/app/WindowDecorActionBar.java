...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        public void setSubtitle(int r22) {
            setSubtitle(WindowDecorActionBar.this.mContext.getResources().getString(r22));
        }
        ...
        public void setTitle(int r22) {
            setTitle(WindowDecorActionBar.this.mContext.getResources().getString(r22));
        }
    ...
    public class TabImpl extends ActionBar.Tab {
        ...
        @Override // androidx.appcompat.app.ActionBar.Tab
        public ActionBar.Tab setContentDescription(int r22) {
            return setContentDescription(WindowDecorActionBar.this.mContext.getResources().getText(r22));
        }

        @Override // androidx.appcompat.app.ActionBar.Tab
        public ActionBar.Tab setContentDescription(CharSequence charSequence) {
            this.mContentDesc = charSequence;
            int r22 = this.mPosition;
            if (r22 >= 0) {
                WindowDecorActionBar.this.mTabScrollView.updateTab(r22);
            }
            return this;
        }

        @Override // androidx.appcompat.app.ActionBar.Tab
        public ActionBar.Tab setCustomView(int r32) {
            return setCustomView(LayoutInflater.from(WindowDecorActionBar.this.getThemedContext()).inflate(r32, (ViewGroup) null));
        }
        ...
        @Override // androidx.appcompat.app.ActionBar.Tab
        public ActionBar.Tab setIcon(int r22) {
            return setIcon(AppCompatResources.getDrawable(WindowDecorActionBar.this.mContext, r22));
        }
        ...
        @Override // androidx.appcompat.app.ActionBar.Tab
        public ActionBar.Tab setText(int r22) {
            return setText(WindowDecorActionBar.this.mContext.getResources().getText(r22));
        }
    ...
    private void configureTab(ActionBar.Tab tab, int r32) {
        TabImpl tabImpl = (TabImpl) tab;
        if (tabImpl.getCallback() == null) {
            throw new IllegalStateException("Action Bar Tab must have a Callback");
        }
        tabImpl.setPosition(r32);
        this.mTabs.add(r32, tabImpl);
        ...
        while (true) {
            ...
            if (r32 >= size) {
                ...
                this.mTabs.get(r32).setPosition(r32);
            }
        }
    }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public void addTab(ActionBar.Tab tab, int r32) {
        addTab(tab, r32, this.mTabs.isEmpty());
    }

    @Override // androidx.appcompat.app.ActionBar
    public void addTab(ActionBar.Tab tab, int r32, boolean z10) {
        ensureTabsExist();
        this.mTabScrollView.addTab(tab, r32, z10);
    ...
    public void dispatchMenuVisibilityChanged(boolean z10) {
        ...
        for (int r12 = 0; r12 < size; r12++) {
            this.mMenuVisibilityListeners.get(r12).onMenuVisibilityChanged(z10);
        }
    }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public ActionBar.Tab getTabAt(int r22) {
        return this.mTabs.get(r22);
    }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public boolean onKeyShortcut(int r52, KeyEvent keyEvent) {
        Menu menu;
        ...
        return menu.performShortcut(r52, keyEvent, 0);
    }

    @Override // androidx.appcompat.widget.ActionBarOverlayLayout.ActionBarVisibilityCallback
    public void onWindowVisibilityChanged(int r12) {
        this.mCurWindowVisibility = r12;
    }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public void removeTabAt(int r52) {
        if (this.mTabScrollView == null) {
            return;
        }
        TabImpl tabImpl = this.mSelectedTab;
        int position = tabImpl != null ? tabImpl.getPosition() : this.mSavedTabPosition;
        this.mTabScrollView.removeTabAt(r52);
        TabImpl tabImplRemove = this.mTabs.remove(r52);
        if (tabImplRemove != null) {
            tabImplRemove.setPosition(-1);
        }
        int size = this.mTabs.size();
        for (int r22 = r52; r22 < size; r22++) {
            this.mTabs.get(r22).setPosition(r22);
        }
        if (position == r52) {
            selectTab(this.mTabs.isEmpty() ? null : this.mTabs.get(Math.max(0, r52 - 1)));
        }
    }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public void setCustomView(int r42) {
        setCustomView(LayoutInflater.from(getThemedContext()).inflate(r42, this.mDecorToolbar.getViewGroup(), false));
    }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public void setDisplayOptions(int r22) {
        if ((r22 & 4) != 0) {
            this.mDisplayHomeAsUpSet = true;
        }
        this.mDecorToolbar.setDisplayOptions(r22);
    }

    @Override // androidx.appcompat.app.ActionBar
    public void setDisplayOptions(int r32, int r42) {
        int displayOptions = this.mDecorToolbar.getDisplayOptions();
        if ((r42 & 4) != 0) {
            this.mDisplayHomeAsUpSet = true;
        }
        this.mDecorToolbar.setDisplayOptions((r32 & r42) | ((~r42) & displayOptions));
    }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public void setHideOffset(int r22) {
        if (r22 != 0 && !this.mOverlayLayout.isInOverlayMode()) {
            throw new IllegalStateException("Action bar must be in overlay mode (Window.FEATURE_OVERLAY_ACTION_BAR) to set a non-zero hide offset");
        }
        this.mOverlayLayout.setActionBarHideOffset(r22);
    }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public void setHomeActionContentDescription(int r22) {
        this.mDecorToolbar.setNavigationContentDescription(r22);
    }
    ...
    public void setHomeAsUpIndicator(int r22) {
        this.mDecorToolbar.setNavigationIcon(r22);
    }
    ...
    public void setNavigationMode(int r6) {
        ...
        if (r6 == 2) {
            ...
            int r22 = this.mSavedTabPosition;
            if (r22 != -1) {
                setSelectedNavigationItem(r22);
                this.mSavedTabPosition = -1;
            }
        }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public void setSelectedNavigationItem(int r32) {
        int navigationMode = this.mDecorToolbar.getNavigationMode();
        if (navigationMode == 1) {
            this.mDecorToolbar.setDropdownSelectedPosition(r32);
        } else {
            if (navigationMode != 2) {
                throw new IllegalStateException("setSelectedNavigationIndex not valid for current navigation mode");
            }
            selectTab(this.mTabs.get(r32));
        }
    }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public void setSubtitle(int r22) {
        setSubtitle(this.mContext.getString(r22));
    }
