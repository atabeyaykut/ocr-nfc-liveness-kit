...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public void setActionBarDescription(int r22) {
            ...
            if (supportActionBar != null) {
                supportActionBar.setHomeActionContentDescription(r22);
            }
        }
        ...
        public void setActionBarUpIndicator(Drawable drawable, int r32) {
            ...
            if (supportActionBar != null) {
                ...
                supportActionBar.setHomeActionContentDescription(r32);
            }
        }
    }
    ...
    public interface ActionBarMenuCallback {
        @Nullable
        View onCreatePanelView(int r12);

        boolean onPreparePanel(int r12);
    }
    ...
    public static class Api17Impl {
        ...
        public static void generateConfigDelta_densityDpi(@NonNull Configuration configuration, @NonNull Configuration configuration2, @NonNull Configuration configuration3) {
            int r02 = configuration.densityDpi;
            int r12 = configuration2.densityDpi;
            if (r02 != r12) {
                configuration3.densityDpi = r12;
            }
        }
    }
    ...
    public class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public void bypassOnPanelClosed(Window.Callback callback, int r42, Menu menu) {
            try {
                this.mOnPanelClosedBypassEnabled = true;
                callback.onPanelClosed(r42, menu);
            } finally {
        ...
        public boolean onCreatePanelMenu(int r22, Menu menu) {
            if (r22 != 0 || (menu instanceof MenuBuilder)) {
                return super.onCreatePanelMenu(r22, menu);
            }
            return false;
        }

        @Override // androidx.appcompat.view.WindowCallbackWrapper, android.view.Window.Callback
        public View onCreatePanelView(int r22) {
            View viewOnCreatePanelView;
            ActionBarMenuCallback actionBarMenuCallback = this.mActionBarCallback;
            return (actionBarMenuCallback == null || (viewOnCreatePanelView = actionBarMenuCallback.onCreatePanelView(r22)) == null) ? super.onCreatePanelView(r22) : viewOnCreatePanelView;
        }

        @Override // androidx.appcompat.view.WindowCallbackWrapper, android.view.Window.Callback
        public boolean onMenuOpened(int r12, Menu menu) {
            super.onMenuOpened(r12, menu);
            AppCompatDelegateImpl.this.onMenuOpened(r12);
            return true;
        }
        ...
        public void onPanelClosed(int r22, Menu menu) {
            if (this.mOnPanelClosedBypassEnabled) {
                getWrapped().onPanelClosed(r22, menu);
            } else {
                super.onPanelClosed(r22, menu);
                AppCompatDelegateImpl.this.onPanelClosed(r22);
            }
        }

        @Override // androidx.appcompat.view.WindowCallbackWrapper, android.view.Window.Callback
        public boolean onPreparePanel(int r52, View view, Menu menu) {
            MenuBuilder menuBuilder = menu instanceof MenuBuilder ? (MenuBuilder) menu : null;
            if (r52 == 0 && menuBuilder == null) {
                return false;
            }
            if (menuBuilder != null) {
            ...
            ActionBarMenuCallback actionBarMenuCallback = this.mActionBarCallback;
            boolean zOnPreparePanel = actionBarMenuCallback != null && actionBarMenuCallback.onPreparePanel(r52);
            if (!zOnPreparePanel) {
                zOnPreparePanel = super.onPreparePanel(r52, view, menu);
            }
            if (menuBuilder != null) {
        ...
        public void onProvideKeyboardShortcuts(List<KeyboardShortcutGroup> list, Menu menu, int r6) {
            ...
            if (panelState == null || (menuBuilder = panelState.menu) == null) {
                ...
                super.onProvideKeyboardShortcuts(list, menuBuilder, r6);
            }
        }
        ...
        @Override // androidx.appcompat.view.WindowCallbackWrapper, android.view.Window.Callback
        @RequiresApi(23)
        public android.view.ActionMode onWindowStartingActionMode(ActionMode.Callback callback, int r32) {
            return (AppCompatDelegateImpl.this.isHandleNativeActionModesEnabled() && r32 == 0) ? startAsSupportActionMode(callback) : super.onWindowStartingActionMode(callback, r32);
        }
    ...
    public class ListMenuDecorView extends ContentFrameLayout {
        ...
        private boolean isOutOfBounds(int r22, int r32) {
            return r22 < -5 || r32 < -5 || r22 > getWidth() + 5 || r32 > getHeight() + 5;
        }
        ...
        public void setBackgroundResource(int r22) {
            setBackgroundDrawable(AppCompatResources.getDrawable(getContext(), r22));
        }
    }
    ...
    public static final class PanelFeatureState {
        ...
        public PanelFeatureState(int r12) {
            this.featureId = r12;
        }
        ...
        public void setStyle(Context context) {
            ...
            int r22 = typedValue.resourceId;
            if (r22 != 0) {
                themeNewTheme.applyStyle(r22, true);
            }
            themeNewTheme.resolveAttribute(androidx.appcompat.R.attr.panelMenuListTheme, typedValue, true);
            int r02 = typedValue.resourceId;
            if (r02 == 0) {
                r02 = androidx.appcompat.R.style.Theme_AppCompat_CompactMenu;
            }
            themeNewTheme.applyStyle(r02, true);
    ...
    private boolean applyDayNight(boolean z10) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, SecurityException, IllegalArgumentException {
        if (this.mDestroyed) {
            return false;
        }
        int r02 = calculateNightMode();
        boolean zUpdateForNightMode = updateForNightMode(mapNightMode(this.mContext, r02), z10);
        if (r02 == 0) {
    ...
    private void applyFixedSizeWindow() {
        ...
        int r22 = androidx.appcompat.R.styleable.AppCompatTheme_windowFixedWidthMajor;
        if (typedArrayObtainStyledAttributes.hasValue(r22)) {
            typedArrayObtainStyledAttributes.getValue(r22, contentFrameLayout.getFixedWidthMajor());
        }
        int r23 = androidx.appcompat.R.styleable.AppCompatTheme_windowFixedWidthMinor;
        if (typedArrayObtainStyledAttributes.hasValue(r23)) {
            typedArrayObtainStyledAttributes.getValue(r23, contentFrameLayout.getFixedWidthMinor());
        }
        int r24 = androidx.appcompat.R.styleable.AppCompatTheme_windowFixedHeightMajor;
        if (typedArrayObtainStyledAttributes.hasValue(r24)) {
            typedArrayObtainStyledAttributes.getValue(r24, contentFrameLayout.getFixedHeightMajor());
        }
        int r25 = androidx.appcompat.R.styleable.AppCompatTheme_windowFixedHeightMinor;
        if (typedArrayObtainStyledAttributes.hasValue(r25)) {
            typedArrayObtainStyledAttributes.getValue(r25, contentFrameLayout.getFixedHeightMinor());
        }
        typedArrayObtainStyledAttributes.recycle();
    ...
    private int calculateNightMode() {
        int r02 = this.mLocalNightMode;
        return r02 != -100 ? r02 : AppCompatDelegate.getDefaultNightMode();
    }
    ...
    @NonNull
    private Configuration createOverrideConfigurationForDayNight(@NonNull Context context, int r32, @Nullable Configuration configuration, boolean z10) {
        int r22 = r32 != 1 ? r32 != 2 ? z10 ? 0 : context.getApplicationContext().getResources().getConfiguration().uiMode & 48 : 32 : 16;
        Configuration configuration2 = new Configuration();
        configuration2.fontScale = 0.0f;
        if (configuration != null) {
            configuration2.setTo(configuration);
        }
        configuration2.uiMode = r22 | (configuration2.uiMode & (-49));
    ...
    private ViewGroup createSubDecor() throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ViewGroup viewGroup;
        TypedArray typedArrayObtainStyledAttributes = this.mContext.obtainStyledAttributes(androidx.appcompat.R.styleable.AppCompatTheme);
        int r12 = androidx.appcompat.R.styleable.AppCompatTheme_windowActionBar;
        ...
        } else if (typedArrayObtainStyledAttributes.getBoolean(r12, false)) {
        ...
        if (this.mWindowNoTitle) {
            viewGroup = (ViewGroup) layoutInflaterFrom.inflate(this.mOverlayActionMode ? androidx.appcompat.R.layout.abc_screen_simple_overlay_action_mode : androidx.appcompat.R.layout.abc_screen_simple, (ViewGroup) null);
        ...
        ViewCompat.setOnApplyWindowInsetsListener(viewGroup, new OnApplyWindowInsetsListener() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.3
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
                ...
                int r13 = AppCompatDelegateImpl.this.updateStatusGuard(windowInsetsCompat, null);
                if (systemWindowInsetTop != r13) {
                    windowInsetsCompat = windowInsetsCompat.replaceSystemWindowInsets(windowInsetsCompat.getSystemWindowInsetLeft(), r13, windowInsetsCompat.getSystemWindowInsetRight(), windowInsetsCompat.getSystemWindowInsetBottom());
                }
    ...
    private static Configuration generateConfigDelta(@NonNull Configuration configuration, @Nullable Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            int r12 = configuration.mcc;
            int r22 = configuration2.mcc;
            if (r12 != r22) {
                configuration3.mcc = r22;
            }
            int r13 = configuration.mnc;
            int r23 = configuration2.mnc;
            if (r13 != r23) {
                configuration3.mnc = r23;
            }
            ...
            int r24 = configuration.touchscreen;
            int r32 = configuration2.touchscreen;
            if (r24 != r32) {
                configuration3.touchscreen = r32;
            }
            int r25 = configuration.keyboard;
            int r33 = configuration2.keyboard;
            if (r25 != r33) {
                configuration3.keyboard = r33;
            }
            int r26 = configuration.keyboardHidden;
            int r34 = configuration2.keyboardHidden;
            if (r26 != r34) {
                configuration3.keyboardHidden = r34;
            }
            int r27 = configuration.navigation;
            int r35 = configuration2.navigation;
            if (r27 != r35) {
                configuration3.navigation = r35;
            }
            int r28 = configuration.navigationHidden;
            int r36 = configuration2.navigationHidden;
            if (r28 != r36) {
                configuration3.navigationHidden = r36;
            }
            int r29 = configuration.orientation;
            int r37 = configuration2.orientation;
            if (r29 != r37) {
                configuration3.orientation = r37;
            }
            int r210 = configuration.screenLayout & 15;
            int r38 = configuration2.screenLayout;
            if (r210 != (r38 & 15)) {
                configuration3.screenLayout |= r38 & 15;
            }
            int r211 = configuration.screenLayout & 192;
            int r39 = configuration2.screenLayout;
            if (r211 != (r39 & 192)) {
                configuration3.screenLayout |= r39 & 192;
            }
            int r212 = configuration.screenLayout & 48;
            int r310 = configuration2.screenLayout;
            if (r212 != (r310 & 48)) {
                configuration3.screenLayout |= r310 & 48;
            }
            int r213 = configuration.screenLayout & 768;
            int r311 = configuration2.screenLayout;
            if (r213 != (r311 & 768)) {
                configuration3.screenLayout |= r311 & 768;
            }
            if (r14 >= 26) {
                Api26Impl.generateConfigDelta_colorMode(configuration, configuration2, configuration3);
            }
            int r15 = configuration.uiMode & 15;
            int r214 = configuration2.uiMode;
            if (r15 != (r214 & 15)) {
                configuration3.uiMode |= r214 & 15;
            }
            int r16 = configuration.uiMode & 48;
            int r215 = configuration2.uiMode;
            if (r16 != (r215 & 48)) {
                configuration3.uiMode |= r215 & 48;
            }
            int r17 = configuration.screenWidthDp;
            int r216 = configuration2.screenWidthDp;
            if (r17 != r216) {
                configuration3.screenWidthDp = r216;
            }
            int r18 = configuration.screenHeightDp;
            int r217 = configuration2.screenHeightDp;
            if (r18 != r217) {
                configuration3.screenHeightDp = r217;
            }
            int r19 = configuration.smallestScreenWidthDp;
            int r218 = configuration2.smallestScreenWidthDp;
            if (r19 != r218) {
                configuration3.smallestScreenWidthDp = r218;
            }
    ...
    */
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        int r12 = panelFeatureState.featureId;
        if ((r12 == 0 || r12 == 108) && this.mDecorContentParent != null) {
            TypedValue typedValue = new TypedValue();
    ...
    private void invalidatePanelMenu(int r32) {
        this.mInvalidatePanelMenuFeatures = (1 << r32) | this.mInvalidatePanelMenuFeatures;
    ...
    private boolean isActivityManifestHandlingUiMode(Context context) throws PackageManager.NameNotFoundException {
        if (!this.mActivityHandlesUiModeChecked && (this.mHost instanceof Activity)) {
            ...
            try {
                ...
                ActivityInfo activityInfo = packageManager.getActivityInfo(new ComponentName(context, this.mHost.getClass()), r32 >= 29 ? 269221888 : r32 >= 24 ? 786432 : 0);
    ...
    private boolean onKeyDownPanel(int r22, KeyEvent keyEvent) {
        if (keyEvent.getRepeatCount() != 0) {
            return false;
        }
        PanelFeatureState panelState = getPanelState(r22, true);
    ...
    */
    ...
    private void openPanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
            ...
            if (viewGroup != null && !panelFeatureState.refreshDecorView) {
                ...
                WindowManager.LayoutParams layoutParams2 = new WindowManager.LayoutParams(r52, -2, panelFeatureState.f441x, panelFeatureState.f442y, PointerIconCompat.TYPE_HAND, 8519680, -3);
            ...
            r52 = -2;
            panelFeatureState.isHandled = false;
            WindowManager.LayoutParams layoutParams22 = new WindowManager.LayoutParams(r52, -2, panelFeatureState.f441x, panelFeatureState.f442y, PointerIconCompat.TYPE_HAND, 8519680, -3);
    ...
    private boolean performPanelShortcut(PanelFeatureState panelFeatureState, int r42, KeyEvent keyEvent, int r6) {
        MenuBuilder menuBuilder;
        ...
        if ((panelFeatureState.isPrepared || preparePanel(panelFeatureState, keyEvent)) && (menuBuilder = panelFeatureState.menu) != null) {
            zPerformShortcut = menuBuilder.performShortcut(r42, keyEvent, r6);
        }
    ...
    private boolean preparePanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        int r32 = panelFeatureState.featureId;
        boolean z10 = r32 == 0 || r32 == 108;
    ...
    private int sanitizeWindowFeatureId(int r32) {
        if (r32 == 8) {
    ...
    private boolean updateForNightMode(int r82, boolean z10) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, SecurityException, IllegalArgumentException {
        boolean z11 = false;
        Configuration configurationCreateOverrideConfigurationForDayNight = createOverrideConfigurationForDayNight(this.mContext, r82, null, false);
        ...
        int r42 = configuration.uiMode & 48;
        int r02 = configurationCreateOverrideConfigurationForDayNight.uiMode & 48;
        boolean z12 = true;
        if (r42 != r02 && z10 && !zIsActivityManifestHandlingUiMode && this.mBaseContextAttached && (sCanReturnDifferentContext || this.mCreated)) {
            Object obj = this.mHost;
        ...
        if (z11 || r42 == r02) {
            ...
            updateResourcesConfigurationForNightMode(r02, zIsActivityManifestHandlingUiMode, null);
        }
        if (z12) {
            Object obj2 = this.mHost;
            if (obj2 instanceof AppCompatActivity) {
                ((AppCompatActivity) obj2).onNightModeChanged(r82);
            }
        }
        return z12;
    }
    ...
    private void updateResourcesConfigurationForNightMode(int r42, boolean z10, @Nullable Configuration configuration) throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException {
        Resources resources = this.mContext.getResources();
        Configuration configuration2 = new Configuration(resources.getConfiguration());
        if (configuration != null) {
            configuration2.updateFrom(configuration);
        }
        configuration2.uiMode = r42 | (resources.getConfiguration().uiMode & (-49));
        resources.updateConfiguration(configuration2, null);
        int r43 = Build.VERSION.SDK_INT;
        if (r43 < 26) {
            ResourcesFlusher.flush(resources);
        }
        int r6 = this.mThemeResId;
        if (r6 != 0) {
            this.mContext.setTheme(r6);
            if (r43 >= 23) {
    ...
    private void updateStatusGuardColor(View view) {
        ...
        if ((ViewCompat.getWindowSystemUiVisibility(view) & 8192) != 0) {
            ...
            r12 = androidx.appcompat.R.color.abc_decor_view_status_guard_light;
        } else {
            context = this.mContext;
            r12 = androidx.appcompat.R.color.abc_decor_view_status_guard;
        }
        view.setBackgroundColor(ContextCompat.getColor(context, r12));
    }
    ...
    public Context attachBaseContext2(@NonNull Context context) {
        ...
        int r12 = mapNightMode(context, calculateNightMode());
        boolean z10 = false;
        if (sCanApplyOverrideConfiguration && (context instanceof ContextThemeWrapper)) {
            try {
                ContextThemeWrapperCompatApi17Impl.applyOverrideConfiguration((ContextThemeWrapper) context, createOverrideConfigurationForDayNight(context, r12, null, false));
                return context;
        ...
        if (context instanceof androidx.appcompat.view.ContextThemeWrapper) {
            try {
                ((androidx.appcompat.view.ContextThemeWrapper) context).applyOverrideConfiguration(createOverrideConfigurationForDayNight(context, r12, null, false));
                return context;
        ...
        Configuration configurationCreateOverrideConfigurationForDayNight = createOverrideConfigurationForDayNight(context, r12, configuration2.equals(configuration3) ? null : generateConfigDelta(configuration2, configuration3), true);
    ...
    public void callOnPanelClosed(int r32, PanelFeatureState panelFeatureState, Menu menu) {
        if (menu == null) {
            if (panelFeatureState == null && r32 >= 0) {
                PanelFeatureState[] panelFeatureStateArr = this.mPanels;
                if (r32 < panelFeatureStateArr.length) {
                    panelFeatureState = panelFeatureStateArr[r32];
                }
            }
        ...
        if ((panelFeatureState == null || panelFeatureState.isOpen) && !this.mDestroyed) {
            this.mAppCompatWindowCallback.bypassOnPanelClosed(this.mWindow.getCallback(), r32, menu);
        }
    }
    ...
    public void closePanel(int r22) {
        closePanel(getPanelState(r22, true), true);
    }
    ...
    public void doInvalidatePanelMenu(int r52) {
        PanelFeatureState panelState;
        PanelFeatureState panelState2 = getPanelState(r52, true);
        ...
        if ((r52 != 108 && r52 != 0) || this.mDecorContentParent == null || (panelState = getPanelState(0, false)) == null) {
            return;
        }
    ...
    public PanelFeatureState findMenuPanel(Menu menu) {
        ...
        for (int r12 = 0; r12 < length; r12++) {
            PanelFeatureState panelFeatureState = panelFeatureStateArr[r12];
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    @Nullable
    public <T extends View> T findViewById(@IdRes int r22) {
        ensureSubDecor();
        return (T) this.mWindow.findViewById(r22);
    }
    ...
    public PanelFeatureState getPanelState(int r42, boolean z10) {
        PanelFeatureState[] panelFeatureStateArr = this.mPanels;
        if (panelFeatureStateArr == null || panelFeatureStateArr.length <= r42) {
            PanelFeatureState[] panelFeatureStateArr2 = new PanelFeatureState[r42 + 1];
        ...
        PanelFeatureState panelFeatureState = panelFeatureStateArr[r42];
        if (panelFeatureState != null) {
            return panelFeatureState;
        }
        PanelFeatureState panelFeatureState2 = new PanelFeatureState(r42);
        panelFeatureStateArr[r42] = panelFeatureState2;
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    public boolean hasWindowFeature(int r52) {
        int r02 = sanitizeWindowFeatureId(r52);
        return (r02 != 1 ? r02 != 2 ? r02 != 5 ? r02 != 10 ? r02 != 108 ? r02 != 109 ? false : this.mOverlayActionBar : this.mHasActionBar : this.mOverlayActionMode : this.mFeatureIndeterminateProgress : this.mFeatureProgress : this.mWindowNoTitle) || this.mWindow.hasFeature(r52);
    }
    ...
    public int mapNightMode(@NonNull Context context, int r42) {
    ...
    */
    ...
    public boolean onKeyShortcut(int r42, KeyEvent keyEvent) {
        ActionBar supportActionBar = getSupportActionBar();
        if (supportActionBar != null && supportActionBar.onKeyShortcut(r42, keyEvent)) {
            return true;
        }
    ...
    public boolean onKeyUp(int r42, KeyEvent keyEvent) {
        if (r42 == 4) {
    ...
    public void onMenuOpened(int r22) {
        ActionBar supportActionBar;
        if (r22 != 108 || (supportActionBar = getSupportActionBar()) == null) {
            return;
        }
        supportActionBar.dispatchMenuVisibilityChanged(true);
    }

    public void onPanelClosed(int r32) {
        if (r32 == 108) {
            ActionBar supportActionBar = getSupportActionBar();
            if (supportActionBar != null) {
        ...
        if (r32 == 0) {
            PanelFeatureState panelState = getPanelState(r32, true);
            if (panelState.isOpen) {
                closePanel(panelState, false);
            }
        }
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    public boolean requestWindowFeature(int r52) {
        int r53 = sanitizeWindowFeatureId(r52);
        if (this.mWindowNoTitle && r53 == 108) {
            return false;
        }
        if (this.mHasActionBar && r53 == 1) {
            this.mHasActionBar = false;
        }
        if (r53 == 1) {
        ...
        if (r53 != 109) {
            return this.mWindow.requestFeature(r53);
        }
        throwFeatureRequestIfSubDecorInstalled();
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    public void setContentView(int r32) {
        ensureSubDecor();
        ViewGroup viewGroup = (ViewGroup) this.mSubDecor.findViewById(R.id.content);
        viewGroup.removeAllViews();
        LayoutInflater.from(this.mContext).inflate(r32, viewGroup);
        this.mAppCompatWindowCallback.bypassOnContentChanged(this.mWindow.getCallback());
    }
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    @RequiresApi(17)
    public void setLocalNightMode(int r22) {
        if (this.mLocalNightMode != r22) {
            this.mLocalNightMode = r22;
    ...
    @Override // androidx.appcompat.app.AppCompatDelegate
    public void setTheme(@StyleRes int r12) {
        this.mThemeResId = r12;
    }
    ...
    public androidx.appcompat.view.ActionMode startSupportActionModeFromWindow(@NonNull ActionMode.Callback callback) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
    ...
    public final int updateStatusGuard(@Nullable WindowInsetsCompat windowInsetsCompat, @Nullable Rect rect) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (actionBarContextView == null || !(actionBarContextView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin == r11 && marginLayoutParams.leftMargin == r12 && marginLayoutParams.rightMargin == r42) {
                    z11 = false;
                } else {
                    marginLayoutParams.topMargin = r11;
                    marginLayoutParams.leftMargin = r12;
                    marginLayoutParams.rightMargin = r42;
                    z11 = true;
                }
                if (r11 <= 0 || this.mStatusGuard != null) {
                    View view = this.mStatusGuard;
                    if (view != null) {
                        ViewGroup.MarginLayoutParams marginLayoutParams2 = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
                        int r43 = marginLayoutParams2.height;
                        int r82 = marginLayoutParams.topMargin;
                        if (r43 != r82 || marginLayoutParams2.leftMargin != systemWindowInsetLeft || marginLayoutParams2.rightMargin != systemWindowInsetRight) {
                            marginLayoutParams2.height = r82;
