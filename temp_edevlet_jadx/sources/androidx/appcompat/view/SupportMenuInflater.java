...
public class SupportMenuInflater extends MenuInflater {
    ...
    public static class InflatedOnMenuItemClickListener implements MenuItem.OnMenuItemClickListener {
        ...
        public InflatedOnMenuItemClickListener(Object obj, String str) {
            ...
            try {
                ...
                StringBuilder sbL = android.support.v4.media.a.l("Couldn't resolve menu item onClick handler ", str, " in class ");
    ...
    public class MenuState {
        ...
        private void setItem(MenuItem menuItem) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            ...
            int r03 = this.itemActionViewLayout;
            if (r03 > 0) {
                if (z10) {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            int r02 = R.styleable.MenuItem_android_checkable;
            this.itemCheckable = tintTypedArrayObtainStyledAttributes.hasValue(r02) ? tintTypedArrayObtainStyledAttributes.getBoolean(r02, false) : this.groupCheckable;
            ...
            int r03 = R.styleable.MenuItem_iconTintMode;
            if (tintTypedArrayObtainStyledAttributes.hasValue(r03)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(r03, -1), this.itemIconTintMode);
            } else {
                this.itemIconTintMode = null;
            }
            int r04 = R.styleable.MenuItem_iconTint;
            if (tintTypedArrayObtainStyledAttributes.hasValue(r04)) {
                this.itemIconTintList = tintTypedArrayObtainStyledAttributes.getColorStateList(r04);
            } else {
    ...
    public void inflate(@LayoutRes int r42, Menu menu) {
        if (!(menu instanceof SupportMenu)) {
            super.inflate(r42, menu);
            return;
        }
        ...
        try {
            try {
                try {
                    layout = this.mContext.getResources().getLayout(r42);
