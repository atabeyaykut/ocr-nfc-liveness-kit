...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view, boolean z10, @AttrRes int r12) {
        this(context, menuBuilder, view, z10, r12, 0);
    }

    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view, boolean z10, @AttrRes int r6, @StyleRes int r72) {
    ...
    private void showPopup(int r42, int r52, boolean z10, boolean z11) {
        MenuPopup popup = getPopup();
        popup.setShowTitle(z11);
        if (z10) {
            if ((GravityCompat.getAbsoluteGravity(this.mDropDownGravity, ViewCompat.getLayoutDirection(this.mAnchorView)) & 7) == 5) {
                r42 -= this.mAnchorView.getWidth();
            }
            popup.setHorizontalOffset(r42);
            popup.setVerticalOffset(r52);
            int r6 = (int) ((this.mContext.getResources().getDisplayMetrics().density * 48.0f) / 2.0f);
            popup.setEpicenterBounds(new Rect(r42 - r6, r52 - r6, r42 + r6, r52 + r6));
        }
        popup.show();
    }
    ...
    public void show(int r12, int r22) {
        if (!tryShow(r12, r22)) {
            throw new IllegalStateException("MenuPopupHelper cannot be used without an anchor");
        }
    }
    ...
    public boolean tryShow(int r32, int r42) {
        if (isShowing()) {
            return true;
        }
        if (this.mAnchorView == null) {
