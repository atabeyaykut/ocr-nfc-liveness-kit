...
public abstract class BaseMenuPresenter implements MenuPresenter {
    ...
    public BaseMenuPresenter(Context context, int r22, int r32) {
        this.mSystemContext = context;
        this.mSystemInflater = LayoutInflater.from(context);
        this.mMenuLayoutRes = r22;
        this.mItemLayoutRes = r32;
    }

    public void addItemView(View view, int r32) {
        ViewGroup viewGroup = (ViewGroup) view.getParent();
        if (viewGroup != null) {
            viewGroup.removeView(view);
        }
        ((ViewGroup) this.mMenuView).addView(view, r32);
    }
    ...
    public boolean filterLeftoverView(ViewGroup viewGroup, int r22) {
    ...
    public void updateMenuView(boolean z10) {
        ...
        if (menuBuilder != null) {
            ...
            for (int r32 = 0; r32 < size; r32++) {
                ...
                if (shouldIncludeItem(r42, menuItemImpl)) {
        ...
        while (r12 < viewGroup.getChildCount()) {
            if (!filterLeftoverView(viewGroup, r12)) {
                r12++;
            }
        }
    }
