...
class MenuDialogHelper implements DialogInterface.OnKeyListener, DialogInterface.OnClickListener, DialogInterface.OnDismissListener, MenuPresenter.Callback {
    ...
    public void onClick(DialogInterface dialogInterface, int r32) {
        this.mMenu.performItemAction((MenuItemImpl) this.mPresenter.getAdapter().getItem(r32), 0);
    }
    ...
    public boolean onKey(DialogInterface dialogInterface, int r42, KeyEvent keyEvent) {
        Window window;
        View decorView;
        ...
        return this.mMenu.performShortcut(r42, keyEvent, 0);
    }
