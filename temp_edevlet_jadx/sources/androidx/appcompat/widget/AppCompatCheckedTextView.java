...
public class AppCompatCheckedTextView extends CheckedTextView implements TintableCheckedTextView, TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    public AppCompatCheckedTextView(@NonNull Context context, @Nullable AttributeSet attributeSet, int r32) {
        ...
        appCompatCheckedTextViewHelper.loadFromAttributes(attributeSet, r32);
        getEmojiTextViewHelper().loadFromAttributes(attributeSet, r32);
    }
    ...
    public void setCheckMarkDrawable(@DrawableRes int r22) {
        setCheckMarkDrawable(AppCompatResources.getDrawable(getContext(), r22));
    }
    ...
    @Override // android.widget.TextView
    public void setTextAppearance(@NonNull Context context, int r32) {
