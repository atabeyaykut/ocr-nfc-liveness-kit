...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onLayout(boolean z10, int r6, int r72, int r82, int r92) {
        ...
        int right;
        View view;
        super.onLayout(z10, r6, r72, r82, r92);
        ...
        if (view2 != null && view2.getVisibility() != 8) {
            ...
            int r22 = layoutParams.bottomMargin;
            view2.layout(r6, measuredHeight2 - r22, r82, measuredHeight - r22);
        }
        if (this.mIsSplit) {
            Drawable drawable3 = this.mSplitBackground;
            if (drawable3 != null) {
    ...
    */
    ...
    @Override // android.view.ViewGroup, android.view.ViewParent
    public ActionMode startActionModeForChild(View view, ActionMode.Callback callback, int r32) {
        if (r32 != 0) {
            return super.startActionModeForChild(view, callback, r32);
        }
        return null;
    }
