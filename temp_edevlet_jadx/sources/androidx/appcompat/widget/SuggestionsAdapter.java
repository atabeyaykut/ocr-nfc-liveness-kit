...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) throws PackageManager.NameNotFoundException {
        ...
        StringBuilder sbE = v.e("Invalid icon resource ", iconResource, " for ");
        sbE.append(componentName.flattenToShortString());
        string = sbE.toString();
    ...
    private Drawable getDrawableFromResourceValue(String str) throws NumberFormatException, IOException {
        ...
        try {
            int r22 = Integer.parseInt(str);
            String str2 = "android.resource://" + this.mProviderContext.getPackageName() + "/" + r22;
            Drawable drawableCheckIconCache = checkIconCache(str2);
            if (drawableCheckIconCache != null) {
                return drawableCheckIconCache;
            }
            Drawable drawable = ContextCompat.getDrawable(this.mProviderContext, r22);
    ...
    private Drawable getIcon1(Cursor cursor) throws NumberFormatException, IOException {
        int r02 = this.mIconName1Col;
        if (r02 == -1) {
            return null;
        }
        Drawable drawableFromResourceValue = getDrawableFromResourceValue(cursor.getString(r02));
        return drawableFromResourceValue != null ? drawableFromResourceValue : getDefaultIcon1();
    }

    private Drawable getIcon2(Cursor cursor) {
        int r02 = this.mIconName2Col;
        if (r02 == -1) {
            return null;
        }
        return getDrawableFromResourceValue(cursor.getString(r02));
    }

    private static String getStringOrNull(Cursor cursor, int r32) {
        if (r32 == -1) {
            return null;
        }
        try {
            return cursor.getString(r32);
        } catch (Exception e10) {
    ...
    private void setViewDrawable(ImageView imageView, Drawable drawable, int r32) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        int r83 = r82 != -1 ? cursor.getInt(r82) : 0;
    ...
    public View getDropDownView(int r22, View view, ViewGroup viewGroup) {
        try {
            return super.getDropDownView(r22, view, viewGroup);
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int r12) {
    ...
    public void setQueryRefinement(int r12) {
        this.mQueryRefinement = r12;
    }
}
