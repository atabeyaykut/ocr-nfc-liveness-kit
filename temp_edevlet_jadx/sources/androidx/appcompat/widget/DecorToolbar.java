...
public interface DecorToolbar {
    void animateToVisibility(int r12);
    ...
    void setNavigationContentDescription(int r12);

    void setNavigationContentDescription(CharSequence charSequence);

    void setNavigationIcon(int r12);

    void setNavigationIcon(Drawable drawable);

    void setNavigationMode(int r12);

    void setSubtitle(CharSequence charSequence);

    void setTitle(CharSequence charSequence);

    void setVisibility(int r12);

    void setWindowCallback(Window.Callback callback);

    void setWindowTitle(CharSequence charSequence);

    ViewPropertyAnimatorCompat setupAnimatorToVisibility(int r12, long j10);
