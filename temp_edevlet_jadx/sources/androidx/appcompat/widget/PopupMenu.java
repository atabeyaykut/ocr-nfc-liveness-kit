...
public class PopupMenu {
    ...
    public PopupMenu(@NonNull Context context, @NonNull View view, int r92) {
        this(context, view, r92, R.attr.popupMenuStyle, 0);
    }

    public PopupMenu(@NonNull Context context, @NonNull View view, int r11, @AttrRes int r12, @StyleRes int r13) {
    ...
    public void inflate(@MenuRes int r32) {
        getMenuInflater().inflate(r32, this.mMenu);
    }
