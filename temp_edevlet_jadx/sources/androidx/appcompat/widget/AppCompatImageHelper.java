...
public class AppCompatImageHelper {
    ...
    private boolean shouldApplyFrameworkTintUsingColorFilter() {
        ...
        return r02 > 21 ? this.mInternalImageTint != null : r02 == 21;
    }
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int r10) {
        ...
        int[] r32 = R.styleable.AppCompatImageView;
        ...
        ViewCompat.saveAttributeDataForStyleable(imageView, imageView.getContext(), r32, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), r10, 0);
        try {
            Drawable drawable = this.mView.getDrawable();
            ...
            int r92 = R.styleable.AppCompatImageView_tint;
            if (tintTypedArrayObtainStyledAttributes.hasValue(r92)) {
                ImageViewCompat.setImageTintList(this.mView, tintTypedArrayObtainStyledAttributes.getColorStateList(r92));
            }
            int r93 = R.styleable.AppCompatImageView_tintMode;
            if (tintTypedArrayObtainStyledAttributes.hasValue(r93)) {
                ImageViewCompat.setImageTintMode(this.mView, DrawableUtils.parseTintMode(tintTypedArrayObtainStyledAttributes.getInt(r93, -1), null));
            }
        } finally {
    ...
    public void setImageResource(int r22) {
        if (r22 != 0) {
            Drawable drawable = AppCompatResources.getDrawable(this.mView.getContext(), r22);
            if (drawable != null) {
                DrawableUtils.fixDrawable(drawable);
            }
            this.mView.setImageDrawable(drawable);
