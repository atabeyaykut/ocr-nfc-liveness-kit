...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public int getCount() {
            ...
            int r02 = Math.min(activityCount, this.mMaxActivityCount);
            return this.mShowFooterView ? r02 + 1 : r02;
        }
        ...
        public Object getItem(int r22) {
            int itemViewType = getItemViewType(r22);
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    return null;
                }
            ...
            return this.mDataModel.getActivity(r22);
        }
        ...
        public int getItemViewType(int r32) {
            return (this.mShowFooterView && r32 == getCount() - 1) ? 1 : 0;
        }
        ...
        public int measureContentWidth() {
            int r02 = this.mMaxActivityCount;
            this.mMaxActivityCount = Integer.MAX_VALUE;
            int r22 = View.MeasureSpec.makeMeasureSpec(0, 0);
            int r32 = View.MeasureSpec.makeMeasureSpec(0, 0);
            int count = getCount();
            View view = null;
            int r6 = 0;
            for (int r12 = 0; r12 < count; r12++) {
                view = getView(r12, view, null);
                view.measure(r22, r32);
                r6 = Math.max(r6, view.getMeasuredWidth());
            }
            this.mMaxActivityCount = r02;
            return r6;
        }
        ...
        public void setMaxActivityCount(int r22) {
            if (this.mMaxActivityCount != r22) {
                this.mMaxActivityCount = r22;
                notifyDataSetChanged();
            }
        }
    ...
    public class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int r32, long j10) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
            int itemViewType = ((ActivityChooserViewAdapter) adapterView.getAdapter()).getItemViewType(r32);
            if (itemViewType != 0) {
                if (itemViewType != 1) {
                    throw new IllegalArgumentException();
                }
            ...
            if (activityChooserView.mIsSelectingDefaultActivity) {
                if (r32 > 0) {
                    activityChooserView.mAdapter.getDataModel().setDefaultActivity(r32);
                    return;
                }
                return;
            }
            ...
            Intent intentChooseActivity = ActivityChooserView.this.mAdapter.getDataModel().chooseActivity(r32);
            if (intentChooseActivity != null) {
                intentChooseActivity.addFlags(524288);
                ActivityChooserView.this.getContext().startActivity(intentChooseActivity);
            }
    ...
    public ActivityChooserView(@NonNull Context context, @Nullable AttributeSet attributeSet, int r12) {
        ...
        int[] r32 = R.styleable.ActivityChooserView;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, r32, r12, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, r32, attributeSet, typedArrayObtainStyledAttributes, r12, 0);
        ...
        int r13 = R.id.image;
        this.mDefaultActivityButtonImage = (ImageView) frameLayout.findViewById(r13);
        ...
        ImageView imageView = (ImageView) frameLayout2.findViewById(r13);
    ...
    public void onLayout(boolean z10, int r22, int r32, int r42, int r52) {
        this.mActivityChooserContent.layout(0, 0, r42 - r22, r52 - r32);
        if (isShowingPopup()) {
            return;
        }
        dismissPopup();
    ...
    public void onMeasure(int r32, int r42) {
        ...
        if (this.mDefaultActivityButton.getVisibility() != 0) {
            r42 = View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(r42), 1073741824);
        }
        measureChild(view, r32, r42);
    ...
    public void setDefaultActionButtonContentDescription(int r12) {
        this.mDefaultActionButtonContentDescription = r12;
    }

    public void setExpandActivityOverflowButtonContentDescription(int r22) {
        this.mExpandActivityOverflowButtonImage.setContentDescription(getContext().getString(r22));
    }
    ...
    public void setInitialActivityCount(int r12) {
        this.mInitialActivityCount = r12;
    }
    ...
    public void showPopupUnchecked(int r6) throws IllegalAccessException, NoSuchFieldException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (r6 == Integer.MAX_VALUE || activityCount <= r6 + r02) {
        ...
        activityChooserViewAdapter.setMaxActivityCount(r6);
