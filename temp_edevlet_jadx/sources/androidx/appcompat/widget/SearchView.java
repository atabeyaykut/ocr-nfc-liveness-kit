...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        public static void setInputMethodMode(SearchAutoComplete searchAutoComplete, int r12) {
    ...
    public interface OnSuggestionListener {
        boolean onSuggestionClick(int r12);

        boolean onSuggestionSelect(int r12);
    }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attributeSet, int r32) {
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (r12 < 600) {
                return (r12 < 640 || r22 < 480) ? 160 : 192;
            }
            return 192;
        }
        ...
        public void onFocusChanged(boolean z10, int r22, Rect rect) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            super.onFocusChanged(z10, r22, rect);
            this.mSearchView.onTextFocusChanged();
        }

        @Override // android.widget.AutoCompleteTextView, android.widget.TextView, android.view.View
        public boolean onKeyPreIme(int r32, KeyEvent keyEvent) {
            if (r32 == 4) {
            ...
            return super.onKeyPreIme(r32, keyEvent);
        }
    ...
    public SearchView(@NonNull Context context, @Nullable AttributeSet attributeSet, int r19) {
        ...
        this.mTextKeyListener = new View.OnKeyListener() { // from class: androidx.appcompat.widget.SearchView.6
            ...
            public boolean onKey(View view, int r52, KeyEvent keyEvent) {
                SearchView searchView = SearchView.this;
                if (searchView.mSearchable == null) {
                    return false;
                }
                if (searchView.mSearchSrcTextView.isPopupShowing() && SearchView.this.mSearchSrcTextView.getListSelection() != -1) {
                    return SearchView.this.onSuggestionsKey(view, r52, keyEvent);
                }
                if (SearchView.this.mSearchSrcTextView.isEmpty() || !keyEvent.hasNoModifiers() || keyEvent.getAction() != 1 || r52 != 66) {
                    return false;
                }
        ...
        TextView.OnEditorActionListener onEditorActionListener = new TextView.OnEditorActionListener() { // from class: androidx.appcompat.widget.SearchView.7
            ...
            public boolean onEditorAction(TextView textView, int r22, KeyEvent keyEvent) {
        ...
        AdapterView.OnItemClickListener onItemClickListener = new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.widget.SearchView.8
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int r32, long j10) {
                SearchView.this.onItemClicked(r32, 0, null);
            }
        };
        ...
        AdapterView.OnItemSelectedListener onItemSelectedListener = new AdapterView.OnItemSelectedListener() { // from class: androidx.appcompat.widget.SearchView.9
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int r32, long j10) {
                SearchView.this.onItemSelected(r32);
            }
        ...
        int[] r22 = R.styleable.SearchView;
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, r22, r19, 0);
        ViewCompat.saveAttributeDataForStyleable(this, context, r22, attributeSet, tintTypedArrayObtainStyledAttributes.getWrappedTypeArray(), r19, 0);
        ...
        int r12 = R.styleable.SearchView_searchIcon;
        imageView.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(r12));
        ...
        imageView5.setImageDrawable(tintTypedArrayObtainStyledAttributes.getDrawable(r12));
        ...
        int r13 = tintTypedArrayObtainStyledAttributes.getInt(R.styleable.SearchView_android_imeOptions, -1);
        if (r13 != -1) {
            setImeOptions(r13);
        }
        int r14 = tintTypedArrayObtainStyledAttributes.getInt(R.styleable.SearchView_android_inputType, -1);
        if (r14 != -1) {
            setInputType(r14);
        }
        ...
        if (viewFindViewById3 != null) {
            viewFindViewById3.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: androidx.appcompat.widget.SearchView.4
                ...
                public void onLayoutChange(View view, int r23, int r32, int r42, int r52, int r6, int r72, int r82, int r92) {
    ...
    private void getChildBoundsWithinSearchView(View view, Rect rect) {
        ...
        int r23 = r22 - r32[1];
        int r03 = r02[0] - r32[0];
        rect.set(r03, r23, view.getWidth() + r03, view.getHeight() + r23);
    }
    ...
    private boolean launchSuggestion(int r22, int r32, String str) {
        Cursor cursor = this.mSuggestionsAdapter.getCursor();
        if (cursor == null || !cursor.moveToPosition(r22)) {
            return false;
        }
        launchIntent(createIntentFromSuggestion(cursor, r32, str));
        return true;
    }
    ...
    private void rewriteQueryFromSuggestion(int r32) {
        ...
        if (!cursor.moveToPosition(r32) || (charSequenceConvertToString = this.mSuggestionsAdapter.convertToString(cursor)) == null) {
            setQuery(text);
        } else {
    ...
    private void updateViewsVisibility(boolean z10) {
        ...
        int r22 = z10 ? 0 : 8;
        boolean z11 = !TextUtils.isEmpty(this.mSearchSrcTextView.getText());
        this.mSearchButton.setVisibility(r22);
    ...
    private void updateVoiceButton(boolean z10) {
        ...
        this.mVoiceButton.setVisibility(r12);
    }
    ...
    public void launchQuerySearch(int r82, String str, String str2) {
        getContext().startActivity(createIntent("android.intent.action.SEARCH", null, null, str2, r82, str));
    }
    ...
    public boolean onItemClicked(int r12, int r22, String str) {
        OnSuggestionListener onSuggestionListener = this.mOnSuggestionListener;
        if (onSuggestionListener != null && onSuggestionListener.onSuggestionClick(r12)) {
            return false;
        }
        launchSuggestion(r12, 0, null);
        this.mSearchSrcTextView.setImeVisibility(false);
        dismissSuggestions();
        return true;
    }

    public boolean onItemSelected(int r22) {
        OnSuggestionListener onSuggestionListener = this.mOnSuggestionListener;
        if (onSuggestionListener != null && onSuggestionListener.onSuggestionSelect(r22)) {
            return false;
        }
        rewriteQueryFromSuggestion(r22);
        return true;
    }
    ...
    public void onLayout(boolean z10, int r22, int r32, int r42, int r52) {
        ...
        if (z10) {
            ...
            rect.set(rect2.left, 0, rect2.right, r52 - r32);
    ...
    */
    ...
    public boolean onSuggestionsKey(View view, int r32, KeyEvent keyEvent) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        if (this.mSearchable != null && this.mSuggestionsAdapter != null && keyEvent.getAction() == 0 && keyEvent.hasNoModifiers()) {
            if (r32 == 66 || r32 == 84 || r32 == 61) {
                return onItemClicked(this.mSearchSrcTextView.getListSelection(), 0, null);
            }
            if (r32 == 21 || r32 == 22) {
                this.mSearchSrcTextView.setSelection(r32 == 21 ? 0 : this.mSearchSrcTextView.length());
    ...
    @Override // android.view.ViewGroup, android.view.View
    public boolean requestFocus(int r32, Rect rect) {
        if (this.mClearingFocus || !isFocusable()) {
            return false;
        }
        if (isIconified()) {
            return super.requestFocus(r32, rect);
        }
        boolean zRequestFocus = this.mSearchSrcTextView.requestFocus(r32, rect);
        if (zRequestFocus) {
            updateViewsVisibility(false);
        }
    ...
    public void setImeOptions(int r22) {
        this.mSearchSrcTextView.setImeOptions(r22);
    }

    public void setInputType(int r22) {
        this.mSearchSrcTextView.setInputType(r22);
    }
    ...
    public void updateFocusedState() {
        int[] r02 = this.mSearchSrcTextView.hasFocus() ? ViewGroup.FOCUSED_STATE_SET : ViewGroup.EMPTY_STATE_SET;
