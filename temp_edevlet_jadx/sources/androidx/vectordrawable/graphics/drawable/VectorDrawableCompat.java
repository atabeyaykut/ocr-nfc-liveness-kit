...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public static class VFullPath extends VPath {
        ...
        private Paint.Cap getStrokeLineCap(int r22, Paint.Cap cap) {
            return r22 != 0 ? r22 != 1 ? r22 != 2 ? cap : Paint.Cap.SQUARE : Paint.Cap.ROUND : Paint.Cap.BUTT;
        }

        private Paint.Join getStrokeLineJoin(int r22, Paint.Join join) {
            return r22 != 0 ? r22 != 1 ? r22 != 2 ? join : Paint.Join.BEVEL : Paint.Join.ROUND : Paint.Join.MITER;
        }
        ...
        @Override // androidx.vectordrawable.graphics.drawable.VectorDrawableCompat.VObject
        public boolean onStateChanged(int[] r32) {
            return this.mStrokeColor.onStateChanged(r32) | this.mFillColor.onStateChanged(r32);
        }
        ...
        public void setStrokeColor(int r22) {
            this.mStrokeColor.setColor(r22);
        }
    ...
    public static class VGroup extends VObject {
        ...
        public VGroup(VGroup vGroup, ArrayMap<String, Object> arrayMap) {
            ...
            for (int r02 = 0; r02 < arrayList.size(); r02++) {
                VObject vObject = arrayList.get(r02);
        ...
        @Override // androidx.vectordrawable.graphics.drawable.VectorDrawableCompat.VObject
        public boolean isStateful() {
            for (int r12 = 0; r12 < this.mChildren.size(); r12++) {
                if (this.mChildren.get(r12).isStateful()) {
                    return true;
                }
            }
            return false;
        ...
        @Override // androidx.vectordrawable.graphics.drawable.VectorDrawableCompat.VObject
        public boolean onStateChanged(int[] r42) {
            boolean zOnStateChanged = false;
            for (int r02 = 0; r02 < this.mChildren.size(); r02++) {
                zOnStateChanged |= this.mChildren.get(r02).onStateChanged(r42);
            }
    ...
    public static abstract class VObject {
        ...
        public boolean onStateChanged(int[] r12) {
            return false;
        }
    }
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int r12 = 0; r12 < pathDataNodeArr.length; r12++) {
                ...
                sbE.append(pathDataNodeArr[r12].mType);
                sbE.append(":");
                string = sbE.toString();
                for (float f : pathDataNodeArr[r12].mParams) {
                    StringBuilder sbE2 = a.e(string);
                    sbE2.append(f);
                    sbE2.append(",");
        ...
        public void printVPath(int r42) {
            String strF = "";
            for (int r12 = 0; r12 < r42; r12++) {
                strF = android.support.v4.media.a.f(strF, "    ");
            }
            StringBuilder sbI = b.i(strF, "current path is :");
            sbI.append(this.mPathName);
            sbI.append(" pathData is ");
            sbI.append(nodesToString(this.mNodes));
            Log.v(VectorDrawableCompat.LOGTAG, sbI.toString());
        }
    ...
    public static class VPathRenderer {
        ...
        private static float cross(float f, float f10, float f11, float f12) {
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int r11, int r12, ColorFilter colorFilter) {
            ...
            float f10 = r12 / this.mViewportHeight;
            float fMin = Math.min(f, f10);
            Matrix matrix = vGroup.mStackedMatrix;
            this.mFinalPathMatrix.set(matrix);
            this.mFinalPathMatrix.postScale(f, f10);
            ...
            float f11 = vFullPath.mTrimPathStart;
            if (f11 != 0.0f || vFullPath.mTrimPathEnd != 1.0f) {
                float f12 = vFullPath.mTrimPathOffset;
                float f13 = (f11 + f12) % 1.0f;
                float f14 = (vFullPath.mTrimPathEnd + f12) % 1.0f;
                ...
                path.reset();
                if (f15 > f16) {
                    this.mPathMeasure.getSegment(f15, length, path, true);
                    this.mPathMeasure.getSegment(0.0f, f16, path, true);
                } else {
                    this.mPathMeasure.getSegment(f15, f16, path, true);
                }
        ...
        public void draw(Canvas canvas, int r92, int r10, ColorFilter colorFilter) {
            drawGroupTree(this.mRootGroup, IDENTITY_MATRIX, canvas, r92, r10, colorFilter);
        }
        ...
        public boolean onStateChanged(int[] r22) {
            return this.mRootGroup.onStateChanged(r22);
        }
    ...
    public static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public boolean canReuseBitmap(int r22, int r32) {
            return r22 == this.mCachedBitmap.getWidth() && r32 == this.mCachedBitmap.getHeight();
        }
        ...
        public void createCachedBitmapIfNeeded(int r22, int r32) {
            if (this.mCachedBitmap == null || !canReuseBitmap(r22, r32)) {
                this.mCachedBitmap = Bitmap.createBitmap(r22, r32, Bitmap.Config.ARGB_8888);
        ...
        public boolean onStateChanged(int[] r22) {
            boolean zOnStateChanged = this.mVPathRenderer.onStateChanged(r22);
        ...
        public void updateCachedBitmap(int r42, int r52) {
            this.mCachedBitmap.eraseColor(0);
            this.mVPathRenderer.draw(new Canvas(this.mCachedBitmap), r42, r52, null);
        }
    }
    ...
    public static int applyAlpha(int r22, float f) {
        return (r22 & ViewCompat.MEASURED_SIZE_MASK) | (((int) (Color.alpha(r22) * f)) << 24);
    }

    @Nullable
    public static VectorDrawableCompat create(@NonNull Resources resources, @DrawableRes int r72, @Nullable Resources.Theme theme) {
        int next;
        if (Build.VERSION.SDK_INT >= 24) {
            VectorDrawableCompat vectorDrawableCompat = new VectorDrawableCompat();
            vectorDrawableCompat.mDelegateDrawable = ResourcesCompat.getDrawable(resources, r72, theme);
            ...
            if (eventType == 2) {
                ...
                if (SHAPE_PATH.equals(name)) {
                    ...
                    if (SHAPE_CLIP_PATH.equals(name)) {
                        ...
                        r72 = vectorDrawableCompatState.mChangingConfigurations;
                        r32 = vClipPath.mChangingConfigurations;
                        ...
                        r72 = vectorDrawableCompatState.mChangingConfigurations;
                        r32 = vGroup2.mChangingConfigurations;
                    }
                    vectorDrawableCompatState.mChangingConfigurations = r32 | r72;
                }
    ...
    private static PorterDuff.Mode parseTintModeCompat(int r12, PorterDuff.Mode mode) {
        if (r12 == 3) {
    ...
    private void printGroupTree(VGroup vGroup, int r6) {
        ...
        StringBuilder sbI = b.i(strF, "current group is :");
        sbI.append(vGroup.getGroupName());
        sbI.append(" rotation is ");
        sbI.append(vGroup.mRotate);
        Log.v(LOGTAG, sbI.toString());
        Log.v(LOGTAG, strF + "matrix is :" + vGroup.getLocalMatrix().toString());
        for (int r12 = 0; r12 < vGroup.mChildren.size(); r12++) {
    ...
    public void draw(Canvas canvas) {
        ...
        int r12 = Math.min(2048, (int) (this.mTmpBounds.width() * fAbs));
        int r32 = Math.min(2048, (int) (this.mTmpBounds.height() * fAbs2));
        if (r12 <= 0 || r32 <= 0) {
            return;
        }
        int r42 = canvas.save();
    ...
    public float getPixelSize() {
        ...
        float f10 = vPathRenderer.mBaseHeight;
        if (f10 == 0.0f) {
            return 1.0f;
        }
        float f11 = vPathRenderer.mViewportHeight;
        if (f11 == 0.0f) {
            return 1.0f;
        }
        float f12 = vPathRenderer.mViewportWidth;
        if (f12 == 0.0f) {
            return 1.0f;
        }
    ...
    public void setAlpha(int r22) {
        ...
        } else if (this.mVectorState.mVPathRenderer.getRootAlpha() != r22) {
            this.mVectorState.mVPathRenderer.setRootAlpha(r22);
            invalidateSelf();
        }
    }
    ...
    @Override // androidx.vectordrawable.graphics.drawable.VectorDrawableCommon, android.graphics.drawable.Drawable
    public /* bridge */ /* synthetic */ void setChangingConfigurations(int r12) {
        super.setChangingConfigurations(r12);
    }

    @Override // androidx.vectordrawable.graphics.drawable.VectorDrawableCommon, android.graphics.drawable.Drawable
    public /* bridge */ /* synthetic */ void setColorFilter(int r12, PorterDuff.Mode mode) {
        super.setColorFilter(r12, mode);
    }
    ...
    @Override // androidx.vectordrawable.graphics.drawable.VectorDrawableCommon, android.graphics.drawable.Drawable
    public /* bridge */ /* synthetic */ boolean setState(int[] r12) {
        return super.setState(r12);
    }
    ...
    public void setTint(int r22) {
        Drawable drawable = this.mDelegateDrawable;
        if (drawable != null) {
            DrawableCompat.setTint(drawable, r22);
        } else {
