...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
            ...
            if (animatedVectorDrawableCompatState != null) {
                ...
                if (arrayList != null) {
                    ...
                    for (int r02 = 0; r02 < size; r02++) {
                        Animator animator = animatedVectorDrawableCompatState.mAnimators.get(r02);
    ...
    @Nullable
    public static AnimatedVectorDrawableCompat create(@NonNull Context context, @DrawableRes int r72) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
        if (Build.VERSION.SDK_INT >= 24) {
            AnimatedVectorDrawableCompat animatedVectorDrawableCompat = new AnimatedVectorDrawableCompat(context);
            Drawable drawable = ResourcesCompat.getDrawable(context.getResources(), r72, context.getTheme());
        ...
        try {
            XmlResourceParser xml = context.getResources().getXml(r72);
    ...
    private void setupColorAnimator(Animator animator) {
        ...
        if ((animator instanceof AnimatorSet) && (childAnimations = ((AnimatorSet) animator).getChildAnimations()) != null) {
            for (int r12 = 0; r12 < childAnimations.size(); r12++) {
                setupColorAnimator(childAnimations.get(r12));
            }
        }
    ...
    public boolean onLevelChange(int r22) {
        Drawable drawable = this.mDelegateDrawable;
        return drawable != null ? drawable.setLevel(r22) : this.mAnimatedVectorState.mVectorDrawable.setLevel(r22);
    }

    @Override // android.graphics.drawable.Drawable
    public boolean onStateChange(int[] r22) {
        Drawable drawable = this.mDelegateDrawable;
        return drawable != null ? drawable.setState(r22) : this.mAnimatedVectorState.mVectorDrawable.setState(r22);
    }
            ...
            this.mAnimatorListener = new AnimatorListenerAdapter() { // from class: androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat.2
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    for (int r12 = 0; r12 < size; r12++) {
                        ((Animatable2Compat.AnimationCallback) arrayList.get(r12)).onAnimationEnd(AnimatedVectorDrawableCompat.this);
                    }
                }
                ...
                public void onAnimationStart(Animator animator) {
                    ...
                    int size = arrayList.size();
                    for (int r12 = 0; r12 < size; r12++) {
                        ((Animatable2Compat.AnimationCallback) arrayList.get(r12)).onAnimationStart(AnimatedVectorDrawableCompat.this);
                    }
                }
            };
        }
    ...
    public void setAlpha(int r22) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setAlpha(r22);
        }
    }
    ...
    public void setTint(int r22) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setTint(r22);
        }
    }
