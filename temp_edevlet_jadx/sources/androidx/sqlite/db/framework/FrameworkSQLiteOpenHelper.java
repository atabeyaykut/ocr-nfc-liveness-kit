...
class FrameworkSQLiteOpenHelper implements SupportSQLiteOpenHelper {
    ...
    public static class OpenHelper extends SQLiteOpenHelper {
        ...
        @Override // android.database.sqlite.SQLiteOpenHelper
        public void onDowngrade(SQLiteDatabase sQLiteDatabase, int r32, int r42) {
            this.mMigrated = true;
            this.mCallback.onDowngrade(getWrappedDb(sQLiteDatabase), r32, r42);
        }
        ...
        @Override // android.database.sqlite.SQLiteOpenHelper
        public void onUpgrade(SQLiteDatabase sQLiteDatabase, int r32, int r42) {
            this.mMigrated = true;
            this.mCallback.onUpgrade(getWrappedDb(sQLiteDatabase), r32, r42);
        }
    }
