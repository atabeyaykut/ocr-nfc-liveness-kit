...
public class Registry {
    ...
    public void setDrawDebug(String str, int r32) {
        RegistryCallback registryCallback = this.mCallbacks.get(str);
        if (registryCallback != null) {
            registryCallback.setDrawDebug(r32);
        }
    }

    public void setLayoutInformationMode(String str, int r32) {
        RegistryCallback registryCallback = this.mCallbacks.get(str);
        if (registryCallback != null) {
            registryCallback.setLayoutInformationMode(r32);
        }
    }
    ...
    public void updateDimensions(String str, int r32, int r42) {
        RegistryCallback registryCallback = this.mCallbacks.get(str);
        if (registryCallback != null) {
            registryCallback.onDimensions(r32, r42);
        }
    }
