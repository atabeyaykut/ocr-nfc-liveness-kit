...
public class ConstraintReference implements Reference {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            int[] r02 = new int[State.Constraint.values().length];
            $SwitchMap$androidx$constraintlayout$core$state$State$Constraint = r02;
            try {
                r02[State.Constraint.LEFT_TO_LEFT.ordinal()] = 1;
    ...
    private void applyConnection(ConstraintWidget constraintWidget, Object obj, State.Constraint constraint) {
        ...
        int[] r82 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint;
        int r03 = r82[constraint.ordinal()];
        switch (r82[constraint.ordinal()]) {
            case 1:
                type = ConstraintAnchor.Type.LEFT;
                anchor = constraintWidget.getAnchor(type);
                anchor2 = target.getAnchor(type);
                r02 = this.mMarginLeft;
                r12 = this.mMarginLeftGone;
                anchor.connect(anchor2, r02, r12, false);
                break;
            case 2:
            ...
            case 5:
                ...
                r02 = this.mMarginStart;
                r12 = this.mMarginStartGone;
                anchor.connect(anchor2, r02, r12, false);
                break;
            case 6:
                anchor = constraintWidget.getAnchor(ConstraintAnchor.Type.LEFT);
            ...
            case 11:
                ...
                r02 = this.mMarginBottom;
                r12 = this.mMarginBottomGone;
                anchor.connect(anchor2, r02, r12, false);
                break;
            case 12:
            ...
            case 13:
                ...
                r42 = this.mMarginBaseline;
                r52 = this.mMarginBaselineGone;
                constraintWidget2 = constraintWidget;
                constraintWidget2.immediateConnect(type7, target, type8, r42, r52);
                break;
            case 14:
                type7 = ConstraintAnchor.Type.BASELINE;
    ...
    public void addCustomColor(String str, int r32) {
        this.mCustomColors.put(str, Integer.valueOf(r32));
    }
    ...
    public void apply() {
        ...
        int r02 = this.mHorizontalChainStyle;
        if (r02 != 0) {
            this.mConstraintWidget.setHorizontalChainStyle(r02);
        }
        int r03 = this.mVerticalChainStyle;
        if (r03 != 0) {
            this.mConstraintWidget.setVerticalChainStyle(r03);
        }
        float f = this.mHorizontalChainWeight;
        if (f != -1.0f) {
            this.mConstraintWidget.setHorizontalWeight(f);
        }
        float f10 = this.mVerticalChainWeight;
        if (f10 != -1.0f) {
            this.mConstraintWidget.setVerticalWeight(f10);
        }
        ...
        int r22 = this.mVisibility;
        widgetFrame.visibility = r22;
        constraintWidget.setVisibility(r22);
    ...
    */
    ...
    public ConstraintReference circularConstraint(Object obj, float f, float f10) {
        this.mCircularConstraint = get(obj);
        this.mCircularAngle = f;
        this.mCircularDistance = f10;
    ...
    public int getVerticalChainStyle(int r12) {
    ...
    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    public ConstraintReference margin(int r32) {
        State.Constraint constraint = this.mLast;
        if (constraint != null) {
            switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()]) {
                case 1:
                case 2:
                    this.mMarginLeft = r32;
                    break;
                case 3:
                case 4:
                    this.mMarginRight = r32;
                    break;
                case 5:
                case 6:
                    this.mMarginStart = r32;
                    break;
                case 7:
                case 8:
                    this.mMarginEnd = r32;
                ...
                case 14:
                case 15:
                    this.mMarginBaseline = r32;
                    break;
                case 16:
                    this.mCircularDistance = r32;
                    break;
            }
        } else {
            this.mMarginLeft = r32;
    ...
    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    public ConstraintReference marginGone(int r32) {
        State.Constraint constraint = this.mLast;
        if (constraint != null) {
            switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Constraint[constraint.ordinal()]) {
                case 1:
                case 2:
                    this.mMarginLeftGone = r32;
                    break;
                case 3:
                case 4:
                    this.mMarginRightGone = r32;
                    break;
                case 5:
                case 6:
                    this.mMarginStartGone = r32;
                    break;
                case 7:
                case 8:
                    this.mMarginEndGone = r32;
                    break;
                case 9:
                case 10:
                    this.mMarginTopGone = r32;
                    break;
                case 13:
                case 14:
                case 15:
                    this.mMarginBaselineGone = r32;
                    break;
            }
        } else {
            this.mMarginLeftGone = r32;
    ...
    public ConstraintReference visibility(int r12) {
