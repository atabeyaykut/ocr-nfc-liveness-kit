...
public class TransitionBuilder {
    ...
    public static MotionScene.Transition buildTransition(MotionScene motionScene, int r22, int r32, ConstraintSet constraintSet, int r52, ConstraintSet constraintSet2) {
        MotionScene.Transition transition = new MotionScene.Transition(r22, motionScene, r32, r52);
