...
public class CustomSupport {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                r02[ConstraintAttribute.AttributeType.INT_TYPE.ordinal()] = 1;
        ...
        try {
            ...
            switch (AnonymousClass1.$SwitchMap$androidx$constraintlayout$widget$ConstraintAttribute$AttributeType[constraintAttribute.getType().ordinal()]) {
                ...
                case 3:
                    ...
                    int r52 = (clamp((int) (((float) Math.pow(fArr[0], 0.45454545454545453d)) * 255.0f)) << 16) | (clamp((int) (fArr[3] * 255.0f)) << 24) | (clamp((int) (((float) Math.pow(fArr[1], 0.45454545454545453d)) * 255.0f)) << 8) | clamp((int) (((float) Math.pow(fArr[2], 0.45454545454545453d)) * 255.0f));
                    ColorDrawable colorDrawable = new ColorDrawable();
                    colorDrawable.setColor(r52);
            ...
            e = e10;
            sb2 = new StringBuilder("cannot access method ");
            sb2.append(str);
            sb2.append(" on View \"");
            ...
            e = e11;
            sb2 = new StringBuilder("no method ");
            sb2.append(str);
            sb2.append(" on View \"");
            sb2.append(Debug.getName(view));
            sb2.append("\"");
