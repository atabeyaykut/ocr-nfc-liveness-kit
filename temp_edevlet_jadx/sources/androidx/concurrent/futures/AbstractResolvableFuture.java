...
public abstract class AbstractResolvableFuture<V> implements a<V> {
    ...
    public final V get(long j10, TimeUnit timeUnit) throws ExecutionException, InterruptedException, TimeoutException {
        ...
        if (nanos + SPIN_THRESHOLD_NANOS < 0) {
            String strF2 = android.support.v4.media.a.f(strF, " (plus ");
            long j11 = -nanos;
            long jConvert = timeUnit.convert(j11, TimeUnit.NANOSECONDS);
            long nanos2 = j11 - timeUnit.toNanos(jConvert);
            boolean z10 = jConvert == 0 || nanos2 > SPIN_THRESHOLD_NANOS;
            if (jConvert > 0) {
                String strF3 = strF2 + jConvert + " " + lowerCase;
                if (z10) {
                    strF3 = android.support.v4.media.a.f(strF3, ",");
                }
                strF2 = android.support.v4.media.a.f(strF3, " ");
            }
            if (z10) {
                strF2 = strF2 + nanos2 + " nanoseconds ";
            }
            strF = android.support.v4.media.a.f(strF2, "delay)");
        }
        if (isDone()) {
            throw new TimeoutException(android.support.v4.media.a.f(strF, " but future completed as timeout expired"));
        }
        throw new TimeoutException(f.g(strF, " for ", string));
    }
    ...
    public String pendingToString() {
        Object obj = this.value;
        if (obj instanceof SetFuture) {
            return c.h(new StringBuilder("setFuture=["), userObjectToString(((SetFuture) obj).future), "]");
        }
