...
class AnimationHandler {
    ...
    public void doAnimationFrame(long j10) {
        ...
        for (int r22 = 0; r22 < this.mAnimationCallbacks.size(); r22++) {
            AnimationFrameCallback animationFrameCallback = this.mAnimationCallbacks.get(r22);
    ...
    public void removeCallback(AnimationFrameCallback animationFrameCallback) {
        this.mDelayedCallbackStartTime.remove(animationFrameCallback);
        int r32 = this.mAnimationCallbacks.indexOf(animationFrameCallback);
        if (r32 >= 0) {
            this.mAnimationCallbacks.set(r32, null);
