...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    public interface OnAnimationEndListener {
        void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z10, float f, float f10);
    }
    ...
    private void endAnimationInternal(boolean z10) {
        ...
        this.mLastFrameTime = 0L;
        this.mStartValueIsSet = false;
        for (int r02 = 0; r02 < this.mEndListeners.size(); r02++) {
            if (this.mEndListeners.get(r02) != null) {
                this.mEndListeners.get(r02).onAnimationEnd(this, z10, this.mValue, this.mVelocity);
            }
        }
    ...
    private static <T> void removeEntry(ArrayList<T> arrayList, T t10) {
        int r22 = arrayList.indexOf(t10);
        if (r22 >= 0) {
            arrayList.set(r22, null);
        }
    }
    ...
    public void setPropertyValue(float f) {
        ...
        for (int r42 = 0; r42 < this.mUpdateListeners.size(); r42++) {
            if (this.mUpdateListeners.get(r42) != null) {
                this.mUpdateListeners.get(r42).onAnimationUpdate(this, this.mValue, this.mVelocity);
            }
        }
