...
public final class NavBackStackEntry implements LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            $SwitchMap$androidx$lifecycle$Lifecycle$Event = r02;
            try {
    ...
    public NavBackStackEntry(@NonNull Context context, @NonNull NavDestination navDestination, @Nullable Bundle bundle, @Nullable LifecycleOwner lifecycleOwner, @Nullable NavControllerViewModel navControllerViewModel, @NonNull UUID r82, @Nullable Bundle bundle2) {
    ...
    public void updateState() {
        ...
        if (this.mHostLifecycle.ordinal() < this.mMaxLifecycle.ordinal()) {
            ...
            state = this.mHostLifecycle;
        } else {
            lifecycleRegistry = this.mLifecycle;
            state = this.mMaxLifecycle;
        }
