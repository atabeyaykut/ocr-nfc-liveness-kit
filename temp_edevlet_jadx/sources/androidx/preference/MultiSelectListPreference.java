...
public class MultiSelectListPreference extends DialogPreference {
    ...
    public MultiSelectListPreference(Context context, AttributeSet attributeSet, int r42) {
        this(context, attributeSet, r42, 0);
    }

    public MultiSelectListPreference(Context context, AttributeSet attributeSet, int r42, int r52) {
        super(context, attributeSet, r42, r52);
        this.mValues = new HashSet();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.MultiSelectListPreference, r42, r52);
    ...
    public boolean[] getSelectedItems() {
        ...
        for (int r42 = 0; r42 < length; r42++) {
            zArr[r42] = set.contains(charSequenceArr[r42].toString());
        }
        return zArr;
    }
    ...
    public Object onGetDefaultValue(TypedArray typedArray, int r52) {
        CharSequence[] textArray = typedArray.getTextArray(r52);
