...
public class PreferenceManager {
    ...
    public static void setDefaultValues(Context context, int r32, boolean z10) {
        setDefaultValues(context, getDefaultSharedPreferencesName(context), getDefaultSharedPreferencesMode(), r32, z10);
    }

    public static void setDefaultValues(Context context, String str, int r52, int r6, boolean z10) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(KEY_HAS_SET_DEFAULT_VALUES, 0);
        if (z10 || !sharedPreferences.getBoolean(KEY_HAS_SET_DEFAULT_VALUES, false)) {
            PreferenceManager preferenceManager = new PreferenceManager(context);
            preferenceManager.setSharedPreferencesName(str);
            preferenceManager.setSharedPreferencesMode(r52);
            preferenceManager.inflateFromResource(context, r6, null);
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public PreferenceScreen inflateFromResource(Context context, int r32, PreferenceScreen preferenceScreen) {
        setNoCommit(true);
        PreferenceScreen preferenceScreen2 = (PreferenceScreen) new PreferenceInflater(context, this).inflate(r32, preferenceScreen);
    ...
    public void setSharedPreferencesMode(int r12) {
        this.mSharedPreferencesMode = r12;
