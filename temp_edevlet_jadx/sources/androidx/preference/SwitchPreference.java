...
public class SwitchPreference extends TwoStatePreference {
    ...
    public SwitchPreference(Context context, AttributeSet attributeSet, int r42) {
        this(context, attributeSet, r42, 0);
    }

    public SwitchPreference(Context context, AttributeSet attributeSet, int r42, int r52) {
        super(context, attributeSet, r42, r52);
        this.mListener = new Listener();
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.SwitchPreference, r42, r52);
