...
public class DropDownPreference extends ListPreference {
    ...
    public DropDownPreference(Context context, AttributeSet attributeSet, int r42) {
        this(context, attributeSet, r42, 0);
    }

    public DropDownPreference(Context context, AttributeSet attributeSet, int r32, int r42) {
        ...
        this.mItemSelectedListener = new AdapterView.OnItemSelectedListener() { // from class: androidx.preference.DropDownPreference.1
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int r33, long j10) {
                if (r33 >= 0) {
                    String string = DropDownPreference.this.getEntryValues()[r33].toString();
    ...
    public void setValueIndex(int r22) {
        setValue(getEntryValues()[r22].toString());
    }
}
