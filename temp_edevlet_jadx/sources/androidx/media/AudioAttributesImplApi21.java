...
class AudioAttributesImplApi21 implements AudioAttributesImpl {
    ...
    public AudioAttributesImplApi21(AudioAttributes audioAttributes, int r22) {
        this.mAudioAttributes = audioAttributes;
        this.mLegacyStreamType = r22;
    }
    ...
    public int getLegacyStreamType() {
        int r02 = this.mLegacyStreamType;
        if (r02 != -1) {
            return r02;
        }
        ...
        try {
            ...
            Log.w(TAG, "getLegacyStreamType() failed on API: " + Build.VERSION.SDK_INT, e10);
            return -1;
        }
    }
    ...
    public Bundle toBundle() {
        ...
        int r12 = this.mLegacyStreamType;
        if (r12 != -1) {
