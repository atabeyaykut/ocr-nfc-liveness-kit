...
public class WorkTypeConverters {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            int[] r02 = new int[OutOfQuotaPolicy.values().length];
            $SwitchMap$androidx$work$OutOfQuotaPolicy = r02;
            try {
                r02[OutOfQuotaPolicy.RUN_AS_NON_EXPEDITED_WORK_REQUEST.ordinal()] = 1;
            ...
            int[] r22 = new int[NetworkType.values().length];
            $SwitchMap$androidx$work$NetworkType = r22;
            try {
                r22[NetworkType.NOT_REQUIRED.ordinal()] = 1;
            ...
            int[] r52 = new int[BackoffPolicy.values().length];
            $SwitchMap$androidx$work$BackoffPolicy = r52;
            try {
                r52[BackoffPolicy.EXPONENTIAL.ordinal()] = 1;
            ...
            int[] r53 = new int[WorkInfo.State.values().length];
            $SwitchMap$androidx$work$WorkInfo$State = r53;
            try {
                r53[WorkInfo.State.ENQUEUED.ordinal()] = 1;
    ...
    public static int backoffPolicyToInt(BackoffPolicy backoffPolicy) {
        int r02 = AnonymousClass1.$SwitchMap$androidx$work$BackoffPolicy[backoffPolicy.ordinal()];
        if (r02 == 1) {
            return 0;
        }
        if (r02 == 2) {
    ...
    */
    ...
    @TypeConverter
    public static BackoffPolicy intToBackoffPolicy(int r32) {
        if (r32 == 0) {
        ...
        throw new IllegalArgumentException(a.f("Could not convert ", r32, " to BackoffPolicy"));
    }

    @TypeConverter
    public static NetworkType intToNetworkType(int r32) {
        if (r32 == 0) {
        ...
        if (Build.VERSION.SDK_INT < 30 || r32 != 5) {
            throw new IllegalArgumentException(a.f("Could not convert ", r32, " to NetworkType"));
        }
    ...
    @NonNull
    @TypeConverter
    public static OutOfQuotaPolicy intToOutOfQuotaPolicy(int r32) {
        if (r32 == 0) {
        ...
        throw new IllegalArgumentException(a.f("Could not convert ", r32, " to OutOfQuotaPolicy"));
    }

    @TypeConverter
    public static WorkInfo.State intToState(int r32) {
        if (r32 == 0) {
        ...
        throw new IllegalArgumentException(a.f("Could not convert ", r32, " to State"));
    }
    ...
    public static int outOfQuotaPolicyToInt(@NonNull OutOfQuotaPolicy outOfQuotaPolicy) {
        int r02 = AnonymousClass1.$SwitchMap$androidx$work$OutOfQuotaPolicy[outOfQuotaPolicy.ordinal()];
        if (r02 == 1) {
            return 0;
        }
        if (r02 == 2) {
