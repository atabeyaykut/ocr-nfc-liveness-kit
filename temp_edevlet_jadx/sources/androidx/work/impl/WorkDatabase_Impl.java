        ...
        return databaseConfiguration.sqliteOpenHelperFactory.create(SupportSQLiteOpenHelper.Configuration.builder(databaseConfiguration.context).name(databaseConfiguration.name).callback(new RoomOpenHelper(databaseConfiguration, new RoomOpenHelper.Delegate(12) { // from class: androidx.work.impl.WorkDatabase_Impl.1
            ...
            public void dropAllTables(SupportSQLiteDatabase supportSQLiteDatabase) throws SQLException {
                ...
                if (((RoomDatabase) WorkDatabase_Impl.this).mCallbacks != null) {
                    ...
                    for (int r12 = 0; r12 < size; r12++) {
                        ((RoomDatabase.Callback) ((RoomDatabase) WorkDatabase_Impl.this).mCallbacks.get(r12)).onDestructiveMigration(supportSQLiteDatabase);
                    }
                }
            }
            ...
            public void onCreate(SupportSQLiteDatabase supportSQLiteDatabase) {
                if (((RoomDatabase) WorkDatabase_Impl.this).mCallbacks != null) {
                    int size = ((RoomDatabase) WorkDatabase_Impl.this).mCallbacks.size();
                    for (int r12 = 0; r12 < size; r12++) {
                        ((RoomDatabase.Callback) ((RoomDatabase) WorkDatabase_Impl.this).mCallbacks.get(r12)).onCreate(supportSQLiteDatabase);
                    }
                }
            }
            ...
            public void onOpen(SupportSQLiteDatabase supportSQLiteDatabase) throws SQLException {
                ...
                if (((RoomDatabase) WorkDatabase_Impl.this).mCallbacks != null) {
                    int size = ((RoomDatabase) WorkDatabase_Impl.this).mCallbacks.size();
                    for (int r12 = 0; r12 < size; r12++) {
                        ((RoomDatabase.Callback) ((RoomDatabase) WorkDatabase_Impl.this).mCallbacks.get(r12)).onOpen(supportSQLiteDatabase);
                    }
                }
            }
