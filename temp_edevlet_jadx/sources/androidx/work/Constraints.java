...
public final class Constraints {
    ...
    public static final class Builder {
        ...
        public Builder(@NonNull Constraints constraints) {
            ...
            if (r12 >= 23 && constraints.requiresDeviceIdle()) {
                z10 = true;
            }
    ...
    public Constraints(Builder builder) {
        ...
        this.mRequiresDeviceIdle = r02 >= 23 && builder.mRequiresDeviceIdle;
    ...
    public int hashCode() {
        int r02 = ((((((((this.mRequiredNetworkType.hashCode() * 31) + (this.mRequiresCharging ? 1 : 0)) * 31) + (this.mRequiresDeviceIdle ? 1 : 0)) * 31) + (this.mRequiresBatteryNotLow ? 1 : 0)) * 31) + (this.mRequiresStorageNotLow ? 1 : 0)) * 31;
        long j10 = this.mTriggerContentUpdateDelay;
        int r03 = (r02 + ((int) (j10 ^ (j10 >>> 32)))) * 31;
        long j11 = this.mTriggerMaxContentDelay;
        return this.mContentUriTriggers.hashCode() + ((r03 + ((int) (j11 ^ (j11 >>> 32)))) * 31);
    }
