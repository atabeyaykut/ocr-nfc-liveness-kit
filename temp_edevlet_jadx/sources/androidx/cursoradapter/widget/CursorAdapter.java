...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilter.CursorFilterClient {
    ...
    public CursorAdapter(Context context, Cursor cursor, int r32) {
        init(context, cursor, r32);
    }
    ...
    public View getDropDownView(int r22, View view, ViewGroup viewGroup) {
        ...
        this.mCursor.moveToPosition(r22);
        if (view == null) {
    ...
    public long getItemId(int r42) {
        Cursor cursor;
        if (this.mDataValid && (cursor = this.mCursor) != null && cursor.moveToPosition(r42)) {
    ...
    public View getView(int r22, View view, ViewGroup viewGroup) {
        ...
        if (!this.mCursor.moveToPosition(r22)) {
            throw new IllegalStateException(a.d("couldn't move cursor to position ", r22));
        }
        if (view == null) {
    ...
    public void init(Context context, Cursor cursor, int r6) {
