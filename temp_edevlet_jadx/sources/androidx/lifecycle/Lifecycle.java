...
public abstract class Lifecycle {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            int[] r52 = new int[State.values().length];
            $SwitchMap$androidx$lifecycle$Lifecycle$State = r52;
            try {
                r52[State.CREATED.ordinal()] = 1;
    ...
    public enum Event {
        ...
        public static Event downFrom(@NonNull State state) {
            int r12 = AnonymousClass1.$SwitchMap$androidx$lifecycle$Lifecycle$State[state.ordinal()];
            if (r12 == 1) {
                return ON_DESTROY;
            }
            if (r12 == 2) {
