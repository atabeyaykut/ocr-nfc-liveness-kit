...
public abstract class LiveData<T> {
    ...
    public static void assertMainThread(String str) {
        if (!ArchTaskExecutor.getInstance().isMainThread()) {
            throw new IllegalStateException(androidx.browser.browseractions.a.a("Cannot invoke ", str, " on a background thread"));
        }
    }
    ...
    private void considerNotify(LiveData<T>.ObserverWrapper observerWrapper) {
        if (observerWrapper.mActive) {
            ...
            int r02 = observerWrapper.mLastVersion;
            int r12 = this.mVersion;
            if (r02 >= r12) {
                return;
            }
            observerWrapper.mLastVersion = r12;
            observerWrapper.mObserver.onChanged((Object) this.mData);
        }
    }

    @MainThread
    public void changeActiveCounter(int r52) {
        int r02 = this.mActiveCount;
        this.mActiveCount = r52 + r02;
        ...
        while (true) {
            try {
                int r22 = this.mActiveCount;
                if (r02 == r22) {
                    return;
                }
                boolean z10 = r02 == 0 && r22 > 0;
                boolean z11 = r02 > 0 && r22 == 0;
                if (z10) {
                    onActive();
                } else if (z11) {
                    onInactive();
