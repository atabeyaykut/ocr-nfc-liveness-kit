...
public class ListFragment extends Fragment {
    ...
    private final AdapterView.OnItemClickListener mOnClickListener = new AdapterView.OnItemClickListener() { // from class: androidx.fragment.app.ListFragment.2
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int r92, long j10) {
            ListFragment.this.onListItemClick((ListView) adapterView, view, r92, j10);
        }
    };
    ...
    public void onListItemClick(@NonNull ListView listView, @NonNull View view, int r32, long j10) {
    }
