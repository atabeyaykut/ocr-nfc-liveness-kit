...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    public void bumpBackStackNesting(int r82) {
        if (this.mAddToBackStack) {
            if (FragmentManager.isLoggingEnabled(2)) {
                Log.v("FragmentManager", "Bump nesting in " + this + " by " + r82);
            }
            int size = this.mOps.size();
            for (int r32 = 0; r32 < size; r32++) {
                FragmentTransaction.Op op = this.mOps.get(r32);
                Fragment fragment = op.mFragment;
                if (fragment != null) {
                    fragment.mBackStackNesting += r82;
                    if (FragmentManager.isLoggingEnabled(2)) {
        ...
        while (size >= 0) {
            ...
            if (op.mFromExpandedOp) {
                if (op.mCmd == 8) {
                    ...
                    int r22 = op.mFragment.mContainerId;
                    op.mCmd = 2;
                    op.mFromExpandedOp = false;
                    for (int r12 = size - 1; r12 >= 0; r12--) {
                        FragmentTransaction.Op op2 = this.mOps.get(r12);
                        if (op2.mFromExpandedOp && op2.mFragment.mContainerId == r22) {
                            this.mOps.remove(r12);
                            size--;
                        }
                    }
                }
    ...
    @Override // androidx.fragment.app.FragmentTransaction
    public void doAddOp(int r12, Fragment fragment, @Nullable String str, int r42) {
        super.doAddOp(r12, fragment, str, r42);
    ...
    public void dump(String str, PrintWriter printWriter, boolean z10) {
        ...
        for (int r12 = 0; r12 < size; r12++) {
            FragmentTransaction.Op op = this.mOps.get(r12);
            switch (op.mCmd) {
                case 0:
                    str2 = "NULL";
                    break;
    ...
    public void executeOps() {
        ...
        for (int r22 = 0; r22 < size; r22++) {
            FragmentTransaction.Op op = this.mOps.get(r22);
            Fragment fragment = op.mFragment;
            if (fragment != null) {
    ...
    */
    ...
    public void runOnCommitRunnables() {
        if (this.mCommitRunnables != null) {
            for (int r02 = 0; r02 < this.mCommitRunnables.size(); r02++) {
                this.mCommitRunnables.get(r02).run();
            }
