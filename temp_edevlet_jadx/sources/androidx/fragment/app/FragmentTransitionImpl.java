...
public abstract class FragmentTransitionImpl {
    public static void bfsAddViewChildren(List<View> list, View view) {
        ...
        for (int r72 = size; r72 < list.size(); r72++) {
            View view2 = list.get(r72);
    ...
    private static boolean containedBeforeIndex(List<View> list, View view, int r52) {
        ...
        for (int r12 = 0; r12 < size; r12++) {
            ...
            if (transitionName != null) {
                ...
                while (true) {
                    ...
                    if (str.equals(arrayList3.get(r52))) {
                        ViewCompat.setTransitionName(arrayList2.get(r52), transitionName);
                        break;
                    }
                    r52++;
                }
        ...
        OneShotPreDrawListener.add(view, new Runnable() { // from class: androidx.fragment.app.FragmentTransitionImpl.1
            ...
            public void run() {
                for (int r02 = 0; r02 < size; r02++) {
                    ViewCompat.setTransitionName((View) arrayList2.get(r02), (String) arrayList3.get(r02));
                    ViewCompat.setTransitionName((View) arrayList.get(r02), (String) arrayList4.get(r02));
                }
            }
        });
    }
