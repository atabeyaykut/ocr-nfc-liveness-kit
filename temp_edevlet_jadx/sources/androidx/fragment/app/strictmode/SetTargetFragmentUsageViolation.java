...
public final class SetTargetFragmentUsageViolation extends TargetFragmentUsageViolation {
    ...
    public SetTargetFragmentUsageViolation(Fragment fragment, Fragment targetFragment, int r52) {
        super(fragment, "Attempting to set target fragment " + targetFragment + " with request code " + r52 + " for fragment " + fragment);
        h.f(fragment, "fragment");
        h.f(targetFragment, "targetFragment");
        this.targetFragment = targetFragment;
        this.requestCode = r52;
    }
