...
abstract class SpecialEffectsController {
    ...
    public static /* synthetic */ class AnonymousClass3 {
        ...
        static {
            int[] r02 = new int[Operation.LifecycleImpact.values().length];
            $SwitchMap$androidx$fragment$app$SpecialEffectsController$Operation$LifecycleImpact = r02;
            try {
                r02[Operation.LifecycleImpact.ADDING.ordinal()] = 1;
            ...
            int[] r32 = new int[Operation.State.values().length];
            $SwitchMap$androidx$fragment$app$SpecialEffectsController$Operation$State = r32;
            try {
                r32[Operation.State.REMOVED.ordinal()] = 1;
    ...
    public static class Operation {
        ...
        public enum State {
            ...
            @NonNull
            public static State from(int r22) {
                if (r22 == 0) {
                    return VISIBLE;
                }
                if (r22 == 4) {
                ...
                throw new IllegalArgumentException(android.support.v4.media.a.d("Unknown visibility ", r22));
            }
            ...
            public void applyState(@NonNull View view) {
                int r02;
                int r03 = AnonymousClass3.$SwitchMap$androidx$fragment$app$SpecialEffectsController$Operation$State[ordinal()];
                if (r03 == 1) {
        ...
        public final void mergeWith(@NonNull State state, @NonNull LifecycleImpact lifecycleImpact) {
            ...
            int r72 = AnonymousClass3.$SwitchMap$androidx$fragment$app$SpecialEffectsController$Operation$LifecycleImpact[lifecycleImpact.ordinal()];
            if (r72 != 1) {
                if (r72 != 2) {
                    if (r72 == 3 && this.mFinalState != State.REMOVED) {
                        if (FragmentManager.isLoggingEnabled(2)) {
    ...
    public static SpecialEffectsController getOrCreateController(@NonNull ViewGroup viewGroup, @NonNull SpecialEffectsControllerFactory specialEffectsControllerFactory) {
        int r02 = R.id.special_effects_controller_view_tag;
        Object tag = viewGroup.getTag(r02);
        ...
        viewGroup.setTag(r02, specialEffectsControllerCreateController);
