...
public abstract class FragmentPagerAdapter extends PagerAdapter {
    ...
    public FragmentPagerAdapter(@NonNull FragmentManager fragmentManager, int r32) {
    ...
    private static String makeFragmentName(int r22, long j10) {
        return "android:switcher:" + r22 + ":" + j10;
    }
    ...
    @Override // androidx.viewpager.widget.PagerAdapter
    @NonNull
    public Object instantiateItem(@NonNull ViewGroup viewGroup, int r6) {
        if (this.mCurTransaction == null) {
            this.mCurTransaction = this.mFragmentManager.beginTransaction();
        }
