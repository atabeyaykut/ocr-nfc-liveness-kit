...
class FragmentStateManager {
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            int[] r02 = new int[Lifecycle.State.values().length];
            $SwitchMap$androidx$lifecycle$Lifecycle$State = r02;
            try {
                r02[Lifecycle.State.RESUMED.ordinal()] = 1;
    ...
    public void addViewToContainer() {
        int r02 = this.mFragmentStore.findFragmentIndexInContainer(this.mFragment);
        Fragment fragment = this.mFragment;
        fragment.mContainer.addView(fragment.mView, r02);
    }
    ...
    public void attach() {
        ...
        if (fragment2 != null) {
            ...
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                ...
                throw new IllegalStateException(androidx.camera.camera2.internal.c.h(sb2, this.mFragment.mTargetWho, " that does not belong to this FragmentManager!"));
            }
        }
    ...
    public int computeExpectedState() {
        ...
        int r12 = this.mFragmentManagerState;
        int r02 = AnonymousClass2.$SwitchMap$androidx$lifecycle$Lifecycle$State[fragment.mMaxState.ordinal()];
        if (r02 != 1) {
            r12 = r02 != 2 ? r02 != 3 ? r02 != 4 ? Math.min(r12, -1) : Math.min(r12, 0) : Math.min(r12, 1) : Math.min(r12, 5);
        }
        Fragment fragment2 = this.mFragment;
        if (fragment2.mFromLayout) {
            if (fragment2.mInLayout) {
                r12 = Math.max(this.mFragmentManagerState, 2);
                View view = this.mFragment.mView;
                if (view != null && view.getParent() == null) {
                    r12 = Math.min(r12, 2);
                }
            } else {
                r12 = this.mFragmentManagerState < 4 ? Math.min(r12, fragment2.mState) : Math.min(r12, 1);
            }
        }
        ...
        if (awaitingCompletionLifecycleImpact == SpecialEffectsController.Operation.LifecycleImpact.ADDING) {
            ...
            if (fragment4.mRemoving) {
                r12 = fragment4.isInBackStack() ? Math.min(r12, 1) : Math.min(r12, -1);
            }
        }
        Fragment fragment5 = this.mFragment;
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder sbE = v.e("computeExpectedState() of ", r12, " for ");
            sbE.append(this.mFragment);
            Log.v("FragmentManager", sbE.toString());
        }
        return r12;
    }
    ...
    public void createView() throws Resources.NotFoundException {
        ...
        if (viewGroup == null) {
            int r32 = fragment2.mContainerId;
            if (r32 == 0) {
                viewGroup = null;
            } else {
                if (r32 == -1) {
    ...
    public void moveToExpectedState() {
        ...
        try {
            ...
            boolean z10 = false;
            while (true) {
                int r52 = computeExpectedState();
                Fragment fragment = this.mFragment;
                int r72 = fragment.mState;
                if (r52 == r72) {
                    if (!z10 && r72 == -1 && fragment.mRemoving && !fragment.isInBackStack() && !this.mFragment.mBeingSaved) {
                        if (FragmentManager.isLoggingEnabled(3)) {
    ...
    public void saveState() {
        ...
        if (fragment.mState <= -1 || fragmentState.mSavedFragmentState != null) {
            ...
            if (this.mFragment.mTargetWho != null) {
                ...
                int r12 = this.mFragment.mTargetRequestCode;
                if (r12 != 0) {
                    fragmentState.mSavedFragmentState.putInt(TARGET_REQUEST_CODE_STATE_TAG, r12);
                }
            }
        }
    ...
    public void setFragmentManagerState(int r12) {
        this.mFragmentManagerState = r12;
    }
