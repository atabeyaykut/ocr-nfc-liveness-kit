...
public class TransitionManager {
    ...
    public static void beginDelayedTransition(@NonNull ViewGroup viewGroup, @Nullable Transition transition) {
        ...
        Transition transitionMo28clone = transition.mo28clone();
        sceneChangeSetup(viewGroup, transitionMo28clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo28clone);
    }
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo28clone = transition.mo28clone();
        transitionMo28clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo28clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo28clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo28clone);
    }
