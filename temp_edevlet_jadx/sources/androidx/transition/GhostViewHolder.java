...
class GhostViewHolder extends FrameLayout {
    ...
    private int getInsertIndex(ArrayList<View> arrayList) {
        ...
        while (r22 <= childCount) {
            int r32 = (r22 + childCount) / 2;
            getParents(((GhostViewPort) getChildAt(r32)).mView, arrayList2);
    ...
    private static boolean isOnTop(View view, View view2) {
        ...
        for (int r22 = 0; r22 < childCount; r22++) {
            View childAt = viewGroup.getChildAt(ViewGroupUtils.getChildDrawingOrder(viewGroup, r22));
            if (childAt == view) {
                return false;
            }
            if (childAt == view2) {
    ...
    private static boolean isOnTop(ArrayList<View> arrayList, ArrayList<View> arrayList2) {
        ...
        int r22 = Math.min(arrayList.size(), arrayList2.size());
        for (int r32 = 1; r32 < r22; r32++) {
            View view = arrayList.get(r32);
            View view2 = arrayList2.get(r32);
            if (view != view2) {
                return isOnTop(view, view2);
            }
        }
        return arrayList2.size() == r22;
    }
