...
class ViewGroupUtils {
    ...
    public static int getChildDrawingOrder(@NonNull ViewGroup viewGroup, int r82) throws NoSuchMethodException, SecurityException {
        if (Build.VERSION.SDK_INT >= 29) {
            return viewGroup.getChildDrawingOrder(r82);
        }
        ...
        if (method != null) {
            try {
                return ((Integer) method.invoke(viewGroup, Integer.valueOf(viewGroup.getChildCount()), Integer.valueOf(r82))).intValue();
