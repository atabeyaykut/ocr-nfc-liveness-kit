...
public class FragmentTransitionSupport extends FragmentTransitionImpl {
    ...
    public void addTargets(Object obj, ArrayList<View> arrayList) {
        ...
        if (transition instanceof TransitionSet) {
            ...
            while (r12 < transitionCount) {
                addTargets(transitionSet.getTransitionAt(r12), arrayList);
                r12++;
            }
            return;
        }
    ...
    public Object cloneTransition(Object obj) {
        if (obj != null) {
            return ((Transition) obj).mo28clone();
        }
        return null;
    }
    ...
    public void replaceTargets(Object obj, ArrayList<View> arrayList, ArrayList<View> arrayList2) {
        ...
        if (transition instanceof TransitionSet) {
            ...
            int transitionCount = transitionSet.getTransitionCount();
            while (r12 < transitionCount) {
                replaceTargets(transitionSet.getTransitionAt(r12), arrayList, arrayList2);
                r12++;
            }
            return;
        }
        ...
        ((Transition) obj).addListener(new Transition.TransitionListener() { // from class: androidx.transition.FragmentTransitionSupport.2
            ...
            public void onTransitionEnd(@NonNull Transition transition) {
                ...
                for (int r12 = 0; r12 < size; r12++) {
                    ((View) arrayList.get(r12)).setVisibility(0);
                }
            }
    ...
    public void setSharedElementTargets(Object obj, View view, ArrayList<View> arrayList) {
        ...
        for (int r22 = 0; r22 < size; r22++) {
            FragmentTransitionImpl.bfsAddViewChildren(targets, arrayList.get(r22));
        }
        targets.add(view);
        arrayList.add(view);
