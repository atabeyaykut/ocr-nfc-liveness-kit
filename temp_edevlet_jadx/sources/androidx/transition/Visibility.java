...
public abstract class Visibility extends Transition {
    ...
    public static class DisappearListener extends AnimatorListenerAdapter implements Transition.TransitionListener, AnimatorUtils.AnimatorPauseListenerCompat {
        ...
        public DisappearListener(View view, int r32, boolean z10) {
            this.mView = view;
        ...
        @Override // androidx.transition.Transition.TransitionListener
        public void onTransitionEnd(@NonNull Transition transition) throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException {
            hideViewWhenNotCanceled();
    ...
    private void captureValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPNAME_SCREEN_LOCATION, r02);
    }
    ...
    */
    ...
    public Animator onAppear(ViewGroup viewGroup, TransitionValues transitionValues, int r52, TransitionValues transitionValues2, int r72) {
