...
public class ChangeImageTransform extends Transition {
    ...
    public static /* synthetic */ class AnonymousClass3 {
        ...
        static {
            int[] r02 = new int[ImageView.ScaleType.values().length];
            $SwitchMap$android$widget$ImageView$ScaleType = r02;
            try {
                r02[ImageView.ScaleType.FIT_XY.ordinal()] = 1;
    ...
    private static Matrix centerCropMatrix(ImageView imageView) {
        ...
        float fMax = Math.max(width / f, height / f10);
        int r22 = Math.round((width - (f * fMax)) / 2.0f);
        int r52 = Math.round((height - (f10 * fMax)) / 2.0f);
        Matrix matrix = new Matrix();
        matrix.postScale(fMax, fMax);
        matrix.postTranslate(r22, r52);
        return matrix;
    }
    ...
    private static Matrix copyImageMatrix(@NonNull ImageView imageView) {
        ...
        if (drawable.getIntrinsicWidth() > 0 && drawable.getIntrinsicHeight() > 0) {
            int r02 = AnonymousClass3.$SwitchMap$android$widget$ImageView$ScaleType[imageView.getScaleType().ordinal()];
            if (r02 == 1) {
