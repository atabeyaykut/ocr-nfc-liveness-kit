...
public class TransitionInflater {
    ...
    */
                            ...
                            if (namedString2 != null) {
                                ...
                                if (namedString3 != null) {
                                    try {
                                        ...
                                        throw new RuntimeException(b.e("Could not create ", namedString3), e10);
                                    }
                                } else {
    ...
    private void loadTransition(AttributeSet attributeSet, XmlPullParser xmlPullParser, ViewGroup viewGroup, TransitionManager transitionManager) throws Resources.NotFoundException {
        ...
        if (namedResourceId >= 0 && (transitionInflateTransition = inflateTransition(namedResourceId)) != null) {
            if (sceneForLayout2 == null) {
                throw new RuntimeException(a.d("No toScene for transition ID ", namedResourceId));
            }
    ...
    public Transition inflateTransition(int r52) throws Resources.NotFoundException {
        XmlResourceParser xml = this.mContext.getResources().getXml(r52);
        try {
            try {
    ...
    public TransitionManager inflateTransitionManager(int r42, ViewGroup viewGroup) throws Resources.NotFoundException {
        XmlResourceParser xml = this.mContext.getResources().getXml(r42);
        try {
            try {
