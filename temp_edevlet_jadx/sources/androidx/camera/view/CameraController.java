...
public abstract class CameraController {
    ...
    @NonNull
    private final m5.a<Void> mInitializationFuture;
    ...
    public static final class OutputSize {
        ...
        public OutputSize(int r22) {
            Preconditions.checkArgument(r22 != -1);
            this.mAspectRatio = r22;
    ...
    public CameraController(@NonNull Context context) {
        ...
        this.mInitializationFuture = Futures.transform(ProcessCameraProvider.getInstance(applicationContext), new Function() { // from class: androidx.camera.view.a
            ...
            public final Object apply(Object obj) {
                return this.f833a.lambda$new$0((ProcessCameraProvider) obj);
            }
        }, CameraXExecutors.mainThreadExecutor());
        this.mRotationProvider = new RotationProvider(applicationContext);
        this.mDeviceRotationListener = new androidx.camera.camera2.interop.f(1, this);
    }
    ...
    private boolean isUseCaseEnabled(int r22) {
        return (r22 & this.mEnabledUseCases) != 0;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$1(int r22) {
        this.mImageAnalysis.setTargetRotation(r22);
        this.mImageCapture.setTargetRotation(r22);
        this.mVideoCapture.setTargetRotation(r22);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$setEnabledUseCases$2(int r12) {
        this.mEnabledUseCases = r12;
    }
    ...
    private float speedUpZoomBy2X(float f) {
        return f > 1.0f ? androidx.appcompat.graphics.drawable.a.d(f, 1.0f, 2.0f, 1.0f) : 1.0f - ((1.0f - f) * 2.0f);
    }
    ...
    @MainThread
    private void unbindImageAnalysisAndRecreate(int r52, int r6) {
        ImageAnalysis.Analyzer analyzer;
        Threads.checkMainThread();
        if (isCameraInitialized()) {
            this.mCameraProvider.unbind(this.mImageAnalysis);
        }
        ImageAnalysis.Builder imageQueueDepth = new ImageAnalysis.Builder().setBackpressureStrategy(r52).setImageQueueDepth(r6);
    ...
    private void unbindImageCaptureAndRecreate(int r52) {
        if (isCameraInitialized()) {
            this.mCameraProvider.unbind(this.mImageCapture);
        }
        ImageCapture.Builder captureMode = new ImageCapture.Builder().setCaptureMode(r52);
    ...
    public m5.a<Void> enableTorch(boolean z10) {
        Threads.checkMainThread();
        if (isCameraAttached()) {
            return this.mCamera.getCameraControl().enableTorch(z10);
        }
    ...
    @NonNull
    public m5.a<Void> getInitializationFuture() {
    ...
    public boolean hasCamera(@NonNull CameraSelector cameraSelector) {
        ...
        try {
            ...
            Logger.w(TAG, "Failed to check camera availability", e10);
            return false;
        }
    }
    ...
    public void onTapToFocus(MeteringPointFactory meteringPointFactory, float f, float f10) {
        if (!isCameraAttached()) {
            Logger.w(TAG, CAMERA_NOT_ATTACHED);
            return;
        }
    ...
    public void setCameraSelector(@NonNull CameraSelector cameraSelector) {
        ...
        processCameraProvider.unbind(this.mPreview, this.mImageCapture, this.mImageAnalysis, this.mVideoCapture);
        startCameraAndTrackStates(new androidx.camera.core.impl.o(2, this, cameraSelector2));
    }

    @OptIn(markerClass = {ExperimentalVideo.class})
    @MainThread
    public void setEnabledUseCases(int r32) {
        Threads.checkMainThread();
        int r02 = this.mEnabledUseCases;
        if (r32 == r02) {
            return;
        }
        this.mEnabledUseCases = r32;
        if (!isVideoCaptureEnabled()) {
            stopRecording();
        }
        startCameraAndTrackStates(new b(r02, 0, this));
    }
    ...
    @MainThread
    public void setImageAnalysisBackpressureStrategy(int r22) {
        Threads.checkMainThread();
        if (this.mImageAnalysis.getBackpressureStrategy() == r22) {
            return;
        }
        unbindImageAnalysisAndRecreate(r22, this.mImageAnalysis.getImageQueueDepth());
        startCameraAndTrackStates();
    }

    @MainThread
    public void setImageAnalysisImageQueueDepth(int r22) {
        Threads.checkMainThread();
        if (this.mImageAnalysis.getImageQueueDepth() == r22) {
            return;
        }
        unbindImageAnalysisAndRecreate(this.mImageAnalysis.getBackpressureStrategy(), r22);
        startCameraAndTrackStates();
    }
    ...
    @MainThread
    public void setImageCaptureFlashMode(int r22) {
        Threads.checkMainThread();
        this.mImageCapture.setFlashMode(r22);
    }
    ...
    @MainThread
    public void setImageCaptureMode(int r22) {
        Threads.checkMainThread();
        if (this.mImageCapture.getCaptureMode() == r22) {
            return;
        }
        unbindImageCaptureAndRecreate(r22);
        startCameraAndTrackStates();
    }
    ...
    public void startRecording(@NonNull OutputFileOptions outputFileOptions, @NonNull Executor executor, @NonNull final OnVideoSavedCallback onVideoSavedCallback) throws IllegalStateException {
        ...
        this.mVideoCapture.lambda$startRecording$0(outputFileOptions.toVideoCaptureOutputFileOptions(), executor, new VideoCapture.OnVideoSavedCallback() { // from class: androidx.camera.view.CameraController.1
            ...
            public void onError(int r32, @NonNull String str, @Nullable Throwable th2) {
                CameraController.this.mVideoIsRecording.set(false);
                onVideoSavedCallback.onError(r32, str, th2);
            }
    ...
    public void updatePreviewViewTransform(@Nullable OutputTransform outputTransform) {
        ...
        if (outputTransform == null) {
            ...
            analyzer = this.mAnalysisAnalyzer;
