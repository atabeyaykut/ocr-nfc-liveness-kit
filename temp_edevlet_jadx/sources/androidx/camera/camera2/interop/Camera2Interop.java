...
public final class Camera2Interop {
    ...
    public static final class Extender<T> {
        ...
        public Extender<T> setCaptureRequestTemplate(int r32) {
            this.mBaseBuilder.getMutableConfig().insertOption(Camera2ImplConfig.TEMPLATE_TYPE_OPTION, Integer.valueOf(r32));
            return this;
        }
