...
public final class Camera2CameraControl {
    ...
    private final Camera2CameraControlImpl.CaptureResultListener mCaptureResultListener = new Camera2CameraControlImpl.CaptureResultListener() { // from class: androidx.camera.camera2.interop.e
        ...
        public final boolean onCaptureResult(TotalCaptureResult totalCaptureResult) {
            return this.f656a.lambda$new$0(totalCaptureResult);
        }
    };
    ...
    public /* synthetic */ Object lambda$addCaptureRequestOptions$4(CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new a(0, this, completer));
    ...
    public /* synthetic */ Object lambda$clearCaptureRequestOptions$6(CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new j(1, this, completer));
    ...
    */
    ...
    public /* synthetic */ Object lambda$setCaptureRequestOptions$2(CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new g(0, this, completer));
    ...
    @NonNull
    public m5.a<Void> addCaptureRequestOptions(@NonNull CaptureRequestOptions captureRequestOptions) {
        addCaptureRequestOptionsInternal(captureRequestOptions);
        return Futures.nonCancellationPropagating(CallbackToFutureAdapter.getFuture(new d(0, this)));
    }

    @NonNull
    public m5.a<Void> clearCaptureRequestOptions() {
        clearCaptureRequestOptionsInternal();
        return Futures.nonCancellationPropagating(CallbackToFutureAdapter.getFuture(new c(0, this)));
    }
    ...
    public void setActive(boolean z10) {
        this.mExecutor.execute(new b(this, 0, z10));
    }

    @NonNull
    public m5.a<Void> setCaptureRequestOptions(@NonNull CaptureRequestOptions captureRequestOptions) {
        clearCaptureRequestOptionsInternal();
        addCaptureRequestOptionsInternal(captureRequestOptions);
        return Futures.nonCancellationPropagating(CallbackToFutureAdapter.getFuture(new f(0, this)));
    }
}
