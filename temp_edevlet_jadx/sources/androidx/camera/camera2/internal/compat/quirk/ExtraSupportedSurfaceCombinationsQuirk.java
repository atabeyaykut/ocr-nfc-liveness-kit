...
public class ExtraSupportedSurfaceCombinationsQuirk implements Quirk {
    ...
    @NonNull
    private List<SurfaceCombination> getLimitedDeviceExtraSupportedFullConfigurations(int r22) {
    ...
    @NonNull
    public List<SurfaceCombination> getExtraSupportedSurfaceCombinations(@NonNull String str, int r32) {
        return isSamsungS7() ? getSamsungS7ExtraCombinations(str) : supportExtraFullConfigurationsSamsungDevice() ? getLimitedDeviceExtraSupportedFullConfigurations(r32) : Collections.emptyList();
    }
}
