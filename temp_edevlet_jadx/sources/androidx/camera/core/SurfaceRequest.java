...
public final class SurfaceRequest {
    ...
    private final m5.a<Void> mSessionStatusFuture;
    private final CallbackToFutureAdapter.Completer<Surface> mSurfaceCompleter;
    final m5.a<Surface> mSurfaceFuture;
    ...
    public static abstract class Result {
        ...
        @NonNull
        public static Result of(int r12, @NonNull Surface surface) {
            return new AutoValue_SurfaceRequest_Result(r12, surface);
        }
    ...
    public static abstract class TransformationInfo {
        @NonNull
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public static TransformationInfo of(@NonNull Rect rect, int r22, int r32) {
            return new AutoValue_SurfaceRequest_TransformationInfo(rect, r22, r32);
        }
    ...
    public SurfaceRequest(@NonNull Size size, @NonNull CameraInternal cameraInternal, boolean z10) {
        ...
        final m5.a future = CallbackToFutureAdapter.getFuture(new d0(1, atomicReference, str));
        ...
        m5.a<Void> future2 = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.x0
        ...
        Futures.addCallback(future2, new FutureCallback<Void>() { // from class: androidx.camera.core.SurfaceRequest.1
            ...
            public void onFailure(Throwable th2) {
                Preconditions.checkState(th2 instanceof RequestCancelledException ? future.cancel(false) : completer.set(null));
            }
        ...
        m5.a<Surface> future3 = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.y0
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
        ...
        final m5.a<Void> terminationFuture = deferrableSurface.getTerminationFuture();
        Futures.addCallback(future3, new FutureCallback<Surface>() { // from class: androidx.camera.core.SurfaceRequest.3
            @Override // androidx.camera.core.impl.utils.futures.FutureCallback
            public void onFailure(Throwable th2) {
                if (th2 instanceof CancellationException) {
                    Preconditions.checkState(completer2.setException(new RequestCancelledException(androidx.camera.camera2.internal.c.h(new StringBuilder(), str, " cancelled."), th2)));
                } else {
                    completer2.set(null);
                }
            }
        ...
        terminationFuture.addListener(new o(3, this), CameraXExecutors.directExecutor());
    }
    ...
    public void provideSurface(@NonNull final Surface surface, @NonNull Executor executor, @NonNull final Consumer<Result> consumer) throws ExecutionException, InterruptedException {
        ...
        try {
            ...
            executor.execute(new androidx.camera.camera2.interop.a(2, consumer, surface));
        } catch (InterruptedException | ExecutionException unused) {
            executor.execute(new a(3, consumer, surface));
        }
    }
    ...
    public void setTransformationInfoListener(@NonNull Executor executor, @NonNull TransformationInfoListener transformationInfoListener) {
        ...
        if (transformationInfo != null) {
            executor.execute(new i(3, transformationInfoListener, transformationInfo));
        }
    }
    ...
    public void updateTransformationInfo(@NonNull TransformationInfo transformationInfo) {
        ...
        executor.execute(new l0(1, transformationInfoListener, transformationInfo));
    }
