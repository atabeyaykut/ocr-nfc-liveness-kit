...
final class AutoValue_ResolutionInfo extends ResolutionInfo {
    ...
    public AutoValue_ResolutionInfo(Size size, Rect rect, int r32) {
        if (size == null) {
    ...
    public String toString() {
        ...
        return androidx.browser.browseractions.a.b(sb2, this.rotationDegrees, "}");
    }
}
