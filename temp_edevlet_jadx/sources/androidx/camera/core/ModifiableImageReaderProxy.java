...
class ModifiableImageReaderProxy extends AndroidImageReaderProxy {
    ...
    public void setImageRotationDegrees(int r12) {
        this.mRotationDegrees = Integer.valueOf(r12);
    }
    ...
    public void setImageTimeStamp(long j10) {
        this.mTimestamp = Long.valueOf(j10);
    }
}
