...
public final class Preview extends UseCase {
    ...
    public static final class Builder implements UseCaseConfig.Builder<Preview, PreviewConfig, Builder>, ImageOutputConfig.Builder<Builder>, ThreadConfig.Builder<Builder> {
        ...
        @NonNull
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public Builder setIsRgba8888SurfaceRequired(boolean z10) {
            getMutableConfig().insertOption(PreviewConfig.OPTION_RGBA8888_SURFACE_REQUIRED, Boolean.valueOf(z10));
            return this;
        }
        ...
        @Override // androidx.camera.core.impl.ImageOutputConfig.Builder
        @NonNull
        public Builder setTargetRotation(int r42) {
            getMutableConfig().insertOption(ImageOutputConfig.OPTION_TARGET_ROTATION, Integer.valueOf(r42));
            getMutableConfig().insertOption(ImageOutputConfig.OPTION_APP_TARGET_ROTATION, Integer.valueOf(r42));
            return this;
        }
    ...
    private boolean sendSurfaceRequestIfReady() {
        ...
        this.mSurfaceProviderExecutor.execute(new i(2, surfaceProvider, surfaceRequest));
        return true;
    }
    ...
    public SessionConfig.Builder createPipeline(@NonNull final String str, @NonNull final PreviewConfig previewConfig, @NonNull final Size size) {
        ...
        if (captureProcessor != null) {
            ...
            processingSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.core.p0
        ...
        builderCreateFrom.addErrorListener(new SessionConfig.ErrorListener() { // from class: androidx.camera.core.q0
            @Override // androidx.camera.core.impl.SessionConfig.ErrorListener
            public final void onError(SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
                this.f782a.lambda$createPipeline$0(str, previewConfig, size, sessionConfig, sessionError);
            }
        });
    ...
    public UseCaseConfig<?> onMergeConfig(@NonNull CameraInfoInternal cameraInfoInternal, @NonNull UseCaseConfig.Builder<?, ?, ?> builder) {
        ...
        mutableConfig.insertOption(option, Integer.valueOf(r12));
