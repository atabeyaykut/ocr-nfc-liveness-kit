...
public final class Logger {
    ...
    private static boolean isLogLevelEnabled(@NonNull String str, int r22) {
        return sMinLogLevel <= r22 || Log.isLoggable(str, r22);
    }
    ...
    public static void setMinLogLevel(@IntRange(from = 3, to = 6) int r02) {
        sMinLogLevel = r02;
    }
