...
final class AutoValue_ImageReaderFormatRecommender_FormatCombo extends ImageReaderFormatRecommender.FormatCombo {
    ...
    public AutoValue_ImageReaderFormatRecommender_FormatCombo(int r12, int r22) {
        this.imageCaptureFormat = r12;
        this.imageAnalysisFormat = r22;
    }
    ...
    public String toString() {
        ...
        return androidx.browser.browseractions.a.b(sb2, this.imageAnalysisFormat, "}");
    }
}
