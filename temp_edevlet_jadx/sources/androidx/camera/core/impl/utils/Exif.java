...
public final class Exif {
    ...
    public static final class Speed {
        ...
        public static Converter fromMetersPerSecond(double d10) {
    ...
    private long parseTimestamp(@Nullable String str, @Nullable String str2) {
        ...
        if (str != null) {
            return parseTimestamp(f.g(str, " ", str2));
        }
        try {
    ...
    public void copyToCroppedImage(@NonNull Exif exif) throws NumberFormatException {
    ...
    public void flipHorizontally() throws NumberFormatException {
        ...
        this.mExifInterface.setAttribute(ExifInterface.TAG_ORIENTATION, String.valueOf(r02));
    }
    ...
    public long getLastModifiedTimestamp() throws NumberFormatException {
        ...
        try {
            long j10 = Long.parseLong(attribute);
            while (j10 > 1000) {
                j10 /= 10;
            }
    ...
    */
    ...
    public void rotate(int r10) throws NumberFormatException {
        ExifInterface exifInterface;
        String strValueOf;
        if (r10 % 90 != 0) {
            Logger.w(TAG, String.format(Locale.US, "Can only rotate in right angles (eg. 0, 90, 180, 270). %d is unsupported.", Integer.valueOf(r10)));
            ...
            exifInterface = this.mExifInterface;
            strValueOf = String.valueOf(orientation);
        }
        exifInterface.setAttribute(ExifInterface.TAG_ORIENTATION, strValueOf);
    }
    ...
    public void setOrientation(int r32) throws NumberFormatException {
        this.mExifInterface.setAttribute(ExifInterface.TAG_ORIENTATION, String.valueOf(r32));
    }
