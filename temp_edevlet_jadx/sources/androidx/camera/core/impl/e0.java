...
public final /* synthetic */ class e0<T extends UseCase> {
    @NonNull
    ...
    public static int l(UseCaseConfig useCaseConfig, int r22) {
        return ((Integer) useCaseConfig.retrieveOption(UseCaseConfig.OPTION_SURFACE_OCCUPANCY_PRIORITY, Integer.valueOf(r22))).intValue();
    }
