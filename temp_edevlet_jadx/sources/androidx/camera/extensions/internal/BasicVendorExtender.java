...
public class BasicVendorExtender implements VendorExtender {
    ...
    public BasicVendorExtender(int r32) {
        ...
        try {
            ...
            this.mImageCaptureExtenderImpl = bokehImageCaptureExtenderImpl;
        } catch (NoClassDefFoundError unused) {
            Logger.e(TAG, "OEM implementation for extension mode " + r32 + "does not exist!");
        }
    }
    ...
    private Size[] getOutputSizes(int r32) {
        return ((StreamConfigurationMap) Camera2CameraInfo.from(this.mCameraInfo).getCameraCharacteristic(CameraCharacteristics.SCALER_STREAM_CONFIGURATION_MAP)).getOutputSizes(r32);
    }
    ...
    public void init(@NonNull CameraInfo cameraInfo) {
        ...
        this.mPreviewExtenderImpl.init(cameraId, cameraCharacteristicsExtractCameraCharacteristics);
        this.mImageCaptureExtenderImpl.init(cameraId, cameraCharacteristicsExtractCameraCharacteristics);
