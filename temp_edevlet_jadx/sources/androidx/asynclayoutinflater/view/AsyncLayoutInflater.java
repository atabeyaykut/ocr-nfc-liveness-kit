...
public final class AsyncLayoutInflater {
    ...
    public interface OnInflateFinishedListener {
        void onInflateFinished(@NonNull View view, @LayoutRes int r22, @Nullable ViewGroup viewGroup);
    }
    ...
    @UiThread
    public void inflate(@LayoutRes int r22, @Nullable ViewGroup viewGroup, @NonNull OnInflateFinishedListener onInflateFinishedListener) throws InterruptedException {
        ...
        inflateRequestObtainRequest.resid = r22;
