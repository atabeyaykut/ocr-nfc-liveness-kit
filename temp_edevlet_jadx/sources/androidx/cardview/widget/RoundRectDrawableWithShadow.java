...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    private void buildShadowCorners() {
        ...
        paint.setShader(new RadialGradient(0.0f, 0.0f, f13, new int[]{r6, r6, this.mShadowEndColor}, new float[]{0.0f, f12, 1.0f}, Shader.TileMode.CLAMP));
        Paint paint2 = this.mEdgeShadowPaint;
        float f14 = this.mCornerRadius;
        float f15 = this.mShadowSize;
        int r52 = this.mShadowStartColor;
        paint2.setShader(new LinearGradient(0.0f, (-f14) + f15, 0.0f, (-f14) - f15, new int[]{r52, r52, this.mShadowEndColor}, new float[]{0.0f, 0.5f, 1.0f}, Shader.TileMode.CLAMP));
    ...
    private void drawShadow(Canvas canvas) {
        ...
        float f12 = f11 * 2.0f;
        boolean z10 = this.mCardBounds.width() - f12 > 0.0f;
        boolean z11 = this.mCardBounds.height() - f12 > 0.0f;
        int r11 = canvas.save();
        RectF rectF = this.mCardBounds;
        canvas.translate(rectF.left + f11, rectF.top + f11);
        canvas.drawPath(this.mCornerShadowPath, this.mCornerShadowPaint);
        if (z10) {
            canvas.drawRect(0.0f, f10, this.mCardBounds.width() - f12, -this.mCornerRadius, this.mEdgeShadowPaint);
        }
        ...
        canvas.drawPath(this.mCornerShadowPath, this.mCornerShadowPaint);
        if (z10) {
            canvas.drawRect(0.0f, f10, this.mCardBounds.width() - f12, (-this.mCornerRadius) + this.mShadowSize, this.mEdgeShadowPaint);
        }
        ...
        canvas.drawPath(this.mCornerShadowPath, this.mCornerShadowPaint);
        if (z11) {
            canvas.drawRect(0.0f, f10, this.mCardBounds.height() - f12, -this.mCornerRadius, this.mEdgeShadowPaint);
        }
    ...
    public boolean getPadding(Rect rect) {
        int r02 = (int) Math.ceil(calculateVerticalPadding(this.mRawMaxShadowSize, this.mCornerRadius, this.mAddPaddingForCorners));
        int r12 = (int) Math.ceil(calculateHorizontalPadding(this.mRawMaxShadowSize, this.mCornerRadius, this.mAddPaddingForCorners));
    ...
    @Override // android.graphics.drawable.Drawable
    public boolean onStateChange(int[] r32) {
        ColorStateList colorStateList = this.mBackground;
        int colorForState = colorStateList.getColorForState(r32, colorStateList.getDefaultColor());
    ...
    public void setAlpha(int r22) {
        this.mPaint.setAlpha(r22);
        this.mCornerShadowPaint.setAlpha(r22);
        this.mEdgeShadowPaint.setAlpha(r22);
    }
