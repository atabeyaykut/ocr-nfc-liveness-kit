...
class RoundRectDrawable extends Drawable {
    ...
    @Override // android.graphics.drawable.Drawable
    public boolean onStateChange(int[] r42) {
        PorterDuff.Mode mode;
        ColorStateList colorStateList = this.mBackground;
        int colorForState = colorStateList.getColorForState(r42, colorStateList.getDefaultColor());
    ...
    public void setPadding(float f, boolean z10, boolean z11) {
        if (f == this.mPadding && this.mInsetForPadding == z10 && this.mInsetForRadius == z11) {
            return;
        }
        this.mPadding = f;
