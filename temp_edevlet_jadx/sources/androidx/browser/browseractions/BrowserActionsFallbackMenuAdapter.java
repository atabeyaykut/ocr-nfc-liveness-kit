...
class BrowserActionsFallbackMenuAdapter extends BaseAdapter {
    ...
    public Object getItem(int r22) {
        return this.mMenuItems.get(r22);
    }
    ...
    @Override // android.widget.Adapter
    public View getView(int r42, View view, ViewGroup viewGroup) throws Resources.NotFoundException {
        final ViewHolderItem viewHolderItem;
        BrowserActionItem browserActionItem = this.mMenuItems.get(r42);
        if (view == null) {
        ...
        if (browserActionItem.getIconId() != 0) {
            ...
            final m5.a<Bitmap> aVarLoadBitmap = BrowserServiceFileProvider.loadBitmap(this.mContext.getContentResolver(), browserActionItem.getIconUri());
            aVarLoadBitmap.addListener(new Runnable() { // from class: androidx.browser.browseractions.BrowserActionsFallbackMenuAdapter.1
                ...
                public void run() {
                    ...
                    if (TextUtils.equals(title, viewHolderItem.mText.getText())) {
                        try {
                            bitmap = (Bitmap) aVarLoadBitmap.get();
