...
public class TrustedWebActivityIntentBuilder {
    ...
    @NonNull
    public TrustedWebActivityIntentBuilder setColorScheme(int r22) {
        this.mIntentBuilder.setColorScheme(r22);
        return this;
    }

    @NonNull
    public TrustedWebActivityIntentBuilder setColorSchemeParams(int r22, @NonNull CustomTabColorSchemeParams customTabColorSchemeParams) {
        this.mIntentBuilder.setColorSchemeParams(r22, customTabColorSchemeParams);
        return this;
    }
    ...
    @NonNull
    public TrustedWebActivityIntentBuilder setNavigationBarColor(@ColorInt int r22) {
        this.mIntentBuilder.setNavigationBarColor(r22);
        return this;
    }

    @NonNull
    public TrustedWebActivityIntentBuilder setNavigationBarDividerColor(@ColorInt int r22) {
        this.mIntentBuilder.setNavigationBarDividerColor(r22);
        return this;
    }

    @NonNull
    public TrustedWebActivityIntentBuilder setScreenOrientation(int r12) {
        this.mScreenOrientation = r12;
        return this;
    }
    ...
    @NonNull
    public TrustedWebActivityIntentBuilder setToolbarColor(@ColorInt int r22) {
        this.mIntentBuilder.setToolbarColor(r22);
        return this;
    }
}
