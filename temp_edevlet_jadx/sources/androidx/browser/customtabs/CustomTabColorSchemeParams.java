...
public final class CustomTabColorSchemeParams {
    ...
    public static final class Builder {
        ...
        public Builder setNavigationBarColor(@ColorInt int r22) {
            this.mNavigationBarColor = Integer.valueOf(r22 | ViewCompat.MEASURED_STATE_MASK);
            return this;
        }

        @NonNull
        public Builder setNavigationBarDividerColor(@ColorInt int r12) {
            this.mNavigationBarDividerColor = Integer.valueOf(r12);
            return this;
        }

        @NonNull
        public Builder setSecondaryToolbarColor(@ColorInt int r12) {
            this.mSecondaryToolbarColor = Integer.valueOf(r12);
            return this;
        }

        @NonNull
        public Builder setToolbarColor(@ColorInt int r22) {
            this.mToolbarColor = Integer.valueOf(r22 | ViewCompat.MEASURED_STATE_MASK);
            return this;
        }
    }
