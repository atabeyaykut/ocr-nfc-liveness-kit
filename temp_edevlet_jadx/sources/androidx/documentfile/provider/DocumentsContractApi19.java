...
class DocumentsContractApi19 {
    ...
    public static boolean canWrite(Context context, Uri uri) {
        ...
        int r42 = queryForInt(context, uri, "flags", 0);
        ...
        if (!"vnd.android.document/directory".equals(rawType) || (r42 & 8) == 0) {
            return (TextUtils.isEmpty(rawType) || (r42 & 2) == 0) ? false : true;
        }
        return true;
    }
    ...
    private static int queryForInt(Context context, Uri uri, String str, int r52) {
        return (int) queryForLong(context, uri, str, r52);
    }

    private static long queryForLong(Context context, Uri uri, String str, long j10) throws Exception {
        Cursor cursorQuery = null;
        try {
