...
public class InstitutionServiceItemModel_ extends InstitutionServiceItemModel implements y<c>, j {
    ...
    public InstitutionServiceItemModel_ m130id(long j10) {
        super.m130id(j10);
        return this;
    }
    ...
    @Override // com.airbnb.epoxy.u
    /* renamed from: id, reason: merged with bridge method [inline-methods] */
    public InstitutionServiceItemModel_ m131id(long j10, long j11) {
    ...
    @Override // com.airbnb.epoxy.u
    /* renamed from: id, reason: merged with bridge method [inline-methods] */
    public InstitutionServiceItemModel_ m132id(@Nullable CharSequence charSequence) {
    ...
    @Override // com.airbnb.epoxy.u
    /* renamed from: id, reason: merged with bridge method [inline-methods] */
    public InstitutionServiceItemModel_ m133id(@Nullable CharSequence charSequence, long j10) {
    ...
    @Override // com.airbnb.epoxy.u
    /* renamed from: id, reason: merged with bridge method [inline-methods] */
    public InstitutionServiceItemModel_ m134id(@Nullable CharSequence charSequence, @Nullable CharSequence... charSequenceArr) {
    ...
    @Override // com.airbnb.epoxy.u
    /* renamed from: id, reason: merged with bridge method [inline-methods] */
    public InstitutionServiceItemModel_ mo135id(@Nullable Number... numberArr) {
    ...
    public InstitutionServiceItemModel_ m136layout(@LayoutRes int r12) {
    ...
    public InstitutionServiceItemModel_ m141spanSizeOverride(@Nullable u.c cVar) {
