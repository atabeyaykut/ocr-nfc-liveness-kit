...
public abstract class ElectronicServiceListItemModel extends a<ItemServiceListBinding> {
    ...
    public static final void bind$lambda$0(ElectronicServiceListItemModel this$0, View view) {
        h.f(this$0, "this$0");
        this$0.getFavoriteListener().invoke(this$0.getService());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void bind$lambda$1(ElectronicServiceListItemModel this$0, View view) {
        h.f(this$0, "this$0");
        this$0.getUnFavoriteListener().invoke(this$0.getService());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void bind$lambda$2(ElectronicServiceListItemModel this$0, View view) {
        h.f(this$0, "this$0");
    ...
    public void bind(ItemServiceListBinding itemServiceListBinding) {
        ...
        itemServiceListBinding.f16307h.setText(getService().getInstitutionName());
        itemServiceListBinding.f16306g.setText(getService().getServiceName());
        ...
        imageView.setOnClickListener(new zd.a(5, this));
        imageView2.setOnClickListener(new d(6, this));
        itemServiceListBinding.f16302b.setOnClickListener(new ie.d(4, this));
    }
