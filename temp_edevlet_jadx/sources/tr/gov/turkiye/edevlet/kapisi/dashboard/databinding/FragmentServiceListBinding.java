...
public final class FragmentServiceListBinding implements ViewBinding {
    ...
    @NonNull
    public final ConstraintLayout f16244a;

    /* renamed from: b, reason: collision with root package name */
    @NonNull
    public final ConstraintLayout f16245b;

    /* renamed from: c, reason: collision with root package name */
    @NonNull
    public final IncludeNoConnectionBinding f16246c;

    /* renamed from: d, reason: collision with root package name */
    @NonNull
    public final ProgressBar f16247d;

    /* renamed from: e, reason: collision with root package name */
    @NonNull
    public final EpoxyRecyclerView f16248e;

    @NonNull
    public final IncludeSystemErrorBinding f;

    public FragmentServiceListBinding(@NonNull ConstraintLayout constraintLayout, @NonNull ConstraintLayout constraintLayout2, @NonNull IncludeNoConnectionBinding includeNoConnectionBinding, @NonNull ProgressBar progressBar, @NonNull EpoxyRecyclerView epoxyRecyclerView, @NonNull IncludeSystemErrorBinding includeSystemErrorBinding) {
        this.f16244a = constraintLayout;
        this.f16245b = constraintLayout2;
        this.f16246c = includeNoConnectionBinding;
        this.f16247d = progressBar;
        this.f16248e = epoxyRecyclerView;
            ...
            if (progressBar != null) {
                ...
                if (epoxyRecyclerView != null) {
                    ...
                    if (viewFindChildViewById2 != null) {
                        return new FragmentServiceListBinding(constraintLayout, constraintLayout, includeNoConnectionBindingBind, progressBar, epoxyRecyclerView, IncludeSystemErrorBinding.bind(viewFindChildViewById2));
                    }
                }
            }
        }
