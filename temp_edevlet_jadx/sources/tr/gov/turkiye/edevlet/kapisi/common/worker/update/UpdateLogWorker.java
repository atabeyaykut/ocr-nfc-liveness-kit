...
public final class UpdateLogWorker extends CoroutineWorker {
    ...
    public static final class a extends c {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f16137a = obj;
            this.f16139c |= Integer.MIN_VALUE;
            return UpdateLogWorker.this.doWork(this);
        }
    }

    @e(c = "tr.gov.turkiye.edevlet.kapisi.common.worker.update.UpdateLogWorker$doWork$2", f = "UpdateLogWorker.kt", l = {32}, m = "invokeSuspend")
    public static final class b extends i implements p<a0, d<? super ListenableWorker.Result>, Object> {

        /* renamed from: a, reason: collision with root package name */
        public int f16140a;

        @e(c = "tr.gov.turkiye.edevlet.kapisi.common.worker.update.UpdateLogWorker$doWork$2$1", f = "UpdateLogWorker.kt", l = {}, m = "invokeSuspend")
        public static final class a extends i implements p<a0, d<? super ListenableWorker.Result>, Object> {

            /* renamed from: a, reason: collision with root package name */
            public final /* synthetic */ UpdateLogWorker f16142a;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public a(UpdateLogWorker updateLogWorker, d<? super a> dVar) {
                super(2, dVar);
                this.f16142a = updateLogWorker;
            }

            @Override // r9.a
            public final d<m> create(Object obj, d<?> dVar) {
                return new a(this.f16142a, dVar);
            }
            ...
            public final Object invokeSuspend(Object obj) throws Throwable {
                ...
                Result errorResult;
                UpdateLogWorker updateLogWorker = this.f16142a;
                w.F(obj);
                try {
                    String string = updateLogWorker.getInputData().getString("appId");
                    Object objB = updateLogWorker.f16135a.b(UpdateCheckerAPI.class);
                    h.e(objB, "apiClientLogin.create(Up…teCheckerAPI::class.java)");
                    try {
                        c0<UpdateLogModel> response = ((UpdateCheckerAPI) objB).updateLog("100", "S-Alert: " + string, updateLogWorker.f16136b).execute();
                    ...
                    if (errorResult instanceof Success) {
                        boolean z10 = UpdateCheckExtensionKt.completeRequest((UpdateLogModel) ((Success) errorResult).getData()) instanceof SuccessResult;
        ...
        @Override // r9.a
        public final d<m> create(Object obj, d<?> dVar) {
            return UpdateLogWorker.this.new b(dVar);
        }
        ...
        public final Object invokeSuspend(Object obj) throws Throwable {
            ...
            int r12 = this.f16140a;
            if (r12 == 0) {
                w.F(obj);
                kotlinx.coroutines.scheduling.b bVar = j0.f10809b;
                a aVar2 = new a(UpdateLogWorker.this, null);
                this.f16140a = 1;
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UpdateLogWorker(Context context, WorkerParameters workerParameters, d0 d0Var, d0 d0Var2, d0 d0Var3, d0 d0Var4, String str, String str2, String str3, SharedPreferences.Editor editor) {
    ...
    */
    public final java.lang.Object doWork(p9.d<? super androidx.work.ListenableWorker.Result> r5) throws java.lang.Throwable {
        /*
            r4 = this;
            boolean r0 = r5 instanceof tr.gov.turkiye.edevlet.kapisi.common.worker.update.UpdateLogWorker.a
            if (r0 == 0) goto L13
            r0 = r5
            tr.gov.turkiye.edevlet.kapisi.common.worker.update.UpdateLogWorker$a r0 = (tr.gov.turkiye.edevlet.kapisi.common.worker.update.UpdateLogWorker.a) r0
            int r1 = r0.f16139c
            ...
            goto L18
        L13:
            tr.gov.turkiye.edevlet.kapisi.common.worker.update.UpdateLogWorker$a r0 = new tr.gov.turkiye.edevlet.kapisi.common.worker.update.UpdateLogWorker$a
            r0.<init>(r5)
        L18:
            java.lang.Object r5 = r0.f16137a
        ...
        L2f:
            c5.w.F(r5)
            tr.gov.turkiye.edevlet.kapisi.common.worker.update.UpdateLogWorker$b r5 = new tr.gov.turkiye.edevlet.kapisi.common.worker.update.UpdateLogWorker$b
            r2 = 0
            r5.<init>(r2)
            r0.f16139c = r3
        ...
        L41:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: tr.gov.turkiye.edevlet.kapisi.common.worker.update.UpdateLogWorker.doWork(p9.d):java.lang.Object");
    }
}
