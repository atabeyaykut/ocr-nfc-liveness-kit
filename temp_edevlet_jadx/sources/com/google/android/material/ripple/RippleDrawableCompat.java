...
public class RippleDrawableCompat extends Drawable implements Shapeable, TintAwareDrawable {
    ...
    @Override // android.graphics.drawable.Drawable
    public boolean onStateChange(@NonNull int[] r52) {
        boolean zOnStateChange = super.onStateChange(r52);
        if (this.drawableState.delegate.setState(r52)) {
            zOnStateChange = true;
        }
        boolean zShouldDrawRippleCompat = RippleUtils.shouldDrawRippleCompat(r52);
        RippleDrawableCompatState rippleDrawableCompatState = this.drawableState;
    ...
    public void setAlpha(int r22) {
        this.drawableState.delegate.setAlpha(r22);
    }
    ...
    public void setTint(@ColorInt int r22) {
        this.drawableState.delegate.setTint(r22);
    }
