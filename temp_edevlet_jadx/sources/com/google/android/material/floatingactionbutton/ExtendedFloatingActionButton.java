...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        @Override // androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
        public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull ExtendedFloatingActionButton extendedFloatingActionButton, int r82) {
            ...
            coordinatorLayout.onLayoutChild(extendedFloatingActionButton, r82);
            return AUTO_SHRINK_DEFAULT;
        }
    ...
    public ExtendedFloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int r19) {
        int r92 = DEF_STYLE_RES;
        super(MaterialThemeOverlay.wrap(context, attributeSet, r19, r92), attributeSet, r19);
        this.animState = 0;
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.ExtendedFloatingActionButton, r19, r92, new int[0]);
        ...
        typedArrayObtainStyledAttributes.recycle();
        setShapeAppearanceModel(ShapeAppearanceModel.builder(context2, attributeSet, r19, r92, ShapeAppearanceModel.PILL).build());
        saveOriginalTextCsl();
    }
    ...
    public int getCollapsedSize() {
        int r02 = this.collapsedSize;
        return r02 < 0 ? (Math.min(ViewCompat.getPaddingStart(this), ViewCompat.getPaddingEnd(this)) * 2) + getIconSize() : r02;
    }
    ...
    public void setExtendMotionSpecResource(@AnimatorRes int r22) {
        setExtendMotionSpec(MotionSpec.createFromResource(getContext(), r22));
    }
    ...
    public void setPaddingRelative(int r12, int r22, int r32, int r42) {
        super.setPaddingRelative(r12, r22, r32, r42);
        if (!this.isExtended || this.isTransforming) {
            return;
        }
        this.extendedPaddingStart = r12;
        this.extendedPaddingEnd = r32;
    }
    ...
    public void setShrinkMotionSpecResource(@AnimatorRes int r22) {
        setShrinkMotionSpec(MotionSpec.createFromResource(getContext(), r22));
    }

    @Override // android.widget.TextView
    public void setTextColor(int r12) {
        super.setTextColor(r12);
        saveOriginalTextCsl();
    }
