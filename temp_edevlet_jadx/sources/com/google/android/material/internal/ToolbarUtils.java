...
public class ToolbarUtils {
    ...
    @Nullable
    public static ActionMenuItemView getActionMenuItemView(@NonNull Toolbar toolbar, @IdRes int r42) {
        ActionMenuView actionMenuView = getActionMenuView(toolbar);
        if (actionMenuView == null) {
            return null;
        }
        for (int r02 = 0; r02 < actionMenuView.getChildCount(); r02++) {
            View childAt = actionMenuView.getChildAt(r02);
            if (childAt instanceof ActionMenuItemView) {
                ActionMenuItemView actionMenuItemView = (ActionMenuItemView) childAt;
                if (actionMenuItemView.getItemData().getItemId() == r42) {
    ...
    public static ActionMenuView getActionMenuView(@NonNull Toolbar toolbar) {
        for (int r02 = 0; r02 < toolbar.getChildCount(); r02++) {
            View childAt = toolbar.getChildAt(r02);
    ...
    public static ImageButton getNavigationIconButton(@NonNull Toolbar toolbar) {
        ...
        for (int r22 = 0; r22 < toolbar.getChildCount(); r22++) {
            View childAt = toolbar.getChildAt(r22);
