...
public final class StateListAnimator {
    ...
    public static class Tuple {
        ...
        public Tuple(int[] r12, ValueAnimator valueAnimator) {
            this.specs = r12;
    ...
    public void addState(int[] r22, ValueAnimator valueAnimator) {
        Tuple tuple = new Tuple(r22, valueAnimator);
    ...
    public void setState(int[] r52) {
        ...
        while (true) {
            ...
            tuple = this.tuples.get(r12);
            if (StateSet.stateSetMatches(tuple.specs, r52)) {
                break;
            } else {
                r12++;
            }
