...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    private static void updateTopBottomPadding(@NonNull View view, int r32, int r42) {
        if (ViewCompat.isPaddingRelative(view)) {
            ViewCompat.setPaddingRelative(view, ViewCompat.getPaddingStart(view), r32, ViewCompat.getPaddingEnd(view), r42);
        } else {
            view.setPadding(view.getPaddingLeft(), r32, view.getPaddingRight(), r42);
        }
    }

    private boolean updateViewsWithinLayout(int r32, int r42, int r52) {
        boolean z10;
        if (r32 != getOrientation()) {
            setOrientation(r32);
            z10 = true;
        } else {
            z10 = false;
        }
        if (this.messageView.getPaddingTop() == r42 && this.messageView.getPaddingBottom() == r52) {
            return z10;
        }
        updateTopBottomPadding(this.messageView, r42, r52);
        return true;
    }

    @Override // com.google.android.material.snackbar.ContentViewCallback
    public void animateContentIn(int r82, int r92) {
    ...
    @Override // com.google.android.material.snackbar.ContentViewCallback
    public void animateContentOut(int r82, int r92) {
