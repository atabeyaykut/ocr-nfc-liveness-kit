...
final class CalendarItemStyle {
    ...
    private CalendarItemStyle(ColorStateList colorStateList, ColorStateList colorStateList2, ColorStateList colorStateList3, int r52, ShapeAppearanceModel shapeAppearanceModel, @NonNull Rect rect) {
        ...
        this.strokeWidth = r52;
        this.itemShape = shapeAppearanceModel;
    }

    @NonNull
    public static CalendarItemStyle create(@NonNull Context context, @StyleRes int r13) throws Resources.NotFoundException {
        Preconditions.checkArgument(r13 != 0, "Cannot create a CalendarItemStyle with a styleResId of 0");
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(r13, R.styleable.MaterialCalendarItem);
