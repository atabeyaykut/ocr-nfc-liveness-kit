...
class DaysOfWeekAdapter extends BaseAdapter {
    ...
    private int positionToDayOfWeek(int r22) {
        int r23 = r22 + this.firstDayOfWeek;
        int r02 = this.daysInWeek;
        return r23 > r02 ? r23 - r02 : r23;
    }
    ...
    @Override // android.widget.Adapter
    @Nullable
    public Integer getItem(int r22) {
        if (r22 >= this.daysInWeek) {
            return null;
        }
        return Integer.valueOf(positionToDayOfWeek(r22));
    }
    ...
    public View getView(int r6, @Nullable View view, @NonNull ViewGroup viewGroup) {
