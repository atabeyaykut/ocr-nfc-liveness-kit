...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.AttachedBehavior {
    ...
    public static class Behavior extends HideBottomViewOnScrollBehavior<BottomAppBar> {
        ...
        public Behavior() {
            this.fabLayoutListener = new View.OnLayoutChangeListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.Behavior.1
                ...
                public void onLayoutChange(View view, int r22, int r32, int r42, int r52, int r6, int r72, int r82, int r92) {
                    ...
                    int r43 = Behavior.this.fabContentRect.height();
                    bottomAppBar.setFabDiameter(r43);
                    ...
                    if (Behavior.this.originalBottomMargin == 0) {
                        ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin = bottomAppBar.getBottomInset() + (bottomAppBar.getResources().getDimensionPixelOffset(R.dimen.mtrl_bottomappbar_fab_bottom_margin) - ((floatingActionButton.getMeasuredHeight() - r43) / 2));
        ...
        public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull BottomAppBar bottomAppBar, int r6) {
        ...
        @Override // com.google.android.material.behavior.HideBottomViewOnScrollBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
        public boolean onStartNestedScroll(@NonNull CoordinatorLayout coordinatorLayout, @NonNull BottomAppBar bottomAppBar, @NonNull View view, @NonNull View view2, int r6, int r72) {
            return bottomAppBar.getHideOnScroll() && super.onStartNestedScroll(coordinatorLayout, (CoordinatorLayout) bottomAppBar, view, view2, r6, r72);
        }
    }
    ...
    public BottomAppBar(@NonNull Context context, @Nullable AttributeSet attributeSet, int r13) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.BottomAppBar, r13, r6, new int[0]);
        ...
        ViewUtils.doOnApplyWindowInsets(this, attributeSet, r13, r6, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.3
    ...
    private void createFabTranslationXAnimation(int r42, @NonNull List<Animator> list) {
        ObjectAnimator objectAnimatorOfFloat = ObjectAnimator.ofFloat(findDependentFab(), "translationX", getFabTranslationX(r42));
        objectAnimatorOfFloat.setDuration(ANIMATION_DURATION);
        list.add(objectAnimatorOfFloat);
    }

    private void createMenuViewTranslationAnimation(final int r92, final boolean z10, @NonNull List<Animator> list) {
        final ActionMenuView actionMenuView = getActionMenuView();
        if (actionMenuView == null) {
            return;
        }
        Animator animatorOfFloat = ObjectAnimator.ofFloat(actionMenuView, "alpha", 1.0f);
        if (Math.abs(actionMenuView.getTranslationX() - getActionMenuViewTranslationX(actionMenuView, r92, z10)) <= 1.0f) {
            ...
            objectAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.bottomappbar.BottomAppBar.7
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    BottomAppBar.this.translateActionMenuView(actionMenuView, r92, z10, z11);
                }
            });
    ...
    public void dispatchAnimationEnd() {
        ...
        int r02 = this.animatingModeChangeCounter - 1;
        this.animatingModeChangeCounter = r02;
        if (r02 != 0 || (arrayList = this.animationListeners) == null) {
            return;
        }
    ...
    public void dispatchAnimationStart() {
        ArrayList<AnimationListener> arrayList;
        int r02 = this.animatingModeChangeCounter;
        this.animatingModeChangeCounter = r02 + 1;
        if (r02 != 0 || (arrayList = this.animationListeners) == null) {
            return;
        }
        Iterator<AnimationListener> it = arrayList.iterator();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public float getFabTranslationX(int r42) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void maybeAnimateMenuView(int r42, boolean z10) {
        ...
        createMenuViewTranslationAnimation(r42, z10, arrayList);
        AnimatorSet animatorSet = new AnimatorSet();
    ...
    private void maybeAnimateModeChange(int r42) {
        if (this.fabAlignmentMode == r42 || !ViewCompat.isLaidOut(this)) {
            return;
        }
        ...
        if (this.fabAnimationMode == 1) {
            createFabTranslationXAnimation(r42, arrayList);
        } else {
            createFabDefaultXAnimation(r42, arrayList);
        }
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.playTogether(arrayList);
    ...
    private void translateActionMenuView(@NonNull ActionMenuView actionMenuView, int r32, boolean z10) {
        translateActionMenuView(actionMenuView, r32, z10, false);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void translateActionMenuView(@NonNull final ActionMenuView actionMenuView, final int r32, final boolean z10, boolean z11) {
        Runnable runnable = new Runnable() { // from class: com.google.android.material.bottomappbar.BottomAppBar.8
            @Override // java.lang.Runnable
            public void run() {
                actionMenuView.setTranslationX(BottomAppBar.this.getActionMenuViewTranslationX(r0, r32, z10));
            }
        };
        if (z11) {
    ...
    public void createFabDefaultXAnimation(final int r22, List<Animator> list) {
        FloatingActionButton floatingActionButtonFindDependentFab = findDependentFab();
        ...
        floatingActionButtonFindDependentFab.hide(new FloatingActionButton.OnVisibilityChangedListener() { // from class: com.google.android.material.bottomappbar.BottomAppBar.5
            ...
            public void onHidden(@NonNull FloatingActionButton floatingActionButton) {
                floatingActionButton.setTranslationX(BottomAppBar.this.getFabTranslationX(r22));
    ...
    public int getActionMenuViewTranslationX(@NonNull ActionMenuView actionMenuView, int r82, boolean z10) {
        if (r82 != 1 || !z10) {
            return 0;
        }
        boolean zIsLayoutRtl = ViewUtils.isLayoutRtl(this);
    ...
    public void replaceMenu(@MenuRes int r22) {
        if (r22 != 0) {
            this.pendingMenuResId = 0;
            getMenu().clear();
            inflateMenu(r22);
    ...
    public void setFabAlignmentMode(int r22) {
        setFabAlignmentModeAndReplaceMenu(r22, 0);
    }

    public void setFabAlignmentModeAndReplaceMenu(int r12, @MenuRes int r22) {
        this.pendingMenuResId = r22;
        this.menuAnimatingWithFabAlignmentMode = true;
        maybeAnimateMenuView(r12, this.fabAttached);
        maybeAnimateModeChange(r12);
        this.fabAlignmentMode = r12;
    }

    public void setFabAnimationMode(int r12) {
        this.fabAnimationMode = r12;
    }
    ...
    public boolean setFabDiameter(@Px int r22) {
        float f = r22;
