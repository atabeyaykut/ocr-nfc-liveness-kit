...
class ViewUtilsLollipop {
    ...
    public static void setDefaultAppBarLayoutStateListAnimator(@NonNull View view, float f) throws Resources.NotFoundException {
        ...
        stateListAnimator.addState(new int[]{R.attr.enabled}, ObjectAnimator.ofFloat(view, "elevation", f).setDuration(j10));
        stateListAnimator.addState(new int[0], ObjectAnimator.ofFloat(view, "elevation", 0.0f).setDuration(0L));
        view.setStateListAnimator(stateListAnimator);
    }

    public static void setStateListAnimatorFromAttrs(@NonNull View view, AttributeSet attributeSet, int r10, int r11) {
