...
public final class IndeterminateDrawable<S extends BaseProgressIndicatorSpec> extends DrawableWithAnimatedVisibilityChange {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        while (true) {
            ...
            int[] r22 = indeterminateAnimatorDelegate.segmentColors;
            if (r02 >= r22.length) {
                canvas.restore();
                return;
            }
            ...
            int r32 = r02 * 2;
            drawingDelegate.fillIndicator(canvas, paint, fArr[r32], fArr[r32 + 1], r22[r02]);
            r02++;
        }
    }
    ...
    public boolean setVisibleInternal(boolean z10, boolean z11, boolean z12) {
        ...
        if (z10 && (z12 || (Build.VERSION.SDK_INT <= 21 && systemAnimatorDurationScale > 0.0f))) {
