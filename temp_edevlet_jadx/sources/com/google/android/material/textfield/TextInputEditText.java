...
public class TextInputEditText extends AppCompatEditText {
    ...
    public TextInputEditText(@NonNull Context context, @Nullable AttributeSet attributeSet, int r11) {
        super(MaterialThemeOverlay.wrap(context, attributeSet, r11, 0), attributeSet, r11);
        this.parentRect = new Rect();
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.TextInputEditText, r11, R.style.Widget_Design_TextInputEditText, new int[0]);
    ...
    private String getAccessibilityNodeInfoText(@NonNull TextInputLayout textInputLayout) {
        ...
        sb2.append(TextUtils.isEmpty(string) ? "" : b.e(", ", string));
        return sb2.toString();
    }
