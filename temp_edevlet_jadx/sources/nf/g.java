...
@r9.e(c = "tr.gov.turkiye.edevlet.kapisi.dashboard.barcode.BarcodeServicesViewModel$favoriteOperation$2", f = "BarcodeServicesViewModel.kt", l = {}, m = "invokeSuspend")
/* loaded from: classes3.dex */
public final class g extends r9.i implements p<kotlinx.coroutines.flow.f<? extends Result<ServiceModelRealm>>, p9.d<? super l9.m>, Object> {

    /* renamed from: a, reason: collision with root package name */
    public /* synthetic */ Object f10919a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ e f10920b;
    ...
    public static final class a extends kotlin.jvm.internal.j implements p<d, r0.b<? extends Result<ServiceModelRealm>>, d> {
        ...
        public final d mo7invoke(d dVar, r0.b<? extends Result<ServiceModelRealm>> bVar) {
            ...
            try {
                ...
                return orThrow != null ? d.copy$default(execute, null, result, true, false, orThrow, null, 33, null) : d.copy$default(execute, null, result, true, false, null, null, 49, null);
            } catch (Throwable th2) {
    ...
    public final p9.d<l9.m> create(Object obj, p9.d<?> dVar) {
        g gVar = new g(this.f10920b, dVar);
        gVar.f10919a = obj;
        return gVar;
    }
    ...
    public final Object mo7invoke(kotlinx.coroutines.flow.f<? extends Result<ServiceModelRealm>> fVar, p9.d<? super l9.m> dVar) {
        return ((g) create(fVar, dVar)).invokeSuspend(l9.m.f9594a);
    }

    @Override // r9.a
    public final Object invokeSuspend(Object obj) throws Throwable {
        w.F(obj);
        z.a(this.f10920b, (kotlinx.coroutines.flow.f) this.f10919a, a.f10921a);
        return l9.m.f9594a;
    }
}
