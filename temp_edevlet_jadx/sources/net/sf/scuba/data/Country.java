...
public abstract class Country implements Serializable {
    ...
    private static Country fromAlpha2(String str) {
        ...
        throw new IllegalArgumentException(b.e("Unknown country code ", str));
    }
    ...
    public static Country getInstance(int r52) {
        for (Country country : values()) {
            if (country.valueOf() == r52) {
                return country;
            }
        }
        throw new IllegalArgumentException(ab.b.c(r52, new StringBuilder("Illegal country code")));
    }
    ...
    public static Country getInstance(String str) {
        ...
        throw new IllegalArgumentException("Illegal country code ".concat(strTrim));
    }
