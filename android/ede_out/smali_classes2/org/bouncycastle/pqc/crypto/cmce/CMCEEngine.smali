...
.method public static cbrecursion([BJJ[SIJJ[I)V
    ...
    invoke-static {v12, v1, v0}, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->sort32([III)V
...
.method public decompress_private_key([B)[B
    ...
    invoke-interface {v3, v0, v8, v1}, Lorg/bouncycastle/crypto/Digest;->update([BII)V
...
.method public generate_public_key_from_private_key([B)[B
    ...
    invoke-static {v3, v1}, Lorg/bouncycastle/pqc/crypto/cmce/Utils;->load4([BI)I
...
.method public kem_keypair([B[BLjava/security/SecureRandom;)V
    ...
    iget v2, v6, Lorg/bouncycastle/pqc/crypto/cmce/CMCEEngine;->SYS_N:I
    ...
    invoke-static {v2, v4, v3, v5}, Landroidx/camera/core/impl/a;->d(IIII)I
    ...
    :goto_0
    invoke-interface {v14, v9, v10, v8}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    array-length v3, v1

    invoke-interface {v14, v1, v10, v3}, Lorg/bouncycastle/crypto/Digest;->update([BII)V

    invoke-interface {v14, v12, v10, v11}, Lorg/bouncycastle/crypto/Xof;->doFinal([BII)I

    add-int/lit8 v1, v11, -0x20

    add-int/lit8 v3, v1, 0x20

    invoke-static {v12, v1, v3}, Lorg/bouncycastle/util/Arrays;->copyOfRange([BII)[B

    move-result-object v15

    invoke-static {v2, v10, v7, v10, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    invoke-static {v15, v10, v0}, Lorg/bouncycastle/util/Arrays;->copyOfRange([BII)[B
    ...
    invoke-static {v12, v3, v4}, Lorg/bouncycastle/pqc/crypto/cmce/Utils;->load_gf([BII)S
    ...
    invoke-static {v12, v1}, Lorg/bouncycastle/pqc/crypto/cmce/Utils;->load4([BI)I
    ...
    invoke-static {v12, v1, v7, v2, v0}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
