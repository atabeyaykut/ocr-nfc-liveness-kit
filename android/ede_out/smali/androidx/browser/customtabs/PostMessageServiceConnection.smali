...
.field private mService:Landroid/support/customtabs/c;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method private isBoundToService()Z
    ...
    iget-object v0, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:Landroid/support/customtabs/c;
...
.method private notifyMessageChannelReadyInternal(Landroid/os/Bundle;)Z
    ...
    :try_start_0
    iget-object v2, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:Landroid/support/customtabs/c;

    iget-object v3, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mSessionBinder:Landroid/support/customtabs/a;

    invoke-interface {v2, v3, p1}, Landroid/support/customtabs/c;->onMessageChannelReady(Landroid/support/customtabs/a;Landroid/os/Bundle;)V
    :try_end_0
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-static {p2}, Landroid/support/customtabs/c$a;->asInterface(Landroid/os/IBinder;)Landroid/support/customtabs/c;

    move-result-object p1

    iput-object p1, p0, Landroidx/browser/customtabs/PostMessageServiceConnection;->mService:Landroid/support/customtabs/c;
...
.method public final postMessage(Ljava/lang/String;Landroid/os/Bundle;)Z
    ...
    invoke-interface {v2, v3, p1, p2}, Landroid/support/customtabs/c;->onPostMessage(Landroid/support/customtabs/a;Ljava/lang/String;Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
