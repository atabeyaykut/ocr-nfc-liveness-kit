...
# direct methods
.method public constructor <init>(Lp9/f;JLx9/p;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    new-instance v1, Lnc/u1;

    invoke-direct {v1, v0}, Lnc/u1;-><init>(Lnc/b1;)V
    ...
    invoke-virtual {v0, p1}, Lp9/a;->plus(Lp9/f;)Lp9/f;

    move-result-object p1

    invoke-interface {p1, v1}, Lp9/f;->plus(Lp9/f;)Lp9/f;

    move-result-object p1

    invoke-static {p1}, Lb8/f;->f(Lp9/f;)Lkotlinx/coroutines/internal/f;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/lifecycle/BlockRunner;-><init>(Landroidx/lifecycle/CoroutineLiveData;Lx9/p;JLnc/a0;Lx9/a;)V
...
.method public synthetic constructor <init>(Lp9/f;JLx9/p;ILkotlin/jvm/internal/d;)V
    .locals 0
    ...
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/lifecycle/CoroutineLiveData;-><init>(Lp9/f;JLx9/p;)V
...
# virtual methods
.method public final clearSource$lifecycle_livedata_ktx_release(Lp9/d;)Ljava/lang/Object;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Landroidx/lifecycle/CoroutineLiveData$clearSource$1;-><init>(Landroidx/lifecycle/CoroutineLiveData;Lp9/d;)V
    ...
    invoke-virtual {p1, v0}, Landroidx/lifecycle/EmittedSource;->disposeNow(Lp9/d;)Ljava/lang/Object;
...
.method public final emitSource$lifecycle_livedata_ktx_release(Landroidx/lifecycle/LiveData;Lp9/d;)Ljava/lang/Object;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p2}, Landroidx/lifecycle/CoroutineLiveData$emitSource$1;-><init>(Landroidx/lifecycle/CoroutineLiveData;Lp9/d;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/lifecycle/CoroutineLiveData;->clearSource$lifecycle_livedata_ktx_release(Lp9/d;)Ljava/lang/Object;
    ...
    invoke-static {p1, p2, v0}, Landroidx/lifecycle/CoroutineLiveDataKt;->addDisposableSource(Landroidx/lifecycle/MediatorLiveData;Landroidx/lifecycle/LiveData;Lp9/d;)Ljava/lang/Object;
