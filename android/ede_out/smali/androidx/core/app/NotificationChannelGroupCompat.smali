...
.method public constructor <init>(Landroid/app/NotificationChannelGroup;Ljava/util/List;)V
    ...
    invoke-static {p1}, Landroidx/appcompat/app/e;->l(Landroid/app/NotificationChannelGroup;)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0}, Landroidx/core/app/NotificationChannelGroupCompat;-><init>(Ljava/lang/String;)V

    invoke-static {p1}, Landroidx/appcompat/widget/l;->m(Landroid/app/NotificationChannelGroup;)Ljava/lang/CharSequence;
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/m;->h(Landroid/app/NotificationChannelGroup;)Ljava/lang/String;
    ...
    invoke-static {p1}, Landroidx/camera/camera2/internal/compat/params/g;->g(Landroid/app/NotificationChannelGroup;)Z

    move-result p2

    iput-boolean p2, p0, Landroidx/core/app/NotificationChannelGroupCompat;->mBlocked:Z

    invoke-static {p1}, Landroidx/browser/trusted/c;->m(Landroid/app/NotificationChannelGroup;)Ljava/util/List;
...
.method private getChannelsCompat(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v1}, Landroidx/camera/camera2/internal/compat/params/b;->g(Landroid/app/NotificationChannel;)Ljava/lang/String;
...
.method public getNotificationChannelGroup()Landroid/app/NotificationChannelGroup;
    ...
    invoke-static {v1, v0}, Landroidx/browser/trusted/d;->j(Landroid/app/NotificationChannelGroup;Ljava/lang/String;)V
