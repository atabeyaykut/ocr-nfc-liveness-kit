...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "await",
        "(Landroidx/work/Operation;Lp9/d;)Ljava/lang/Object;",
...
# direct methods
.method public static final await(Landroidx/work/Operation;Lp9/d;)Ljava/lang/Object;
    .locals 4
    ...
    invoke-direct {v0, p1}, Landroidx/work/OperationKt$await$1;-><init>(Lp9/d;)V
    ...
    invoke-interface {p0}, Landroidx/work/Operation;->getResult()Lm5/a;
    ...
    invoke-direct {p1, v3, v0}, Lnc/j;-><init>(ILp9/d;)V

    invoke-virtual {p1}, Lnc/j;->n()V

    new-instance v0, Landroidx/work/ListenableFutureKt$await$2$1;

    invoke-direct {v0, p1, p0}, Landroidx/work/ListenableFutureKt$await$2$1;-><init>(Lnc/i;Lm5/a;)V

    sget-object v2, Landroidx/work/DirectExecutor;->INSTANCE:Landroidx/work/DirectExecutor;

    invoke-interface {p0, v0, v2}, Lm5/a;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V

    new-instance v0, Landroidx/work/ListenableFutureKt$await$2$2;

    invoke-direct {v0, p0}, Landroidx/work/ListenableFutureKt$await$2$2;-><init>(Lm5/a;)V

    invoke-interface {p1, v0}, Lnc/i;->D(Lx9/l;)V
...
.method private static final await$$forInline(Landroidx/work/Operation;Lp9/d;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p1, v0, p0}, Landroidx/work/ListenableFutureKt$await$2$1;-><init>(Lnc/i;Lm5/a;)V

    sget-object v1, Landroidx/work/DirectExecutor;->INSTANCE:Landroidx/work/DirectExecutor;

    invoke-interface {p0, p1, v1}, Lm5/a;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V

    new-instance p1, Landroidx/work/ListenableFutureKt$await$2$2;

    invoke-direct {p1, p0}, Landroidx/work/ListenableFutureKt$await$2$2;-><init>(Lm5/a;)V
