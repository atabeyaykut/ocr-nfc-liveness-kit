...
.method public static synthetic a(Lm5/a;)V
    ...
    invoke-static {p0}, Landroidx/camera/core/impl/DeferrableSurfaces;->lambda$surfaceListWithTimeout$2(Lm5/a;)V

    return-void
.end method

.method public static synthetic b(Lm5/a;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Landroidx/camera/core/impl/DeferrableSurfaces;->lambda$surfaceListWithTimeout$0(Lm5/a;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
...
.method public static synthetic d(Ljava/util/concurrent/Executor;Lm5/a;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
    .locals 0

    invoke-static {p0, p1, p2, p3, p4}, Landroidx/camera/core/impl/DeferrableSurfaces;->lambda$surfaceListWithTimeout$1(Ljava/util/concurrent/Executor;Lm5/a;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
...
.method private static synthetic lambda$surfaceListWithTimeout$0(Lm5/a;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
    .locals 3
...
.method private static synthetic lambda$surfaceListWithTimeout$1(Ljava/util/concurrent/Executor;Lm5/a;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
    .locals 1

    new-instance v0, Landroidx/camera/core/impl/r;

    invoke-direct {v0, p1, p2, p3, p4}, Landroidx/camera/core/impl/r;-><init>(Lm5/a;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
...
.method private static synthetic lambda$surfaceListWithTimeout$2(Lm5/a;)V
    .locals 1
...
.method private static synthetic lambda$surfaceListWithTimeout$3(Ljava/util/List;Ljava/util/concurrent/ScheduledExecutorService;Ljava/util/concurrent/Executor;JZLandroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Landroidx/camera/core/impl/utils/futures/Futures;->successfulAsList(Ljava/util/Collection;)Lm5/a;
    ...
    invoke-direct/range {v0 .. v5}, Landroidx/camera/core/impl/s;-><init>(Ljava/util/concurrent/Executor;Lm5/a;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;J)V
    ...
    invoke-direct {p3, p4, p0}, Landroidx/camera/core/impl/t;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static {p0, p3, p2}, Landroidx/camera/core/impl/utils/futures/Futures;->addCallback(Lm5/a;Landroidx/camera/core/impl/utils/futures/FutureCallback;Ljava/util/concurrent/Executor;)V
...
.method public static surfaceListWithTimeout(Ljava/util/Collection;ZJLjava/util/concurrent/Executor;Ljava/util/concurrent/ScheduledExecutorService;)Lm5/a;
    .locals 7
    ...
    invoke-virtual {v0}, Landroidx/camera/core/impl/DeferrableSurface;->getSurface()Lm5/a;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/camera/core/impl/u;-><init>(Ljava/util/ArrayList;Ljava/util/concurrent/ScheduledExecutorService;Ljava/util/concurrent/Executor;JZ)V

    invoke-static {p0}, Landroidx/concurrent/futures/CallbackToFutureAdapter;->getFuture(Landroidx/concurrent/futures/CallbackToFutureAdapter$Resolver;)Lm5/a;
