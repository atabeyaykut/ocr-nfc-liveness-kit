...
.method public constructor <init>(Landroidx/core/app/NotificationCompat$Builder;)V
    ...
    iget-object v4, p1, Landroidx/core/app/NotificationCompat$Builder;->mSmallIcon:Landroid/graphics/drawable/Icon;

    if-eqz v4, :cond_c

    iget-object v8, p0, Landroidx/core/app/NotificationCompatBuilder;->mBuilder:Landroid/app/Notification$Builder;

    invoke-virtual {v8, v4}, Landroid/app/Notification$Builder;->setSmallIcon(Landroid/graphics/drawable/Icon;)Landroid/app/Notification$Builder;
    ...
    invoke-virtual {v4, v8}, Landroid/app/Notification$Builder;->setExtras(Landroid/os/Bundle;)Landroid/app/Notification$Builder;
    ...
    invoke-virtual {v8, v4}, Landroid/app/Notification$Builder;->setCustomContentView(Landroid/widget/RemoteViews;)Landroid/app/Notification$Builder;
    ...
    invoke-virtual {v8, v4}, Landroid/app/Notification$Builder;->setCustomBigContentView(Landroid/widget/RemoteViews;)Landroid/app/Notification$Builder;
    ...
    invoke-virtual {v8, v4}, Landroid/app/Notification$Builder;->setCustomHeadsUpContentView(Landroid/widget/RemoteViews;)Landroid/app/Notification$Builder;
    ...
    invoke-virtual {v8, v4}, Landroid/app/Notification$Builder;->setSound(Landroid/net/Uri;)Landroid/app/Notification$Builder;
    ...
    invoke-static {v6, v3}, Landroidx/browser/trusted/f;->i(Landroid/app/Notification$Builder;Landroid/app/Person;)V
    ...
    invoke-static {v3, v6}, Landroidx/appcompat/widget/t;->g(Landroid/app/Notification$Builder;Z)V
    ...
    invoke-static {v3, v6}, Landroidx/core/app/m;->d(Landroid/app/Notification$Builder;Landroid/app/Notification$BubbleMetadata;)V
    ...
    invoke-static {v6, v3}, Landroidx/appcompat/widget/u;->f(Landroid/app/Notification$Builder;Landroid/content/LocusId;)V
    ...
    invoke-static {v6, v3}, Landroidx/core/app/q;->c(Landroid/app/Notification$Builder;I)V
...
.method private addAction(Landroidx/core/app/NotificationCompat$Action;)V
    ...
    invoke-static {v0, v3}, Landroidx/camera/camera2/internal/compat/r;->g(Landroid/app/Notification$Action$Builder;Z)V
    ...
    invoke-static {v0, v3}, Landroidx/browser/trusted/d;->i(Landroid/app/Notification$Action$Builder;I)V
    ...
    invoke-static {v0, v3}, Landroidx/appcompat/widget/r;->h(Landroid/app/Notification$Action$Builder;Z)V
    ...
    invoke-static {v0, v2}, Landroidx/core/app/r;->a(Landroid/app/Notification$Action$Builder;Z)V
