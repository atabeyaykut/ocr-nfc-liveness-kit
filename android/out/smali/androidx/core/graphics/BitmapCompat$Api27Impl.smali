...
.method public static createBitmapWithSourceColorspace(IILandroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
    ...
    invoke-static {p2}, Landroidx/appcompat/widget/l;->h(Landroid/graphics/Bitmap;)Landroid/graphics/ColorSpace;

    move-result-object v1

    invoke-static {}, Landroidx/appcompat/widget/k;->i()Landroid/graphics/ColorSpace$Named;

    move-result-object v2

    invoke-static {v2}, Landroidx/appcompat/app/d;->f(Landroid/graphics/ColorSpace$Named;)Landroid/graphics/ColorSpace;
    ...
    invoke-static {p3, v2}, Landroidx/core/app/i;->k(Landroid/graphics/ColorSpace;Ljava/lang/Object;)Z
    ...
    invoke-static {p0, p1, v0, p2, v1}, Landroidx/browser/trusted/b;->g(IILandroid/graphics/Bitmap$Config;ZLandroid/graphics/ColorSpace;)Landroid/graphics/Bitmap;
...
.method public static isAlreadyF16AndLinear(Landroid/graphics/Bitmap;)Z
    ...
    invoke-static {p0}, Landroidx/appcompat/widget/l;->h(Landroid/graphics/Bitmap;)Landroid/graphics/ColorSpace;

    move-result-object p0

    invoke-static {p0, v0}, Landroidx/core/app/i;->k(Landroid/graphics/ColorSpace;Ljava/lang/Object;)Z
