...
.method public static getDefaultImpl()Landroid/support/customtabs/b;
    .locals 1
...
.method public static setDefaultImpl(Landroid/support/customtabs/b;)Z
    .locals 1
    ...
    sput-object p0, Landroid/support/customtabs/b$a$a;->b:Landroid/support/customtabs/b;
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    :cond_1
    invoke-interface {p0, p1, p4, v2, v0}, Landroid/support/customtabs/b;->receiveFile(Landroid/support/customtabs/a;Landroid/net/Uri;ILandroid/os/Bundle;)Z
    ...
    :cond_3
    invoke-interface {p0, p1, p4, v0}, Landroid/support/customtabs/b;->requestPostMessageChannelWithExtras(Landroid/support/customtabs/a;Landroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    :cond_4
    invoke-interface {p0, p1, v0}, Landroid/support/customtabs/b;->newSessionWithExtras(Landroid/support/customtabs/a;Landroid/os/Bundle;)Z
    ...
    :cond_6
    invoke-interface {p0, p1, p4, v2, v0}, Landroid/support/customtabs/b;->validateRelationship(Landroid/support/customtabs/a;ILandroid/net/Uri;Landroid/os/Bundle;)Z
    ...
    :cond_7
    invoke-interface {p0, p1, p4, v0}, Landroid/support/customtabs/b;->postMessage(Landroid/support/customtabs/a;Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    :cond_8
    invoke-interface {p0, p1, v0}, Landroid/support/customtabs/b;->requestPostMessageChannel(Landroid/support/customtabs/a;Landroid/net/Uri;)Z
    ...
    :cond_9
    invoke-interface {p0, p1, v0}, Landroid/support/customtabs/b;->updateVisuals(Landroid/support/customtabs/a;Landroid/os/Bundle;)Z
    ...
    :cond_a
    invoke-interface {p0, p1, v0}, Landroid/support/customtabs/b;->extraCommand(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    invoke-interface {p0, p1, p4, v0, p2}, Landroid/support/customtabs/b;->mayLaunchUrl(Landroid/support/customtabs/a;Landroid/net/Uri;Landroid/os/Bundle;Ljava/util/List;)Z
