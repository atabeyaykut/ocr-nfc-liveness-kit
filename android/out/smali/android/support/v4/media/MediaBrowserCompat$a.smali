...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    check-cast v3, Landroid/support/v4/media/MediaBrowserCompat$f;
    ...
    invoke-interface {v3, v5, v2, v1}, Landroid/support/v4/media/MediaBrowserCompat$f;->a(Landroid/os/Messenger;Ljava/lang/String;Landroid/os/Bundle;)V

    goto :goto_0

    :cond_2
    invoke-interface {v3, v5}, Landroid/support/v4/media/MediaBrowserCompat$f;->b(Landroid/os/Messenger;)V
    ...
    invoke-interface {v3, v5, v1, v2}, Landroid/support/v4/media/MediaBrowserCompat$f;->c(Landroid/os/Messenger;Ljava/lang/String;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    :try_end_1
