...
# static fields
.field public static final g:Lgb/s;

.field public static final h:Lgb/s$a;
...
.method public static constructor <clinit>()V
    ...
    .line 5
    .line 6
    sput-object v0, Lgb/s;->h:Lgb/s$a;
    ...
    .line 19
    iput-object v1, v0, Lgb/s;->c:Ljava/util/List;
...
.method public constructor <init>()V
    ...
    iput-byte v0, p0, Lgb/s;->e:B

    iput v0, p0, Lgb/s;->f:I

    sget-object v0, Lmb/c;->a:Lmb/o;

    iput-object v0, p0, Lgb/s;->a:Lmb/c;
...
.method public constructor <init>(Lmb/d;Lmb/f;)V
    ...
    iput-object v1, p0, Lgb/s;->c:Ljava/util/List;

    iput v0, p0, Lgb/s;->d:I
    ...
    .line 6
    :cond_1
    iget v5, p0, Lgb/s;->b:I

    or-int/2addr v5, v1

    iput v5, p0, Lgb/s;->b:I
    ...
    iput-object v5, p0, Lgb/s;->c:Ljava/util/List;

    or-int/lit8 v4, v4, 0x1

    :cond_3
    iget-object v5, p0, Lgb/s;->c:Ljava/util/List;

    sget-object v6, Lgb/p;->x:Lgb/p$a;
    ...
    iget-object p2, p0, Lgb/s;->c:Ljava/util/List;

    invoke-static {p2}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p2

    iput-object p2, p0, Lgb/s;->c:Ljava/util/List;
    ...
    iput-object p2, p0, Lgb/s;->a:Lmb/c;
    ...
    iget-object p1, p0, Lgb/s;->c:Ljava/util/List;

    invoke-static {p1}, Ljava/util/Collections;->unmodifiableList(Ljava/util/List;)Ljava/util/List;

    move-result-object p1

    iput-object p1, p0, Lgb/s;->c:Ljava/util/List;
    ...
    iput-object p1, p0, Lgb/s;->a:Lmb/c;
...
.method public static i(Lgb/s;)Lgb/s$b;
    .locals 1
    ...
    .line 5
    .line 6
    invoke-virtual {v0, p0}, Lgb/s$b;->l(Lgb/s;)V
...
.method public final b()Z
    ...
    .line 12
    :goto_0
    iget-object v3, p0, Lgb/s;->c:Ljava/util/List;
...
.method public final c()I
    ...
    :goto_0
    iget-object v2, p0, Lgb/s;->c:Ljava/util/List;
    ...
    iget v2, p0, Lgb/s;->d:I

    invoke-static {v0, v2}, Lmb/e;->b(II)I
    ...
    :cond_2
    iget-object v0, p0, Lgb/s;->a:Lmb/c;
...
.method public final d(Lmb/e;)V
    ...
    invoke-virtual {p0}, Lgb/s;->c()I

    const/4 v0, 0x0

    :goto_0
    iget-object v1, p0, Lgb/s;->c:Ljava/util/List;
...
.method public final f()Lmb/p$a;
    ...
    invoke-static {p0}, Lgb/s;->i(Lgb/s;)Lgb/s$b;
