...
.method public final a(ILp9/d;)Ljava/lang/Object;
    ...
    instance-of v0, p2, Ltf/g$a;

    if-eqz v0, :cond_0

    move-object v0, p2

    check-cast v0, Ltf/g$a;

    iget v1, v0, Ltf/g$a;->c:I
    ...
    invoke-direct {v0, p0, p2}, Ltf/g$a;-><init>(Ltf/g;Lp9/d;)V

    :goto_0
    iget-object p2, v0, Ltf/g$a;->a:Ljava/lang/Object;

    sget-object v1, Lq9/a;->a:Lq9/a;

    iget v2, v0, Ltf/g$a;->c:I
    ...
    :try_start_1
    invoke-static {p1}, Ltf/g;->b(I)Ljava/util/List;
    ...
    .line 1
    iget-object p2, p0, Ltf/g;->e:Lgf/b;
    ...
    .line 3
    iget-object p2, p0, Ltf/g;->a:Lud/d0;
    ...
    const-string v3, "mApiClient.create(MyCityListAPI::class.java)"
    ...
    .line 5
    iget-object v8, p0, Ltf/g;->b:Ljava/lang/String;
    ...
    .line 6
    iget-object v10, p0, Ltf/g;->d:Ljava/lang/String;

    if-eqz v10, :cond_c

    .line 7
    iget-object v11, p0, Ltf/g;->c:Ljava/lang/String;
    ...
    .line 8
    invoke-interface/range {v5 .. v11}, Ltf/a;->a(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lud/b;
    ...
    :cond_5
    new-instance v3, Landroidx/camera/camera2/internal/compat/workaround/b;

    const/4 v5, 0x4

    invoke-direct {v3, v5, v6}, Landroidx/camera/camera2/internal/compat/workaround/b;-><init>(ILjava/lang/Object;)V
    ...
    .line 10
    new-instance v3, Ltf/g$b;

    invoke-direct {v3, p0, p1, v2}, Ltf/g$b;-><init>(Ltf/g;ILp9/d;)V

    iput v4, v0, Ltf/g$a;->c:I
    ...
    .line 19
    new-instance v4, Ltf/g$c;

    invoke-direct {v4, p0, p1, v2}, Ltf/g$c;-><init>(Ltf/g;ILp9/d;)V

    iput v3, v0, Ltf/g$a;->c:I
