...
public final class t {
    ...
    public static final class a {
        ...
        public a() {
            this.f19645a = new a[256];
            this.f19646b = 0;
            this.f19647c = 0;
        }

        public a(int r22, int r32) {
            this.f19645a = null;
            this.f19646b = r22;
            int r23 = r32 & 7;
            this.f19647c = r23 == 0 ? 8 : r23;
        }
    }

    static {
        for (int r12 = 0; r12 < 256; r12++) {
            a(r12, f19642a[r12], f19643b[r12]);
        }
    }

    public static void a(int r32, int r42, int r52) {
        a aVar = new a(r32, r52);
        a aVar2 = f19644c;
        while (r52 > 8) {
            r52 -= 8;
            int r12 = (r42 >>> r52) & 255;
            a[] aVarArr = aVar2.f19645a;
        ...
        int r13 = 8 - r52;
        int r43 = (r42 << r13) & 255;
        a[] aVarArr2 = aVar2.f19645a;
        kotlin.jvm.internal.h.c(aVarArr2);
        Arrays.fill(aVarArr2, r43, (1 << r13) + r43, aVar);
    }
}
