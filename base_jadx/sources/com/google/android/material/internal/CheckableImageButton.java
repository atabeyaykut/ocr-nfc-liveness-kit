...
public class CheckableImageButton extends AppCompatImageButton implements Checkable {
    ...
    public CheckableImageButton(Context context, AttributeSet attributeSet, int r32) {
    ...
    public int[] onCreateDrawableState(int r32) {
        if (!this.checked) {
            return super.onCreateDrawableState(r32);
        }
        int[] r02 = DRAWABLE_STATE_CHECKED;
        return View.mergeDrawableStates(super.onCreateDrawableState(r32 + r02.length), r02);
    }
