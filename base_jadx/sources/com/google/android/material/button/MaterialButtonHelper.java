...
class MaterialButtonHelper {
    ...
    private MaterialShapeDrawable getMaterialShapeDrawable(boolean z10) {
        ...
        return (MaterialShapeDrawable) (IS_LOLLIPOP ? (LayerDrawable) ((InsetDrawable) this.rippleDrawable.getDrawable(0)).getDrawable() : this.rippleDrawable).getDrawable(!z10 ? 1 : 0);
    }
    ...
    private void setVerticalInsets(@Dimension int r82, @Dimension int r92) {
        int paddingStart = ViewCompat.getPaddingStart(this.materialButton);
        int paddingTop = this.materialButton.getPaddingTop();
        int paddingEnd = ViewCompat.getPaddingEnd(this.materialButton);
        int paddingBottom = this.materialButton.getPaddingBottom();
        int r42 = this.insetTop;
        int r52 = this.insetBottom;
        this.insetBottom = r92;
        this.insetTop = r82;
        if (!this.backgroundOverwritten) {
            updateBackground();
        }
        ViewCompat.setPaddingRelative(this.materialButton, paddingStart, (paddingTop + r82) - r42, paddingEnd, (paddingBottom + r92) - r52);
    }
    ...
    public void loadFromAttributes(@NonNull TypedArray typedArray) {
        ...
        int r02 = R.styleable.MaterialButton_cornerRadius;
        if (typedArray.hasValue(r02)) {
            int dimensionPixelSize = typedArray.getDimensionPixelSize(r02, -1);
    ...
    public void setBackgroundColor(int r22) {
        if (getMaterialShapeDrawable() != null) {
            getMaterialShapeDrawable().setTint(r22);
        }
    }
    ...
    public void setCornerRadius(int r22) {
        if (this.cornerRadiusSet && this.cornerRadius == r22) {
            return;
        }
        this.cornerRadius = r22;
        this.cornerRadiusSet = true;
        setShapeAppearanceModel(this.shapeAppearanceModel.withCornerSize(r22));
    }

    public void setInsetBottom(@Dimension int r22) {
        setVerticalInsets(this.insetTop, r22);
    }

    public void setInsetTop(@Dimension int r22) {
        setVerticalInsets(r22, this.insetBottom);
    }
    ...
    public void setStrokeWidth(int r22) {
        if (this.strokeWidth != r22) {
    ...
    public void updateMaskBounds(int r52, int r6) {
        Drawable drawable = this.maskDrawable;
        if (drawable != null) {
            drawable.setBounds(this.insetLeft, this.insetTop, r6 - this.insetRight, r52 - this.insetBottom);
        }
    }
}
