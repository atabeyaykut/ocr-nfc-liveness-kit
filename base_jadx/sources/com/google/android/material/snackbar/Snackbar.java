...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public static class Callback extends BaseTransientBottomBar.BaseCallback<Snackbar> {
        ...
        public void onDismissed(Snackbar snackbar, int r22) {
        }
    ...
    static {
        int r22 = R.attr.snackbarButtonStyle;
        SNACKBAR_BUTTON_STYLE_ATTR = new int[]{r22};
        SNACKBAR_CONTENT_STYLE_ATTRS = new int[]{r22, R.attr.snackbarTextViewStyle};
    }
    ...
    @NonNull
    public static Snackbar make(@NonNull Context context, @NonNull View view, @NonNull CharSequence charSequence, int r32) {
        return makeInternal(context, view, charSequence, r32);
    }

    @NonNull
    public static Snackbar make(@NonNull View view, @StringRes int r22, int r32) {
        return make(view, view.getResources().getText(r22), r32);
    }

    @NonNull
    public static Snackbar make(@NonNull View view, @NonNull CharSequence charSequence, int r32) {
        return makeInternal(null, view, charSequence, r32);
    }

    @NonNull
    private static Snackbar makeInternal(@Nullable Context context, @NonNull View view, @NonNull CharSequence charSequence, int r6) {
    ...
    @NonNull
    public Snackbar setAction(@StringRes int r22, View.OnClickListener onClickListener) {
        return setAction(getContext().getText(r22), onClickListener);
    }
    ...
    @NonNull
    public Snackbar setActionTextColor(@ColorInt int r32) {
        ((SnackbarContentLayout) this.view.getChildAt(0)).getActionView().setTextColor(r32);
        return this;
    }
    ...
    @NonNull
    public Snackbar setBackgroundTint(@ColorInt int r12) {
        return setBackgroundTintList(ColorStateList.valueOf(r12));
    }
    ...
    @NonNull
    public Snackbar setMaxInlineActionWidth(@Dimension int r32) {
        ((SnackbarContentLayout) this.view.getChildAt(0)).setMaxInlineActionWidth(r32);
        return this;
    }

    @NonNull
    public Snackbar setText(@StringRes int r22) {
        return setText(getContext().getText(r22));
    }
    ...
    @NonNull
    public Snackbar setTextColor(@ColorInt int r32) {
        ((SnackbarContentLayout) this.view.getChildAt(0)).getMessageView().setTextColor(r32);
        return this;
    }
