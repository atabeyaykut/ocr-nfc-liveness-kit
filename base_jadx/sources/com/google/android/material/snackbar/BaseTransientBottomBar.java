...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public static abstract class BaseCallback<B> {
        ...
        public void onDismissed(B b10, int r22) {
        }
    ...
    public interface OnLayoutChangeListener {
        void onLayoutChange(View view, int r22, int r32, int r42, int r52);
    }
    ...
    public BaseTransientBottomBar(@NonNull Context context, @NonNull ViewGroup viewGroup, @NonNull View view, @NonNull com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        ...
        this.managerCallback = new SnackbarManager.Callback() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.6
            ...
            public void dismiss(int r52) {
                Handler handler2 = BaseTransientBottomBar.handler;
                handler2.sendMessage(handler2.obtainMessage(1, r52, 0, BaseTransientBottomBar.this));
            }
    ...
    private void animateViewOut(int r32) {
        if (this.view.getAnimationMode() == 1) {
            startFadeOutAnimation(r32);
        } else {
            startSlideOutAnimation(r32);
        }
    }
    ...
    public int calculateBottomMarginForAnchorView() {
        ...
        int r23 = r22[1];
        int[] r12 = new int[2];
        this.targetParent.getLocationOnScreen(r12);
        return (this.targetParent.getHeight() + r12[1]) - r23;
    }
    ...
    public int getViewAbsoluteBottom() {
        int[] r02 = new int[2];
        this.view.getLocationOnScreen(r02);
        return this.view.getHeight() + r02[1];
    }
    ...
    private void setUpBehavior(CoordinatorLayout.LayoutParams layoutParams) {
        ...
        newBehavior.setListener(new SwipeDismissBehavior.OnDismissListener() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.9
            ...
            @Override // com.google.android.material.behavior.SwipeDismissBehavior.OnDismissListener
            public void onDragStateChanged(int r22) {
                if (r22 == 0) {
    ...
    private void startFadeOutAnimation(final int r42) {
        ...
        alphaAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.12
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                BaseTransientBottomBar.this.onViewHidden(r42);
            }
        });
        alphaAnimator.start();
    }
    ...
    public void startSlideInAnimation() {
        ...
        valueAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener(translationYBottom) { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.16
            ...
            public void onAnimationUpdate(@NonNull ValueAnimator valueAnimator2) {
                int r32 = ((Integer) valueAnimator2.getAnimatedValue()).intValue();
                if (BaseTransientBottomBar.USE_OFFSET_API) {
                    ViewCompat.offsetTopAndBottom(BaseTransientBottomBar.this.view, r32 - this.previousAnimatedIntValue);
                } else {
                    BaseTransientBottomBar.this.view.setTranslationY(r32);
                }
                this.previousAnimatedIntValue = r32;
            }
        });
        valueAnimator.start();
    }

    private void startSlideOutAnimation(final int r52) {
        ValueAnimator valueAnimator = new ValueAnimator();
        ...
        valueAnimator.addListener(new AnimatorListenerAdapter() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.17
            @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
            public void onAnimationEnd(Animator animator) {
                BaseTransientBottomBar.this.onViewHidden(r52);
            }
    ...
    public void dispatchDismiss(int r32) {
        SnackbarManager.getInstance().dismiss(this.managerCallback, r32);
    }
    ...
    public final void hideView(int r22) {
    ...
    public void onViewHidden(int r32) {
        SnackbarManager.getInstance().onDismissed(this.managerCallback);
        List<BaseCallback<B>> list = this.callbacks;
        if (list != null) {
            for (int size = list.size() - 1; size >= 0; size--) {
                this.callbacks.get(size).onDismissed(this, r32);
            }
        }
    ...
    @NonNull
    public B setAnchorView(@IdRes int r32) {
        View viewFindViewById = this.targetParent.findViewById(r32);
        if (viewFindViewById != null) {
            return (B) setAnchorView(viewFindViewById);
        }
        throw new IllegalArgumentException(a.d("Unable to find anchor view with id: ", r32));
    }
    ...
    @NonNull
    public B setAnimationMode(int r22) {
        this.view.setAnimationMode(r22);
        return this;
    }
    ...
    public final void showView() {
        ...
        if (ViewCompat.isLaidOut(this.view)) {
            ...
            this.view.setOnLayoutChangeListener(new OnLayoutChangeListener() { // from class: com.google.android.material.snackbar.BaseTransientBottomBar.8
                ...
                public void onLayoutChange(View view, int r22, int r32, int r42, int r52) {
