...
public final class MaterialTimePicker extends DialogFragment {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setHour(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY, to = 23) int r22) {
            this.time.setHourOfDay(r22);
            return this;
        }

        @NonNull
        public Builder setInputMode(int r12) {
            this.inputMode = r12;
            return this;
        }

        @NonNull
        public Builder setMinute(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY, to = 60) int r22) {
            this.time.setMinute(r22);
            return this;
        }

        @NonNull
        public Builder setTheme(@StyleRes int r12) {
            this.overrideThemeResId = r12;
            return this;
        }

        @NonNull
        public Builder setTimeFormat(int r42) {
            TimeModel timeModel = this.time;
            int r12 = timeModel.hour;
            int r02 = timeModel.minute;
            TimeModel timeModel2 = new TimeModel(r42);
            this.time = timeModel2;
            timeModel2.setMinute(r02);
            this.time.setHourOfDay(r12);
            return this;
        }

        @NonNull
        public Builder setTitleText(@StringRes int r12) {
    ...
    private Pair<Integer, Integer> dataForMode(int r32) {
        if (r32 == 0) {
        ...
        throw new IllegalArgumentException(a.d("no icon for mode: ", r32));
    }
    ...
    private TimePickerPresenter initializeOrRetrieveActivePresenterForMode(int r32) {
        if (r32 != 0) {
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        int r12 = MaterialAttributes.resolveOrThrow(context, R.attr.colorSurface, MaterialTimePicker.class.getCanonicalName());
        int r32 = R.attr.materialTimePickerStyle;
        int r42 = R.style.Widget_MaterialComponents_TimePicker;
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, r32, r42);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, R.styleable.MaterialTimePicker, r32, r42);
        ...
        materialShapeDrawable.setFillColor(ColorStateList.valueOf(r12));
