...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public ChipTextInputComboView(@NonNull Context context, @Nullable AttributeSet attributeSet, int r6) {
    ...
    @Override // android.view.View
    public void setTag(int r22, Object obj) {
        this.chip.setTag(r22, obj);
    }
