...
final class LinearIndeterminateContiguousAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private void maybeUpdateSegmentColors() {
        ...
        int[] r02 = this.segmentColors;
        r02[2] = r02[1];
        r02[1] = r02[0];
        r02[0] = MaterialColors.compositeARGBWithAlpha(this.baseSpec.indicatorColors[this.newIndicatorColorIndex], this.drawable.getAlpha());
        this.dirtyColors = false;
    }

    private void updateSegmentPositions(int r42) {
        this.segmentPositions[0] = 0.0f;
        float fractionInRange = getFractionInRange(r42, 0, TOTAL_DURATION_IN_MS);
