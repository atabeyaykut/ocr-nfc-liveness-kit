...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    public BaseProgressIndicator(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int r10, @StyleRes int r11) {
        super(MaterialThemeOverlay.wrap(context, attributeSet, r10, DEF_STYLE_RES), attributeSet, r10);
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.BaseProgressIndicator, r10, r11, new int[0]);
    ...
    public void hide() {
        ...
        int r22 = this.minHideDelay;
        if (jUptimeMillis >= ((long) r22)) {
            this.delayedHide.run();
        } else {
            postDelayed(this.delayedHide, r22 - jUptimeMillis);
        }
    }
    ...
    @Override // android.widget.ProgressBar, android.view.View
    public synchronized void onMeasure(int r22, int r32) {
    ...
    public void setHideAnimationBehavior(int r22) {
        this.spec.hideAnimationBehavior = r22;
        invalidate();
    }
    ...
    public void setIndicatorColor(@ColorInt int... r42) {
        if (r42.length == 0) {
            r42 = new int[]{MaterialColors.getColor(getContext(), R.attr.colorPrimary, -1)};
        }
        if (Arrays.equals(getIndicatorColor(), r42)) {
            return;
        }
        this.spec.indicatorColors = r42;
        getIndeterminateDrawable().getAnimatorDelegate().invalidateSpecValues();
        invalidate();
    }

    @Override // android.widget.ProgressBar
    public synchronized void setProgress(int r22) {
        if (isIndeterminate()) {
            return;
        }
        setProgressCompat(r22, false);
    }

    public void setProgressCompat(int r22, boolean z10) {
        if (!isIndeterminate()) {
            super.setProgress(r22);
    ...
    public void setShowAnimationBehavior(int r22) {
        this.spec.showAnimationBehavior = r22;
        invalidate();
    }

    public void setTrackColor(@ColorInt int r32) {
        S s7 = this.spec;
        if (s7.trackColor != r32) {
            s7.trackColor = r32;
            invalidate();
        }
    }

    public void setTrackCornerRadius(@Px int r32) {
        S s7 = this.spec;
        if (s7.trackCornerRadius != r32) {
            s7.trackCornerRadius = Math.min(r32, s7.trackThickness / 2);
        }
    }

    public void setTrackThickness(@Px int r32) {
        S s7 = this.spec;
        if (s7.trackThickness != r32) {
            s7.trackThickness = r32;
            requestLayout();
        }
    }

    public void setVisibilityAfterHide(int r22) {
        if (r22 != 0 && r22 != 4 && r22 != 8) {
            throw new IllegalArgumentException("The component's visibility must be one of VISIBLE, INVISIBLE, and GONE defined in View.");
        }
        this.visibilityAfterHide = r22;
    }
