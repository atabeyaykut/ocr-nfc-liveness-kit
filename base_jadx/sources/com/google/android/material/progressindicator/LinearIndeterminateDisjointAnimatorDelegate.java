...
final class LinearIndeterminateDisjointAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private void updateSegmentPositions(int r52) {
        for (int r02 = 0; r02 < 4; r02++) {
            this.segmentPositions[r02] = Math.max(0.0f, Math.min(1.0f, this.interpolatorArray[r02].getInterpolation(getFractionInRange(r52, DELAY_TO_MOVE_SEGMENT_ENDS[r02], DURATION_TO_MOVE_SEGMENT_ENDS[r02]))));
        }
    }
    ...
    public void resetPropertiesForNewStart() {
        this.indicatorColorIndex = 0;
        int r12 = MaterialColors.compositeARGBWithAlpha(this.baseSpec.indicatorColors[0], this.drawable.getAlpha());
        int[] r22 = this.segmentColors;
        r22[0] = r12;
        r22[1] = r12;
    }
