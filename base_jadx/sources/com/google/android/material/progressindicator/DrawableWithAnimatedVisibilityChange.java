...
abstract class DrawableWithAnimatedVisibilityChange extends Drawable implements Animatable2Compat {
    ...
    @VisibleForTesting
    public void setMockHideAnimationRunning(boolean z10, @FloatRange(from = 0.0d, to = 1.0d) float f) {
        this.mockHideAnimationRunning = z10;
        this.mockGrowFraction = f;
    }

    @VisibleForTesting
    public void setMockShowAnimationRunning(boolean z10, @FloatRange(from = 0.0d, to = 1.0d) float f) {
