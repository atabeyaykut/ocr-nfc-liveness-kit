...
class BorderDrawable extends Drawable {
    ...
    public boolean getPadding(@NonNull Rect rect) {
        ...
        int r02 = Math.round(this.borderWidth);
        rect.set(r02, r02, r02, r02);
        return true;
    }
    ...
    public boolean onStateChange(int[] r32) {
        int colorForState;
        ColorStateList colorStateList = this.borderTint;
        if (colorStateList != null && (colorForState = colorStateList.getColorForState(r32, this.currentBorderTintColor)) != this.currentBorderTintColor) {
            this.invalidateShader = true;
    ...
    @Override // android.graphics.drawable.Drawable
    public void setAlpha(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY, to = 255) int r22) {
    ...
    public void setGradientColors(@ColorInt int r12, @ColorInt int r22, @ColorInt int r32, @ColorInt int r42) {
        this.topOuterStrokeColor = r12;
        this.topInnerStrokeColor = r22;
        this.bottomOuterStrokeColor = r32;
        this.bottomInnerStrokeColor = r42;
    }
