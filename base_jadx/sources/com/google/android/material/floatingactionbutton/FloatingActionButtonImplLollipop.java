...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    @NonNull
    public BorderDrawable createBorderDrawable(int r72, ColorStateList colorStateList) {
        ...
        borderDrawable.setBorderWidth(r72);
    ...
    @Override // com.google.android.material.floatingactionbutton.FloatingActionButtonImpl
    public void initializeBackgroundDrawable(ColorStateList colorStateList, @Nullable PorterDuff.Mode mode, ColorStateList colorStateList2, int r6) {
    ...
    @Override // com.google.android.material.floatingactionbutton.FloatingActionButtonImpl
    public void onDrawableStateChanged(int[] r32) {
    ...
    public void onElevationsChanged(float f, float f10, float f11) {
        ...
        if (r02 == 21) {
            ...
            stateListAnimator.addState(FloatingActionButtonImpl.PRESSED_ENABLED_STATE_SET, createElevationAnimator(f, f11));
            stateListAnimator.addState(FloatingActionButtonImpl.HOVERED_FOCUSED_ENABLED_STATE_SET, createElevationAnimator(f, f10));
            stateListAnimator.addState(FloatingActionButtonImpl.FOCUSED_ENABLED_STATE_SET, createElevationAnimator(f, f10));
            stateListAnimator.addState(FloatingActionButtonImpl.HOVERED_ENABLED_STATE_SET, createElevationAnimator(f, f10));
            AnimatorSet animatorSet = new AnimatorSet();
