...
public final class CompositeDateValidator implements CalendarConstraints.DateValidator {
    ...
    public static final Parcelable.Creator<CompositeDateValidator> CREATOR = new Parcelable.Creator<CompositeDateValidator>() { // from class: com.google.android.material.datepicker.CompositeDateValidator.3
        ...
        public CompositeDateValidator createFromParcel(@NonNull Parcel parcel) {
            ...
            return new CompositeDateValidator((List) Preconditions.checkNotNull(arrayList), (r42 != 2 && r42 == 1) ? CompositeDateValidator.ANY_OPERATOR : CompositeDateValidator.ALL_OPERATOR);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        @NonNull
        public CompositeDateValidator[] newArray(int r12) {
            return new CompositeDateValidator[r12];
        }
    };
