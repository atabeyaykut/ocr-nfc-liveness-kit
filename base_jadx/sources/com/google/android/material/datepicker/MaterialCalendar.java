...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    private void addActionsToMonthNavigation(@NonNull View view, @NonNull final MonthsPagerAdapter monthsPagerAdapter) {
        ...
        ViewCompat.setAccessibilityDelegate(materialButton, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.5
            ...
            public void onInitializeAccessibilityNodeInfo(View view2, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    ...
                    r02 = R.string.mtrl_picker_toggle_to_year_selection;
                } else {
                    materialCalendar = MaterialCalendar.this;
                    r02 = R.string.mtrl_picker_toggle_to_day_selection;
                }
                accessibilityNodeInfoCompat.setHintText(materialCalendar.getString(r02));
            }
        });
        ...
        this.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.6
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int r22, int r32) {
                ...
                int r12 = r22 < 0 ? layoutManager.findFirstVisibleItemPosition() : layoutManager.findLastVisibleItemPosition();
                MaterialCalendar.this.current = monthsPagerAdapter.getPageMonth(r12);
                materialButton.setText(monthsPagerAdapter.getPageTitle(r12));
            }
        });
        ...
        materialButton3.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.8
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                int r32 = MaterialCalendar.this.getLayoutManager().findFirstVisibleItemPosition() + 1;
                if (r32 < MaterialCalendar.this.recyclerView.getAdapter().getItemCount()) {
                    MaterialCalendar.this.setCurrentMonth(monthsPagerAdapter.getPageMonth(r32));
                }
            }
        });
        materialButton2.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.MaterialCalendar.9
            @Override // android.view.View.OnClickListener
            public void onClick(View view2) {
                int r32 = MaterialCalendar.this.getLayoutManager().findLastVisibleItemPosition() - 1;
                if (r32 >= 0) {
                    MaterialCalendar.this.setCurrentMonth(monthsPagerAdapter.getPageMonth(r32));
                }
            }
                ...
                if ((recyclerView.getAdapter() instanceof YearGridAdapter) && (recyclerView.getLayoutManager() instanceof GridLayoutManager)) {
                    ...
                    for (Pair<Long, Long> pair : MaterialCalendar.this.dateSelector.getSelectedRanges()) {
                        ...
                        if (l5 != null && pair.second != null) {
                            ...
                            for (int r82 = spanCount; r82 <= spanCount2; r82++) {
                                View viewFindViewByPosition3 = gridLayoutManager.findViewByPosition(gridLayoutManager.getSpanCount() * r82);
                                if (viewFindViewByPosition3 != null) {
                                    ...
                                    canvas.drawRect(r82 == spanCount ? (viewFindViewByPosition.getWidth() / 2) + viewFindViewByPosition.getLeft() : 0, top, r82 == spanCount2 ? (viewFindViewByPosition2.getWidth() / 2) + viewFindViewByPosition2.getLeft() : recyclerView.getWidth(), bottom, MaterialCalendar.this.calendarStyle.rangeFill);
                                }
                            }
                        }
                    }
    ...
    @NonNull
    public static <T> MaterialCalendar<T> newInstance(@NonNull DateSelector<T> dateSelector, @StyleRes int r42, @NonNull CalendarConstraints calendarConstraints) {
        MaterialCalendar<T> materialCalendar = new MaterialCalendar<>();
        Bundle bundle = new Bundle();
        bundle.putInt(THEME_RES_ID_KEY, r42);
    ...
    private void postSmoothRecyclerViewScroll(final int r32) {
        this.recyclerView.post(new Runnable() { // from class: com.google.android.material.datepicker.MaterialCalendar.10
            @Override // java.lang.Runnable
            public void run() {
                MaterialCalendar.this.recyclerView.smoothScrollToPosition(r32);
            }
        });
    }
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) throws IllegalStateException, Resources.NotFoundException {
        ...
        if (MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            r12 = R.layout.mtrl_calendar_vertical;
            r92 = 1;
        } else {
            r12 = R.layout.mtrl_calendar_horizontal;
            r92 = 0;
        }
        View viewInflate = layoutInflaterCloneInContext.inflate(r12, viewGroup, false);
        ...
        this.recyclerView.setLayoutManager(new SmoothCalendarLayoutManager(getContext(), r92, false) { // from class: com.google.android.material.datepicker.MaterialCalendar.2
            @Override // androidx.recyclerview.widget.LinearLayoutManager
            public void calculateExtraLayoutSpace(@NonNull RecyclerView.State state, @NonNull int[] r42) {
                if (r92 == 0) {
                    r42[0] = MaterialCalendar.this.recyclerView.getWidth();
                    r42[1] = MaterialCalendar.this.recyclerView.getWidth();
                } else {
                    r42[0] = MaterialCalendar.this.recyclerView.getHeight();
                    r42[1] = MaterialCalendar.this.recyclerView.getHeight();
                }
            }
        });
