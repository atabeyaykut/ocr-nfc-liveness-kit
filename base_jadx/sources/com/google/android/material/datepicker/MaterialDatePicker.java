...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public static final class Builder<S> {
        ...
        @NonNull
        public Builder<S> setInputMode(int r12) {
            this.inputMode = r12;
            return this;
        }
        ...
        @NonNull
        public Builder<S> setTheme(@StyleRes int r12) {
            this.overrideThemeResId = r12;
            return this;
        }

        @NonNull
        public Builder<S> setTitleText(@StringRes int r12) {
            this.titleTextResId = r12;
            this.titleText = null;
            return this;
        }
    ...
    private static int getDialogPickerHeight(@NonNull Context context) throws Resources.NotFoundException {
        ...
        int r22 = MonthAdapter.MAXIMUM_WEEKS;
        return a.a(dimensionPixelOffset, dimensionPixelSize, (resources.getDimensionPixelOffset(com.google.android.material.R.dimen.mtrl_calendar_month_vertical_padding) * (r22 - 1)) + (resources.getDimensionPixelSize(com.google.android.material.R.dimen.mtrl_calendar_day_height) * r22), resources.getDimensionPixelOffset(com.google.android.material.R.dimen.mtrl_calendar_bottom_padding));
    }
    ...
    private static int getPaddedPickerWidth(@NonNull Context context) throws Resources.NotFoundException {
        ...
        int r12 = Month.current().daysInWeek;
        return ((r12 - 1) * resources.getDimensionPixelOffset(com.google.android.material.R.dimen.mtrl_calendar_month_horizontal_padding)) + (resources.getDimensionPixelSize(com.google.android.material.R.dimen.mtrl_calendar_day_width) * r12) + (dimensionPixelOffset * 2);
    }

    private int getThemeResId(Context context) {
        int r02 = this.overrideThemeResId;
        return r02 != 0 ? r02 : this.dateSelector.getDefaultThemeResId(context);
    }
    ...
    public static boolean readMaterialCalendarStyleBoolean(@NonNull Context context, int r42) throws Resources.NotFoundException {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, com.google.android.material.R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{r42});
    ...
    public final Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        int r12 = MaterialAttributes.resolveOrThrow(context, com.google.android.material.R.attr.colorSurface, MaterialDatePicker.class.getCanonicalName());
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, com.google.android.material.R.attr.materialCalendarStyle, com.google.android.material.R.style.Widget_MaterialComponents_MaterialCalendar);
        this.background = materialShapeDrawable;
        materialShapeDrawable.initializeElevationOverlay(context);
        this.background.setFillColor(ColorStateList.valueOf(r12));
