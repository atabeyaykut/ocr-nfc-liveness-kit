...
class YearGridAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    @NonNull
    private View.OnClickListener createYearClickListener(final int r22) {
        return new View.OnClickListener() { // from class: com.google.android.material.datepicker.YearGridAdapter.1
            @Override // android.view.View.OnClickListener
            public void onClick(View view) {
                YearGridAdapter.this.materialCalendar.setCurrentMonth(YearGridAdapter.this.materialCalendar.getCalendarConstraints().clamp(Month.create(r22, YearGridAdapter.this.materialCalendar.getCurrentMonth().month)));
    ...
    public int getPositionForYear(int r22) {
        return r22 - this.materialCalendar.getCalendarConstraints().getStart().year;
    }

    public int getYearForPosition(int r22) {
        return this.materialCalendar.getCalendarConstraints().getStart().year + r22;
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int r92) {
        int yearForPosition = getYearForPosition(r92);
