...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void calculateCenterAndBounds(@NonNull Context context, @NonNull Rect rect, @NonNull View view) throws Resources.NotFoundException {
        float textWidth;
        int r12 = this.savedState.additionalVerticalOffset + this.savedState.verticalOffset;
        int r02 = this.savedState.badgeGravity;
        this.badgeCenterY = (r02 == 8388691 || r02 == 8388693) ? rect.bottom - r12 : rect.top + r12;
        if (getNumber() <= 9) {
        ...
        int r13 = this.savedState.additionalHorizontalOffset + this.savedState.horizontalOffset;
        int r03 = this.savedState.badgeGravity;
        this.badgeCenterX = (r03 == 8388659 || r03 == 8388691 ? ViewCompat.getLayoutDirection(view) != 0 : ViewCompat.getLayoutDirection(view) == 0) ? ((rect.right + this.halfBadgeWidth) - dimensionPixelSize) - r13 : (rect.left - this.halfBadgeWidth) + dimensionPixelSize + r13;
    }
    ...
    @NonNull
    private static BadgeDrawable createFromAttributes(@NonNull Context context, AttributeSet attributeSet, @AttrRes int r32, @StyleRes int r42) throws Resources.NotFoundException {
        BadgeDrawable badgeDrawable = new BadgeDrawable(context);
        badgeDrawable.loadDefaultStateFromAttributes(context, attributeSet, r32, r42);
        return badgeDrawable;
    }

    @NonNull
    public static BadgeDrawable createFromResource(@NonNull Context context, @XmlRes int r32) {
        AttributeSet drawableXml = DrawableUtils.parseDrawableXml(context, r32, "badge");
    ...
    private void loadDefaultStateFromAttributes(Context context, AttributeSet attributeSet, @AttrRes int r10, @StyleRes int r11) throws Resources.NotFoundException {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.Badge, r10, r11, new int[0]);
        setMaxCharacterCount(typedArrayObtainStyledAttributes.getInt(R.styleable.Badge_maxCharacterCount, 4));
        int r102 = R.styleable.Badge_number;
        if (typedArrayObtainStyledAttributes.hasValue(r102)) {
            setNumber(typedArrayObtainStyledAttributes.getInt(r102, 0));
        }
        setBackgroundColor(readColorFromAttributes(context, typedArrayObtainStyledAttributes, R.styleable.Badge_backgroundColor));
        int r103 = R.styleable.Badge_badgeTextColor;
        if (typedArrayObtainStyledAttributes.hasValue(r103)) {
            setBadgeTextColor(readColorFromAttributes(context, typedArrayObtainStyledAttributes, r103));
        }
    ...
    private static int readColorFromAttributes(Context context, @NonNull TypedArray typedArray, @StyleableRes int r22) {
        return MaterialResources.getColorStateList(context, typedArray, r22).getDefaultColor();
    }
    ...
    private void setTextAppearanceResource(@StyleRes int r32) throws Resources.NotFoundException {
        Context context = this.contextRef.get();
        if (context == null) {
            return;
        }
        setTextAppearance(new TextAppearance(context, r32));
    }
    ...
    private void tryWrapAnchorInCompatParent(final View view) {
        ...
        if (viewGroup == null || viewGroup.getId() != R.id.mtrl_anchor_parent) {
            ...
            if (weakReference == null || weakReference.get() != viewGroup) {
                ...
                int r22 = viewGroup.indexOfChild(view);
                viewGroup.removeViewAt(r22);
                view.setLayoutParams(new FrameLayout.LayoutParams(-1, -1));
                frameLayout.addView(view);
                viewGroup.addView(frameLayout, r22);
    ...
    public void setAdditionalHorizontalOffset(int r22) throws Resources.NotFoundException {
        this.savedState.additionalHorizontalOffset = r22;
        updateCenterAndBounds();
    }

    public void setAdditionalVerticalOffset(int r22) throws Resources.NotFoundException {
        this.savedState.additionalVerticalOffset = r22;
        updateCenterAndBounds();
    }

    @Override // android.graphics.drawable.Drawable
    public void setAlpha(int r22) {
        this.savedState.alpha = r22;
        this.textDrawableHelper.getTextPaint().setAlpha(r22);
        invalidateSelf();
    }

    public void setBackgroundColor(@ColorInt int r22) {
        this.savedState.backgroundColor = r22;
        ColorStateList colorStateListValueOf = ColorStateList.valueOf(r22);
    ...
    public void setBadgeGravity(int r22) throws Resources.NotFoundException {
        if (this.savedState.badgeGravity != r22) {
            this.savedState.badgeGravity = r22;
            WeakReference<View> weakReference = this.anchorViewRef;
    ...
    public void setBadgeTextColor(@ColorInt int r22) {
        this.savedState.badgeTextColor = r22;
        if (this.textDrawableHelper.getTextPaint().getColor() != r22) {
            this.textDrawableHelper.getTextPaint().setColor(r22);
            invalidateSelf();
        }
    }
    ...
    public void setContentDescriptionExceedsMaxBadgeNumberStringResource(@StringRes int r22) {
        this.savedState.contentDescriptionExceedsMaxBadgeNumberRes = r22;
    }
    ...
    public void setContentDescriptionQuantityStringsResource(@PluralsRes int r22) {
        this.savedState.contentDescriptionQuantityStrings = r22;
    }

    public void setHorizontalOffset(int r22) throws Resources.NotFoundException {
        this.savedState.horizontalOffset = r22;
        updateCenterAndBounds();
    }

    public void setMaxCharacterCount(int r22) throws Resources.NotFoundException {
        if (this.savedState.maxCharacterCount != r22) {
            this.savedState.maxCharacterCount = r22;
    ...
    public void setNumber(int r22) throws Resources.NotFoundException {
        int r23 = Math.max(0, r22);
        if (this.savedState.number != r23) {
            this.savedState.number = r23;
            this.textDrawableHelper.setTextWidthDirty(true);
            updateCenterAndBounds();
            invalidateSelf();
        }
    ...
    public void setVerticalOffset(int r22) throws Resources.NotFoundException {
        this.savedState.verticalOffset = r22;
        updateCenterAndBounds();
    }
