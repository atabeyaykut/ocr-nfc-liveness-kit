...
@r9.e(c = "tr.gov.turkiye.edevlet.kapisi.dashboard.ebys.ElectronicDocServicesViewModel$fetchElectronicService$2", f = "ElectronicDocServicesViewModel.kt", l = {}, m = "invokeSuspend")
...
public final class h extends r9.i implements p<kotlinx.coroutines.flow.f<? extends Result<List<? extends ServiceModelRealm>>>, p9.d<? super l9.m>, Object> {
    ...
    public /* synthetic */ Object f13177a;
    ...
    public static final class a extends kotlin.jvm.internal.j implements p<c, r0.b<? extends Result<List<? extends ServiceModelRealm>>>, c> {
        ...
        public final c mo7invoke(c cVar, r0.b<? extends Result<List<? extends ServiceModelRealm>>> bVar) {
            ...
            try {
                ...
                return orThrow != null ? c.copy$default(execute, result, orThrow, null, false, false, null, 60, null) : c.copy$default(execute, result, null, null, false, false, null, 62, null);
            } catch (Throwable th2) {
                return c.copy$default(execute, new r0.i(null, th2), null, null, false, false, null, 62, null);
            }
        }
    }
    ...
    public final p9.d<l9.m> create(Object obj, p9.d<?> dVar) {
        h hVar = new h(this.f13178b, dVar);
        hVar.f13177a = obj;
        return hVar;
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        w.F(obj);
        z.a(this.f13178b, (kotlinx.coroutines.flow.f) this.f13177a, a.f13179a);
        return l9.m.f9594a;
    }
}
