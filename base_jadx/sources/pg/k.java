...
public final class k extends BroadcastReceiver {
    ...
    public final /* synthetic */ PaymentPageActivity f13211a;

    public k(PaymentPageActivity paymentPageActivity) {
        this.f13211a = paymentPageActivity;
    }

    @Override // android.content.BroadcastReceiver
    public final void onReceive(Context context, Intent intent) {
        PaymentPageActivity paymentPageActivity = this.f13211a;
        try {
            int r02 = PaymentPageActivity.f16765y;
            paymentPageActivity.y();
            ...
            if (cursorQuery.moveToFirst()) {
                ...
                if (file.exists()) {
                    ...
                    c.b(paymentPageActivity, file, mimeType);
                } else {
                    paymentPageActivity.A();
                }
            }
            cursorQuery.close();
        } catch (Exception unused) {
            int r82 = PaymentPageActivity.f16765y;
            paymentPageActivity.A();
        }
    }
}
