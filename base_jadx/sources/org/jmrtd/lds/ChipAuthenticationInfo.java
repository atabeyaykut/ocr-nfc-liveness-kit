...
public class ChipAuthenticationInfo extends SecurityInfo {
    ...
    public ChipAuthenticationInfo(String str, int r32) {
        this(str, r32, null);
    }

    public ChipAuthenticationInfo(String str, int r22, BigInteger bigInteger) {
        this.oid = str;
        this.version = r22;
    ...
    public int hashCode() {
        String str = this.oid;
        int r12 = (this.version * 61) + ((str == null ? 0 : str.hashCode()) * 11) + 3;
        BigInteger bigInteger = this.keyId;
        return ((bigInteger == null ? 111 : bigInteger.hashCode()) * 1991) + r12;
    }
