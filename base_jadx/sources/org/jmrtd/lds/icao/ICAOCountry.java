...
public class ICAOCountry extends Country {
    ...
    static {
        ...
        XXX = iCAOCountry11;
        ICAOCountry iCAOCountry12 = new ICAOCountry("EU", "EUE", "Europe", "European");
        EUE = iCAOCountry12;
    ...
    public static Country getInstance(String str) {
        ...
        try {
            ...
            LOGGER.log(Level.FINE, "Unknown country", (Throwable) e10);
            throw new IllegalArgumentException(b.e("Illegal ICAO country alpha 3 code ", str));
        }
    }
