...
public class FingerImageInfo extends AbstractImageInfo {
    ...
    public FingerImageInfo(int r13, int r14, int r15, int r16, int r17, int r18, int r19, InputStream inputStream, int r21, int r22) throws IOException {
        long j10 = r21;
        super(2, r18, r19, inputStream, j10, FingerInfo.toMimeType(r22));
        if (r16 < 0 || r16 > 100) {
        ...
        this.viewNumber = r15;
        this.quality = r16;
        this.impressionType = r17;
        this.compressionAlgorithm = r22;
        this.recordLength = j10 + 14;
    }

    public FingerImageInfo(InputStream inputStream, int r42) throws IOException {
        super(2, FingerInfo.toMimeType(r42));
        this.compressionAlgorithm = r42;
        readObject(inputStream);
    }

    private static String impressionTypeToString(int r12) {
        if (r12 == 0) {
    ...
    private static String positionToString(int r02) {
        switch (r02) {
            case 0:
    ...
    private static int toBiometricSubtype(int r22) {
        switch (r22) {
            case 1:
                return 5;
            case 2:
    ...
    @Override // org.jmrtd.lds.AbstractImageInfo
    public int hashCode() {
        int r02 = ((((((((super.hashCode() * 31) + this.compressionAlgorithm) * 31) + this.impressionType) * 31) + this.position) * 31) + this.quality) * 31;
        long j10 = this.recordLength;
        return ((((r02 + ((int) (j10 ^ (j10 >>> 32)))) * 31) + this.viewCount) * 31) + this.viewNumber;
    }
