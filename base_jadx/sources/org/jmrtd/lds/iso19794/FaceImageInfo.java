...
public class FaceImageInfo extends AbstractImageInfo {
    ...
    public enum EyeColor {
        ...
        public static EyeColor toEyeColor(int r52) {
            for (EyeColor eyeColor : values()) {
                if (eyeColor.toInt() == r52) {
                    return eyeColor;
                }
            }
            return UNKNOWN;
    ...
    public static class FeaturePoint implements Serializable {
        ...
        public FeaturePoint(int r82, byte b10, int r10, int r11) {
            this(r82, (b10 & 240) >> 4, b10 & PassportService.SFI_DG15, r10, r11);
        }

        public FeaturePoint(int r12, int r22, int r32, int r42, int r52) {
            this.type = r12;
            this.majorCode = r22;
            this.minorCode = r32;
            this.f12082x = r42;
        ...
        public String toString() {
            ...
            sb2.append(", (");
            sb2.append(this.f12082x);
            sb2.append(", ");
            return a.b(sb2, this.f12083y, "))");
        }
    }
    ...
    public enum HairColor {
        ...
        public static HairColor toHairColor(int r52) {
            for (HairColor hairColor : values()) {
                if (hairColor.toInt() == r52) {
                    return hairColor;
                }
            }
            return UNKNOWN;
    ...
    public FaceImageInfo(Gender gender, EyeColor eyeColor, int r18, int r19, int r20, int[] r21, int[] r22, int r23, int r24, int r25, int r26, int r27, FeaturePoint[] featurePointArr, int r29, int r30, InputStream inputStream, int r32, int r33) throws IOException {
        long j10 = r32;
        super(0, r29, r30, inputStream, j10, toMimeType(r33));
        if (inputStream == null) {
            throw new IllegalArgumentException("Null image");
        }
        this.gender = gender == null ? Gender.UNSPECIFIED : gender;
        this.eyeColor = eyeColor == null ? EyeColor.UNSPECIFIED : eyeColor;
        this.featureMask = r18;
        this.hairColor = r19;
        this.expression = r20;
        this.colorSpace = r24;
        this.sourceType = r25;
        ...
        int[] r34 = new int[3];
        this.poseAngle = r34;
        System.arraycopy(r21, 0, r34, 0, 3);
        int[] r35 = new int[3];
        this.poseAngleUncertainty = r35;
        System.arraycopy(r22, 0, r35, 0, 3);
        this.imageDataType = r33;
        this.recordLength = (length * 8) + 20 + 12 + j10;
        this.faceImageType = r23;
        this.colorSpace = r24;
        this.sourceType = r25;
        this.deviceType = r26;
        this.quality = r27;
    ...
    private String faceImageTypeToString() {
        int r02 = this.faceImageType;
        return r02 != 0 ? r02 != 1 ? r02 != 2 ? EnvironmentCompat.MEDIA_UNKNOWN : "token frontal" : "full frontal" : "basic";
    }
    ...
    private static String toMimeType(int r32) {
        if (r32 == 0) {
        ...
        LOGGER.warning("Unknown image type: " + r32);
        return null;
    }
    ...
    private void writeFacialRecordData(OutputStream outputStream) throws IOException {
        ...
        for (int r12 = 0; r12 < 3; r12++) {
            dataOutputStream.writeByte(this.poseAngle[r12]);
        }
        for (int r13 = 0; r13 < 3; r13++) {
            dataOutputStream.writeByte(this.poseAngleUncertainty[r13]);
        }
    ...
    public int[] getPoseAngle() {
        int[] r12 = new int[3];
        System.arraycopy(this.poseAngle, 0, r12, 0, 3);
        return r12;
    }

    public int[] getPoseAngleUncertainty() {
        int[] r12 = new int[3];
        System.arraycopy(this.poseAngleUncertainty, 0, r12, 0, 3);
        return r12;
    }
    ...
    @Override // org.jmrtd.lds.AbstractImageInfo
    public int hashCode() {
        int r02 = ((((((super.hashCode() * 31) + this.colorSpace) * 31) + this.deviceType) * 31) + this.expression) * 31;
        EyeColor eyeColor = this.eyeColor;
        int r03 = (((((((r02 + (eyeColor == null ? 0 : eyeColor.hashCode())) * 31) + this.faceImageType) * 31) + this.featureMask) * 31) + Arrays.hashCode(this.featurePoints)) * 31;
        Gender gender = this.gender;
        int r04 = (((Arrays.hashCode(this.poseAngleUncertainty) + ((Arrays.hashCode(this.poseAngle) + ((((((r03 + (gender != null ? gender.hashCode() : 0)) * 31) + this.hairColor) * 31) + this.imageDataType) * 31)) * 31)) * 31) + this.quality) * 31;
        long j10 = this.recordLength;
        return ((r04 + ((int) (j10 ^ (j10 >>> 32)))) * 31) + this.sourceType;
    }
    ...
    public void readObject(InputStream inputStream) throws IOException {
        ...
        this.featureMask = unsignedByte2;
        this.featureMask = (unsignedByte2 << 16) | dataInputStream.readUnsignedShort();
        ...
        while (true) {
            ...
            this.featurePoints[r52] = new FeaturePoint(unsignedByte, b10, unsignedShort2, unsignedShort3);
            r52++;
        }
        this.faceImageType = unsignedByte;
