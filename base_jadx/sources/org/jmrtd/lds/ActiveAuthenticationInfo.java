...
public class ActiveAuthenticationInfo extends SecurityInfo {
    ...
    public ActiveAuthenticationInfo(String str, int r22, String str2) {
        this.oid = str;
        this.version = r22;
    ...
    public static String lookupMnemonicByOID(String str) throws NoSuchAlgorithmException {
        ...
        throw new NoSuchAlgorithmException(b.e("Unknown OID ", str));
    }
    ...
    public int hashCode() {
        String str = this.oid;
        int r12 = (this.version * 5) + ((str == null ? 0 : str.hashCode()) * 3) + 12345;
        String str2 = this.signatureAlgorithmOID;
        return ((str2 == null ? 1 : str2.hashCode()) * 11) + r12;
    }
