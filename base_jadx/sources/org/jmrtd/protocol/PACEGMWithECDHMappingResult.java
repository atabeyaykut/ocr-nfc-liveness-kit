...
public class PACEGMWithECDHMappingResult extends PACEGMMappingResult {
    ...
    public boolean equals(Object obj) {
        ...
        BigInteger bigInteger3 = pACEGMWithECDHMappingResult.sharedSecretPointY;
        if (bigInteger2 == null) {
            if (bigInteger3 != null) {
                return false;
            }
    ...
    public int hashCode() {
        ...
        BigInteger bigInteger = this.sharedSecretPointX;
        int r03 = r02 + (bigInteger == null ? 0 : bigInteger.hashCode());
        BigInteger bigInteger2 = this.sharedSecretPointY;
        return r03 + (bigInteger2 != null ? bigInteger2.hashCode() : 0);
    }
}
