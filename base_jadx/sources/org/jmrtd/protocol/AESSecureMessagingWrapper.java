...
public class AESSecureMessagingWrapper extends SecureMessagingWrapper {
    ...
    public AESSecureMessagingWrapper(SecretKey secretKey, SecretKey secretKey2, int r12, boolean z10, long j10) throws GeneralSecurityException {
        super(secretKey, secretKey2, "AES/CBC/NoPadding", "AESCMAC", r12, z10, j10);
        this.sscIVCipher = Util.getCipher("AES/ECB/NoPadding", 1, secretKey);
    }

    public AESSecureMessagingWrapper(SecretKey secretKey, SecretKey secretKey2, long j10) throws GeneralSecurityException {
