...
public class PACECAMResult extends PACEResult {
    ...
    public PACECAMResult(AccessKeySpec accessKeySpec, String str, String str2, String str3, int r19, PACEMappingResult pACEMappingResult, KeyPair keyPair, PublicKey publicKey, byte[] bArr, byte[] bArr2, SecureMessagingWrapper secureMessagingWrapper) {
        super(accessKeySpec, PACEInfo.MappingType.CAM, str, str2, str3, r19, pACEMappingResult, keyPair, publicKey, secureMessagingWrapper);
    ...
    @Override // org.jmrtd.protocol.PACEResult
    public int hashCode() {
        return Arrays.hashCode(this.encryptedChipAuthenticationData) + ((Arrays.hashCode(this.chipAuthenticationData) + (super.hashCode() * 31)) * 31);
    }
