...
public class ScryptParams extends ASN1Object {
    ...
    private ScryptParams(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() != 4 && aSN1Sequence.size() != 5) {
            throw new IllegalArgumentException(a.g(aSN1Sequence, new StringBuilder("invalid sequence: size = ")));
        }
        this.salt = androidx.fragment.app.a.i(aSN1Sequence, 0);
    ...
    public ScryptParams(byte[] bArr, int r10, int r11, int r12) {
        this(bArr, BigInteger.valueOf(r10), BigInteger.valueOf(r11), BigInteger.valueOf(r12), (BigInteger) null);
    }

    public ScryptParams(byte[] bArr, int r10, int r11, int r12, int r13) {
        this(bArr, BigInteger.valueOf(r10), BigInteger.valueOf(r11), BigInteger.valueOf(r12), BigInteger.valueOf(r13));
    }
