...
public class MonetaryLimit extends ASN1Object {
    ...
    public MonetaryLimit(String str, int r42, int r52) {
        this.currency = new DERPrintableString(str, true);
        this.amount = new ASN1Integer(r42);
        this.exponent = new ASN1Integer(r52);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        return androidx.browser.browseractions.a.e(aSN1EncodableVector, this.exponent, aSN1EncodableVector);
    }
}
