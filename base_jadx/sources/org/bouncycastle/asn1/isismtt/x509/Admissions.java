...
public class Admissions extends ASN1Object {
    ...
    private Admissions(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Encodable instanceof ASN1TaggedObject) {
            ...
            if (tagNo == 0) {
                ...
                if (tagNo != 1) {
                    throw new IllegalArgumentException(b.h(aSN1TaggedObject, new StringBuilder("Bad tag number: ")));
                }
        ...
        if (aSN1Encodable instanceof ASN1TaggedObject) {
            ...
            if (aSN1TaggedObject2.getTagNo() != 1) {
                throw new IllegalArgumentException(b.h(aSN1TaggedObject2, new StringBuilder("Bad tag number: ")));
            }
    ...
    public static Admissions getInstance(Object obj) {
        ...
        throw new IllegalArgumentException(ab.b.f(obj, "illegal object in getInstance: "));
    }
    ...
    public ProfessionInfo[] getProfessionInfos() {
        ...
        while (objects.hasMoreElements()) {
            professionInfoArr[r22] = ProfessionInfo.getInstance(objects.nextElement());
            r22++;
        }
