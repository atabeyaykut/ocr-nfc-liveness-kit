...
public class KMACwithSHAKE128_params extends ASN1Object {
    ...
    public KMACwithSHAKE128_params(int r12) {
        this.outputLength = r12;
        this.customizationString = EMPTY_STRING;
    }

    public KMACwithSHAKE128_params(int r12, byte[] bArr) {
        this.outputLength = r12;
    ...
    private KMACwithSHAKE128_params(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() == 2) {
            this.outputLength = f.f(aSN1Sequence, 0);
            this.customizationString = a.i(aSN1Sequence, 1);
            ...
            this.outputLength = 256;
            this.customizationString = a.i(aSN1Sequence, 0);
        }
    }
