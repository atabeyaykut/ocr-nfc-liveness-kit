...
abstract class ASN1UniversalType extends ASN1Type {
    ...
    public ASN1UniversalType(Class cls, int r22) {
        super(cls);
        this.tag = ASN1Tag.create(0, r22);
    }
    ...
    public final ASN1Primitive getContextInstance(ASN1TaggedObject aSN1TaggedObject, boolean z10) {
        return checkedCast(ASN1Util.checkContextTagClass(aSN1TaggedObject).getBaseUniversal(z10, this));
    }
