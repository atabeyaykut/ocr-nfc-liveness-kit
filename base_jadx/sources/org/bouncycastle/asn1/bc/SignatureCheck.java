...
public class SignatureCheck extends ASN1Object {
    ...
    private SignatureCheck(ASN1Sequence aSN1Sequence) {
        ...
        this.signatureValue = ASN1BitString.getInstance(aSN1Sequence.getObjectAt(r02));
    }
    ...
    public Certificate[] getCertificates() {
        ...
        for (int r22 = 0; r22 != size; r22++) {
            certificateArr[r22] = Certificate.getInstance(this.certificates.getObjectAt(r22));
        }
