...
public class DSTU4145NamedCurves {
    ...
    static {
        ...
        while (true) {
            ...
            if (r12 >= eCDomainParametersArr.length) {
                break;
            }
            eCDomainParametersArr[r12] = new ECDomainParameters(f2mArr[r12], eCPointArr[r12], bigIntegerArr[r12], bigIntegerArr2[r12]);
            r12++;
        }
        while (true) {
            ASN1ObjectIdentifier[] aSN1ObjectIdentifierArr = oids;
            if (r15 >= aSN1ObjectIdentifierArr.length) {
                return;
            }
            aSN1ObjectIdentifierArr[r15] = new ASN1ObjectIdentifier(oidBase + r15);
            r15++;
        }
    }
    ...
    public static ECDomainParameters getByOID(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        if (!id2.startsWith(oidBase) || (r32 = Integer.parseInt(id2.substring(id2.lastIndexOf(46) + 1))) < 0) {
            return null;
        }
        ECDomainParameters[] eCDomainParametersArr = params;
        if (r32 < eCDomainParametersArr.length) {
            return eCDomainParametersArr[r32];
        }
        return null;
    }
