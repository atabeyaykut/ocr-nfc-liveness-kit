...
public class RecipientIdentifier extends ASN1Object implements ASN1Choice {
    ...
    public static RecipientIdentifier getInstance(Object obj) {
        ...
        throw new IllegalArgumentException(b.f(obj, "Illegal object in RecipientIdentifier: "));
    }

    public ASN1Encodable getId() {
        ASN1Encodable aSN1Encodable = this.f11367id;
    ...
    public boolean isTagged() {
        return this.f11367id instanceof ASN1TaggedObject;
    }

    @Override // org.bouncycastle.asn1.ASN1Object, org.bouncycastle.asn1.ASN1Encodable
    public ASN1Primitive toASN1Primitive() {
        return this.f11367id.toASN1Primitive();
    }
}
