...
public class CMSORIforKEMOtherInfo extends ASN1Object {
    ...
    public CMSORIforKEMOtherInfo(AlgorithmIdentifier algorithmIdentifier, int r32) {
        this(algorithmIdentifier, r32, null);
    }

    public CMSORIforKEMOtherInfo(AlgorithmIdentifier algorithmIdentifier, int r22, byte[] bArr) {
