...
public class CMSAlgorithmProtection extends ASN1Object {
    ...
    private CMSAlgorithmProtection(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1TaggedObject.getTagNo() == 1) {
            ...
            if (aSN1TaggedObject.getTagNo() != 2) {
                throw new IllegalArgumentException(b.h(aSN1TaggedObject, new StringBuilder("Unknown tag found: ")));
            }
    ...
    public CMSAlgorithmProtection(AlgorithmIdentifier algorithmIdentifier, int r32, AlgorithmIdentifier algorithmIdentifier2) {
        ...
        if (r32 == 1) {
            ...
            if (r32 != 2) {
                throw new IllegalArgumentException(a.d("Unknown type: ", r32));
            }
            this.signatureAlgorithm = null;
