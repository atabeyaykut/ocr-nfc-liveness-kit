...
public class AttributeTable {
    ...
    public AttributeTable(ASN1EncodableVector aSN1EncodableVector) {
        this.attributes = new Hashtable();
        for (int r02 = 0; r02 != aSN1EncodableVector.size(); r02++) {
            Attribute attribute = Attribute.getInstance(aSN1EncodableVector.get(r02));
    ...
    public AttributeTable(ASN1Set aSN1Set) {
        ...
        for (int r02 = 0; r02 != aSN1Set.size(); r02++) {
            Attribute attribute = Attribute.getInstance(aSN1Set.getObjectAt(r02));
            addAttribute(attribute.getAttrType(), attribute);
        }
    }
    ...
    public int size() {
        ...
        while (enumerationElements.hasMoreElements()) {
            ...
            size = objNextElement instanceof Vector ? ((Vector) objNextElement).size() + size : size + 1;
        }
        return size;
    }
