...
public class AuthEnvelopedData extends ASN1Object {
    ...
    private AuthEnvelopedData(ASN1Sequence aSN1Sequence) {
        ...
        int r12 = r32 + 1;
        this.authEncryptedContentInfo = EncryptedContentInfo.getInstance(aSN1Sequence.getObjectAt(r32).toASN1Primitive());
        int r22 = r12 + 1;
        ASN1Primitive aSN1Primitive2 = aSN1Sequence.getObjectAt(r12).toASN1Primitive();
        if (aSN1Primitive2 instanceof ASN1TaggedObject) {
            this.authAttrs = ASN1Set.getInstance((ASN1TaggedObject) aSN1Primitive2, false);
            int r13 = r22 + 1;
            ASN1Primitive aSN1Primitive3 = aSN1Sequence.getObjectAt(r22).toASN1Primitive();
            r22 = r13;
        ...
        if (aSN1Sequence.size() > r22) {
            this.unauthAttrs = ASN1Set.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(r22).toASN1Primitive(), false);
        }
    }
