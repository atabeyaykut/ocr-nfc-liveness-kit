...
public class RevokeRequest extends ASN1Object {
    ...
    private RevokeRequest(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() > r12 && (aSN1Sequence.getObjectAt(r12).toASN1Primitive() instanceof ASN1OctetString)) {
            this.passphrase = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(r12));
            r12++;
        }
        if (aSN1Sequence.size() <= r12 || !(aSN1Sequence.getObjectAt(r12).toASN1Primitive() instanceof ASN1UTF8String)) {
            return;
        }
        this.comment = ASN1UTF8String.getInstance(aSN1Sequence.getObjectAt(r12));
    }
