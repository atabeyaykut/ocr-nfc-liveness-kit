...
public class RDN extends ASN1Object {
    ...
    public static RDN getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z10) {
        return new RDN(ASN1Set.getInstance(aSN1TaggedObject, z10));
    }

    public int collectAttributeTypes(ASN1ObjectIdentifier[] aSN1ObjectIdentifierArr, int r6) {
        int size = this.values.size();
        for (int r12 = 0; r12 < size; r12++) {
            aSN1ObjectIdentifierArr[r6 + r12] = AttributeTypeAndValue.getInstance(this.values.getObjectAt(r12)).getType();
        }
        return size;
    }
    ...
    public boolean containsAttributeType(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        for (int r22 = 0; r22 < size; r22++) {
            if (AttributeTypeAndValue.getInstance(this.values.getObjectAt(r22)).getType().equals((ASN1Primitive) aSN1ObjectIdentifier)) {
                return true;
            }
        }
        return false;
    ...
    public AttributeTypeAndValue[] getTypesAndValues() {
        ...
        for (int r22 = 0; r22 != size; r22++) {
            attributeTypeAndValueArr[r22] = AttributeTypeAndValue.getInstance(this.values.getObjectAt(r22));
        }
