...
public class TBSRequest extends ASN1Object {
    ...
    private TBSRequest(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.getObjectAt(r02) instanceof ASN1TaggedObject) {
            this.requestorName = GeneralName.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(r02), true);
            r02++;
        }
        int r12 = r02 + 1;
        this.requestList = (ASN1Sequence) aSN1Sequence.getObjectAt(r02);
        if (aSN1Sequence.size() == r12 + 1) {
            this.requestExtensions = Extensions.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(r12), true);
        }
    }
