...
public class CVCertificate extends ASN1Object {
    ...
    private void setPrivateData(ASN1TaggedObject aSN1TaggedObject) throws IOException {
        ...
        if (!aSN1TaggedObject.hasTag(64, 33)) {
            throw new IOException(b.h(aSN1TaggedObject, new StringBuilder("not a CARDHOLDER_CERTIFICATE :")));
        }
        ...
        while (objects.hasMoreElements()) {
            ...
            if (tagNo == 55) {
                ...
                if (tagNo != 78) {
                    throw new IOException(b.h(aSN1TaggedObject2, new StringBuilder("Invalid tag, not an Iso7816CertificateStructure :")));
                }
        ...
        if (this.valid != (signValid | bodyValid)) {
            throw new IOException(b.h(aSN1TaggedObject, new StringBuilder("invalid CARDHOLDER_CERTIFICATE :")));
        }
    }
