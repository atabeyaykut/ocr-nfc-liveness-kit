...
public class CertificateHolderAuthorization extends ASN1Object {
    ...
    public CertificateHolderAuthorization(ASN1ObjectIdentifier aSN1ObjectIdentifier, int r22) throws IOException {
        setOid(aSN1ObjectIdentifier);
        setAccessRights((byte) r22);
    }
    ...
    public static int getFlag(String str) {
        ...
        throw new IllegalArgumentException(b.e("Unknown value ", str));
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static String getRoleDescription(int r12) {
        return (String) AuthorizationRole.get(Integers.valueOf(r12));
    }

    private void setAccessRights(byte b10) {
        this.accessRights = b10;
    }
