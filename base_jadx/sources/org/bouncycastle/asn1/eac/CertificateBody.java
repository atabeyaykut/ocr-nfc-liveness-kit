...
public class CertificateBody extends ASN1Object {
    ...
    private CertificateBody(ASN1TaggedObject aSN1TaggedObject) throws IOException, IllegalArgumentException {
    ...
    private void setCertificateEffectiveDate(ASN1TaggedObject aSN1TaggedObject) throws IllegalArgumentException {
        if (!aSN1TaggedObject.hasTag(64, 37)) {
            throw new IllegalArgumentException(b.h(aSN1TaggedObject, new StringBuilder("Not an Iso7816Tags.APPLICATION_EFFECTIVE_DATE tag :")));
        }
    ...
    private void setCertificateProfileIdentifier(ASN1TaggedObject aSN1TaggedObject) throws IllegalArgumentException {
        if (!aSN1TaggedObject.hasTag(64, 41)) {
            throw new IllegalArgumentException(b.h(aSN1TaggedObject, new StringBuilder("Not an Iso7816Tags.INTERCHANGE_PROFILE tag :")));
        }
    ...
    private void setIso7816CertificateBody(ASN1TaggedObject aSN1TaggedObject) throws IOException, IllegalArgumentException {
        ...
        for (int r42 = 0; r42 < size; r42++) {
            ASN1TaggedObject aSN1TaggedObject2 = ASN1TaggedObject.getInstance(aSN1Sequence.getObjectAt(r42), 64);
            ...
            if (tagNo == 2) {
                ...
                if (tagNo != 37) {
                    ...
                    throw new IOException(b.h(aSN1TaggedObject2, new StringBuilder("Not a valid iso7816 ASN1TaggedObject tag ")));
                }
