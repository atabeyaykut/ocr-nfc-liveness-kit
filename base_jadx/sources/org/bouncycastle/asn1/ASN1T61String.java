...
public abstract class ASN1T61String extends ASN1Primitive implements ASN1String {
    ...
    public ASN1T61String(byte[] bArr, boolean z10) {
    ...
    public static ASN1T61String getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z10) {
        return (ASN1T61String) TYPE.getContextInstance(aSN1TaggedObject, z10);
    }
    ...
    public final void encode(ASN1OutputStream aSN1OutputStream, boolean z10) throws IOException {
        aSN1OutputStream.writeEncodingDL(z10, 20, this.contents);
    }
