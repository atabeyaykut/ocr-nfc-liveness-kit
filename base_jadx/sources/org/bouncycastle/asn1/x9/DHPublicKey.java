...
public class DHPublicKey extends ASN1Object {
    ...
    private ASN1Integer f11404y;

    public DHPublicKey(BigInteger bigInteger) {
        if (bigInteger == null) {
            throw new IllegalArgumentException("'y' cannot be null");
        }
        this.f11404y = new ASN1Integer(bigInteger);
    }
    ...
    public static DHPublicKey getInstance(Object obj) {
        ...
        throw new IllegalArgumentException(b.f(obj, "Invalid DHPublicKey: "));
    }
    ...
    public BigInteger getY() {
        return this.f11404y.getPositiveValue();
    }
