...
public class DVCSRequestInformation extends ASN1Object {
    ...
    private DVCSRequestInformation(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.getObjectAt(0) instanceof ASN1Integer) {
            this.version = f.f(aSN1Sequence, 0);
            r22 = 1;
        } else {
            this.version = 1;
            r22 = 0;
        }
        this.service = ServiceType.getInstance(aSN1Sequence.getObjectAt(r22));
        for (int r32 = r22 + 1; r32 < aSN1Sequence.size(); r32++) {
            ...
            if (objectAt instanceof ASN1Integer) {
                ...
                if (tagNo == 0) {
                    ...
                    if (tagNo != 4) {
                        throw new IllegalArgumentException(a.d("unknown tag number encountered: ", tagNo));
                    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        for (int r22 = 0; r22 < 5; r22++) {
            int r52 = r32[r22];
            ASN1Encodable aSN1Encodable = aSN1EncodableArr[r22];
            if (aSN1Encodable != null) {
                aSN1EncodableVector.add(new DERTaggedObject(false, r52, aSN1Encodable));
            }
        }
