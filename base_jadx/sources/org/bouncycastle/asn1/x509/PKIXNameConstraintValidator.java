...
public class PKIXNameConstraintValidator implements NameConstraintValidator {
    ...
    private int hashCollection(Collection collection) {
        ...
        for (Object obj : collection) {
            r02 = (obj instanceof byte[] ? Arrays.hashCode((byte[]) obj) : obj.hashCode()) + r02;
        }
        return r02;
    }
    ...
    private boolean isIPConstrained(byte[] bArr, byte[] bArr2) {
        ...
        for (int r22 = 0; r22 < length; r22++) {
            bArr4[r22] = (byte) (bArr2[r22] & bArr3[r22]);
            bArr5[r22] = (byte) (bArr[r22] & bArr3[r22]);
        }
    ...
    private static byte[] max(byte[] bArr, byte[] bArr2) {
        for (int r02 = 0; r02 < bArr.length; r02++) {
            if ((bArr[r02] & 65535) > (65535 & bArr2[r02])) {
                return bArr;
            }
        }
        return bArr2;
    ...
    private byte[][] minMaxIPs(byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) {
        ...
        for (int r6 = 0; r6 < length; r6++) {
            bArr5[r6] = (byte) (bArr[r6] & bArr2[r6]);
            byte b10 = bArr[r6];
            byte b11 = bArr2[r6];
            bArr6[r6] = (byte) ((b10 & b11) | (~b11));
            bArr7[r6] = (byte) (bArr3[r6] & bArr4[r6]);
            byte b12 = bArr3[r6];
            byte b13 = bArr4[r6];
            bArr8[r6] = (byte) ((b12 & b13) | (~b13));
        }
    ...
    private String stringifyIP(byte[] bArr) {
        ...
        for (int r22 = 0; r22 < bArr.length / 2; r22++) {
            if (sb2.length() > 0) {
                sb2.append(".");
            }
            sb2.append(Integer.toString(bArr[r22] & 255));
        }
        sb2.append("/");
        boolean z10 = true;
    ...
    private String stringifyIPCollection(Set set) {
        ...
        while (it.hasNext()) {
            ...
            sbE.append(stringifyIP((byte[]) it.next()));
        }
        sbE.append("]");
        return sbE.toString();
    }
    ...
    private String stringifyOtherNameCollection(Set set) {
        ...
        while (it.hasNext()) {
            ...
            sbE.append(otherName.getTypeID().getId());
            sbE.append(":");
            try {
                sbE.append(Hex.toHexString(otherName.getValue().toASN1Primitive().getEncoded()));
            } catch (IOException e10) {
                sbE.append(e10.toString());
            }
        }
        sbE.append("]");
        return sbE.toString();
    ...
    */
    ...
    private static boolean withinDNSubtree(ASN1Sequence aSN1Sequence, ASN1Sequence aSN1Sequence2) {
        ...
        int r42 = 0;
        while (true) {
            if (r32 >= aSN1Sequence.size()) {
                r32 = r42;
                break;
            }
            if (IETFUtils.rDNAreEqual(rdn, RDN.getInstance(aSN1Sequence.getObjectAt(r32)))) {
                break;
            }
            r42 = r32;
            r32++;
        }
        if (aSN1Sequence2.size() > aSN1Sequence.size() - r32) {
            return false;
        }
        for (int r02 = 0; r02 < aSN1Sequence2.size(); r02++) {
            RDN rdn2 = RDN.getInstance(aSN1Sequence2.getObjectAt(r02));
            RDN rdn3 = RDN.getInstance(aSN1Sequence.getObjectAt(r32 + r02));
    ...
    private boolean withinDomain(String str, String str2) {
        ...
        for (int r42 = -1; r42 < strArrSplit.length; r42++) {
            if (r42 == -1) {
                if (strArrSplit2[r42 + length].equals("")) {
                    return false;
                }
            } else if (!strArrSplit[r42].equalsIgnoreCase(strArrSplit2[r42 + length])) {
                return false;
            }
        }
        return true;
    ...
    @Override // org.bouncycastle.asn1.x509.NameConstraintValidator
    public void intersectEmptyPermittedSubtree(int r32) {
        if (r32 == 0) {
        ...
        if (r32 == 4) {
            ...
            if (r32 != 7) {
                throw new IllegalStateException(android.support.v4.media.a.d("Unknown tag encountered: ", r32));
            }
    ...
    public void intersectPermittedSubtree(GeneralSubtree[] generalSubtreeArr) {
        ...
        for (int r12 = 0; r12 != generalSubtreeArr.length; r12++) {
            GeneralSubtree generalSubtree = generalSubtreeArr[r12];
        ...
        for (Map.Entry entry : map.entrySet()) {
            int r13 = ((Integer) entry.getKey()).intValue();
            if (r13 == 0) {
                ...
                if (r13 != 7) {
                    throw new IllegalStateException(android.support.v4.media.a.d("Unknown tag encountered: ", r13));
                }
