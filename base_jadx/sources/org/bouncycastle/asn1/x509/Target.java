...
public class Target extends ASN1Object implements ASN1Choice {
    ...
    public Target(int r22, GeneralName generalName) {
        this(new DERTaggedObject(r22, generalName));
    }
    ...
    private Target(ASN1TaggedObject aSN1TaggedObject) {
        ...
        if (tagNo == 0) {
            ...
            if (tagNo != 1) {
                throw new IllegalArgumentException(b.h(aSN1TaggedObject, new StringBuilder("unknown tag: ")));
            }
