...
public class DistributionPoint extends ASN1Object {
    ...
    public DistributionPoint(ASN1Sequence aSN1Sequence) {
        for (int r12 = 0; r12 != aSN1Sequence.size(); r12++) {
            ...
            if (tagNo == 0) {
                ...
                if (tagNo != 2) {
                    throw new IllegalArgumentException(b.h(aSN1TaggedObject, new StringBuilder("Unknown tag encountered in structure: ")));
                }
    ...
    public static DistributionPoint getInstance(Object obj) {
        ...
        throw new IllegalArgumentException(ab.b.f(obj, "Invalid DistributionPoint: "));
    }
