...
public class ExtendedKeyUsage extends ASN1Object {
    ...
    public ExtendedKeyUsage(KeyPurposeId[] keyPurposeIdArr) {
        ...
        for (int r12 = 0; r12 != keyPurposeIdArr.length; r12++) {
            aSN1EncodableVector.add(keyPurposeIdArr[r12]);
            Hashtable hashtable = this.usageTable;
            KeyPurposeId keyPurposeId = keyPurposeIdArr[r12];
    ...
    public KeyPurposeId[] getUsages() {
        ...
        int r22 = 0;
        while (objects.hasMoreElements()) {
            keyPurposeIdArr[r22] = KeyPurposeId.getInstance(objects.nextElement());
            r22++;
        }
