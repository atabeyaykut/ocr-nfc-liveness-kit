...
public class Challenge extends ASN1Object {
    ...
    private Challenge(ASN1Sequence aSN1Sequence) {
        ...
        this.witness = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(r22));
        this.challenge = ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(r22 + 1));
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        return b.l(aSN1EncodableVector, this.challenge, aSN1EncodableVector);
    }
}
