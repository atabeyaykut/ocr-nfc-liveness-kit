...
public class RevRepContent extends ASN1Object {
    ...
    public CertificateList[] getCrls() {
        ...
        for (int r22 = 0; r22 != size; r22++) {
            certificateListArr[r22] = CertificateList.getInstance(this.crls.getObjectAt(r22));
        }
    ...
    public CertId[] getRevCerts() {
        ...
        for (int r22 = 0; r22 != size; r22++) {
            certIdArr[r22] = CertId.getInstance(this.revCerts.getObjectAt(r22));
        }
        return certIdArr;
    }
    ...
    public PKIStatusInfo[] getStatus() {
        ...
        for (int r22 = 0; r22 != size; r22++) {
            pKIStatusInfoArr[r22] = PKIStatusInfo.getInstance(this.status.getObjectAt(r22));
        }
