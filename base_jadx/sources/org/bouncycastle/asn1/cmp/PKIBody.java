...
public class PKIBody extends ASN1Object implements ASN1Choice {
    ...
    public PKIBody(int r12, ASN1Encodable aSN1Encodable) {
        this.tagNo = r12;
        this.body = getBodyForType(r12, aSN1Encodable);
    }
    ...
    private PKIBody(ASN1TaggedObject aSN1TaggedObject) {
        ...
        try {
            ...
            throw Exceptions.illegalArgumentException("malformed body found: " + e10.getMessage(), e10);
        } catch (IllegalArgumentException e11) {
            throw Exceptions.illegalArgumentException("malformed body found: " + e11.getMessage(), e11);
        }
    }

    private static ASN1Encodable getBodyForType(int r52, ASN1Encodable aSN1Encodable) {
        try {
            switch (r52) {
                case 0:
                ...
                default:
                    throw new IllegalArgumentException("unknown tag number: " + r52);
            }
        } catch (ClassCastException unused) {
            StringBuilder sbE = v.e("body type of ", r52, " has incorrect type got: ");
            sbE.append(aSN1Encodable.getClass());
            throw new IllegalArgumentException(sbE.toString());
        } catch (IllegalArgumentException unused2) {
            StringBuilder sbE2 = v.e("body type of ", r52, " has incorrect type got: ");
            sbE2.append(aSN1Encodable.getClass());
            throw new IllegalArgumentException(sbE2.toString());
        }
    }
