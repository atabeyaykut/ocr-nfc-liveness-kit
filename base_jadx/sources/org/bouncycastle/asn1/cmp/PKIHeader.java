...
public class PKIHeader extends ASN1Object {
    ...
    public PKIHeader(int r42, GeneralName generalName, GeneralName generalName2) {
        this(new ASN1Integer(r42), generalName, generalName2);
    }
    ...
    public InfoTypeAndValue[] getGeneralInfo() {
        ...
        for (int r22 = 0; r22 < size; r22++) {
            infoTypeAndValueArr[r22] = InfoTypeAndValue.getInstance(this.generalInfo.getObjectAt(r22));
        }
