...
public class PBMParameter extends ASN1Object {
    ...
    public PBMParameter(byte[] bArr, AlgorithmIdentifier algorithmIdentifier, int r6, AlgorithmIdentifier algorithmIdentifier2) {
        this(new DEROctetString(bArr), algorithmIdentifier, new ASN1Integer(r6), algorithmIdentifier2);
    }
