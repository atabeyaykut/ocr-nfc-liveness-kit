...
public class CertTemplateBuilder {
    ...
    private void addOptional(ASN1EncodableVector aSN1EncodableVector, int r32, boolean z10, ASN1Encodable aSN1Encodable) {
        if (aSN1Encodable != null) {
            aSN1EncodableVector.add(new DERTaggedObject(z10, r32, aSN1Encodable));
        }
    }
    ...
    public CertTemplateBuilder setVersion(int r42) {
        this.version = new ASN1Integer(r42);
        return this;
    }
}
