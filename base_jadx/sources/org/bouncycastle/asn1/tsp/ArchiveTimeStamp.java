...
public class ArchiveTimeStamp extends ASN1Object {
    ...
    private ArchiveTimeStamp(ASN1Sequence aSN1Sequence) {
        ...
        for (int r52 = 0; r52 < aSN1Sequence.size() - 1; r52++) {
            ASN1Encodable objectAt = aSN1Sequence.getObjectAt(r52);
            if (objectAt instanceof ASN1TaggedObject) {
                ...
                if (tagNo == 0) {
                    ...
                    if (tagNo != 2) {
                        throw new IllegalArgumentException(b.h(aSN1TaggedObject, new StringBuilder("invalid tag no in constructor: ")));
                    }
    ...
    public PartialHashtree[] getReducedHashTree() {
        ...
        for (int r22 = 0; r22 != size; r22++) {
            partialHashtreeArr[r22] = PartialHashtree.getInstance(this.reducedHashTree.getObjectAt(r22));
        }
