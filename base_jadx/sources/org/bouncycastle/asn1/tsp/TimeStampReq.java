...
public class TimeStampReq extends ASN1Object {
    ...
    private TimeStampReq(ASN1Sequence aSN1Sequence) {
        ...
        for (int r32 = 2; r32 < size; r32++) {
            if (aSN1Sequence.getObjectAt(r32) instanceof ASN1ObjectIdentifier) {
                checkOption(this.tsaPolicy, r32, 2);
                this.tsaPolicy = ASN1ObjectIdentifier.getInstance(aSN1Sequence.getObjectAt(r32));
            } else if (aSN1Sequence.getObjectAt(r32) instanceof ASN1Integer) {
                checkOption(this.nonce, r32, 3);
                this.nonce = ASN1Integer.getInstance(aSN1Sequence.getObjectAt(r32));
            } else if (aSN1Sequence.getObjectAt(r32) instanceof ASN1Boolean) {
                checkOption(this.certReq, r32, 4);
                this.certReq = ASN1Boolean.getInstance(aSN1Sequence.getObjectAt(r32));
            } else {
                if (!(aSN1Sequence.getObjectAt(r32) instanceof ASN1TaggedObject)) {
                    throw new IllegalArgumentException("unidentified structure in sequence");
                }
                checkOption(this.extensions, r32, 5);
                ASN1TaggedObject aSN1TaggedObject = (ASN1TaggedObject) aSN1Sequence.getObjectAt(r32);
    ...
    private void checkOption(Object obj, int r22, int r32) {
        if (obj != null || r22 > r32) {
