...
public abstract class ASN1GeneralString extends ASN1Primitive implements ASN1String {
    ...
    public ASN1GeneralString(byte[] bArr, boolean z10) {
    ...
    public static ASN1GeneralString getInstance(ASN1TaggedObject aSN1TaggedObject, boolean z10) {
        return (ASN1GeneralString) TYPE.getContextInstance(aSN1TaggedObject, z10);
    }
    ...
    public final void encode(ASN1OutputStream aSN1OutputStream, boolean z10) throws IOException {
        aSN1OutputStream.writeEncodingDL(z10, 27, this.contents);
    }
