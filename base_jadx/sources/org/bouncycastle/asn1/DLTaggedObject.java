...
public class DLTaggedObject extends ASN1TaggedObject {
    public DLTaggedObject(int r12, int r22, int r32, ASN1Encodable aSN1Encodable) {
        super(r12, r22, r32, aSN1Encodable);
    }

    public DLTaggedObject(int r22, int r32, ASN1Encodable aSN1Encodable) {
        super(true, r22, r32, aSN1Encodable);
    }

    public DLTaggedObject(int r22, ASN1Encodable aSN1Encodable) {
        super(true, r22, aSN1Encodable);
    }

    public DLTaggedObject(boolean z10, int r22, int r32, ASN1Encodable aSN1Encodable) {
        super(z10, r22, r32, aSN1Encodable);
    }

    public DLTaggedObject(boolean z10, int r22, ASN1Encodable aSN1Encodable) {
    ...
    public int encodedLength(boolean z10) throws IOException {
        ASN1Primitive dLObject = this.obj.toASN1Primitive().toDLObject();
        boolean zIsExplicit = isExplicit();
        int lengthOfDL = dLObject.encodedLength(zIsExplicit);
        if (zIsExplicit) {
    ...
    public ASN1TaggedObject replaceTag(int r42, int r52) {
        return new DLTaggedObject(this.explicitness, r42, r52, this.obj);
    }
