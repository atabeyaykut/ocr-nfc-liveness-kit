...
public class X931Signer implements Signer {
    ...
    private void createSignatureBlock(int r52) {
        int length;
        ...
        if (r52 == 188) {
            ...
            bArr3[bArr3.length - 2] = (byte) (r52 >>> 8);
            bArr3[bArr3.length - 1] = (byte) r52;
            length = length2;
        }
        this.block[0] = 107;
        for (int r53 = length - 2; r53 != 0; r53--) {
            this.block[r53] = -69;
        }
    ...
    public void init(boolean z10, CipherParameters cipherParameters) {
        ...
        int r22 = this.kParam.getModulus().bitLength();
        this.keyBits = r22;
        this.block = new byte[(r22 + 7) / 8];
        reset();
    }
