...
public class Ed448phSigner implements Signer {
    ...
    public void init(boolean z10, CipherParameters cipherParameters) {
        ...
        CryptoServicesRegistrar.checkConstraints(Utils.getDefaultProperties(EdDSAParameterSpec.Ed448, BERTags.FLAGS, cipherParameters, z10));
        reset();
    }
    ...
    public void update(byte[] bArr, int r32, int r42) {
        this.prehash.update(bArr, r32, r42);
    }
