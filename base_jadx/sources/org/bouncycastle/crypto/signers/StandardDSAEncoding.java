...
public class StandardDSAEncoding implements DSAEncoding {
    ...
    public BigInteger decodeValue(BigInteger bigInteger, ASN1Sequence aSN1Sequence, int r32) {
        return checkValue(bigInteger, ((ASN1Integer) aSN1Sequence.getObjectAt(r32)).getValue());
    }
