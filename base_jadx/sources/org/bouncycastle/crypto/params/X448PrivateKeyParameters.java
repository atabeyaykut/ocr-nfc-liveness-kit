...
public final class X448PrivateKeyParameters extends AsymmetricKeyParameter {
    ...
    public X448PrivateKeyParameters(byte[] bArr, int r52) {
        super(true);
        byte[] bArr2 = new byte[56];
        this.data = bArr2;
        System.arraycopy(bArr, r52, bArr2, 0, 56);
    }
    ...
    public void encode(byte[] bArr, int r52) {
        System.arraycopy(this.data, 0, bArr, r52, 56);
    }
    ...
    public void generateSecret(X448PublicKeyParameters x448PublicKeyParameters, byte[] bArr, int r10) {
        byte[] bArr2 = new byte[56];
        x448PublicKeyParameters.encode(bArr2, 0);
        if (!X448.calculateAgreement(this.data, 0, bArr2, 0, bArr, r10)) {
