...
public class SkeinParameters implements CipherParameters {
    ...
    public static class Builder {
        ...
        public Builder set(int r32, byte[] bArr) {
            if (bArr == null) {
                throw new IllegalArgumentException("Parameter value must not be null.");
            }
            if (r32 != 0 && (r32 < 4 || r32 >= 63 || r32 == 48)) {
                throw new IllegalArgumentException("Parameter types must be in the range 0,5..47,49..62.");
            }
            if (r32 == 4) {
                throw new IllegalArgumentException("Parameter type 4 is reserved for internal use.");
            }
            this.parameters.put(Integers.valueOf(r32), bArr);
            return this;
        }
        ...
        public Builder setPersonalisation(Date date, String str, String str2) throws IOException {
            try {
                ...
                throw new IllegalStateException(a.c("Byte I/O failed: ", e10));
            }
        }
