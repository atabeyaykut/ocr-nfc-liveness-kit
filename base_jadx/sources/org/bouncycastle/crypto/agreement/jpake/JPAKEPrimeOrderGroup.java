...
public class JPAKEPrimeOrderGroup {
    ...
    private final BigInteger f11421g;

    /* renamed from: p, reason: collision with root package name */
    private final BigInteger f11422p;

    /* renamed from: q, reason: collision with root package name */
    private final BigInteger f11423q;
    ...
    public JPAKEPrimeOrderGroup(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, boolean z10) {
        ...
        this.f11422p = bigInteger;
        this.f11423q = bigInteger2;
        this.f11421g = bigInteger3;
    }
