...
public class JPAKEUtil {
    ...
    private static byte[] intToByteArray(int r32) {
    ...
    public static void validateParticipantIdsDiffer(String str, String str2) throws CryptoException {
        if (str.equals(str2)) {
            throw new CryptoException(androidx.browser.browseractions.a.a("Both participants are using the same participantId (", str, "). This is not allowed. Each participant must use a unique participantId."));
        }
    }
