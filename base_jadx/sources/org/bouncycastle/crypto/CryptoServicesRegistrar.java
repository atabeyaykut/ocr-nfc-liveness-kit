...
public final class CryptoServicesRegistrar {
    ...
    private static int chooseLowerBound(int r12) {
        if (r12 <= 1024) {
            return 160;
        }
        if (r12 <= 2048) {
    ...
    public static <T> T getSizedProperty(Property property, int r52) {
        Object[] objArrLookupProperty = lookupProperty(property);
        if (objArrLookupProperty == null) {
            return null;
        }
        ...
        if (property.type.isAssignableFrom(DHParameters.class)) {
            while (r32 != objArrLookupProperty.length) {
                ?? r42 = (T) ((DHParameters) objArrLookupProperty[r32]);
                if (r42.getP().bitLength() == r52) {
                    return r42;
                }
                r32++;
            }
            ...
            while (r32 != objArrLookupProperty.length) {
                ?? r43 = (T) ((DSAParameters) objArrLookupProperty[r32]);
                if (r43.getP().bitLength() == r52) {
                    return r43;
                }
                r32++;
            }
