...
public class SkeinDigest implements ExtendedDigest, Memoable {
    ...
    public SkeinDigest(int r22, int r32) {
        this(r22, r32, CryptoServicePurpose.ANY);
    }

    public SkeinDigest(int r22, int r32, CryptoServicePurpose cryptoServicePurpose) throws IllegalStateException, DataLengthException {
        this.engine = new SkeinEngine(r22, r32);
    ...
    public int doFinal(byte[] bArr, int r32) {
        return this.engine.doFinal(bArr, r32);
    }
    ...
    public void update(byte[] bArr, int r32, int r42) throws IllegalStateException, DataLengthException {
        this.engine.update(bArr, r32, r42);
    }
}
