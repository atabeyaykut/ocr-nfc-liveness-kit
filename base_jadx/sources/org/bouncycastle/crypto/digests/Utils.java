...
class Utils {
    ...
    public static class DefaultProperties implements CryptoServiceProperties {
        ...
        public DefaultProperties(int r12, String str, CryptoServicePurpose cryptoServicePurpose) {
            this.bitsOfSecurity = r12;
    ...
    public static class DefaultPropertiesWithPRF implements CryptoServiceProperties {
        ...
        public DefaultPropertiesWithPRF(int r12, int r22, String str, CryptoServicePurpose cryptoServicePurpose) {
            this.bitsOfSecurity = r12;
            this.prfBitsOfSecurity = r22;
            this.algorithmName = str;
            this.purpose = cryptoServicePurpose;
        }
    ...
    public static CryptoServiceProperties getDefaultProperties(Digest digest, int r32, CryptoServicePurpose cryptoServicePurpose) {
        return new DefaultPropertiesWithPRF(digest.getDigestSize() * 4, r32, digest.getAlgorithmName(), cryptoServicePurpose);
    }
