...
public class SHA512Digest extends LongDigest {
    ...
    public int doFinal(byte[] bArr, int r52) {
        finish();
        Pack.longToBigEndian(this.H1, bArr, r52);
        Pack.longToBigEndian(this.H2, bArr, r52 + 8);
        Pack.longToBigEndian(this.H3, bArr, r52 + 16);
        Pack.longToBigEndian(this.H4, bArr, r52 + 24);
        Pack.longToBigEndian(this.H5, bArr, r52 + 32);
        Pack.longToBigEndian(this.H6, bArr, r52 + 40);
        Pack.longToBigEndian(this.H7, bArr, r52 + 48);
        Pack.longToBigEndian(this.H8, bArr, r52 + 56);
        reset();
        return 64;
    }
