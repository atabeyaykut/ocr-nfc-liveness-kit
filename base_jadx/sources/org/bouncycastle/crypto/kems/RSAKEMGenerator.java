...
public class RSAKEMGenerator implements EncapsulatedSecretGenerator {
    ...
    public RSAKEMGenerator(int r12, DerivationFunction derivationFunction, SecureRandom secureRandom) {
        this.keyLen = r12;
        this.kdf = derivationFunction;
        this.rnd = secureRandom;
    }

    public static byte[] generateKey(DerivationFunction derivationFunction, BigInteger bigInteger, BigInteger bigInteger2, int r42) throws DataLengthException, IllegalArgumentException {
        ...
        derivationFunction.generateBytes(bArr, 0, r42);
        return bArr;
    }
