...
public class SP800SecureRandomBuilder {
    ...
    public static class CTRDRBGProvider implements DRBGProvider {
        ...
        public CTRDRBGProvider(BlockCipher blockCipher, int r22, byte[] bArr, byte[] bArr2, int r52) {
            this.blockCipher = blockCipher;
            this.keySizeInBits = r22;
            this.nonce = bArr;
            this.personalizationString = bArr2;
            this.securityStrength = r52;
        }
    ...
    public static class HMacDRBGProvider implements DRBGProvider {
        ...
        public HMacDRBGProvider(Mac mac, byte[] bArr, byte[] bArr2, int r42) {
            this.hMac = mac;
            this.nonce = bArr;
            this.personalizationString = bArr2;
            this.securityStrength = r42;
        }
    ...
    public static class HashDRBGProvider implements DRBGProvider {
        ...
        public HashDRBGProvider(Digest digest, byte[] bArr, byte[] bArr2, int r42) {
            this.digest = digest;
            this.nonce = bArr;
            this.personalizationString = bArr2;
            this.securityStrength = r42;
    ...
    public static String getSimplifiedName(Digest digest) {
        ...
        int r02 = algorithmName.indexOf(45);
        if (r02 <= 0 || algorithmName.startsWith("SHA3")) {
            return algorithmName;
        }
        return algorithmName.substring(0, r02) + algorithmName.substring(r02 + 1);
    }

    public SP800SecureRandom buildCTR(BlockCipher blockCipher, int r12, byte[] bArr, boolean z10) {
        return new SP800SecureRandom(this.random, this.entropySourceProvider.get(this.entropyBitsRequired), new CTRDRBGProvider(blockCipher, r12, bArr, this.personalizationString, this.securityStrength), z10);
    }
    ...
    public SP800SecureRandomBuilder setEntropyBitsRequired(int r12) {
        this.entropyBitsRequired = r12;
        return this;
    }
    ...
    public SP800SecureRandomBuilder setSecurityStrength(int r12) {
        this.securityStrength = r12;
        return this;
    }
}
