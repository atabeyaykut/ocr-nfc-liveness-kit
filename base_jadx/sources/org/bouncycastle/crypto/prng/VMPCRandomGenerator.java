...
public class VMPCRandomGenerator implements RandomGenerator {
    ...
    @Override // org.bouncycastle.crypto.prng.RandomGenerator
    public void nextBytes(byte[] bArr, int r92, int r10) {
        synchronized (this.P) {
            int r102 = r10 + r92;
            while (r92 != r102) {
                byte[] bArr2 = this.P;
                byte b10 = this.f11646s;
                byte b11 = this.f11645n;
                byte b12 = bArr2[(b10 + bArr2[b11 & 255]) & 255];
                this.f11646s = b12;
                bArr[r92] = bArr2[(bArr2[bArr2[b12 & 255] & 255] + 1) & 255];
                byte b13 = bArr2[b11 & 255];
                bArr2[b11 & 255] = bArr2[b12 & 255];
                bArr2[b12 & 255] = b13;
                this.f11645n = (byte) ((b11 + 1) & 255);
                r92++;
            }
        }
    }
