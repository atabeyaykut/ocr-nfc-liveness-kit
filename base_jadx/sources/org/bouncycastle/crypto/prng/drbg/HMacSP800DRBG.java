...
public class HMacSP800DRBG implements SP80090DRBG {
    ...
    public HMacSP800DRBG(Mac mac, int r32, EntropySource entropySource, byte[] bArr, byte[] bArr2) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        if (r32 > Utils.getMaxSecurityStrength(mac)) {
            throw new IllegalArgumentException("Requested security strength is not supported by the derivation function");
        }
        if (entropySource.entropySize() < r32) {
            throw new IllegalArgumentException("Not enough entropy for security strength required");
        }
        this._securityStrength = r32;
    ...
    private void hmac_DRBG_Update_Func(byte[] bArr, byte b10) throws IllegalStateException, DataLengthException, IllegalArgumentException {
    ...
    public int generate(byte[] bArr, byte[] bArr2, boolean z10) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        this._hMac.init(new KeyParameter(this._K));
        for (int r42 = 0; r42 < length3; r42++) {
            Mac mac = this._hMac;
            byte[] bArr4 = this._V;
            mac.update(bArr4, 0, bArr4.length);
            this._hMac.doFinal(this._V, 0);
            byte[] bArr5 = this._V;
            System.arraycopy(bArr5, 0, bArr3, bArr5.length * r42, bArr5.length);
        }
        byte[] bArr6 = this._V;
