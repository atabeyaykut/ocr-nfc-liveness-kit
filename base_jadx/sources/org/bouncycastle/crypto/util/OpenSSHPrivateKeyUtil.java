    ...
    public static byte[] encodePrivateKey(AsymmetricKeyParameter asymmetricKeyParameter) throws IOException {
        ...
        if (asymmetricKeyParameter instanceof DSAPrivateKeyParameters) {
            ...
            try {
                ...
                throw new IllegalStateException(a.j(e10, new StringBuilder("unable to encode DSAPrivateKeyParameters ")));
            }
        }
        ...
        int r42 = CryptoServicesRegistrar.getSecureRandom().nextInt();
        sSHBuilder2.u32(r42);
        sSHBuilder2.u32(r42);
    ...
    public static AsymmetricKeyParameter parsePrivateKeyBlob(byte[] bArr) {
        ...
        if (bArr[0] == 48) {
            ...
            if ("ssh-ed25519".equals(string)) {
                ...
                if (byOID == null) {
                    throw new IllegalStateException(android.support.v4.media.a.g("Curve not found for: ", byName));
                }
                sSHBuffer2.readBlock();
