...
public class McElieceCCA2KeyFactorySpi extends KeyFactorySpi implements AsymmetricKeyInfoConverter {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        if (!(keySpec instanceof PKCS8EncodedKeySpec)) {
            throw new InvalidKeySpecException(b.g(keySpec, new StringBuilder("Unsupported key specification: "), "."));
        }
        try {
            ...
            throw new InvalidKeySpecException(a.c("Unable to decode PKCS8EncodedKeySpec: ", e10));
        }
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        try {
            ...
            try {
                ...
                throw new InvalidKeySpecException(android.support.v4.media.a.c(e10, new StringBuilder("Unable to decode X509EncodedKeySpec: ")));
            }
    ...
    public KeySpec getKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        if (key instanceof BCMcElieceCCA2PrivateKey) {
            ...
            if (!(key instanceof BCMcElieceCCA2PublicKey)) {
                throw new InvalidKeySpecException(androidx.camera.core.impl.a.f(key, new StringBuilder("Unsupported key type: "), "."));
            }
            if (X509EncodedKeySpec.class.isAssignableFrom(cls)) {
                return new X509EncodedKeySpec(key.getEncoded());
            }
        }
        throw new InvalidKeySpecException(c.f("Unknown key specification: ", cls, "."));
    }
