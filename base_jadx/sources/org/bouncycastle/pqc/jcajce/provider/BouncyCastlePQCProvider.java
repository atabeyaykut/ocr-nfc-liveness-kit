...
public class BouncyCastlePQCProvider extends Provider implements ConfigurableProvider {
    ...
    private void loadAlgorithms(String str, String[] strArr) {
        for (int r02 = 0; r02 != strArr.length; r02++) {
            ...
            sbE.append(strArr[r02]);
            sbE.append("$Mappings");
            Class clsLoadClass = loadClass(BouncyCastlePQCProvider.class, sbE.toString());
            if (clsLoadClass != null) {
                try {
                    ((AlgorithmProvider) clsLoadClass.newInstance()).configure(this);
                } catch (Exception e10) {
                    throw new InternalError("cannot create instance of " + str + strArr[r02] + "$Mappings : " + e10);
                }
            }
        }
    }
