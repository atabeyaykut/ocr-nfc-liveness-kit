...
public class BCLMSPrivateKey implements PrivateKey, LMSPrivateKey {
    ...
    public LMSPrivateKey extractKeyShard(int r32) {
        LMSKeyParameters lMSKeyParameters = this.keyParams;
        return lMSKeyParameters instanceof LMSPrivateKeyParameters ? new BCLMSPrivateKey(((LMSPrivateKeyParameters) lMSKeyParameters).extractKeyShard(r32)) : new BCLMSPrivateKey(((HSSPrivateKeyParameters) lMSKeyParameters).extractKeyShard(r32));
    }
