...
public interface StateAwareSignature {
    ...
    int sign(byte[] bArr, int r22, int r32) throws SignatureException;
    ...
    void update(byte[] bArr, int r22, int r32) throws SignatureException;

    boolean verify(byte[] bArr) throws SignatureException;

    boolean verify(byte[] bArr, int r22, int r32) throws SignatureException;
}
