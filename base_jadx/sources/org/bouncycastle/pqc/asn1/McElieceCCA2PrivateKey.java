...
public class McElieceCCA2PrivateKey extends ASN1Object {
    ...
    public McElieceCCA2PrivateKey(int r12, int r22, GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM, Permutation permutation, AlgorithmIdentifier algorithmIdentifier) {
        this.f11827n = r12;
        this.f11826k = r22;
    ...
    private McElieceCCA2PrivateKey(ASN1Sequence aSN1Sequence) {
        this.f11827n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f11826k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f11827n));
        aSN1EncodableVector.add(new ASN1Integer(this.f11826k));
