...
public class McEliecePrivateKey extends ASN1Object {
    ...
    public McEliecePrivateKey(int r12, int r22, GF2mField gF2mField, PolynomialGF2mSmallM polynomialGF2mSmallM, Permutation permutation, Permutation permutation2, GF2Matrix gF2Matrix) {
        this.f11832n = r12;
        this.f11831k = r22;
    ...
    private McEliecePrivateKey(ASN1Sequence aSN1Sequence) {
        this.f11832n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f11831k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f11832n));
        aSN1EncodableVector.add(new ASN1Integer(this.f11831k));
        ...
        return a.j(aSN1EncodableVector, new DEROctetString(this.encSInv), aSN1EncodableVector);
    }
}
