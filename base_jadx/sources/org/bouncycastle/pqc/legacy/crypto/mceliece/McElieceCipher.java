...
public class McElieceCipher implements MessageEncryptor {
    ...
    private GF2Vector computeMessageRepresentative(byte[] bArr) {
        byte[] bArr2 = new byte[this.maxPlainTextSize + ((this.f11994k & 7) != 0 ? 1 : 0)];
        System.arraycopy(bArr, 0, bArr2, 0, bArr.length);
        bArr2[bArr.length] = 1;
        return GF2Vector.OS2VP(this.f11994k, bArr2);
    }

    private void initCipherDecrypt(McEliecePrivateKeyParameters mcEliecePrivateKeyParameters) {
        this.f11995n = mcEliecePrivateKeyParameters.getN();
        int k10 = mcEliecePrivateKeyParameters.getK();
        this.f11994k = k10;
        this.maxPlainTextSize = k10 >> 3;
        this.cipherTextSize = this.f11995n >> 3;
    }

    private void initCipherEncrypt(McEliecePublicKeyParameters mcEliecePublicKeyParameters) {
        this.f11995n = mcEliecePublicKeyParameters.getN();
        this.f11994k = mcEliecePublicKeyParameters.getK();
        this.f11996t = mcEliecePublicKeyParameters.getT();
        this.cipherTextSize = this.f11995n >> 3;
        this.maxPlainTextSize = this.f11994k >> 3;
    }
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException {
        ...
        GF2Vector gF2VectorOS2VP = GF2Vector.OS2VP(this.f11995n, bArr);
        ...
        return computeMessage((GF2Vector) sInv.leftMultiply(gF2Vector2.extractRightVector(this.f11994k)));
    }
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        return ((GF2Vector) ((McEliecePublicKeyParameters) this.key).getG().leftMultiply(gF2VectorComputeMessageRepresentative).add(new GF2Vector(this.f11995n, this.f11996t, this.sr))).getEncoded();
    }
}
