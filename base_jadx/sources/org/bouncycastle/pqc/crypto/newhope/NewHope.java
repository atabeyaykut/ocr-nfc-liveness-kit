...
class NewHope {
    ...
    public static void decodeB(short[] sArr, short[] sArr2, byte[] bArr) {
        ...
        for (int r42 = 0; r42 < 256; r42++) {
            int r02 = r42 * 4;
            int r12 = bArr[r42 + 1792] & 255;
            sArr2[r02 + 0] = (short) (r12 & 3);
            sArr2[r02 + 1] = (short) ((r12 >>> 2) & 3);
            sArr2[r02 + 2] = (short) ((r12 >>> 4) & 3);
            sArr2[r02 + 3] = (short) (r12 >>> 6);
        }
    }
    ...
    public static void encodeB(byte[] bArr, short[] sArr, short[] sArr2) {
        ...
        for (int r52 = 0; r52 < 256; r52++) {
            int r02 = r52 * 4;
            bArr[r52 + 1792] = (byte) ((sArr2[r02 + 3] << 6) | sArr2[r02] | (sArr2[r02 + 1] << 2) | (sArr2[r02 + 2] << 4));
        }
    }
