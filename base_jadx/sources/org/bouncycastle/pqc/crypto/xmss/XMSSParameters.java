...
public final class XMSSParameters {
    ...
    public XMSSParameters(int r42, ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        if (r42 < 2) {
        ...
        this.oid = DefaultXMSSOid.lookup(digestName, treeDigestSize, winternitzParameter, wOTSPlusParameters.getLen(), r42);
    }

    public XMSSParameters(int r12, Digest digest) {
        this(r12, DigestUtil.getDigestOID(digest.getAlgorithmName()));
    }
    ...
    public static XMSSParameters lookupByOID(int r12) {
