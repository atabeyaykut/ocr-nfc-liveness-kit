...
final class OTSHashAddress extends XMSSAddress {
    ...
    public static class Builder extends XMSSAddress.Builder<Builder> {
        ...
        public Builder withChainAddress(int r12) {
            this.chainAddress = r12;
            return this;
        }

        public Builder withHashAddress(int r12) {
            this.hashAddress = r12;
            return this;
        }

        public Builder withOTSAddress(int r12) {
            this.otsAddress = r12;
            return this;
        }
    }
