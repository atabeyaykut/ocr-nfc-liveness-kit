...
public final class XMSSMTPrivateKeyParameters extends XMSSMTKeyParameters implements XMSSStoreableObjectInterface, Encodable {
    ...
    private XMSSMTPrivateKeyParameters(Builder builder) {
        ...
        if (bArr != null) {
            ...
            int r32 = (height + 7) / 8;
            this.index = XMSSUtil.bytesToXBigEndian(bArr, 0, r32);
            if (!XMSSUtil.isIndexValid(height, this.index)) {
                throw new IllegalArgumentException("index out of bounds");
            }
            int r33 = r32 + 0;
            this.secretKeySeed = XMSSUtil.extractBytesAtOffset(bArr, r33, treeDigestSize);
            int r34 = r33 + treeDigestSize;
            this.secretKeyPRF = XMSSUtil.extractBytesAtOffset(bArr, r34, treeDigestSize);
            int r35 = r34 + treeDigestSize;
            this.publicSeed = XMSSUtil.extractBytesAtOffset(bArr, r35, treeDigestSize);
            int r36 = r35 + treeDigestSize;
            this.root = XMSSUtil.extractBytesAtOffset(bArr, r36, treeDigestSize);
            int r37 = r36 + treeDigestSize;
            try {
                this.bdsState = ((BDSStateMap) XMSSUtil.deserialize(XMSSUtil.extractBytesAtOffset(bArr, r37, bArr.length - r37), BDSStateMap.class)).withWOTSDigest(builder.xmss.getTreeDigestOID());
                return;
    ...
    public XMSSMTPrivateKeyParameters extractKeyShard(int r82) {
        ...
        synchronized (this) {
            ...
            xMSSMTPrivateKeyParametersBuild = new Builder(this.params).withSecretKeySeed(this.secretKeySeed).withSecretKeyPRF(this.secretKeyPRF).withPublicSeed(this.publicSeed).withRoot(this.root).withIndex(getIndex()).withBDSState(new BDSStateMap(this.bdsState, (getIndex() + j10) - 1)).build();
    ...
    public byte[] toByteArray() {
        ...
        synchronized (this) {
            ...
            int r22 = height + 0;
            XMSSUtil.copyBytesAtOffset(bArr, this.secretKeySeed, r22);
            int r23 = r22 + treeDigestSize;
            XMSSUtil.copyBytesAtOffset(bArr, this.secretKeyPRF, r23);
            int r24 = r23 + treeDigestSize;
            XMSSUtil.copyBytesAtOffset(bArr, this.publicSeed, r24);
            XMSSUtil.copyBytesAtOffset(bArr, this.root, r24 + treeDigestSize);
            try {
