...
public final class DefaultXMSSOid implements XMSSOid {
    ...
    private DefaultXMSSOid(int r12, String str) {
        this.oid = r12;
        this.stringRepresentation = str;
    }

    private static String createKey(String str, int r22, int r32, int r42, int r52) {
        if (str == null) {
            throw new NullPointerException("algorithmName == null");
        }
        return str + "-" + r22 + "-" + r32 + "-" + r42 + "-" + r52;
    }

    public static DefaultXMSSOid lookup(String str, int r22, int r32, int r42, int r52) {
        if (str != null) {
            return oidLookupTable.get(createKey(str, r22, r32, r42, r52));
        }
        throw new NullPointerException("algorithmName == null");
    }
