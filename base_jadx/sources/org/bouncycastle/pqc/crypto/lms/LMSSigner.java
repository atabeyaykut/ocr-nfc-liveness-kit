...
public class LMSSigner implements MessageSigner {
    ...
    public byte[] generateSignature(byte[] bArr) {
        try {
            ...
            throw new IllegalStateException(a.c(e10, new StringBuilder("unable to encode signature: ")));
        }
    }
    ...
    public boolean verifySignature(byte[] bArr, byte[] bArr2) {
        try {
            ...
            throw new IllegalStateException(a.c(e10, new StringBuilder("unable to decode signature: ")));
        }
    }
}
