...
public class GeMSSParameters {
    ...
    static {
        ...
        GeMSSParameters geMSSParameters2 = new GeMSSParameters("gemss192", 192, 265, 20, 22, 4, InputDeviceCompat.SOURCE_DPAD, 9, 0);
        ...
        GeMSSParameters geMSSParameters11 = new GeMSSParameters("whitegemss192", 192, 268, 21, 21, 3, InputDeviceCompat.SOURCE_DPAD, 9, 0);
        whitegemss192 = geMSSParameters11;
        GeMSSParameters geMSSParameters12 = new GeMSSParameters("whitegemss256", 256, 364, 29, 31, 3, InputDeviceCompat.SOURCE_DPAD, 9, 0);
        ...
        Integer numValueOf4 = Integers.valueOf(InputDeviceCompat.SOURCE_DPAD);
        ...
        Integer numValueOf10 = Integers.valueOf(InputDeviceCompat.SOURCE_GAMEPAD);
    ...
    private GeMSSParameters(String str, int r13, int r14, int r15, int r16, int r17, int r18, int r19, int r20) {
        this.name = str;
        this.engine = new GeMSSEngine(r13, r14, r15, r16, r17, r18, r19, r20);
    }
