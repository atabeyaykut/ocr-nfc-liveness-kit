...
abstract class Symmetric {
    ...
    public static class AesSymmetric extends Symmetric {
        ...
        public void hash_h(byte[] bArr, byte[] bArr2, int r6) {
            ...
            this.sha256Digest.doFinal(bArr, r6);
        }

        @Override // org.bouncycastle.pqc.crypto.saber.Symmetric
        public void prf(byte[] bArr, byte[] bArr2, int r10, int r11) throws DataLengthException, IllegalArgumentException {
            this.cipher.init(true, new ParametersWithIV(new KeyParameter(bArr2, 0, r10), new byte[16]));
            this.cipher.processBytes(new byte[r11], 0, r11, bArr, 0);
        }
    }
    ...
    public static class ShakeSymmetric extends Symmetric {
        ...
        @Override // org.bouncycastle.pqc.crypto.saber.Symmetric
        public void prf(byte[] bArr, byte[] bArr2, int r52, int r6) {
            this.shakeDigest.reset();
            this.shakeDigest.update(bArr2, 0, r52);
            this.shakeDigest.doFinal(bArr, 0, r6);
        }
    }
    ...
    public abstract void prf(byte[] bArr, byte[] bArr2, int r32, int r42);
}
