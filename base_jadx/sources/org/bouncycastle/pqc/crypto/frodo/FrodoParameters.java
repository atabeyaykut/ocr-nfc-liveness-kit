...
public class FrodoParameters implements KEMParameters {
    ...
    private FrodoParameters(String str, int r92, int r10, int r11, short[] sArr, Xof xof, FrodoMatrixGenerator frodoMatrixGenerator) {
        this.name = str;
        this.f11883n = r92;
        this.D = r10;
        this.B = r11;
        this.defaultKeySize = r11 * 8 * 8;
        this.engine = new FrodoEngine(r92, r10, r11, sArr, xof, frodoMatrixGenerator);
    }
