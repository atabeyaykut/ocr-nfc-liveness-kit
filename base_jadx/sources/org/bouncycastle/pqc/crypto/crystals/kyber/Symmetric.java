...
abstract class Symmetric {
    ...
    public static class AesSymmetric extends Symmetric {
        ...
        private void doDigest(ExtendedDigest extendedDigest, byte[] bArr, byte[] bArr2, int r6) {
            extendedDigest.update(bArr2, 0, bArr2.length);
            extendedDigest.doFinal(bArr, r6);
        }
        ...
        @Override // org.bouncycastle.pqc.crypto.crystals.kyber.Symmetric
        public void hash_h(byte[] bArr, byte[] bArr2, int r42) {
            doDigest(this.sha256Digest, bArr, bArr2, r42);
        }
        ...
        @Override // org.bouncycastle.pqc.crypto.crystals.kyber.Symmetric
        public void prf(byte[] bArr, byte[] bArr2, byte b10) throws DataLengthException, IllegalArgumentException {
        ...
        @Override // org.bouncycastle.pqc.crypto.crystals.kyber.Symmetric
        public void xofAbsorb(byte[] bArr, byte b10, byte b11) throws IllegalArgumentException {
        ...
        @Override // org.bouncycastle.pqc.crypto.crystals.kyber.Symmetric
        public void xofSqueezeBlocks(byte[] bArr, int r22, int r32) throws DataLengthException {
            aes128(bArr, r22, r32);
        }
    }
    ...
    public static class ShakeSymmetric extends Symmetric {
        ...
        @Override // org.bouncycastle.pqc.crypto.crystals.kyber.Symmetric
        public void hash_h(byte[] bArr, byte[] bArr2, int r6) {
            this.sha3Digest256.update(bArr2, 0, bArr2.length);
            this.sha3Digest256.doFinal(bArr, r6);
        }
        ...
        @Override // org.bouncycastle.pqc.crypto.crystals.kyber.Symmetric
        public void xofSqueezeBlocks(byte[] bArr, int r32, int r42) {
            this.xof.doOutput(bArr, r32, r42);
        }
    }

    public Symmetric(int r12) {
        this.xofBlockBytes = r12;
    }

    public abstract void hash_g(byte[] bArr, byte[] bArr2);

    public abstract void hash_h(byte[] bArr, byte[] bArr2, int r32);
    ...
    public abstract void xofSqueezeBlocks(byte[] bArr, int r22, int r32);
}
