...
class Utils {
    ...
    static {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifier57 = BCObjectIdentifiers.kyber512;
        map16.put(kyberParameters, aSN1ObjectIdentifier57);
        KyberParameters kyberParameters2 = KyberParameters.kyber768;
        ASN1ObjectIdentifier aSN1ObjectIdentifier58 = BCObjectIdentifiers.kyber768;
        map16.put(kyberParameters2, aSN1ObjectIdentifier58);
        KyberParameters kyberParameters3 = KyberParameters.kyber1024;
        ASN1ObjectIdentifier aSN1ObjectIdentifier59 = BCObjectIdentifiers.kyber1024;
        map16.put(kyberParameters3, aSN1ObjectIdentifier59);
        map17.put(aSN1ObjectIdentifier57, kyberParameters);
        map17.put(aSN1ObjectIdentifier58, kyberParameters2);
        map17.put(aSN1ObjectIdentifier59, kyberParameters3);
        ...
        map18.put(nTRULPRimeParameters, aSN1ObjectIdentifier60);
        ...
        map18.put(nTRULPRimeParameters2, aSN1ObjectIdentifier61);
        ...
        map18.put(nTRULPRimeParameters3, aSN1ObjectIdentifier62);
        ...
        map18.put(nTRULPRimeParameters4, aSN1ObjectIdentifier63);
        ...
        map18.put(nTRULPRimeParameters5, aSN1ObjectIdentifier64);
        ...
        map18.put(nTRULPRimeParameters6, aSN1ObjectIdentifier65);
        map19.put(aSN1ObjectIdentifier60, nTRULPRimeParameters);
        map19.put(aSN1ObjectIdentifier61, nTRULPRimeParameters2);
        map19.put(aSN1ObjectIdentifier62, nTRULPRimeParameters3);
        map19.put(aSN1ObjectIdentifier63, nTRULPRimeParameters4);
        map19.put(aSN1ObjectIdentifier64, nTRULPRimeParameters5);
        map19.put(aSN1ObjectIdentifier65, nTRULPRimeParameters6);
        ...
        map20.put(sNTRUPrimeParameters, aSN1ObjectIdentifier66);
        ...
        map20.put(sNTRUPrimeParameters2, aSN1ObjectIdentifier67);
        ...
        map20.put(sNTRUPrimeParameters3, aSN1ObjectIdentifier68);
        ...
        map20.put(sNTRUPrimeParameters4, aSN1ObjectIdentifier69);
        ...
        map20.put(sNTRUPrimeParameters5, aSN1ObjectIdentifier70);
        ...
        map20.put(sNTRUPrimeParameters6, aSN1ObjectIdentifier71);
        map21.put(aSN1ObjectIdentifier66, sNTRUPrimeParameters);
        map21.put(aSN1ObjectIdentifier67, sNTRUPrimeParameters2);
        map21.put(aSN1ObjectIdentifier68, sNTRUPrimeParameters3);
        map21.put(aSN1ObjectIdentifier69, sNTRUPrimeParameters4);
        map21.put(aSN1ObjectIdentifier70, sNTRUPrimeParameters5);
        map21.put(aSN1ObjectIdentifier71, sNTRUPrimeParameters6);
        ...
        map22.put(dilithiumParameters, aSN1ObjectIdentifier72);
        ...
        map22.put(dilithiumParameters2, aSN1ObjectIdentifier73);
        ...
        map22.put(dilithiumParameters3, aSN1ObjectIdentifier74);
        map23.put(aSN1ObjectIdentifier72, dilithiumParameters);
        map23.put(aSN1ObjectIdentifier73, dilithiumParameters2);
        map23.put(aSN1ObjectIdentifier74, dilithiumParameters3);
        ASN1ObjectIdentifier aSN1ObjectIdentifier75 = BCObjectIdentifiers.bike128;
        BIKEParameters bIKEParameters = BIKEParameters.bike128;
        map25.put(aSN1ObjectIdentifier75, bIKEParameters);
        ASN1ObjectIdentifier aSN1ObjectIdentifier76 = BCObjectIdentifiers.bike192;
        BIKEParameters bIKEParameters2 = BIKEParameters.bike192;
        map25.put(aSN1ObjectIdentifier76, bIKEParameters2);
        ASN1ObjectIdentifier aSN1ObjectIdentifier77 = BCObjectIdentifiers.bike256;
        BIKEParameters bIKEParameters3 = BIKEParameters.bike256;
        map25.put(aSN1ObjectIdentifier77, bIKEParameters3);
        map24.put(bIKEParameters, aSN1ObjectIdentifier75);
        map24.put(bIKEParameters2, aSN1ObjectIdentifier76);
        map24.put(bIKEParameters3, aSN1ObjectIdentifier77);
        ASN1ObjectIdentifier aSN1ObjectIdentifier78 = BCObjectIdentifiers.hqc128;
        HQCParameters hQCParameters = HQCParameters.hqc128;
        map27.put(aSN1ObjectIdentifier78, hQCParameters);
        ASN1ObjectIdentifier aSN1ObjectIdentifier79 = BCObjectIdentifiers.hqc192;
        HQCParameters hQCParameters2 = HQCParameters.hqc192;
        map27.put(aSN1ObjectIdentifier79, hQCParameters2);
        ASN1ObjectIdentifier aSN1ObjectIdentifier80 = BCObjectIdentifiers.hqc256;
        HQCParameters hQCParameters3 = HQCParameters.hqc256;
        map27.put(aSN1ObjectIdentifier80, hQCParameters3);
        map26.put(hQCParameters, aSN1ObjectIdentifier78);
        map26.put(hQCParameters2, aSN1ObjectIdentifier79);
        map26.put(hQCParameters3, aSN1ObjectIdentifier80);
        ASN1ObjectIdentifier aSN1ObjectIdentifier81 = BCObjectIdentifiers.rainbow_III_classic;
        RainbowParameters rainbowParameters = RainbowParameters.rainbowIIIclassic;
        map29.put(aSN1ObjectIdentifier81, rainbowParameters);
        ASN1ObjectIdentifier aSN1ObjectIdentifier82 = BCObjectIdentifiers.rainbow_III_circumzenithal;
        RainbowParameters rainbowParameters2 = RainbowParameters.rainbowIIIcircumzenithal;
        map29.put(aSN1ObjectIdentifier82, rainbowParameters2);
        ASN1ObjectIdentifier aSN1ObjectIdentifier83 = BCObjectIdentifiers.rainbow_III_compressed;
        RainbowParameters rainbowParameters3 = RainbowParameters.rainbowIIIcompressed;
        map29.put(aSN1ObjectIdentifier83, rainbowParameters3);
        ASN1ObjectIdentifier aSN1ObjectIdentifier84 = BCObjectIdentifiers.rainbow_V_classic;
        RainbowParameters rainbowParameters4 = RainbowParameters.rainbowVclassic;
        map29.put(aSN1ObjectIdentifier84, rainbowParameters4);
        ASN1ObjectIdentifier aSN1ObjectIdentifier85 = BCObjectIdentifiers.rainbow_V_circumzenithal;
        RainbowParameters rainbowParameters5 = RainbowParameters.rainbowVcircumzenithal;
        map29.put(aSN1ObjectIdentifier85, rainbowParameters5);
        ASN1ObjectIdentifier aSN1ObjectIdentifier86 = BCObjectIdentifiers.rainbow_V_compressed;
        RainbowParameters rainbowParameters6 = RainbowParameters.rainbowVcompressed;
        map29.put(aSN1ObjectIdentifier86, rainbowParameters6);
        map28.put(rainbowParameters, aSN1ObjectIdentifier81);
        map28.put(rainbowParameters2, aSN1ObjectIdentifier82);
        map28.put(rainbowParameters3, aSN1ObjectIdentifier83);
        map28.put(rainbowParameters4, aSN1ObjectIdentifier84);
        map28.put(rainbowParameters5, aSN1ObjectIdentifier85);
        map28.put(rainbowParameters6, aSN1ObjectIdentifier86);
        SPHINCSPlusParameters sPHINCSPlusParameters = SPHINCSPlusParameters.sha2_128s_robust;
        ASN1ObjectIdentifier aSN1ObjectIdentifier87 = BCObjectIdentifiers.sphincsPlus_sha2_128s_r3;
        map10.put(sPHINCSPlusParameters, aSN1ObjectIdentifier87);
        SPHINCSPlusParameters sPHINCSPlusParameters2 = SPHINCSPlusParameters.sha2_128f_robust;
        ASN1ObjectIdentifier aSN1ObjectIdentifier88 = BCObjectIdentifiers.sphincsPlus_sha2_128f_r3;
        map10.put(sPHINCSPlusParameters2, aSN1ObjectIdentifier88);
        SPHINCSPlusParameters sPHINCSPlusParameters3 = SPHINCSPlusParameters.shake_128s_robust;
        ASN1ObjectIdentifier aSN1ObjectIdentifier89 = BCObjectIdentifiers.sphincsPlus_shake_128s_r3;
        map10.put(sPHINCSPlusParameters3, aSN1ObjectIdentifier89);
        SPHINCSPlusParameters sPHINCSPlusParameters4 = SPHINCSPlusParameters.shake_128f_robust;
        ASN1ObjectIdentifier aSN1ObjectIdentifier90 = BCObjectIdentifiers.sphincsPlus_shake_128f_r3;
        map10.put(sPHINCSPlusParameters4, aSN1ObjectIdentifier90);
        SPHINCSPlusParameters sPHINCSPlusParameters5 = SPHINCSPlusParameters.haraka_128s;
        ASN1ObjectIdentifier aSN1ObjectIdentifier91 = BCObjectIdentifiers.sphincsPlus_haraka_128s_r3;
        map10.put(sPHINCSPlusParameters5, aSN1ObjectIdentifier91);
        SPHINCSPlusParameters sPHINCSPlusParameters6 = SPHINCSPlusParameters.haraka_128f;
        ASN1ObjectIdentifier aSN1ObjectIdentifier92 = BCObjectIdentifiers.sphincsPlus_haraka_128f_r3;
        map10.put(sPHINCSPlusParameters6, aSN1ObjectIdentifier92);
        ...
        map10.put(sPHINCSPlusParameters7, aSN1ObjectIdentifier93);
        ...
        map10.put(sPHINCSPlusParameters8, aSN1ObjectIdentifier94);
        ...
        map10.put(sPHINCSPlusParameters9, aSN1ObjectIdentifier95);
        ...
        map10.put(sPHINCSPlusParameters10, aSN1ObjectIdentifier96);
        SPHINCSPlusParameters sPHINCSPlusParameters11 = SPHINCSPlusParameters.haraka_192s;
        ASN1ObjectIdentifier aSN1ObjectIdentifier97 = BCObjectIdentifiers.sphincsPlus_haraka_192s_r3;
        map10.put(sPHINCSPlusParameters11, aSN1ObjectIdentifier97);
        SPHINCSPlusParameters sPHINCSPlusParameters12 = SPHINCSPlusParameters.haraka_192f;
        ASN1ObjectIdentifier aSN1ObjectIdentifier98 = BCObjectIdentifiers.sphincsPlus_haraka_192f_r3;
        map10.put(sPHINCSPlusParameters12, aSN1ObjectIdentifier98);
        SPHINCSPlusParameters sPHINCSPlusParameters13 = SPHINCSPlusParameters.sha2_256s_robust;
        ASN1ObjectIdentifier aSN1ObjectIdentifier99 = BCObjectIdentifiers.sphincsPlus_sha2_256s_r3;
        map10.put(sPHINCSPlusParameters13, aSN1ObjectIdentifier99);
        SPHINCSPlusParameters sPHINCSPlusParameters14 = SPHINCSPlusParameters.sha2_256f_robust;
        ASN1ObjectIdentifier aSN1ObjectIdentifier100 = BCObjectIdentifiers.sphincsPlus_sha2_256f_r3;
        map10.put(sPHINCSPlusParameters14, aSN1ObjectIdentifier100);
        SPHINCSPlusParameters sPHINCSPlusParameters15 = SPHINCSPlusParameters.shake_256s_robust;
        ASN1ObjectIdentifier aSN1ObjectIdentifier101 = BCObjectIdentifiers.sphincsPlus_shake_256s_r3;
        map10.put(sPHINCSPlusParameters15, aSN1ObjectIdentifier101);
        SPHINCSPlusParameters sPHINCSPlusParameters16 = SPHINCSPlusParameters.shake_256f_robust;
        ASN1ObjectIdentifier aSN1ObjectIdentifier102 = BCObjectIdentifiers.sphincsPlus_shake_256f_r3;
        map10.put(sPHINCSPlusParameters16, aSN1ObjectIdentifier102);
        SPHINCSPlusParameters sPHINCSPlusParameters17 = SPHINCSPlusParameters.haraka_256s;
        ASN1ObjectIdentifier aSN1ObjectIdentifier103 = BCObjectIdentifiers.sphincsPlus_haraka_256s_r3;
        map10.put(sPHINCSPlusParameters17, aSN1ObjectIdentifier103);
        SPHINCSPlusParameters sPHINCSPlusParameters18 = SPHINCSPlusParameters.haraka_256f;
        ASN1ObjectIdentifier aSN1ObjectIdentifier104 = BCObjectIdentifiers.sphincsPlus_haraka_256f_r3;
        map10.put(sPHINCSPlusParameters18, aSN1ObjectIdentifier104);
        SPHINCSPlusParameters sPHINCSPlusParameters19 = SPHINCSPlusParameters.haraka_128s_simple;
        ASN1ObjectIdentifier aSN1ObjectIdentifier105 = BCObjectIdentifiers.sphincsPlus_haraka_128s_r3_simple;
        map10.put(sPHINCSPlusParameters19, aSN1ObjectIdentifier105);
        SPHINCSPlusParameters sPHINCSPlusParameters20 = SPHINCSPlusParameters.haraka_128f_simple;
        ASN1ObjectIdentifier aSN1ObjectIdentifier106 = BCObjectIdentifiers.sphincsPlus_haraka_128f_r3_simple;
        map10.put(sPHINCSPlusParameters20, aSN1ObjectIdentifier106);
        SPHINCSPlusParameters sPHINCSPlusParameters21 = SPHINCSPlusParameters.haraka_192s_simple;
        ASN1ObjectIdentifier aSN1ObjectIdentifier107 = BCObjectIdentifiers.sphincsPlus_haraka_192s_r3_simple;
        map10.put(sPHINCSPlusParameters21, aSN1ObjectIdentifier107);
        SPHINCSPlusParameters sPHINCSPlusParameters22 = SPHINCSPlusParameters.haraka_192f_simple;
        ASN1ObjectIdentifier aSN1ObjectIdentifier108 = BCObjectIdentifiers.sphincsPlus_haraka_192f_r3_simple;
        map10.put(sPHINCSPlusParameters22, aSN1ObjectIdentifier108);
        SPHINCSPlusParameters sPHINCSPlusParameters23 = SPHINCSPlusParameters.haraka_256s_simple;
        ASN1ObjectIdentifier aSN1ObjectIdentifier109 = BCObjectIdentifiers.sphincsPlus_haraka_256s_r3_simple;
        map10.put(sPHINCSPlusParameters23, aSN1ObjectIdentifier109);
        SPHINCSPlusParameters sPHINCSPlusParameters24 = SPHINCSPlusParameters.haraka_256f_simple;
        ASN1ObjectIdentifier aSN1ObjectIdentifier110 = BCObjectIdentifiers.sphincsPlus_haraka_256f_r3_simple;
        map10.put(sPHINCSPlusParameters24, aSN1ObjectIdentifier110);
        SPHINCSPlusParameters sPHINCSPlusParameters25 = SPHINCSPlusParameters.sha2_128s;
        ASN1ObjectIdentifier aSN1ObjectIdentifier111 = BCObjectIdentifiers.sphincsPlus_sha2_128s;
        map10.put(sPHINCSPlusParameters25, aSN1ObjectIdentifier111);
        SPHINCSPlusParameters sPHINCSPlusParameters26 = SPHINCSPlusParameters.sha2_128f;
        ASN1ObjectIdentifier aSN1ObjectIdentifier112 = BCObjectIdentifiers.sphincsPlus_sha2_128f;
        map10.put(sPHINCSPlusParameters26, aSN1ObjectIdentifier112);
        SPHINCSPlusParameters sPHINCSPlusParameters27 = SPHINCSPlusParameters.shake_128s;
        ASN1ObjectIdentifier aSN1ObjectIdentifier113 = BCObjectIdentifiers.sphincsPlus_shake_128s;
        map10.put(sPHINCSPlusParameters27, aSN1ObjectIdentifier113);
        SPHINCSPlusParameters sPHINCSPlusParameters28 = SPHINCSPlusParameters.shake_128f;
        ASN1ObjectIdentifier aSN1ObjectIdentifier114 = BCObjectIdentifiers.sphincsPlus_shake_128f;
        map10.put(sPHINCSPlusParameters28, aSN1ObjectIdentifier114);
        SPHINCSPlusParameters sPHINCSPlusParameters29 = SPHINCSPlusParameters.sha2_192s;
        ASN1ObjectIdentifier aSN1ObjectIdentifier115 = BCObjectIdentifiers.sphincsPlus_sha2_192s;
        map10.put(sPHINCSPlusParameters29, aSN1ObjectIdentifier115);
        SPHINCSPlusParameters sPHINCSPlusParameters30 = SPHINCSPlusParameters.sha2_192f;
        ASN1ObjectIdentifier aSN1ObjectIdentifier116 = BCObjectIdentifiers.sphincsPlus_sha2_192f;
        map10.put(sPHINCSPlusParameters30, aSN1ObjectIdentifier116);
        SPHINCSPlusParameters sPHINCSPlusParameters31 = SPHINCSPlusParameters.shake_192s;
        ASN1ObjectIdentifier aSN1ObjectIdentifier117 = BCObjectIdentifiers.sphincsPlus_shake_192s;
        map10.put(sPHINCSPlusParameters31, aSN1ObjectIdentifier117);
        SPHINCSPlusParameters sPHINCSPlusParameters32 = SPHINCSPlusParameters.shake_192f;
        ASN1ObjectIdentifier aSN1ObjectIdentifier118 = BCObjectIdentifiers.sphincsPlus_shake_192f;
        map10.put(sPHINCSPlusParameters32, aSN1ObjectIdentifier118);
        ...
        map10.put(sPHINCSPlusParameters33, aSN1ObjectIdentifier119);
        ...
        map10.put(sPHINCSPlusParameters34, aSN1ObjectIdentifier120);
        SPHINCSPlusParameters sPHINCSPlusParameters35 = SPHINCSPlusParameters.shake_256s;
        ASN1ObjectIdentifier aSN1ObjectIdentifier121 = BCObjectIdentifiers.sphincsPlus_shake_256s;
        map10.put(sPHINCSPlusParameters35, aSN1ObjectIdentifier121);
        SPHINCSPlusParameters sPHINCSPlusParameters36 = SPHINCSPlusParameters.shake_256f;
        ASN1ObjectIdentifier aSN1ObjectIdentifier122 = BCObjectIdentifiers.sphincsPlus_shake_256f;
        map10.put(sPHINCSPlusParameters36, aSN1ObjectIdentifier122);
        map11.put(aSN1ObjectIdentifier111, sPHINCSPlusParameters25);
        map11.put(aSN1ObjectIdentifier112, sPHINCSPlusParameters26);
        map11.put(aSN1ObjectIdentifier113, sPHINCSPlusParameters27);
        map11.put(aSN1ObjectIdentifier114, sPHINCSPlusParameters28);
        map11.put(aSN1ObjectIdentifier115, sPHINCSPlusParameters29);
        map11.put(aSN1ObjectIdentifier116, sPHINCSPlusParameters30);
        map11.put(aSN1ObjectIdentifier117, sPHINCSPlusParameters31);
        map11.put(aSN1ObjectIdentifier118, sPHINCSPlusParameters32);
        map11.put(aSN1ObjectIdentifier119, sPHINCSPlusParameters33);
        map11.put(aSN1ObjectIdentifier120, sPHINCSPlusParameters34);
        map11.put(aSN1ObjectIdentifier121, sPHINCSPlusParameters35);
        map11.put(aSN1ObjectIdentifier122, sPHINCSPlusParameters36);
        map11.put(aSN1ObjectIdentifier87, sPHINCSPlusParameters);
        map11.put(aSN1ObjectIdentifier88, sPHINCSPlusParameters2);
        map11.put(aSN1ObjectIdentifier89, sPHINCSPlusParameters3);
        map11.put(aSN1ObjectIdentifier90, sPHINCSPlusParameters4);
        map11.put(aSN1ObjectIdentifier91, sPHINCSPlusParameters5);
        map11.put(aSN1ObjectIdentifier92, sPHINCSPlusParameters6);
        map11.put(aSN1ObjectIdentifier93, sPHINCSPlusParameters7);
        map11.put(aSN1ObjectIdentifier94, sPHINCSPlusParameters8);
        map11.put(aSN1ObjectIdentifier95, sPHINCSPlusParameters9);
        map11.put(aSN1ObjectIdentifier96, sPHINCSPlusParameters10);
        map11.put(aSN1ObjectIdentifier97, sPHINCSPlusParameters11);
        map11.put(aSN1ObjectIdentifier98, sPHINCSPlusParameters12);
        map11.put(aSN1ObjectIdentifier99, sPHINCSPlusParameters13);
        map11.put(aSN1ObjectIdentifier100, sPHINCSPlusParameters14);
        map11.put(aSN1ObjectIdentifier101, sPHINCSPlusParameters15);
        map11.put(aSN1ObjectIdentifier102, sPHINCSPlusParameters16);
        map11.put(aSN1ObjectIdentifier103, sPHINCSPlusParameters17);
        map11.put(aSN1ObjectIdentifier104, sPHINCSPlusParameters18);
        ...
        map11.put(aSN1ObjectIdentifier105, sPHINCSPlusParameters19);
        map11.put(aSN1ObjectIdentifier106, sPHINCSPlusParameters20);
        ...
        map11.put(aSN1ObjectIdentifier107, sPHINCSPlusParameters21);
        map11.put(aSN1ObjectIdentifier108, sPHINCSPlusParameters22);
        ...
        map11.put(aSN1ObjectIdentifier109, sPHINCSPlusParameters23);
        map11.put(aSN1ObjectIdentifier110, sPHINCSPlusParameters24);
    }
    ...
    public static String getDigestName(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        throw new IllegalArgumentException(a.g("unrecognised digest algorithm: ", aSN1ObjectIdentifier));
    }
    ...
    public static AlgorithmIdentifier qTeslaLookupAlgID(int r22) {
        if (r22 == 5) {
