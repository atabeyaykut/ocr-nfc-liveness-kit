...
class SimpleBigDecimal {
    ...
    public SimpleBigDecimal(BigInteger bigInteger, int r22) {
        if (r22 < 0) {
    ...
    public static SimpleBigDecimal getInstance(BigInteger bigInteger, int r22) {
        return new SimpleBigDecimal(bigInteger.shiftLeft(r22), r22);
    }
    ...
    public SimpleBigDecimal adjustScale(int r42) {
        if (r42 < 0) {
            throw new IllegalArgumentException("scale may not be negative");
        }
        int r02 = this.scale;
        return r42 == r02 ? this : new SimpleBigDecimal(this.bigInt.shiftLeft(r42 - r02), r42);
    }
    ...
    public SimpleBigDecimal multiply(SimpleBigDecimal simpleBigDecimal) {
        ...
        int r12 = this.scale;
        return new SimpleBigDecimal(bigIntegerMultiply, r12 + r12);
    }
    ...
    public SimpleBigDecimal shiftLeft(int r32) {
        return new SimpleBigDecimal(this.bigInt.shiftLeft(r32), this.scale);
    }
    ...
    public String toString() {
        ...
        int r42 = this.scale - length;
        for (int r6 = 0; r6 < r42; r6++) {
            cArr[r6] = '0';
        }
        for (int r52 = 0; r52 < length; r52++) {
            cArr[r42 + r52] = string2.charAt(r52);
        }
