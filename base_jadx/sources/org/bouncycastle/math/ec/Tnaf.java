...
class Tnaf {
    ...
    public static SimpleBigDecimal approximateDivisionByN(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, byte b10, int r6, int r72) {
        BigInteger bigIntegerMultiply = bigInteger2.multiply(bigInteger.shiftRight(((r6 - r0) - 2) + b10));
        BigInteger bigIntegerAdd = bigIntegerMultiply.add(bigInteger3.multiply(bigIntegerMultiply.shiftRight(r6)));
        int r02 = (((r6 + 5) / 2) + r72) - r72;
        BigInteger bigIntegerShiftRight = bigIntegerAdd.shiftRight(r02);
        if (bigIntegerAdd.testBit(r02 - 1)) {
            bigIntegerShiftRight = bigIntegerShiftRight.add(ECConstants.ONE);
        }
        return new SimpleBigDecimal(bigIntegerShiftRight, r72);
    }

    public static BigInteger[] getLucas(byte b10, int r6, boolean z10) {
    ...
    public static byte getMu(int r02) {
        return (byte) (r02 == 0 ? -1 : 1);
    }
    ...
    public static ECPoint.AbstractF2m[] getPreComp(ECPoint.AbstractF2m abstractF2m, byte b10) {
        ...
        for (int r32 = 3; r32 < length; r32 += 2) {
            abstractF2mArr[r32 >>> 1] = multiplyFromTnaf(abstractF2m, abstractF2m2, bArr[r32]);
        }
    ...
    public static BigInteger[] getSi(int r32, int r42, BigInteger bigInteger) {
        byte mu = getMu(r42);
        int shiftsForCofactor = getShiftsForCofactor(bigInteger);
        BigInteger[] lucas = getLucas(mu, (r32 + 3) - r42, false);
        if (mu == 1) {
    ...
    public static BigInteger getTw(byte b10, int r42) {
        if (r42 == 4) {
            return b10 == 1 ? BigInteger.valueOf(6L) : BigInteger.valueOf(10L);
        }
        BigInteger[] lucas = getLucas(b10, r42, false);
        BigInteger bit = ECConstants.ZERO.setBit(r42);
    ...
    public static ECPoint.AbstractF2m multiplyFromTnaf(ECPoint.AbstractF2m abstractF2m, ECPoint.AbstractF2m abstractF2m2, byte[] bArr) {
        ...
        for (int length = bArr.length - 1; length >= 0; length--) {
            ...
            if (b10 != 0) {
                abstractF2m3 = (ECPoint.AbstractF2m) abstractF2m3.tauPow(r32).add(b10 > 0 ? abstractF2m : abstractF2m2);
                r32 = 0;
            }
        }
        return r32 > 0 ? abstractF2m3.tauPow(r32) : abstractF2m3;
    }

    public static ECPoint.AbstractF2m multiplyRTnaf(ECPoint.AbstractF2m abstractF2m, BigInteger bigInteger) {
        ECCurve.AbstractF2m abstractF2m2 = (ECCurve.AbstractF2m) abstractF2m.getCurve();
        int r12 = abstractF2m2.getA().toBigInteger().intValue();
        return multiplyTnaf(abstractF2m, partModReduction(abstractF2m2, bigInteger, (byte) r12, getMu(r12), (byte) 10));
    }
    ...
    public static BigInteger norm(byte b10, ZTauElement zTauElement) {
        BigInteger bigIntegerSubtract;
        BigInteger bigInteger = zTauElement.f11729u;
        BigInteger bigIntegerMultiply = bigInteger.multiply(bigInteger);
        if (b10 == 1) {
            bigIntegerSubtract = zTauElement.f11730v.shiftLeft(1).add(zTauElement.f11729u);
        } else {
            if (b10 != -1) {
                throw new IllegalArgumentException("mu must be 1 or -1");
            }
            bigIntegerSubtract = zTauElement.f11730v.shiftLeft(1).subtract(zTauElement.f11729u);
        }
        return bigIntegerSubtract.multiply(zTauElement.f11730v).add(bigIntegerMultiply);
    }
    ...
    public static ZTauElement partModReduction(ECCurve.AbstractF2m abstractF2m, BigInteger bigInteger, byte b10, byte b11, byte b12) {
        ...
        BigInteger bigIntegerAdd = b11 == 1 ? si[0].add(si[1]) : si[0].subtract(si[1]);
        if (abstractF2m.isKoblitz()) {
            BigInteger bigInteger2 = ECConstants.ONE;
        ...
        ZTauElement zTauElementRound = round(approximateDivisionByN(bigInteger, si[0], bigInteger3, b10, fieldSize, b12), approximateDivisionByN(bigInteger, si[1], bigInteger3, b10, fieldSize, b12), b11);
        return new ZTauElement(bigInteger.subtract(bigIntegerAdd.multiply(zTauElementRound.f11729u)).subtract(si[1].multiply(zTauElementRound.f11730v).shiftLeft(1)), si[1].multiply(zTauElementRound.f11729u).subtract(si[0].multiply(zTauElementRound.f11730v)));
    }
    ...
    */
    ...
    public static byte[] tauAdicNaf(byte b10, ZTauElement zTauElement) {
        ...
        int r12 = norm(b10, zTauElement).bitLength();
        byte[] bArr = new byte[r12 > 30 ? r12 + 4 : 34];
        BigInteger bigIntegerClearBit = zTauElement.f11729u;
        BigInteger bigInteger = zTauElement.f11730v;
        int r42 = 0;
        int r52 = 0;
        while (true) {
            ...
            if (bigIntegerClearBit.equals(bigInteger2) && bigInteger.equals(bigInteger2)) {
                ...
                System.arraycopy(bArr, 0, bArr2, 0, r43);
                return bArr2;
            }
    ...
    public static byte[] tauAdicWNaf(byte b10, ZTauElement zTauElement, int r19, int r20, ZTauElement[] zTauElementArr) {
        if (b10 != 1 && b10 != -1) {
            throw new IllegalArgumentException("mu must be 1 or -1");
        }
        int r32 = norm(b10, zTauElement).bitLength();
        byte[] bArr = new byte[r32 > 30 ? r32 + 4 + r19 : r19 + 34];
        int r42 = (1 << r19) - 1;
        int r52 = 32 - r19;
        BigInteger bigIntegerSubtract = zTauElement.f11729u;
        BigInteger bigIntegerSubtract2 = zTauElement.f11730v;
        int r82 = 0;
        while (true) {
            ...
            if (bigIntegerSubtract.testBit(0)) {
                int r10 = (bigIntegerSubtract2.intValue() * r20) + bigIntegerSubtract.intValue();
                int r92 = r10 & r42;
                bArr[r82] = (byte) ((r10 << r52) >> r52);
                bigIntegerSubtract = bigIntegerSubtract.subtract(zTauElementArr[r92].f11729u);
                bigIntegerSubtract2 = bigIntegerSubtract2.subtract(zTauElementArr[r92].f11730v);
            }
            r82++;
        ...
        while ((jLongValueExact | jLongValueExact2) != 0) {
            if ((1 & jLongValueExact) != 0) {
                int r11 = (((int) jLongValueExact2) * r20) + ((int) jLongValueExact);
                int r12 = r11 & r42;
                bArr[r82] = (byte) ((r11 << r52) >> r52);
                jLongValueExact -= zTauElementArr[r12].f11729u.intValue();
                jLongValueExact2 -= zTauElementArr[r12].f11730v.intValue();
            }
            r82++;
            long j10 = jLongValueExact >> 1;
            long j11 = b10 == 1 ? jLongValueExact2 + j10 : jLongValueExact2 - j10;
            long j12 = -j10;
            jLongValueExact = j11;
            jLongValueExact2 = j12;
        }
        return bArr;
    }
}
