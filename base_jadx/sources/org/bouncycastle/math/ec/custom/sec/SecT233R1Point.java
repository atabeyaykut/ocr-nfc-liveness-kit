...
public class SecT233R1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint twice() {
        ...
        if (eCFieldElementG.isZero()) {
            return new SecT233R1Point(curve, eCFieldElementG, curve.getB().sqrt());
        }
        ...
        return new SecT233R1Point(curve, eCFieldElementSquare2, eCFieldElementMultiply.squarePlusProduct(eCFieldElementG, eCFieldElementMultiply2).add(eCFieldElementSquare2).add(eCFieldElementMultiply3), new ECFieldElement[]{eCFieldElementMultiply3});
    }
