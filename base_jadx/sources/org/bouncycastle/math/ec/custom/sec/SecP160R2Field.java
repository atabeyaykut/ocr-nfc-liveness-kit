...
public class SecP160R2Field {
    ...
    public static void reduce(int[] r72, int[] r82) {
        if (Nat160.mul33DWordAdd(PInv33, Nat160.mul33Add(PInv33, r72, 5, r72, 0, r82, 0), r82, 0) != 0 || (r82[4] == -1 && Nat160.gte(r82, P))) {
            Nat.add33To(5, PInv33, r82);
        }
    }

    public static void reduce32(int r22, int[] r32) {
        if ((r22 == 0 || Nat160.mul33WordAdd(PInv33, r22, r32, 0) == 0) && !(r32[4] == -1 && Nat160.gte(r32, P))) {
            return;
        }
        Nat.add33To(5, PInv33, r32);
    }
