    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        if (rawXCoord.isZero()) {
            ...
            if (eCFieldElementG.isZero()) {
                return new SecT233K1Point(curve, eCFieldElementG, curve.getB());
            }
            ...
            if (eCFieldElementMultiply8.isZero()) {
                return new SecT233K1Point(curve, eCFieldElementMultiply8, curve.getB());
            }
        ...
        return new SecT233K1Point(curve, eCFieldElementG, eCFieldElementSquarePlusProduct, new ECFieldElement[]{eCFieldElementMultiply4});
    }
