...
public class SecT239K1Point extends ECPoint.AbstractF2m {
    ...
    public ECPoint add(ECPoint eCPoint) {
        ...
        ECFieldElement eCFieldElementG;
        ...
        if (rawXCoord.isZero()) {
            ...
            eCFieldElementG = a.g(eCFieldElementDivide, eCFieldElementDivide, xCoord);
            if (eCFieldElementG.isZero()) {
                return new SecT239K1Point(curve, eCFieldElementG, curve.getB());
            }
            eCFieldElementSquarePlusProduct = eCFieldElementDivide.multiply(xCoord.add(eCFieldElementG)).add(eCFieldElementG).add(yCoord).divide(eCFieldElementG).add(eCFieldElementG);
            ...
            if (eCFieldElementMultiply8.isZero()) {
                return new SecT239K1Point(curve, eCFieldElementMultiply8, curve.getB());
            }
            ...
            eCFieldElementG = eCFieldElementMultiply8;
            eCFieldElementMultiply4 = !zIsOne ? eCFieldElementMultiply9.multiply(eCFieldElement2) : eCFieldElementMultiply9;
        }
        return new SecT239K1Point(curve, eCFieldElementG, eCFieldElementSquarePlusProduct, new ECFieldElement[]{eCFieldElementMultiply4});
    }
