...
public class SecT409Field {
    ...
    public static void reduce39(long[] jArr, int r92) {
        int r02 = r92 + 6;
        long j10 = jArr[r02];
        long j11 = j10 >>> 25;
        jArr[r92] = jArr[r92] ^ j11;
        int r93 = r92 + 1;
        jArr[r93] = (j11 << 23) ^ jArr[r93];
        jArr[r02] = j10 & M25;
    }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j14 = (jUnshuffle5 & BodyPartID.bodyIdMax) | (jUnshuffle6 << 32);
        long j15 = (jUnshuffle5 >>> 32) | (jUnshuffle6 & (-4294967296L));
        long jUnshuffle7 = Interleave.unshuffle(jArr[6]);
        long j16 = jUnshuffle7 & BodyPartID.bodyIdMax;
        long j17 = jUnshuffle7 >>> 32;
        jArr2[0] = j10 ^ (j11 << 44);
