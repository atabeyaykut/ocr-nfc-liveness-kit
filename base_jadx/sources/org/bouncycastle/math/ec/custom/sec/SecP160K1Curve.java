...
public class SecP160K1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f11737q = SecP160R2FieldElement.Q;
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int r82, final int r92) {
        ...
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecP160K1Curve.1
            private ECPoint createPoint(int[] r34, int[] r42) {
                return SecP160K1Curve.this.createRawPoint(new SecP160R2FieldElement(r34), new SecP160R2FieldElement(r42), SecP160K1Curve.SECP160K1_AFFINE_ZS);
            }
