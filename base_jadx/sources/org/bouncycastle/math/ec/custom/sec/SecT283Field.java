...
public class SecT283Field {
    ...
    public static void implMulw(long[] jArr, long j10, long j11, long[] jArr2, int r23) {
        jArr[1] = j11;
        long j12 = j11 << 1;
        jArr[2] = j12;
        long j13 = j12 ^ j11;
        ...
        do {
            int r12 = (int) (j10 >>> r10);
            long j18 = (jArr[(r12 >>> 6) & 7] << 6) ^ (jArr[r12 & 7] ^ (jArr[(r12 >>> 3) & 7] << 3));
            j16 ^= j18 << r10;
            j17 ^= j18 >>> (-r10);
            r10 -= 9;
        } while (r10 > 0);
        jArr2[r23] = M57 & j16;
        jArr2[r23 + 1] = (((((j10 & 72198606942111744L) & ((j11 << 7) >> 63)) >>> 8) ^ j17) << 7) ^ (j16 >>> 57);
    }
    ...
    public static void reduce37(long[] jArr, int r12) {
        int r02 = r12 + 4;
        long j10 = jArr[r02];
        long j11 = j10 >>> 27;
        jArr[r12] = ((j11 << 12) ^ (((j11 << 5) ^ j11) ^ (j11 << 7))) ^ jArr[r12];
        jArr[r02] = j10 & M27;
    }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j11 = (jUnshuffle3 & BodyPartID.bodyIdMax) | (jUnshuffle4 << 32);
        jArrCreate64[1] = (jUnshuffle3 >>> 32) | ((-4294967296L) & jUnshuffle4);
        long jUnshuffle5 = Interleave.unshuffle(jArr[4]);
        long j12 = BodyPartID.bodyIdMax & jUnshuffle5;
