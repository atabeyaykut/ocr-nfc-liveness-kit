...
public class SecT131R2Curve extends ECCurve.AbstractF2m {
    ...
    public SecT131R2Curve() {
        ...
        this.f11714a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("03E5A88919D7CAFCBF415F07C2176573B2")));
        this.f11715b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("04B8266A46C55657AC734CE38F018F2192")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int r82, final int r92) {
        ...
        for (int r22 = 0; r22 < r92; r22++) {
            ...
            Nat192.copy64(((SecT131FieldElement) eCPoint.getRawXCoord()).f11759x, 0, jArr, r32);
            int r33 = r32 + 3;
            Nat192.copy64(((SecT131FieldElement) eCPoint.getRawYCoord()).f11759x, 0, jArr, r33);
            r32 = r33 + 3;
        }
