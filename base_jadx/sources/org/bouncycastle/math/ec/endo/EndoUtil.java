...
public abstract class EndoUtil {
    ...
    private static BigInteger calculateB(BigInteger bigInteger, BigInteger bigInteger2, int r32) {
        boolean z10 = bigInteger2.signum() < 0;
        BigInteger bigIntegerMultiply = bigInteger.multiply(bigInteger2.abs());
        boolean zTestBit = bigIntegerMultiply.testBit(r32 - 1);
        BigInteger bigIntegerShiftRight = bigIntegerMultiply.shiftRight(r32);
        if (zTestBit) {
