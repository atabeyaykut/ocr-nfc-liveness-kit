...
public class DeltaCtl extends CtlFormat {
    ...
    public DeltaCtl(Version version, Time32 time32, UINT8 r92, SequenceOfCtlCommand sequenceOfCtlCommand) {
        super(version, time32, ASN1Boolean.FALSE, r92, sequenceOfCtlCommand);
    }
