...
public class EtsiTs103097Certificate extends ExplicitCertificate {
    ...
    public EtsiTs103097Certificate(UINT8 r12, IssuerIdentifier issuerIdentifier, ToBeSignedCertificate toBeSignedCertificate, Signature signature) {
        super(r12, issuerIdentifier, toBeSignedCertificate, signature);
    }
