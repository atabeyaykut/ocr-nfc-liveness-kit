...
public class EeRaCertRequest extends ASN1Object {
    ...
    public EeRaCertRequest(UINT8 r12, Time32 time32, CertificateType certificateType, ToBeSignedCertificate toBeSignedCertificate, AdditionalParams additionalParams) {
        this.version = r12;
        this.generationTime = time32;
        this.type = certificateType;
        this.tbsCert = toBeSignedCertificate;
