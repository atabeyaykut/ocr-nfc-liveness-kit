...
public class Ieee1609Dot2Dot1EeRaInterface {
    ...
    static {
        ...
        OERDefinition.Builder builderTypeName2 = OERDefinition.seq(builderTypeName.label("signingExpansion"), builder.label("encryptionKey"), builderTypeName.label("encryptionExpansion")).typeName("ButterflyParamsOriginal");
