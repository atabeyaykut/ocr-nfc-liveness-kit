...
public class IEEE1609dot2 {
    ...
    static {
        ...
        OERDefinition.Builder builderTypeName4 = OERDefinition.seq(builder.label("cracaId"), builder2.label("crlSeries"), OERDefinition.extension(new Object[0])).typeName("MissingCrlIdentifier");
        ...
        OERDefinition.Builder builderTypeName5 = OERDefinition.seq(builderValidSwitchValue.label("contributorId"), OERDefinition.aSwitch(r42).label("Extn")).typeName("ContributedExtensionBlock");
        ...
        OERDefinition.Builder builderTypeName24 = OERDefinition.choice(builder3.label("sha256AndDigest"), builder5.label("self"), OERDefinition.extension(builder3.label("sha384AndDigest"))).typeName("IssuerIdentifier");
        ...
        OERDefinition.Builder builderTypeName26 = OERDefinition.seq(builder6.label("version"), builderTypeName25.label("type"), builderTypeName24.label("issuer"), builderTypeName23.label("toBeSigned"), OERDefinition.optional(builder7.label("signature"))).label("signature").typeName("CertificateBase");
        ...
        OERDefinition.Builder builderTypeName29 = OERDefinition.choice(builder3.label("digest"), builderTypeName28.label("certificate"), OERDefinition.nullValue().label("self"), OERDefinition.extension(new Object[0])).typeName("SignerIdentifier");
