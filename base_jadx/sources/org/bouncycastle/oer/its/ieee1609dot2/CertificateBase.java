...
public class CertificateBase extends ASN1Object {
    ...
    public static class Builder {
        ...
        public Builder setVersion(UINT8 r12) {
            this.version = r12;
            return this;
        }
    }
    ...
    public CertificateBase(UINT8 r12, CertificateType certificateType, IssuerIdentifier issuerIdentifier, ToBeSignedCertificate toBeSignedCertificate, Signature signature) {
        this.version = r12;
        this.type = certificateType;
        this.issuer = issuerIdentifier;
        this.toBeSigned = toBeSignedCertificate;
