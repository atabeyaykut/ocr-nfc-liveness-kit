...
public class Point256 extends ASN1Object {
    ...
    private final ASN1OctetString f11812x;

    /* renamed from: y, reason: collision with root package name */
    private final ASN1OctetString f11813y;

    public static class Builder {

        /* renamed from: x, reason: collision with root package name */
        private ASN1OctetString f11814x;

        /* renamed from: y, reason: collision with root package name */
        private ASN1OctetString f11815y;

        public Point256 createPoint256() {
            return new Point256(this.f11814x, this.f11815y);
        }
        ...
        public Builder setX(ASN1OctetString aSN1OctetString) {
            this.f11814x = aSN1OctetString;
            return this;
        }

        public Builder setX(byte[] bArr) {
            this.f11814x = new DEROctetString(bArr);
            return this;
        }
        ...
        public Builder setY(ASN1OctetString aSN1OctetString) {
            this.f11815y = aSN1OctetString;
            return this;
        }

        public Builder setY(byte[] bArr) {
            this.f11815y = new DEROctetString(bArr);
            return this;
        }
    }
    ...
    public Point256(ASN1OctetString aSN1OctetString, ASN1OctetString aSN1OctetString2) {
        ...
        this.f11812x = aSN1OctetString;
        this.f11813y = aSN1OctetString2;
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        return new DERSequence(new ASN1Encodable[]{this.f11812x, this.f11813y});
    }
}
