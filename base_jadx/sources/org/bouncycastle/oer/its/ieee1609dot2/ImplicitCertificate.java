...
public class ImplicitCertificate extends CertificateBase {
    ...
    public ImplicitCertificate(UINT8 r72, IssuerIdentifier issuerIdentifier, ToBeSignedCertificate toBeSignedCertificate, Signature signature) {
        super(r72, CertificateType.implicit, issuerIdentifier, toBeSignedCertificate, signature);
    }
