...
public class Certificate extends CertificateBase {
    ...
    public Certificate(UINT8 r12, CertificateType certificateType, IssuerIdentifier issuerIdentifier, ToBeSignedCertificate toBeSignedCertificate, Signature signature) {
        super(r12, certificateType, issuerIdentifier, toBeSignedCertificate, signature);
    }
