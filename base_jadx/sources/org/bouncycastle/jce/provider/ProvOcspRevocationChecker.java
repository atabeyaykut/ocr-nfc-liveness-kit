...
class ProvOcspRevocationChecker implements PKIXCertRevocationChecker {
    ...
    private CertID createCertID(AlgorithmIdentifier algorithmIdentifier, Certificate certificate, ASN1Integer aSN1Integer) throws CertPathValidatorException {
        try {
            ...
            throw new CertPathValidatorException(a.e("problem creating ID: ", e10), e10);
        }
    }
    ...
    private Certificate extractCert() throws CertPathValidatorException {
        try {
            ...
            throw new CertPathValidatorException(androidx.constraintlayout.core.a.j(e10, new StringBuilder("cannot process signing cert: ")), e10, this.parameters.getCertPath(), this.parameters.getIndex());
        }
    }
    ...
    public static URI getOcspResponderURI(X509Certificate x509Certificate) {
        ...
        for (int r12 = 0; r12 != accessDescriptions.length; r12++) {
            AccessDescription accessDescription = accessDescriptions[r12];
    ...
    private static String getSignatureName(AlgorithmIdentifier algorithmIdentifier) {
        ...
        if (parameters != null && !DERNull.INSTANCE.equals(parameters) && algorithmIdentifier.getAlgorithm().equals((ASN1Primitive) PKCSObjectIdentifiers.id_RSASSA_PSS)) {
            return c.h(new StringBuilder(), getDigestName(RSASSAPSSparams.getInstance(parameters).getHashAlgorithm().getAlgorithm()), "WITHRSAANDMGF1");
        }
        Map map = oids;
    ...
    public static boolean validatedOcspResponse(BasicOCSPResponse basicOCSPResponse, PKIXCertRevocationCheckerParameters pKIXCertRevocationCheckerParameters, byte[] bArr, X509Certificate x509Certificate, JcaJceHelper jcaJceHelper) throws SignatureException, NoSuchAlgorithmException, InvalidKeyException, CertPathValidatorException, CertificateException, NoSuchProviderException {
        try {
            ...
            throw new CertPathValidatorException(a.c(e10, new StringBuilder("OCSP response failure: ")), e10, pKIXCertRevocationCheckerParameters.getCertPath(), pKIXCertRevocationCheckerParameters.getIndex());
    ...
    public void check(java.security.cert.Certificate certificate) throws CertPathValidatorException {
        ...
        URI r42 = ocspResponder;
        if (ocspResponses.get(x509Certificate) != null || r42 == null) {
            List<java.security.cert.Extension> ocspExtensions = this.parent.getOcspExtensions();
            bArr = null;
            for (int r22 = 0; r22 != ocspExtensions.size(); r22++) {
                java.security.cert.Extension extension = ocspExtensions.get(r22);
            ...
            try {
                ocspResponses.put(x509Certificate, OcspCache.getOcspResponse(createCertID(new AlgorithmIdentifier(OIWObjectIdentifiers.idSHA1), extractCert(), new ASN1Integer(x509Certificate.getSerialNumber())), this.parameters, r42, this.parent.getOcspResponderCert(), this.parent.getOcspExtensions(), this.helper).getEncoded());
                bArr = null;
                z10 = true;
        ...
        if (responseBytes.getResponseType().equals((ASN1Primitive) OCSPObjectIdentifiers.id_pkix_ocsp_basic)) {
            try {
                ...
                if (z10 || validatedOcspResponse(basicOCSPResponse, this.parameters, bArr, this.parent.getOcspResponderCert(), this.helper)) {
                    ...
                    for (int r82 = 0; r82 != responses.size(); r82++) {
                        SingleResponse singleResponse = SingleResponse.getInstance(responses.getObjectAt(r82));
