...
public class X509CRLObject extends X509CRL {
    ...
    private CertificateList f11693c;
    ...
    public X509CRLObject(CertificateList certificateList) throws CRLException {
        ...
        try {
            ...
            throw new CRLException(a.e("CRL contents invalid: ", e10));
        }
    }
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws SignatureException, NoSuchAlgorithmException, InvalidKeyException, CRLException {
        if (!this.f11693c.getSignatureAlgorithm().equals(this.f11693c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z10) {
        ...
        if (getVersion() != 2 || (extensions = this.f11693c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f11693c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f11693c.equals(x509CRLObject.f11693c);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f11693c.getEncoded(ASN1Encoding.DER);
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f11693c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f11693c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f11693c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f11693c.getNextUpdate() != null) {
            return this.f11693c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f11693c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f11693c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f11693c.getTBSCertList().getEncoded(ASN1Encoding.DER);
        } catch (IOException e10) {
            throw new CRLException(e10.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f11693c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f11693c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        Enumeration revokedCertificateEnumeration = this.f11693c.getRevokedCertificateEnumeration();
        X500Name issuer2 = this.f11693c.getIssuer();
    ...
    /*  JADX ERROR: JadxRuntimeException in pass: RegionMakerVisitor
        jadx.core.utils.exceptions.JadxRuntimeException: Can't find top splitter block for handler:B:42:0x0180
