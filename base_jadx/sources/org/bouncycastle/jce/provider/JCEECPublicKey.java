...
public class JCEECPublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f11685q = EC5Util.convertPoint(params, eCPublicKeySpec.getW());
    }

    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters) {
        this.algorithm = str;
        this.f11685q = eCPublicKeyParameters.getQ();
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = str;
        this.f11685q = jCEECPublicKey.f11685q;
    ...
    public JCEECPublicKey(String str, org.bouncycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.algorithm = str;
        this.f11685q = eCPublicKeySpec.getQ();
        if (eCPublicKeySpec.getParams() != null) {
            ...
            if (this.f11685q.getCurve() == null) {
                this.f11685q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f11685q.getAffineXCoord().toBigInteger(), this.f11685q.getAffineYCoord().toBigInteger());
            }
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f11685q = EC5Util.convertPoint(params, eCPublicKey.getW());
    }
    ...
    private void extractBytes(byte[] bArr, int r72, BigInteger bigInteger) {
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (algorithm.getAlgorithm().equals((ASN1Primitive) CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                bArr[0] = 4;
                for (int r52 = 1; r52 <= 32; r52++) {
                    bArr[r52] = octets[32 - r52];
                    bArr[r52 + 32] = octets[64 - r52];
                }
                ...
                this.f11685q = curve2.decodePoint(bArr);
        ...
        if (x962Parameters.isNamedCurve()) {
            ...
            if (x962Parameters.isImplicitlyCA()) {
                ...
                this.f11685q = new X9ECPoint(curve, dEROctetString).getPoint();
            }
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f11685q.getAffineXCoord().toBigInteger();
            BigInteger bigInteger2 = this.f11685q.getAffineYCoord().toBigInteger();
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f11685q.getDetachedPoint() : this.f11685q;
    }

    @Override // java.security.interfaces.ECPublicKey
    public java.security.spec.ECPoint getW() {
        return EC5Util.convertPoint(this.f11685q);
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f11685q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(strLineSeparator);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f11685q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(strLineSeparator);
