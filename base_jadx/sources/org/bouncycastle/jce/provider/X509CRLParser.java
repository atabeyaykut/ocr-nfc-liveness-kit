...
public class X509CRLParser extends X509StreamParserSpi {
    ...
    private CRL getCRL() throws CRLException {
        ...
        int r22 = this.sDataObjectCount;
        this.sDataObjectCount = r22 + 1;
        return new X509CRLObject(CertificateList.getInstance(aSN1Set2.getObjectAt(r22)));
    }
    ...
    public Object engineRead() throws StreamParsingException, IOException {
        try {
            ...
            int r02 = this.currentStream.read();
            if (r02 == -1) {
                return null;
            }
            if (r02 != 48) {
