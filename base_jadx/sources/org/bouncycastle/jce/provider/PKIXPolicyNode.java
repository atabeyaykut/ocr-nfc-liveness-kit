...
public class PKIXPolicyNode implements PolicyNode {
    ...
    public PKIXPolicyNode(List list, int r22, Set set, PolicyNode policyNode, Set set2, String str, boolean z10) {
        this.children = list;
        this.depth = r22;
    ...
    public String toString(String str) {
        ...
        stringBuffer.append(" {\n");
        for (int r12 = 0; r12 < this.children.size(); r12++) {
            stringBuffer.append(((PKIXPolicyNode) this.children.get(r12)).toString(str + "    "));
        }
        stringBuffer.append(str);
        stringBuffer.append("}\n");
