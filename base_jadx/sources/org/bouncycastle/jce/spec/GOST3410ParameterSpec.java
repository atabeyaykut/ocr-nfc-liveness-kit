...
public class GOST3410ParameterSpec implements AlgorithmParameterSpec, GOST3410Params {
    ...
    public GOST3410ParameterSpec(String str, String str2, String str3) {
        ...
        try {
            ...
            ASN1ObjectIdentifier aSN1ObjectIdentifier = GOST3410NamedParameters.getOID(str);
            if (aSN1ObjectIdentifier != null) {
                str = aSN1ObjectIdentifier.getId();
                byOID = GOST3410NamedParameters.getByOID(aSN1ObjectIdentifier);
            } else {
                byOID = null;
            }
        }
    ...
    public boolean equals(Object obj) {
        ...
        String str = this.digestParamSetOID;
        String str2 = gOST3410ParameterSpec.digestParamSetOID;
    ...
    public int hashCode() {
        int r02 = this.keyParameters.hashCode() ^ this.digestParamSetOID.hashCode();
