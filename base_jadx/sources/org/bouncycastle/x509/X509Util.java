...
class X509Util {
    ...
    private static RSASSAPSSparams creatPSSParams(AlgorithmIdentifier algorithmIdentifier, int r6) {
        return new RSASSAPSSparams(algorithmIdentifier, new AlgorithmIdentifier(PKCSObjectIdentifiers.id_mgf1, algorithmIdentifier), new ASN1Integer(r6), new ASN1Integer(1L));
    }
    ...
    public static Implementation getImplementation(String str, String str2) throws NoSuchAlgorithmException {
        ...
        for (int r12 = 0; r12 != providers.length; r12++) {
            Implementation implementation = getImplementation(str, Strings.toUpperCase(str2), providers[r12]);
            if (implementation != null) {
                return implementation;
            }
            try {
                getImplementation(str, str2, providers[r12]);
            } catch (NoSuchAlgorithmException unused) {
            }
        }
        throw new NoSuchAlgorithmException(b.e("cannot find implementation ", str2));
    }
    ...
    public static Provider getProvider(String str) throws NoSuchProviderException {
        ...
        throw new NoSuchProviderException(a.a("Provider ", str, " not found"));
    }
    ...
    public static Implementation getImplementation(String str, String str2, Provider provider) throws NoSuchAlgorithmException {
        ...
        if (property2 != null) {
            try {
                ...
                StringBuilder sbL = android.support.v4.media.a.l("algorithm ", upperCase, " in provider ");
                sbL.append(provider.getName());
                sbL.append(" but no class \"");
                sbL.append(property2);
                sbL.append("\" found!");
                throw new IllegalStateException(sbL.toString());
            } catch (Exception unused2) {
                StringBuilder sbL2 = android.support.v4.media.a.l("algorithm ", upperCase, " in provider ");
                sbL2.append(provider.getName());
                sbL2.append(" but class \"");
                sbL2.append(property2);
                sbL2.append("\" inaccessible!");
                throw new IllegalStateException(sbL2.toString());
            }
        }
        StringBuilder sbL3 = android.support.v4.media.a.l("cannot find implementation ", upperCase, " for provider ");
        sbL3.append(provider.getName());
        throw new NoSuchAlgorithmException(sbL3.toString());
    }
}
