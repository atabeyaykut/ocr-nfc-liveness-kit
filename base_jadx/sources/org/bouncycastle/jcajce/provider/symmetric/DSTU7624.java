...
public class DSTU7624 {
    ...
    public static class KeyGen extends BaseKeyGenerator {
        ...
        public KeyGen(int r32) {
            super("DSTU7624", r32, new CipherKeyGenerator());
        }
    }
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.i(sb2, str, "$AlgParams", configurableProvider, "AlgorithmParameters.DSTU7624");
            ASN1ObjectIdentifier aSN1ObjectIdentifier = UAObjectIdentifiers.dstu7624cbc_128;
            v.g(str, "$AlgParams", configurableProvider, "AlgorithmParameters", aSN1ObjectIdentifier);
            ASN1ObjectIdentifier aSN1ObjectIdentifier2 = UAObjectIdentifiers.dstu7624cbc_256;
            v.g(str, "$AlgParams", configurableProvider, "AlgorithmParameters", aSN1ObjectIdentifier2);
            ...
            configurableProvider.addAlgorithm("Cipher", aSN1ObjectIdentifier3, c.h(androidx.browser.browseractions.a.c(androidx.browser.browseractions.b.j(configurableProvider, "Cipher", aSN1ObjectIdentifier, c.h(new StringBuilder(), str, "$CBC128"), str), "$CBC256", configurableProvider, "Cipher", aSN1ObjectIdentifier2), str, "$CBC512"));
            ASN1ObjectIdentifier aSN1ObjectIdentifier7 = UAObjectIdentifiers.dstu7624ofb_128;
            v.g(str, "$OFB128", configurableProvider, "Cipher", aSN1ObjectIdentifier7);
            ASN1ObjectIdentifier aSN1ObjectIdentifier8 = UAObjectIdentifiers.dstu7624ofb_256;
            v.g(str, "$OFB256", configurableProvider, "Cipher", aSN1ObjectIdentifier8);
            ASN1ObjectIdentifier aSN1ObjectIdentifier9 = UAObjectIdentifiers.dstu7624ofb_512;
            v.g(str, "$OFB512", configurableProvider, "Cipher", aSN1ObjectIdentifier9);
            ASN1ObjectIdentifier aSN1ObjectIdentifier10 = UAObjectIdentifiers.dstu7624cfb_128;
            v.g(str, "$CFB128", configurableProvider, "Cipher", aSN1ObjectIdentifier10);
            ASN1ObjectIdentifier aSN1ObjectIdentifier11 = UAObjectIdentifiers.dstu7624cfb_256;
            v.g(str, "$CFB256", configurableProvider, "Cipher", aSN1ObjectIdentifier11);
            ASN1ObjectIdentifier aSN1ObjectIdentifier12 = UAObjectIdentifiers.dstu7624cfb_512;
            v.g(str, "$CFB512", configurableProvider, "Cipher", aSN1ObjectIdentifier12);
            ASN1ObjectIdentifier aSN1ObjectIdentifier13 = UAObjectIdentifiers.dstu7624ctr_128;
            v.g(str, "$CTR128", configurableProvider, "Cipher", aSN1ObjectIdentifier13);
            ASN1ObjectIdentifier aSN1ObjectIdentifier14 = UAObjectIdentifiers.dstu7624ctr_256;
            v.g(str, "$CTR256", configurableProvider, "Cipher", aSN1ObjectIdentifier14);
            ASN1ObjectIdentifier aSN1ObjectIdentifier15 = UAObjectIdentifiers.dstu7624ctr_512;
            v.g(str, "$CTR512", configurableProvider, "Cipher", aSN1ObjectIdentifier15);
            ASN1ObjectIdentifier aSN1ObjectIdentifier16 = UAObjectIdentifiers.dstu7624ccm_128;
            v.g(str, "$CCM128", configurableProvider, "Cipher", aSN1ObjectIdentifier16);
            ASN1ObjectIdentifier aSN1ObjectIdentifier17 = UAObjectIdentifiers.dstu7624ccm_256;
            v.g(str, "$CCM256", configurableProvider, "Cipher", aSN1ObjectIdentifier17);
            ...
            a.i(new StringBuilder(), str, "$Wrap", configurableProvider, "Cipher.DSTU7624KW");
            StringBuilder sbD = androidx.fragment.app.a.d(configurableProvider, "Cipher.DSTU7624-128KW", android.support.v4.media.a.k(configurableProvider, "Alg.Alias.Cipher.DSTU7624WRAP", "DSTU7624KW", str, "$Wrap128"), "Alg.Alias.Cipher.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier19 = UAObjectIdentifiers.dstu7624kw_128;
            sbD.append(aSN1ObjectIdentifier19.getId());
            configurableProvider.addAlgorithm(sbD.toString(), "DSTU7624-128KW");
            StringBuilder sbD2 = androidx.fragment.app.a.d(configurableProvider, "Cipher.DSTU7624-256KW", android.support.v4.media.a.k(configurableProvider, "Alg.Alias.Cipher.DSTU7624-128WRAP", "DSTU7624-128KW", str, "$Wrap256"), "Alg.Alias.Cipher.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier20 = UAObjectIdentifiers.dstu7624kw_256;
            sbD2.append(aSN1ObjectIdentifier20.getId());
            configurableProvider.addAlgorithm(sbD2.toString(), "DSTU7624-256KW");
            StringBuilder sbD3 = androidx.fragment.app.a.d(configurableProvider, "Cipher.DSTU7624-512KW", android.support.v4.media.a.k(configurableProvider, "Alg.Alias.Cipher.DSTU7624-256WRAP", "DSTU7624-256KW", str, "$Wrap512"), "Alg.Alias.Cipher.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier21 = UAObjectIdentifiers.dstu7624kw_512;
            sbD3.append(aSN1ObjectIdentifier21.getId());
            configurableProvider.addAlgorithm(sbD3.toString(), "DSTU7624-512KW");
            StringBuilder sbD4 = androidx.fragment.app.a.d(configurableProvider, "Mac.DSTU7624-128GMAC", android.support.v4.media.a.k(configurableProvider, "Mac.DSTU7624GMAC", android.support.v4.media.a.k(configurableProvider, "Alg.Alias.Cipher.DSTU7624-512WRAP", "DSTU7624-512KW", str, "$GMAC"), str, "$GMAC128"), "Alg.Alias.Mac.");
            ASN1ObjectIdentifier aSN1ObjectIdentifier22 = UAObjectIdentifiers.dstu7624gmac_128;
            sbD4.append(aSN1ObjectIdentifier22.getId());
            configurableProvider.addAlgorithm(sbD4.toString(), "DSTU7624-128GMAC");
