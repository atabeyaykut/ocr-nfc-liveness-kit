...
public final class SipHash128 {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.i(sb2, str, "$Mac24", configurableProvider, "Mac.SIPHASH128-2-4");
            configurableProvider.addAlgorithm("KeyGenerator.SIPHASH128", android.support.v4.media.a.k(configurableProvider, "Mac.SIPHASH128-4-8", android.support.v4.media.a.k(configurableProvider, "Alg.Alias.Mac.SIPHASH128", "SIPHASH128-2-4", str, "$Mac48"), str, "$KeyGen"));
