...
public final class Camellia {
    ...
    public static class KeyGen extends BaseKeyGenerator {
        ...
        public KeyGen(int r32) {
            super("Camellia", r32, new CipherKeyGenerator());
        }
    }
    ...
    public static class Mappings extends SymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.i(sb2, str, "$AlgParams", configurableProvider, "AlgorithmParameters.CAMELLIA");
            ...
            b.i(androidx.browser.browseractions.b.j(configurableProvider, "Alg.Alias.AlgorithmParameters", aSN1ObjectIdentifier3, "CAMELLIA", str), "$AlgParamGen", configurableProvider, "AlgorithmParameterGenerator.CAMELLIA");
            ...
            b.i(androidx.browser.browseractions.b.j(configurableProvider, "Alg.Alias.Cipher", aSN1ObjectIdentifier6, "CAMELLIAWRAP", str), "$KeyFactory", configurableProvider, "SecretKeyFactory.CAMELLIA");
            ...
            StringBuilder sbJ = androidx.browser.browseractions.b.j(configurableProvider, "KeyGenerator", aSN1ObjectIdentifier3, c.h(androidx.browser.browseractions.a.c(androidx.browser.browseractions.b.j(configurableProvider, "KeyGenerator", aSN1ObjectIdentifier, c.h(androidx.browser.browseractions.a.c(androidx.browser.browseractions.b.j(configurableProvider, "KeyGenerator", aSN1ObjectIdentifier5, c.h(androidx.browser.browseractions.a.c(androidx.room.util.a.d(androidx.browser.browseractions.b.j(configurableProvider, "Alg.Alias.SecretKeyFactory", aSN1ObjectIdentifier3, "CAMELLIA", str), "$KeyGen", configurableProvider, "KeyGenerator.CAMELLIA", str), "$KeyGen128", configurableProvider, "KeyGenerator", aSN1ObjectIdentifier4), str, "$KeyGen192"), str), "$KeyGen256", configurableProvider, "KeyGenerator", aSN1ObjectIdentifier6), str, "$KeyGen128"), str), "$KeyGen192", configurableProvider, "KeyGenerator", aSN1ObjectIdentifier2), str, "$KeyGen256"), str);
            sbJ.append("$GMAC");
            addGMacAlgorithm(configurableProvider, "CAMELLIA", sbJ.toString(), android.support.v4.media.a.f(str, "$KeyGen"));
            addPoly1305Algorithm(configurableProvider, "CAMELLIA", android.support.v4.media.a.f(str, "$Poly1305"), android.support.v4.media.a.f(str, "$Poly1305KeyGen"));
        }
    }
