...
public final class SipHash {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm("KeyGenerator.SIPHASH", android.support.v4.media.a.k(configurableProvider, "Mac.SIPHASH-4-8", android.support.v4.media.a.k(configurableProvider, "Alg.Alias.Mac.SIPHASH", "SIPHASH-2-4", str, "$Mac48"), str, "$KeyGen"));
