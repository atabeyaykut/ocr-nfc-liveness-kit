...
public class TLSKDF {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.i(c.i(c.i(c.i(c.i(sb2, str, "$TLS10", configurableProvider, "SecretKeyFactory.TLS10KDF"), str, "$TLS11", configurableProvider, "SecretKeyFactory.TLS11KDF"), str, "$TLS12withSHA256", configurableProvider, "SecretKeyFactory.TLS12WITHSHA256KDF"), str, "$TLS12withSHA384", configurableProvider, "SecretKeyFactory.TLS12WITHSHA384KDF"), str, "$TLS12withSHA512", configurableProvider, "SecretKeyFactory.TLS12WITHSHA512KDF");
        }
    }
    ...
    public static byte[] PRF_legacy(TLSKeyMaterialSpec tLSKeyMaterialSpec) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        for (int r72 = 0; r72 < length2; r72++) {
            bArr3[r72] = (byte) (bArr3[r72] ^ bArr4[r72]);
        }
        return bArr3;
    }
    ...
    public static void hmac_hash(Mac mac, byte[] bArr, byte[] bArr2, byte[] bArr3) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        while (r52 < length) {
            ...
            mac.doFinal(bArr5, 0);
            int r6 = macSize * r52;
            System.arraycopy(bArr5, 0, bArr3, r6, Math.min(macSize, bArr3.length - r6));
            r52++;
            bArr6 = bArr4;
        }
    }
