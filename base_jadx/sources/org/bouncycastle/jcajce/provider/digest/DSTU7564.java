...
public class DSTU7564 {
    ...
    public static class DigestDSTU7564 extends BCMessageDigest implements Cloneable {
        public DigestDSTU7564(int r22) {
            super(new DSTU7564Digest(r22));
        }
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.i(c.i(c.i(sb2, str, "$Digest256", configurableProvider, "MessageDigest.DSTU7564-256"), str, "$Digest384", configurableProvider, "MessageDigest.DSTU7564-384"), str, "$Digest512", configurableProvider, "MessageDigest.DSTU7564-512");
            v.g(str, "$Digest256", configurableProvider, "MessageDigest", UAObjectIdentifiers.dstu7564digest_256);
            v.g(str, "$Digest384", configurableProvider, "MessageDigest", UAObjectIdentifiers.dstu7564digest_384);
            configurableProvider.addAlgorithm("MessageDigest", UAObjectIdentifiers.dstu7564digest_512, str + "$Digest512");
            addHMACAlgorithm(configurableProvider, "DSTU7564-256", c.h(new StringBuilder(), str, "$HashMac256"), android.support.v4.media.a.f(str, "$KeyGenerator256"));
            addHMACAlgorithm(configurableProvider, "DSTU7564-384", android.support.v4.media.a.f(str, "$HashMac384"), android.support.v4.media.a.f(str, "$KeyGenerator384"));
            addHMACAlgorithm(configurableProvider, "DSTU7564-512", android.support.v4.media.a.f(str, "$HashMac512"), android.support.v4.media.a.f(str, "$KeyGenerator512"));
