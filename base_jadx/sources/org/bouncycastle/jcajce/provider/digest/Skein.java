...
public class Skein {
    ...
    public static class DigestSkein1024 extends BCMessageDigest implements Cloneable {
        public DigestSkein1024(int r32) {
            super(new SkeinDigest(1024, r32));
        }
    ...
    public static class DigestSkein256 extends BCMessageDigest implements Cloneable {
        public DigestSkein256(int r32) {
            super(new SkeinDigest(256, r32));
        }
    ...
    public static class DigestSkein512 extends BCMessageDigest implements Cloneable {
        public DigestSkein512(int r32) {
            super(new SkeinDigest(512, r32));
        }
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        private void addSkeinMacAlgorithm(ConfigurableProvider configurableProvider, int r72, int r82) {
            String strC = a.c("Skein-MAC-", r72, "-", r82);
            ...
            sb2.append("_");
            sb2.append(r82);
            configurableProvider.addAlgorithm("Mac." + strC, sb2.toString());
            configurableProvider.addAlgorithm("Alg.Alias.Mac.Skein-MAC" + r72 + "/" + r82, strC);
            StringBuilder sb3 = new StringBuilder("KeyGenerator.");
            sb3.append(strC);
            configurableProvider.addAlgorithm(sb3.toString(), str + "$SkeinMacKeyGenerator_" + r72 + "_" + r82);
            configurableProvider.addAlgorithm("Alg.Alias.KeyGenerator.Skein-MAC" + r72 + "/" + r82, strC);
        }
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            StringBuilder sb2 = new StringBuilder();
            String str = PREFIX;
            addHMACAlgorithm(configurableProvider, "Skein-256-128", c.h(c.i(c.i(c.i(c.i(c.i(c.i(c.i(c.i(c.i(c.i(c.i(c.i(c.i(sb2, str, "$Digest_256_128", configurableProvider, "MessageDigest.Skein-256-128"), str, "$Digest_256_160", configurableProvider, "MessageDigest.Skein-256-160"), str, "$Digest_256_224", configurableProvider, "MessageDigest.Skein-256-224"), str, "$Digest_256_256", configurableProvider, "MessageDigest.Skein-256-256"), str, "$Digest_512_128", configurableProvider, "MessageDigest.Skein-512-128"), str, "$Digest_512_160", configurableProvider, "MessageDigest.Skein-512-160"), str, "$Digest_512_224", configurableProvider, "MessageDigest.Skein-512-224"), str, "$Digest_512_256", configurableProvider, "MessageDigest.Skein-512-256"), str, "$Digest_512_384", configurableProvider, "MessageDigest.Skein-512-384"), str, "$Digest_512_512", configurableProvider, "MessageDigest.Skein-512-512"), str, "$Digest_1024_384", configurableProvider, "MessageDigest.Skein-1024-384"), str, "$Digest_1024_512", configurableProvider, "MessageDigest.Skein-1024-512"), str, "$Digest_1024_1024", configurableProvider, "MessageDigest.Skein-1024-1024"), str, "$HashMac_256_128"), android.support.v4.media.a.f(str, "$HMacKeyGenerator_256_128"));
            addHMACAlgorithm(configurableProvider, "Skein-256-160", android.support.v4.media.a.f(str, "$HashMac_256_160"), android.support.v4.media.a.f(str, "$HMacKeyGenerator_256_160"));
            addHMACAlgorithm(configurableProvider, "Skein-256-224", android.support.v4.media.a.f(str, "$HashMac_256_224"), android.support.v4.media.a.f(str, "$HMacKeyGenerator_256_224"));
            addHMACAlgorithm(configurableProvider, "Skein-256-256", android.support.v4.media.a.f(str, "$HashMac_256_256"), android.support.v4.media.a.f(str, "$HMacKeyGenerator_256_256"));
            addHMACAlgorithm(configurableProvider, "Skein-512-128", android.support.v4.media.a.f(str, "$HashMac_512_128"), android.support.v4.media.a.f(str, "$HMacKeyGenerator_512_128"));
            addHMACAlgorithm(configurableProvider, "Skein-512-160", android.support.v4.media.a.f(str, "$HashMac_512_160"), android.support.v4.media.a.f(str, "$HMacKeyGenerator_512_160"));
            addHMACAlgorithm(configurableProvider, "Skein-512-224", android.support.v4.media.a.f(str, "$HashMac_512_224"), android.support.v4.media.a.f(str, "$HMacKeyGenerator_512_224"));
            addHMACAlgorithm(configurableProvider, "Skein-512-256", android.support.v4.media.a.f(str, "$HashMac_512_256"), android.support.v4.media.a.f(str, "$HMacKeyGenerator_512_256"));
            addHMACAlgorithm(configurableProvider, "Skein-512-384", android.support.v4.media.a.f(str, "$HashMac_512_384"), android.support.v4.media.a.f(str, "$HMacKeyGenerator_512_384"));
            addHMACAlgorithm(configurableProvider, "Skein-512-512", android.support.v4.media.a.f(str, "$HashMac_512_512"), android.support.v4.media.a.f(str, "$HMacKeyGenerator_512_512"));
            addHMACAlgorithm(configurableProvider, "Skein-1024-384", android.support.v4.media.a.f(str, "$HashMac_1024_384"), android.support.v4.media.a.f(str, "$HMacKeyGenerator_1024_384"));
            addHMACAlgorithm(configurableProvider, "Skein-1024-512", android.support.v4.media.a.f(str, "$HashMac_1024_512"), android.support.v4.media.a.f(str, "$HMacKeyGenerator_1024_512"));
            addHMACAlgorithm(configurableProvider, "Skein-1024-1024", android.support.v4.media.a.f(str, "$HashMac_1024_1024"), android.support.v4.media.a.f(str, "$HMacKeyGenerator_1024_1024"));
