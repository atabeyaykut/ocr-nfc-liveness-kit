...
public class SM3 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            String str = PREFIX;
            a.i(sb2, str, "$Digest", configurableProvider, "MessageDigest.SM3");
            ...
            StringBuilder sbH = androidx.appcompat.graphics.drawable.a.h(new StringBuilder("Alg.Alias.MessageDigest."), GMObjectIdentifiers.sm3, configurableProvider, "SM3", str);
            sbH.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "SM3", sbH.toString(), android.support.v4.media.a.f(str, "$KeyGenerator"));
