...
public class RIPEMD160 {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            StringBuilder sbH = a.h(new StringBuilder("Alg.Alias.MessageDigest."), TeleTrusTObjectIdentifiers.ripemd160, configurableProvider, "RIPEMD160", str);
            sbH.append("$HashMac");
            addHMACAlgorithm(configurableProvider, "RIPEMD160", sbH.toString(), android.support.v4.media.a.f(str, "$KeyGenerator"));
            ...
            sb3.append(str);
            b.i(sb3, "$PBEWithHmac", configurableProvider, "Mac.PBEWITHHMACRIPEMD160");
        }
    }
