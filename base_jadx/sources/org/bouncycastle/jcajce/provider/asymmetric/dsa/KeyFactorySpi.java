...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        if (keySpec instanceof DSAPublicKeySpec) {
            try {
                ...
                throw new InvalidKeySpecException(a.j(e10, new StringBuilder("invalid KeySpec: "))) { // from class: org.bouncycastle.jcajce.provider.asymmetric.dsa.KeyFactorySpi.1
    ...
    public KeySpec engineGetKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        ...
        if (cls.isAssignableFrom(OpenSSHPublicKeySpec.class) && (key instanceof DSAPublicKey)) {
            ...
            try {
                ...
                throw new IllegalArgumentException(android.support.v4.media.a.c(e10, new StringBuilder("unable to produce encoding: ")));
            }
        }
        ...
        try {
            ...
            throw new IllegalArgumentException(android.support.v4.media.a.c(e11, new StringBuilder("unable to produce encoding: ")));
        }
    }
    ...
    public PrivateKey generatePrivate(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        throw new IOException(v.d("algorithm identifier ", algorithm, " in key not recognised"));
    }
