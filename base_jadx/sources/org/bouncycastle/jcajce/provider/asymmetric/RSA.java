...
public class RSA {
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        private void addDigestSignature(ConfigurableProvider configurableProvider, String str, String str2, ASN1ObjectIdentifier aSN1ObjectIdentifier) {
            String strF = a.f(str, "WITHRSA");
            String strF2 = a.f(str, "withRSA");
            String strF3 = a.f(str, "WithRSA");
            String strF4 = a.f(str, "/RSA");
            String strF5 = a.f(str, "WITHRSAENCRYPTION");
            String strF6 = a.f(str, "withRSAEncryption");
            String strF7 = a.f(str, "WithRSAEncryption");
            configurableProvider.addAlgorithm("Signature." + strF, str2);
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + strF2, strF);
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + strF3, strF);
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + strF5, strF);
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + strF6, strF);
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + strF7, strF);
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + strF4, strF);
            if (aSN1ObjectIdentifier != null) {
                configurableProvider.addAlgorithm("Alg.Alias.Signature." + aSN1ObjectIdentifier, strF);
                androidx.browser.browseractions.a.g(new StringBuilder("Alg.Alias.Signature.OID."), aSN1ObjectIdentifier, configurableProvider, strF);
            }
            configurableProvider.addAttributes(b.e("Signature.", strF), RSA.generalRsaAttributes);
        }

        private void addISO9796Signature(ConfigurableProvider configurableProvider, String str, String str2) {
            StringBuilder sbH = f.h(str, "WITHRSA/ISO9796-2", configurableProvider, c.h(f.h(str, "WITHRSA/ISO9796-2", configurableProvider, androidx.browser.browseractions.a.a("Alg.Alias.Signature.", str, "withRSA/ISO9796-2"), "Alg.Alias.Signature."), str, "WithRSA/ISO9796-2"), "Signature.");
            sbH.append(str);
            sbH.append("WITHRSA/ISO9796-2");
            configurableProvider.addAlgorithm(sbH.toString(), str2);
            configurableProvider.addAttributes(androidx.browser.browseractions.a.a("Signature.", str, "WITHRSA/ISO9796-2"), RSA.generalRsaAttributes);
        }

        private void addPSSSignature(ConfigurableProvider configurableProvider, String str, String str2, String str3) {
            String strE = b.e("WITHRSAAND", str2);
            if (str2.equals("MGF1")) {
                configurableProvider.addAlgorithm(c.h(f.h(str, strE, configurableProvider, c.h(f.h(str, strE, configurableProvider, c.h(f.h(str, strE, configurableProvider, c.h(f.h(str, strE, configurableProvider, c.h(f.h(str, strE, configurableProvider, androidx.browser.browseractions.a.a("Alg.Alias.Signature.", str, "withRSA/PSS"), "Alg.Alias.Signature."), str, "WithRSA/PSS"), "Alg.Alias.Signature."), str, "WITHRSA/PSS"), "Alg.Alias.Signature."), str, "withRSASSA-PSS"), "Alg.Alias.Signature."), str, "WithRSASSA-PSS"), "Alg.Alias.Signature."), str, "WITHRSASSA-PSS"), str + strE);
            }
            configurableProvider.addAlgorithm(a.i(f.h(str, strE, configurableProvider, a.i(f.h(str, strE, configurableProvider, c.g("Alg.Alias.Signature.", str, "withRSAand", str2), "Alg.Alias.Signature."), str, "WithRSAAnd", str2), "Signature."), str, "WITHRSAAND", str2), str3);
            StringBuilder sb2 = new StringBuilder("Signature.");
            sb2.append(str);
            configurableProvider.addAttributes(c.h(sb2, "WITHRSAAND", str2), RSA.generalRsaAttributes);
        }

        private void addX931Signature(ConfigurableProvider configurableProvider, String str, String str2) {
            StringBuilder sbH = f.h(str, "WITHRSA/X9.31", configurableProvider, c.h(f.h(str, "WITHRSA/X9.31", configurableProvider, androidx.browser.browseractions.a.a("Alg.Alias.Signature.", str, "withRSA/X9.31"), "Alg.Alias.Signature."), str, "WithRSA/X9.31"), "Signature.");
            sbH.append(str);
            sbH.append("WITHRSA/X9.31");
            configurableProvider.addAlgorithm(sbH.toString(), str2);
            configurableProvider.addAttributes(androidx.browser.browseractions.a.a("Signature.", str, "WITHRSA/X9.31"), RSA.generalRsaAttributes);
        }
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm(androidx.camera.core.impl.a.h(configurableProvider, "Alg.Alias.Signature." + aSN1ObjectIdentifier4, "RSASSA-PSS", "Alg.Alias.Signature.OID.", aSN1ObjectIdentifier4), "RSASSA-PSS");
            ...
            if (configurableProvider.hasAlgorithm("MessageDigest", "SHA1")) {
                ...
                androidx.browser.browseractions.a.g(androidx.room.util.a.e(sb2, aSN1ObjectIdentifier5, configurableProvider, "SHA1WITHRSA", "Alg.Alias.Signature.OID."), aSN1ObjectIdentifier5, configurableProvider, "SHA1WITHRSA");
        ...
        private void addPSSSignature(ConfigurableProvider configurableProvider, String str, String str2, ASN1ObjectIdentifier aSN1ObjectIdentifier) {
            configurableProvider.addAlgorithm(c.h(f.h(str, "WITHRSAPSS", configurableProvider, c.h(f.h(str, "WITHRSAPSS", configurableProvider, c.h(f.h(str, "WITHRSAPSS", configurableProvider, c.h(f.h(str, "WITHRSAPSS", configurableProvider, androidx.browser.browseractions.a.a("Alg.Alias.Signature.", str, "withRSA/PSS"), "Alg.Alias.Signature."), str, "WithRSA/PSS"), "Alg.Alias.Signature."), str, "withRSASSA-PSS"), "Alg.Alias.Signature."), str, "WithRSASSA-PSS"), "Alg.Alias.Signature."), str, "WITHRSASSA-PSS"), str + "WITHRSAPSS");
            ...
            configurableProvider.addAttributes(androidx.browser.browseractions.a.a("Signature.", str, "WITHRSAPSS"), RSA.generalRsaAttributes);
        }
    }
}
