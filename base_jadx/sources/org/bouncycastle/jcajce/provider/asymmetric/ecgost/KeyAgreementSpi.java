...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public Key engineDoPhase(Key key, boolean z10) throws IllegalStateException, InvalidKeyException {
        ...
        try {
            ...
            throw new InvalidKeyException(a.j(e10, new StringBuilder("calculation failed: "))) { // from class: org.bouncycastle.jcajce.provider.asymmetric.ecgost.KeyAgreementSpi.1
