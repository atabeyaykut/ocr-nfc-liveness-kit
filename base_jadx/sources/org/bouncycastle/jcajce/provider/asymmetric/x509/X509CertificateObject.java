...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
    ...
    private static BasicConstraints createBasicConstraints(Certificate certificate) throws CertificateParsingException {
        try {
            ...
            throw new CertificateParsingException(a.e("cannot construct BasicConstraints: ", e10));
        }
    }
    ...
    private static boolean[] createKeyUsage(Certificate certificate) throws CertificateParsingException {
        try {
            ...
            boolean[] zArr = new boolean[r6];
            for (int r22 = 0; r22 != length; r22++) {
                zArr[r22] = (bytes[r22 / 8] & (128 >>> (r22 % 8))) != 0;
            }
            return zArr;
        } catch (Exception e10) {
    ...
    private static String createSigAlgName(Certificate certificate) throws CertificateParsingException {
        try {
            ...
            throw new CertificateParsingException(a.e("cannot construct SigAlgName: ", e10));
        }
    }
    ...
    private static byte[] createSigAlgParams(Certificate certificate) throws CertificateParsingException {
        try {
            ...
            throw new CertificateParsingException(a.e("cannot construct SigAlgParams: ", e10));
        }
    }
    ...
    private X509CertificateInternal getInternalCertificate() throws IOException {
        ...
        synchronized (this.cacheLock) {
            ...
            try {
                ...
                encoded = this.f11675c.getEncoded(ASN1Encoding.DER);
            } catch (IOException e10) {
                encoded = null;
                x509CertificateEncodingException = new X509CertificateEncodingException(e10);
            }
            X509CertificateInternal x509CertificateInternal3 = new X509CertificateInternal(this.bcHelper, this.f11675c, this.basicConstraints, this.keyUsage, this.sigAlgName, this.sigAlgParams, encoded, x509CertificateEncodingException);
            synchronized (this.cacheLock) {
    ...
    public boolean equals(Object obj) throws IOException {
        ...
        if (obj instanceof X509CertificateObject) {
            ...
            } else if ((this.internalCertificateValue == null || x509CertificateObject.internalCertificateValue == null) && (signature = this.f11675c.getSignature()) != null && !signature.equals((ASN1Primitive) x509CertificateObject.f11675c.getSignature())) {
                return false;
            }
