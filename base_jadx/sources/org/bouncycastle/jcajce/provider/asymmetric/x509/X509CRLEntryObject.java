...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f11673c.getExtensions();
        if (extensions != null) {
    ...
    private X500Name loadCertificateIssuer(boolean z10, X500Name x500Name) {
        ...
        try {
            ...
            for (int r52 = 0; r52 < names.length; r52++) {
                if (names[r52].getTagNo() == 4) {
                    return X500Name.getInstance(names[r52].getName());
                }
            }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f11673c.equals(x509CRLEntryObject.f11673c);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f11673c.getEncoded(ASN1Encoding.DER);
    ...
    public byte[] getExtensionValue(String str) {
        ...
        try {
            ...
            throw new IllegalStateException(a.b(e10, new StringBuilder("Exception encoding: ")));
        }
    }
    ...
    public Date getRevocationDate() {
        return this.f11673c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f11673c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f11673c.getExtensions() != null;
    }
