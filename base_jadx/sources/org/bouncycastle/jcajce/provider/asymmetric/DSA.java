    ...
    public static class Mappings extends AsymmetricAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            while (true) {
                ...
                if (r22 == aSN1ObjectIdentifierArr.length) {
                    return;
                }
                a.g(new StringBuilder("Alg.Alias.Signature."), aSN1ObjectIdentifierArr[r22], configurableProvider, "DSA");
                registerOid(configurableProvider, aSN1ObjectIdentifierArr[r22], "DSA", keyFactorySpi);
                registerOidAlgorithmParameterGenerator(configurableProvider, aSN1ObjectIdentifierArr[r22], "DSA");
                r22++;
            }
        }
    }
