...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public byte[] bigIntToBytes(BigInteger bigInteger) {
        return BigIntegers.asUnsignedByteArray((this.f11660p.bitLength() + 7) / 8, bigInteger);
    }
    ...
    public void doInitFromKey(Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (algorithmParameterSpec == null) {
            this.f11660p = dHPrivateKey.getParams().getP();
            this.f11659g = dHPrivateKey.getParams().getG();
        } else if (algorithmParameterSpec instanceof DHParameterSpec) {
            DHParameterSpec dHParameterSpec = (DHParameterSpec) algorithmParameterSpec;
            this.f11660p = dHParameterSpec.getP();
            this.f11659g = dHParameterSpec.getG();
    ...
    public Key engineDoPhase(Key key, boolean z10) throws IllegalStateException, InvalidKeyException {
        ...
        if (!dHPublicKey.getParams().getG().equals(this.f11659g) || !dHPublicKey.getParams().getP().equals(this.f11660p)) {
            throw new InvalidKeyException("DHPublicKey not for this KeyAgreement!");
        }
        BigInteger y10 = dHPublicKey.getY();
        if (y10 != null && y10.compareTo(TWO) >= 0) {
            BigInteger bigInteger = this.f11660p;
            ...
            if (y10.compareTo(bigInteger.subtract(bigInteger2)) < 0) {
                ...
                BigInteger bigIntegerModPow = y10.modPow(this.f11661x, this.f11660p);
    ...
    public int engineGenerateSecret(byte[] bArr, int r32) throws IllegalStateException, ShortBufferException {
        if (this.f11661x != null) {
            return super.engineGenerateSecret(bArr, r32);
        }
        throw new IllegalStateException("Diffie-Hellman not initialised.");
    }
