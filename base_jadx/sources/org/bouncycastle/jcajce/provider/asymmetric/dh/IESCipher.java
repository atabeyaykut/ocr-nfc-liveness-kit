...
public class IESCipher extends BaseCipherSpi {
    ...
    @Override // javax.crypto.CipherSpi
    public byte[] engineDoFinal(byte[] bArr, int r72, int r82) throws BadPaddingException, IllegalBlockSizeException {
        if (r82 != 0) {
            this.buffer.write(bArr, r72, r82);
        }
            ...
            try {
                this.engine.init(this.key, iESWithCipherParameters, new EphemeralKeyPairGenerator(dHKeyPairGenerator, new KeyEncoder() { // from class: org.bouncycastle.jcajce.provider.asymmetric.dh.IESCipher.1
                    ...
                    public byte[] getEncoded(AsymmetricKeyParameter asymmetricKeyParameter2) {
                        int r03 = (((DHKeyParameters) asymmetricKeyParameter2).getParameters().getP().bitLength() + 7) / 8;
                        ...
                        if (bArrAsUnsignedByteArray.length > r03) {
                            throw new IllegalArgumentException("Senders's public key longer than expected.");
                        }
                        System.arraycopy(bArrAsUnsignedByteArray, 0, bArr2, r03 - bArrAsUnsignedByteArray.length, bArrAsUnsignedByteArray.length);
                        return bArr2;
                    }
                }));
                return this.engine.processBlock(byteArray, 0, byteArray.length);
    ...
    public int engineGetOutputSize(int r92) {
        ...
        int r22 = this.otherKeyParameter == null ? (((((DHKeyParameters) this.key).getParameters().getP().bitLength() + 7) * 2) / 8) + 1 : 0;
        if (this.engine.getCipher() != null) {
            ...
            r92 = cipher.getOutputSize(r92);
        }
        int r12 = this.state;
        if (r12 == 1 || r12 == 3) {
            size = this.buffer.size() + macSize + r22;
        } else {
            if (r12 != 2 && r12 != 4) {
                throw new IllegalStateException("IESCipher not initialised");
            }
