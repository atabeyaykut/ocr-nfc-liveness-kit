...
public abstract class BaseAgreementSpi extends KeyAgreementSpi {
    ...
    private byte[] calcSecret() {
        ...
        byte[] bArrConcatenate = this.hybridSpec.isPrependedT() ? Arrays.concatenate(this.hybridSpec.getT(), bArrDoCalcSecret) : Arrays.concatenate(bArrDoCalcSecret, this.hybridSpec.getT());
    ...
    private byte[] getSharedSecretBytes(byte[] bArr, String str, int r82) throws DataLengthException, NoSuchAlgorithmException, IllegalArgumentException {
        ...
        if (derivationFunction == null) {
            ...
            System.arraycopy(bArr, 0, bArr2, 0, r83);
            Arrays.clear(bArr);
            return bArr2;
        }
        if (r82 < 0) {
            throw new NoSuchAlgorithmException(b.e("unknown algorithm encountered: ", str));
        }
        int r22 = r82 / 8;
        ...
        if (derivationFunction instanceof DHKEKGenerator) {
            ...
            try {
                kDFParameters = new DHKDFParameters(new ASN1ObjectIdentifier(str), r82, bArr, this.ukmParameters);
            ...
            if (derivationFunction instanceof HKDFBytesGenerator) {
                ...
                this.kdf.generateBytes(bArr3, 0, r22);
                Arrays.clear(bArr);
                return bArr3;
            }
    ...
    public static byte[] trimZeroes(byte[] bArr) {
        ...
        int r12 = 0;
        while (r12 < bArr.length && bArr[r12] == 0) {
            r12++;
        }
        int length = bArr.length - r12;
        byte[] bArr2 = new byte[length];
        System.arraycopy(bArr, r12, bArr2, 0, length);
        return bArr2;
    }
    ...
    public int engineGenerateSecret(byte[] bArr, int r52) throws IllegalStateException, ShortBufferException {
        byte[] bArrEngineGenerateSecret = engineGenerateSecret();
        if (bArr.length - r52 >= bArrEngineGenerateSecret.length) {
            System.arraycopy(bArrEngineGenerateSecret, 0, bArr, r52, bArrEngineGenerateSecret.length);
            return bArrEngineGenerateSecret.length;
        }
        StringBuilder sb2 = new StringBuilder();
        sb2.append(this.kaAlgorithm);
        sb2.append(" key agreement: need ");
        throw new ShortBufferException(a.b(sb2, bArrEngineGenerateSecret.length, " bytes"));
    }
