...
public class BCECGOST3410_2012PublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            int r02 = algorithm.equals((ASN1Primitive) RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512) ? 64 : 32;
            int r22 = r02 * 2;
            byte[] bArr = new byte[r22 + 1];
            bArr[0] = 4;
            for (int r42 = 1; r42 <= r02; r42++) {
                bArr[r42] = octets[r02 - r42];
                bArr[r42 + r02] = octets[r22 - r42];
            }
    ...
    public byte[] getEncoded() {
        ...
        if (gostParams == null) {
            ...
            if (eCParameterSpec instanceof ECNamedCurveSpec) {
                ASN1ObjectIdentifier aSN1ObjectIdentifier2 = ECGOST3410NamedCurves.getOID(((ECNamedCurveSpec) eCParameterSpec).getName());
                x962Parameters = z10 ? new GOST3410PublicKeyAlgParameters(aSN1ObjectIdentifier2, RosstandartObjectIdentifiers.id_tc26_gost_3411_12_512) : (aSN1ObjectIdentifier2.equals((ASN1Primitive) RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256_paramSetB) || aSN1ObjectIdentifier2.equals((ASN1Primitive) RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256_paramSetC) || aSN1ObjectIdentifier2.equals((ASN1Primitive) RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256_paramSetD)) ? new GOST3410PublicKeyAlgParameters(aSN1ObjectIdentifier2, null) : new GOST3410PublicKeyAlgParameters(aSN1ObjectIdentifier2, RosstandartObjectIdentifiers.id_tc26_gost_3411_12_256);
            } else {
        ...
        int r62 = r6 / 2;
        extractBytes(bArr, r62, 0, bigInteger);
        extractBytes(bArr, r62, r72, bigInteger2);
        try {
