...
public class KeyPairGeneratorSpi extends java.security.KeyPairGeneratorSpi {
    ...
    private KeyPair getCompositeKeyPair() {
        ...
        for (int r22 = 0; r22 < this.generators.size(); r22++) {
            KeyPair keyPairGenerateKeyPair = this.generators.get(r22).generateKeyPair();
            publicKeyArr[r22] = keyPairGenerateKeyPair.getPublic();
            privateKeyArr[r22] = keyPairGenerateKeyPair.getPrivate();
        }
