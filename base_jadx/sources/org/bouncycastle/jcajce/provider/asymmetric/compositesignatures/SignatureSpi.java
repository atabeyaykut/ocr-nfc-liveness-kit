...
public class SignatureSpi extends java.security.SignatureSpi {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            int[] r02 = new int[CompositeSignaturesConstants.CompositeName.values().length];
            $SwitchMap$org$bouncycastle$jcajce$provider$asymmetric$compositesignatures$CompositeSignaturesConstants$CompositeName = r02;
            try {
                r02[CompositeSignaturesConstants.CompositeName.MLDSA44_Ed25519_SHA512.ordinal()] = 1;
    ...
    public void engineInitSign(PrivateKey privateKey) throws InvalidKeyException {
        ...
        for (int r02 = 0; r02 < this.componentSignatures.size(); r02++) {
            this.componentSignatures.get(r02).initSign(compositePrivateKey.getPrivateKeys().get(r02));
        }
    }
    ...
    public void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        ...
        for (int r02 = 0; r02 < this.componentSignatures.size(); r02++) {
            this.componentSignatures.get(r02).initVerify(compositePublicKey.getPublicKeys().get(r02));
        }
    }
    ...
    public byte[] engineSign() throws SignatureException {
        ...
        try {
            ...
            for (int r32 = 0; r32 < this.componentSignatures.size(); r32++) {
                this.componentSignatures.get(r32).update(this.OIDBytes);
                this.componentSignatures.get(r32).update(bArr);
                aSN1EncodableVector.add(new DERBitString(this.componentSignatures.get(r32).sign()));
            }
    ...
    public boolean engineVerify(byte[] bArr) throws SignatureException {
        ...
        boolean z10 = false;
        for (int r22 = 0; r22 < this.componentSignatures.size(); r22++) {
            this.componentSignatures.get(r22).update(this.OIDBytes);
            this.componentSignatures.get(r22).update(bArr2);
            if (!this.componentSignatures.get(r22).verify(ASN1BitString.getInstance(aSN1Sequence.getObjectAt(r22)).getOctets())) {
                z10 = true;
            }
        }
        return !z10;
