...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        ...
        try {
            ...
            throw new InvalidKeySpecException(a.c(e10, new StringBuilder("bad encoding: ")));
        }
    }
    ...
    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        try {
            ...
            throw new InvalidKeySpecException(androidx.constraintlayout.core.a.j(e10, new StringBuilder("invalid KeySpec: ")), e10);
        }
    }
    ...
    public KeySpec engineGetKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        ...
        if (cls.isAssignableFrom(OpenSSHPublicKeySpec.class) && (key instanceof ECPublicKey)) {
            ...
            try {
                ...
                throw new IllegalArgumentException(a.c(e10, new StringBuilder("unable to produce encoding: ")));
            }
        }
        ...
        try {
            ...
            throw new IllegalArgumentException(a.c(e11, new StringBuilder("cannot encoded key: ")));
        }
    }
