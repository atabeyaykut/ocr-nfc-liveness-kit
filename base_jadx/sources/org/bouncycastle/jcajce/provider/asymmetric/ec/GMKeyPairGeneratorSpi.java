...
public abstract class GMKeyPairGeneratorSpi extends KeyPairGenerator {
    ...
    public static class BaseSM2 extends GMKeyPairGeneratorSpi {
        ...
        @Override // java.security.KeyPairGenerator, java.security.KeyPairGeneratorSpi
        public void initialize(int r22, SecureRandom secureRandom) {
            this.strength = r22;
            this.random = secureRandom;
            ECNamedCurveGenParameterSpec eCNamedCurveGenParameterSpec = (ECNamedCurveGenParameterSpec) ecParameters.get(Integers.valueOf(r22));
        ...
        public void initializeNamedCurve(String str, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
            ...
            if (domainParametersFromName == null) {
                throw new InvalidAlgorithmParameterException(b.e("unknown curve name: ", str));
            }
