...
public class KeyAgreementSpi extends BaseAgreementSpi {
    ...
    public void doInitFromKey(Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (obj instanceof ECMQVBasicAgreement) {
            ...
            if (!z10 && !(algorithmParameterSpec instanceof MQVParameterSpec)) {
                ...
                throw new InvalidAlgorithmParameterException(c.h(sb2, getSimpleName(MQVParameterSpec.class), " for initialisation"));
            }
            if (z10) {
        ...
        if (!(algorithmParameterSpec instanceof DHUParameterSpec)) {
            if (!(key instanceof PrivateKey)) {
                ...
                throw new InvalidKeyException(c.h(sb3, getSimpleName(ECPrivateKey.class), " for initialisation"));
            }
    ...
    public Key engineDoPhase(Key key, boolean z10) throws IllegalStateException, InvalidKeyException {
        ...
        if (this.parameters == null) {
            throw new IllegalStateException(c.h(new StringBuilder(), this.kaAlgorithm, " not initialised."));
        }
        if (!z10) {
            throw new IllegalStateException(c.h(new StringBuilder(), this.kaAlgorithm, " can only be between two parties."));
        }
        Object obj = this.agreement;
        if (obj instanceof ECMQVBasicAgreement) {
            ...
            if (!(key instanceof PublicKey)) {
                ...
                sb2.append(this.kaAlgorithm);
                sb2.append(" key agreement requires ");
                throw new InvalidKeyException(c.h(sb2, getSimpleName(ECPublicKey.class), " for doPhase"));
            }
        ...
        try {
            ...
            throw new InvalidKeyException(a.j(e10, new StringBuilder("calculation failed: "))) { // from class: org.bouncycastle.jcajce.provider.asymmetric.ec.KeyAgreementSpi.1
