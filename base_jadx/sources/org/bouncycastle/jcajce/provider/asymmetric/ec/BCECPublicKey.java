...
public class BCECPublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public byte[] getEncoded() {
        ...
        if (this.encoding == null || this.oldPcSet != zIsOverrideSet) {
            boolean z10 = this.withCompression || zIsOverrideSet;
            this.encoding = KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(X9ObjectIdentifiers.id_ecPublicKey, ECUtils.getDomainParametersFromName(this.ecSpec, z10)), this.ecPublicKey.getQ().getEncoded(z10));
