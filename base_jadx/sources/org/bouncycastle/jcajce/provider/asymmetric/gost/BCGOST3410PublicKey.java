...
public class BCGOST3410PublicKey implements GOST3410PublicKey {
    ...
    public BCGOST3410PublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            for (int r22 = 0; r22 != octets.length; r22++) {
                bArr[r22] = octets[(octets.length - 1) - r22];
            }
            this.f11672y = new BigInteger(1, bArr);
    ...
    public BCGOST3410PublicKey(GOST3410PublicKeyParameters gOST3410PublicKeyParameters, GOST3410ParameterSpec gOST3410ParameterSpec) {
        this.f11672y = gOST3410PublicKeyParameters.getY();
        this.gost3410Spec = gOST3410ParameterSpec;
    }

    public BCGOST3410PublicKey(GOST3410PublicKey gOST3410PublicKey) {
        this.f11672y = gOST3410PublicKey.getY();
        this.gost3410Spec = gOST3410PublicKey.getParameters();
    }

    public BCGOST3410PublicKey(GOST3410PublicKeySpec gOST3410PublicKeySpec) {
        this.f11672y = gOST3410PublicKeySpec.getY();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f11672y.equals(bCGOST3410PublicKey.f11672y) && this.gost3410Spec.equals(bCGOST3410PublicKey.gost3410Spec);
    }
    ...
    public byte[] getEncoded() {
        ...
        for (int r12 = 0; r12 != bArr.length; r12++) {
            bArr[r12] = byteArray[(byteArray.length - 1) - r12];
        }
        try {
    ...
    public int hashCode() {
        return this.f11672y.hashCode() ^ this.gost3410Spec.hashCode();
    }

    public String toString() {
        try {
            return GOSTUtil.publicKeyToString("GOST3410", this.f11672y, ((GOST3410PublicKeyParameters) GOST3410Util.generatePublicKeyParameter(this)).getParameters());
