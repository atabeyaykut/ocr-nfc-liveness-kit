...
public enum AuthorizationRoleSignTermEnum implements AuthorizationRole {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            int[] r02 = new int[AuthorizationRoleSignTermEnum.values().length];
            $SwitchMap$org$ejbca$cvc$AuthorizationRoleSignTermEnum = r02;
            try {
                r02[AuthorizationRoleSignTermEnum.CVCA.ordinal()] = 1;
    ...
    AuthorizationRoleSignTermEnum(int r32) {
        this.value = (byte) r32;
    }
    ...
    public String toString() {
        int r02 = AnonymousClass1.$SwitchMap$org$ejbca$cvc$AuthorizationRoleSignTermEnum[ordinal()];
        if (r02 == 1) {
            return "CVCA";
        }
        if (r02 == 2) {
