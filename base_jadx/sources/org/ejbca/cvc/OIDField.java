...
public class OIDField extends AbstractDataField {
    ...
    public OIDField(byte[] bArr) {
        this();
        this.f12079id = ASN1ObjectIdentifier.getInstance(new DERTaggedObject(true, 0, (ASN1Encodable) new DEROctetString(bArr)), false).getId();
    }

    public boolean equals(Object obj) {
        if (obj instanceof OIDField) {
            return this.f12079id.equals(((OIDField) obj).getValue());
        }
        return false;
    }
    ...
    public byte[] getEncoded() {
        try {
            byte[] encoded = new ASN1ObjectIdentifier(this.f12079id).getEncoded();
