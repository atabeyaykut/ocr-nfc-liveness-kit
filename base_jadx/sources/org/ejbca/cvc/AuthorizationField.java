...
public class AuthorizationField extends AbstractDataField {
    ...
    private static AccessRights getRightsFromBytes(OIDField oIDField, byte[] bArr) {
        ...
        if (CVCObjectIdentifiers.id_EAC_ePassport.equals(oIDField)) {
            ...
            while (r32 < length) {
                AccessRightEnum accessRightEnum = accessRightEnumArrValues[r32];
        ...
        while (r32 < length2) {
            AccessRightSignTermEnum accessRightSignTermEnum = accessRightSignTermEnumArrValues[r32];
    ...
    private static AuthorizationRole getRoleFromByte(OIDField oIDField, byte b10) {
        ...
        if (CVCObjectIdentifiers.id_EAC_ePassport.equals(oIDField)) {
            ...
            if (!CVCObjectIdentifiers.id_EAC_roles_AT.equals(oIDField)) {
                return new AuthorizationRoleRawValue(b10);
            }
        ...
        for (AuthorizationRole authorizationRole : authorizationRoleArrValues) {
            if (b11 == authorizationRole.getValue()) {
