...
public enum AuthorizationRoleEnum implements AuthorizationRole {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            int[] r02 = new int[AuthorizationRoleEnum.values().length];
            $SwitchMap$org$ejbca$cvc$AuthorizationRoleEnum = r02;
            try {
                r02[AuthorizationRoleEnum.CVCA.ordinal()] = 1;
    ...
    public String toString() {
        int r02 = AnonymousClass1.$SwitchMap$org$ejbca$cvc$AuthorizationRoleEnum[ordinal()];
        if (r02 == 1) {
            return "CVCA";
        }
        if (r02 == 2) {
