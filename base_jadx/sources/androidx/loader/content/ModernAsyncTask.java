...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    public static /* synthetic */ class AnonymousClass4 {
        ...
        static {
            ...
            $SwitchMap$androidx$loader$content$ModernAsyncTask$Status = r02;
            try {
                r02[Status.RUNNING.ordinal()] = 1;
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        ...
        int r32 = AnonymousClass4.$SwitchMap$androidx$loader$content$ModernAsyncTask$Status[this.mStatus.ordinal()];
        if (r32 == 1) {
