...
public abstract class TrustedWebActivityService extends Service {
            ...
            if (trustedWebActivityService.mVerifiedUid == -1) {
                ...
                if (tokenLoad != null) {
                    ...
                    while (true) {
                        ...
                        if (tokenLoad.matches(packagesForUid[r12], packageManager)) {
    ...
    @BinderThread
    public void onCancelNotification(@NonNull String str, int r32) {
        ensureOnCreateCalled();
    ...
    public Bundle onGetSmallIconBitmap() {
        int r02 = onGetSmallIconId();
        Bundle bundle = new Bundle();
        if (r02 == -1) {
            return bundle;
        }
        bundle.putParcelable(KEY_SMALL_ICON_BITMAP, BitmapFactory.decodeResource(getResources(), r02));
        return bundle;
    }
    ...
    @BinderThread
    public boolean onNotifyNotificationWithChannel(@NonNull String str, int r52, @NonNull Notification notification, @NonNull String str2) {
        ensureOnCreateCalled();
        if (!NotificationManagerCompat.from(this).areNotificationsEnabled()) {
            return false;
        }
        ...
        this.mNotificationManager.notify(str, r52, notification);
        return true;
    }
