...
public final class TrustedWebActivityServiceConnection {
    ...
    public static class CancelNotificationArgs {
        ...
        public CancelNotificationArgs(String str, int r22) {
    ...
    public static class NotifyNotificationArgs {
        ...
        public NotifyNotificationArgs(String str, int r22, Notification notification, String str2) {
            this.platformTag = str;
            this.platformId = r22;
    ...
    public static void ensureBundleContains(Bundle bundle, String str) {
        if (!bundle.containsKey(str)) {
            throw new IllegalArgumentException(androidx.browser.browseractions.b.e("Bundle must contain ", str));
        }
    }
    ...
    private static android.support.customtabs.trusted.a wrapCallback(@Nullable final TrustedWebActivityCallback trustedWebActivityCallback) {
        ...
        return new a.AbstractBinderC0018a() { // from class: androidx.browser.trusted.TrustedWebActivityServiceConnection.1
    ...
    public void cancel(@NonNull String str, int r32) throws RemoteException {
        this.mService.cancelNotification(new CancelNotificationArgs(str, r32).toBundle());
    }
    ...
    public boolean notify(@NonNull String str, int r32, @NonNull Notification notification, @NonNull String str2) throws RemoteException {
        return ResultArgs.fromBundle(this.mService.notifyNotificationWithChannel(new NotifyNotificationArgs(str, r32, notification, str2).toBundle())).success;
    }
    ...
    public Bundle sendExtraCommand(@NonNull String str, @NonNull Bundle bundle, @Nullable TrustedWebActivityCallback trustedWebActivityCallback) throws RemoteException {
        android.support.customtabs.trusted.a aVarWrapCallback = wrapCallback(trustedWebActivityCallback);
