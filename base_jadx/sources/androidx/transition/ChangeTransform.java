...
public class ChangeTransform extends Transition {
    ...
    public static class Transforms {
        ...
        public int hashCode() {
            ...
            int r02 = (f != 0.0f ? Float.floatToIntBits(f) : 0) * 31;
            float f10 = this.mTranslationY;
            int r03 = (r02 + (f10 != 0.0f ? Float.floatToIntBits(f10) : 0)) * 31;
            float f11 = this.mTranslationZ;
            int r04 = (r03 + (f11 != 0.0f ? Float.floatToIntBits(f11) : 0)) * 31;
            float f12 = this.mScaleX;
            int r05 = (r04 + (f12 != 0.0f ? Float.floatToIntBits(f12) : 0)) * 31;
            float f13 = this.mScaleY;
            int r06 = (r05 + (f13 != 0.0f ? Float.floatToIntBits(f13) : 0)) * 31;
            float f14 = this.mRotationX;
            int r07 = (r06 + (f14 != 0.0f ? Float.floatToIntBits(f14) : 0)) * 31;
            float f15 = this.mRotationY;
            int r08 = (r07 + (f15 != 0.0f ? Float.floatToIntBits(f15) : 0)) * 31;
            float f16 = this.mRotationZ;
            return r08 + (f16 != 0.0f ? Float.floatToIntBits(f16) : 0);
        }
