...
class GhostViewPort extends ViewGroup implements GhostView {
    ...
    public static void removeGhost(View view) {
        GhostViewPort ghostView = getGhostView(view);
        if (ghostView != null) {
            int r02 = ghostView.mReferences - 1;
            ghostView.mReferences = r02;
            if (r02 <= 0) {
    ...
    public void setVisibility(int r22) throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException {
        super.setVisibility(r22);
        if (getGhostView(this.mView) == this) {
            ViewUtils.setTransitionVisibility(this.mView, r22 == 0 ? 4 : 0);
        }
    }
}
