...
class TransitionUtils {
    ...
    public static class MatrixEvaluator implements TypeEvaluator<Matrix> {
        ...
        public Matrix evaluate(float f, Matrix matrix, Matrix matrix2) {
            ...
            for (int r42 = 0; r42 < 9; r42++) {
                ...
                float f10 = fArr[r42];
                float f11 = this.mTempStartValues[r42];
    ...
    public static View copyViewImage(ViewGroup viewGroup, View view, View view2) {
        ...
        int r12 = Math.round(rectF.left);
        int r22 = Math.round(rectF.top);
        int r32 = Math.round(rectF.right);
        int r42 = Math.round(rectF.bottom);
        ...
        imageView.measure(View.MeasureSpec.makeMeasureSpec(r32 - r12, 1073741824), View.MeasureSpec.makeMeasureSpec(r42 - r22, 1073741824));
        imageView.layout(r12, r22, r32, r42);
        return imageView;
    }
    ...
    */
    private static android.graphics.Bitmap createViewBitmap(android.view.View r8, android.graphics.Matrix r9, android.graphics.RectF r10, android.view.ViewGroup r11) {
        ...
        L33:
            ...
            r8.draw(r4)
            r10.endRecording()
            android.graphics.Bitmap r4 = androidx.camera.camera2.internal.compat.params.c.b(r10)
            goto L99
        L88:
