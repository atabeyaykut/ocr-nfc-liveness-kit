...
public abstract class PreferenceFragment extends Fragment implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment {
    ...
    public void addPreferencesFromResource(@XmlRes int r42) {
        ...
        setPreferenceScreen(this.mPreferenceManager.inflateFromResource(this.mStyledContext, r42, getPreferenceScreen()));
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(getActivity(), r02);
    ...
    public void setPreferencesFromResource(@XmlRes int r42, @Nullable String str) {
        requirePreferenceManager();
        PreferenceScreen preferenceScreenInflateFromResource = this.mPreferenceManager.inflateFromResource(this.mStyledContext, r42, null);
