        ...
        builder.setMultiChoiceItems(this.mEntries, zArr, new DialogInterface.OnMultiChoiceClickListener() { // from class: androidx.preference.MultiSelectListPreferenceDialogFragment.1
            ...
            public void onClick(DialogInterface dialogInterface, int r42, boolean z10) {
                ...
                if (z10) {
                    ...
                    zRemove = multiSelectListPreferenceDialogFragment.mNewValues.add(multiSelectListPreferenceDialogFragment.mEntryValues[r42].toString());
                } else {
                    z11 = multiSelectListPreferenceDialogFragment.mPreferenceChanged;
                    zRemove = multiSelectListPreferenceDialogFragment.mNewValues.remove(multiSelectListPreferenceDialogFragment.mEntryValues[r42].toString());
                }
                multiSelectListPreferenceDialogFragment.mPreferenceChanged = zRemove | z11;
            }
        });
    }
