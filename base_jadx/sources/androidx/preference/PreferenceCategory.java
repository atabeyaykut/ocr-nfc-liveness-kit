...
public class PreferenceCategory extends PreferenceGroup {
    ...
    public PreferenceCategory(Context context, AttributeSet attributeSet, int r42) {
        this(context, attributeSet, r42, 0);
    }

    public PreferenceCategory(Context context, AttributeSet attributeSet, int r32, int r42) {
