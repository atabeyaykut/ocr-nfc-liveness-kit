...
public class MultiSelectListPreferenceDialogFragmentCompat extends PreferenceDialogFragmentCompat {
    ...
    public void onPrepareDialogBuilder(AlertDialog.Builder builder) {
        ...
        for (int r22 = 0; r22 < length; r22++) {
            zArr[r22] = this.mNewValues.contains(this.mEntryValues[r22].toString());
        }
        builder.setMultiChoiceItems(this.mEntries, zArr, new DialogInterface.OnMultiChoiceClickListener() { // from class: androidx.preference.MultiSelectListPreferenceDialogFragmentCompat.1
            ...
            public void onClick(DialogInterface dialogInterface, int r42, boolean z10) {
                boolean z11;
                boolean zRemove;
                MultiSelectListPreferenceDialogFragmentCompat multiSelectListPreferenceDialogFragmentCompat = MultiSelectListPreferenceDialogFragmentCompat.this;
                if (z10) {
                    z11 = multiSelectListPreferenceDialogFragmentCompat.mPreferenceChanged;
                    zRemove = multiSelectListPreferenceDialogFragmentCompat.mNewValues.add(multiSelectListPreferenceDialogFragmentCompat.mEntryValues[r42].toString());
                } else {
                    z11 = multiSelectListPreferenceDialogFragmentCompat.mPreferenceChanged;
                    zRemove = multiSelectListPreferenceDialogFragmentCompat.mNewValues.remove(multiSelectListPreferenceDialogFragmentCompat.mEntryValues[r42].toString());
                }
                multiSelectListPreferenceDialogFragmentCompat.mPreferenceChanged = zRemove | z11;
            }
        });
    }
