...
class PreferenceInflater {
    ...
    public Preference inflate(int r22, @Nullable PreferenceGroup preferenceGroup) throws Resources.NotFoundException {
        XmlResourceParser xml = getContext().getResources().getXml(r22);
        try {
