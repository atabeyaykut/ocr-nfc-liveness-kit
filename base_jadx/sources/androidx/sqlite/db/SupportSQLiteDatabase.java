...
public interface SupportSQLiteDatabase extends Closeable {
    ...
    long insert(String str, int r22, ContentValues contentValues) throws SQLException;
    ...
    void setMaxSqlCacheSize(int r12);
    ...
    void setVersion(int r12);

    int update(String str, int r22, ContentValues contentValues, String str2, Object[] objArr);
