...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class ConnectionRecord implements IBinder.DeathRecipient {
        ...
        public ConnectionRecord(String str, int r32, int r42, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            this.pkg = str;
            this.pid = r32;
            this.uid = r42;
            this.browserInfo = new MediaSessionManager.RemoteUserInfo(str, r32, r42);
    ...
    public class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy {
        ...
        public void notifyChildrenChangedForCompat(final MediaSessionManager.RemoteUserInfo remoteUserInfo, final String str, final Bundle bundle) {
            MediaBrowserServiceCompat.this.mHandler.post(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.MediaBrowserServiceImplApi21.4
                @Override // java.lang.Runnable
                public void run() {
                    for (int r02 = 0; r02 < MediaBrowserServiceCompat.this.mConnections.size(); r02++) {
                        ConnectionRecord connectionRecordValueAt = MediaBrowserServiceCompat.this.mConnections.valueAt(r02);
        ...
        public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String str, int r13, Bundle bundle) {
            Bundle extras;
            if (bundle == null || bundle.getInt(MediaBrowserProtocol.EXTRA_CLIENT_VERSION, 0) == 0) {
                ...
                if (token != null) {
                    b bVar = token.f403b;
                    BundleCompat.putBinder(extras, MediaBrowserProtocol.EXTRA_SESSION_BINDER, bVar == null ? null : bVar.asBinder());
                } else {
                    this.mRootExtrasList.add(extras);
                }
            }
            MediaBrowserServiceCompat mediaBrowserServiceCompat = MediaBrowserServiceCompat.this;
            mediaBrowserServiceCompat.mCurConnection = mediaBrowserServiceCompat.new ConnectionRecord(str, -1, r13, bundle, null);
                ...
                public void run() {
                    if (!MediaBrowserServiceImplApi21.this.mRootExtrasList.isEmpty()) {
                        ...
                        if (bVar != null) {
                            ...
                            while (it.hasNext()) {
                                BundleCompat.putBinder(it.next(), MediaBrowserProtocol.EXTRA_SESSION_BINDER, bVar.asBinder());
                            }
                        }
                        MediaBrowserServiceImplApi21.this.mRootExtrasList.clear();
                    }
                    MediaBrowserServiceCompatApi21.setSessionToken(MediaBrowserServiceImplApi21.this.mServiceObj, token.f402a);
                }
            });
        }
    }
    ...
    public class ServiceBinderImpl {
            ...
            if (MediaBrowserServiceCompat.this.isValidPackage(str, r12)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.1
                    ...
                    public void run() throws RemoteException {
                        ...
                        BrowserRoot browserRootOnGetRoot = mediaBrowserServiceCompat.onGetRoot(str, r12, bundle);
        ...
        public void getMediaItem(final String str, final a.b bVar, final ServiceCallbacks serviceCallbacks) {
        ...
        public void search(final String str, final Bundle bundle, final a.b bVar, final ServiceCallbacks serviceCallbacks) {
            if (TextUtils.isEmpty(str) || bVar == null) {
                return;
            }
        ...
        public void sendCustomAction(final String str, final Bundle bundle, final a.b bVar, final ServiceCallbacks serviceCallbacks) {
            if (TextUtils.isEmpty(str) || bVar == null) {
                return;
            }
    ...
    public static class ServiceCallbacksCompat implements ServiceCallbacks {
        ...
        private void sendRequest(int r22, Bundle bundle) throws RemoteException {
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    this.mServiceBinderImpl.getMediaItem(data.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), (a.b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    break;
                case 6:
                ...
                case 8:
                    ...
                    this.mServiceBinderImpl.search(data.getString(MediaBrowserProtocol.DATA_SEARCH_QUERY), bundle4, (a.b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    break;
                case 9:
                    Bundle bundle5 = data.getBundle(MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS);
                    MediaSessionCompat.a(bundle5);
                    this.mServiceBinderImpl.sendCustomAction(data.getString(MediaBrowserProtocol.DATA_CUSTOM_ACTION), bundle5, (a.b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    break;
                default:
    ...
    public List<MediaBrowserCompat.MediaItem> applyOptions(List<MediaBrowserCompat.MediaItem> list, Bundle bundle) {
        ...
        int r02 = bundle.getInt("android.media.browse.extra.PAGE", -1);
        int r52 = bundle.getInt("android.media.browse.extra.PAGE_SIZE", -1);
        if (r02 == -1 && r52 == -1) {
            return list;
        }
        int r12 = r52 * r02;
        int size = r12 + r52;
        if (r02 < 0 || r52 < 1 || r12 >= list.size()) {
            return Collections.emptyList();
        }
        if (size > list.size()) {
            size = list.size();
        }
        return list.subList(r12, size);
    }
    ...
    public boolean isValidPackage(String str, int r6) {
        if (str == null) {
            return false;
        }
        for (String str2 : getPackageManager().getPackagesForUid(r6)) {
            if (str2.equals(str)) {
                return true;
            }
        }
    ...
    public void onCreate() {
        ...
        this.mImpl = r02 >= 28 ? new MediaBrowserServiceImplApi28() : r02 >= 26 ? new MediaBrowserServiceImplApi26() : r02 >= 23 ? new MediaBrowserServiceImplApi23() : new MediaBrowserServiceImplApi21();
        this.mImpl.onCreate();
    }
    ...
    @Nullable
    public abstract BrowserRoot onGetRoot(@NonNull String str, int r22, @Nullable Bundle bundle);
    ...
    public void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final a.b bVar) {
    ...
    public void performLoadChildren(final String str, final ConnectionRecord connectionRecord, final Bundle bundle, final Bundle bundle2) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(a.i(new StringBuilder("onLoadChildren must call detach() or sendResult() before returning for package="), connectionRecord.pkg, " id=", str));
        }
    }

    public void performLoadItem(String str, ConnectionRecord connectionRecord, final a.b bVar) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(androidx.browser.browseractions.b.e("onLoadItem must call detach() or sendResult() before returning for id=", str));
        }
    }

    public void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final a.b bVar) {
        ...
        this.mCurConnection = null;
        if (!result.isDone()) {
            throw new IllegalStateException(androidx.browser.browseractions.b.e("onSearch must call detach() or sendResult() before returning for query=", str));
        }
    }
