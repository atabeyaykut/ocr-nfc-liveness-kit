...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static class Builder {
        ...
        public Builder setContentType(int r22) {
            if (r22 == 0 || r22 == 1 || r22 == 2 || r22 == 3 || r22 == 4) {
                this.mContentType = r22;
            } else {
                this.mUsage = 0;
            }
            return this;
        ...
        public Builder setFlags(int r22) {
            this.mFlags = (r22 & AudioAttributesCompat.FLAG_ALL) | this.mFlags;
            return this;
        }

        /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
        public Builder setInternalLegacyStreamType(int r42) {
            int r02 = 1;
            switch (r42) {
                case 0:
                case 10:
                    this.mContentType = r02;
                    break;
                case 1:
                case 2:
                case 4:
                ...
                case 7:
                    ...
                    break;
                default:
                    Log.e(AudioAttributesCompat.TAG, "Invalid stream type " + r42 + " for AudioAttributesCompat");
                    break;
            }
            this.mUsage = AudioAttributesCompat.usageForStreamType(r42);
            return this;
        }

        public Builder setLegacyStreamType(int r22) {
            if (r22 == 10) {
                throw new IllegalArgumentException("STREAM_ACCESSIBILITY is not a legacy stream type that was used for audio playback");
            }
            this.mLegacyStream = r22;
            return setInternalLegacyStreamType(r22);
        }

        public Builder setUsage(int r32) {
            switch (r32) {
                case 0:
                case 1:
                case 2:
    ...
    public static int toVolumeStreamType(boolean z10, int r42, int r52) {
        if ((r42 & 1) == 1) {
            return z10 ? 1 : 7;
        }
        if ((r42 & 4) == 4) {
        ...
        switch (r52) {
            ...
            default:
                if (z10) {
                    throw new IllegalArgumentException(a.f("Unknown usage value ", r52, " in audio attributes"));
                }
                return 3;
        }
    }

    public static int toVolumeStreamType(boolean z10, AudioAttributesCompat audioAttributesCompat) {
        return toVolumeStreamType(z10, audioAttributesCompat.getFlags(), audioAttributesCompat.getUsage());
    }

    public static int usageForStreamType(int r12) {
        switch (r12) {
        }
        return 2;
    }

    public static String usageToString(int r12) {
        switch (r12) {
            case 0:
            ...
            case 15:
            default:
                return android.support.v4.media.a.d("unknown usage ", r12);
            case 16:
