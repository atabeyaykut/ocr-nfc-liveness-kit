...
public class AppCompatViewInflater {
    ...
    private View createViewFromTag(Context context, String str, AttributeSet attributeSet) {
        ...
        try {
            ...
            while (true) {
                ...
                if (r82 >= strArr.length) {
                    return null;
                }
                View viewCreateViewByPrefix = createViewByPrefix(context, str, strArr[r82]);
    ...
    public final View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet, boolean z10, boolean z11, boolean z12, boolean z13) {
        Context context2;
