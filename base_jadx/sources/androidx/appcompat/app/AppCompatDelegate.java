...
public abstract class AppCompatDelegate {
    ...
    public static void setDefaultNightMode(int r12) {
        if (r12 != -1 && r12 != 0 && r12 != 1 && r12 != 2 && r12 != 3) {
            Log.d(TAG, "setDefaultNightMode() called with an unknown mode");
        } else if (sDefaultNightMode != r12) {
            sDefaultNightMode = r12;
    ...
    @Nullable
    public abstract <T extends View> T findViewById(@IdRes int r12);
    ...
    public abstract boolean hasWindowFeature(int r12);
    ...
    public abstract boolean requestWindowFeature(int r12);

    public abstract void setContentView(@LayoutRes int r12);
    ...
    @RequiresApi(17)
    public abstract void setLocalNightMode(int r12);
