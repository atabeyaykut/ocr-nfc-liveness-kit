...
public class AppCompatActivity extends FragmentActivity implements AppCompatCallback, TaskStackBuilder.SupportParentable, ActionBarDrawerToggle.DelegateProvider {
    ...
    @ContentView
    public AppCompatActivity(@LayoutRes int r12) {
        super(r12);
        initDelegate();
    }
    ...
    public <T extends View> T findViewById(@IdRes int r22) {
        return (T) getDelegate().findViewById(r22);
    }
    ...
    public final boolean onMenuItemSelected(int r22, @NonNull MenuItem menuItem) {
    ...
    public boolean onMenuOpened(int r12, Menu menu) {
        return super.onMenuOpened(r12, menu);
    }

    public void onNightModeChanged(int r12) {
    }

    @Override // androidx.view.ComponentActivity, android.app.Activity, android.view.Window.Callback
    public void onPanelClosed(int r12, @NonNull Menu menu) {
        super.onPanelClosed(r12, menu);
    }
    ...
    @Override // android.app.Activity
    public void onTitleChanged(CharSequence charSequence, int r22) {
        super.onTitleChanged(charSequence, r22);
    ...
    public void setContentView(@LayoutRes int r22) {
        initViewTreeOwners();
        getDelegate().setContentView(r22);
    }
    ...
    @Deprecated
    public void setSupportProgress(int r12) {
    }
    ...
    public void setTheme(@StyleRes int r22) {
        super.setTheme(r22);
        getDelegate().setTheme(r22);
    }
    ...
    public boolean supportRequestWindowFeature(int r22) {
        return getDelegate().requestWindowFeature(r22);
    }
