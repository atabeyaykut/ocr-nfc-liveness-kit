...
abstract class BaseMenuWrapper {
    ...
    public final void internalRemoveGroup(int r32) {
        if (this.mMenuItems == null) {
            return;
        }
        int r02 = 0;
        while (r02 < this.mMenuItems.size()) {
            if (this.mMenuItems.keyAt(r02).getGroupId() == r32) {
                this.mMenuItems.removeAt(r02);
                r02--;
            }
            r02++;
        }
    ...
    public final void internalRemoveItem(int r32) {
        if (this.mMenuItems == null) {
            return;
        }
        for (int r02 = 0; r02 < this.mMenuItems.size(); r02++) {
            if (this.mMenuItems.keyAt(r02).getItemId() == r32) {
                this.mMenuItems.removeAt(r02);
                return;
            }
        }
