...
class SubMenuWrapperICS extends MenuWrapperICS implements SubMenu {
    ...
    @Override // android.view.SubMenu
    public SubMenu setHeaderIcon(int r22) {
        this.mSubMenu.setHeaderIcon(r22);
        return this;
    }
    ...
    @Override // android.view.SubMenu
    public SubMenu setHeaderTitle(int r22) {
        this.mSubMenu.setHeaderTitle(r22);
        return this;
    }
