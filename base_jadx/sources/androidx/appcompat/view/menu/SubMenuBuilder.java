...
public class SubMenuBuilder extends MenuBuilder implements SubMenu {
    ...
    @Override // android.view.SubMenu
    public SubMenu setHeaderIcon(int r12) {
        return (SubMenu) super.setHeaderIconInt(r12);
    }
    ...
    @Override // android.view.SubMenu
    public SubMenu setHeaderTitle(int r12) {
        return (SubMenu) super.setHeaderTitleInt(r12);
    }
    ...
    @Override // android.view.SubMenu
    public SubMenu setIcon(int r22) {
        this.mItem.setIcon(r22);
        return this;
    }
