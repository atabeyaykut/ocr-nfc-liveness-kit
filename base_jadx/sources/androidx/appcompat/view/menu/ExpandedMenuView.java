...
public final class ExpandedMenuView extends ListView implements MenuBuilder.ItemInvoker, MenuView, AdapterView.OnItemClickListener {
    ...
    public ExpandedMenuView(Context context, AttributeSet attributeSet, int r52) {
        super(context, attributeSet);
        setOnItemClickListener(this);
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, TINT_ATTRS, r52, 0);
    ...
    public void onItemClick(AdapterView adapterView, View view, int r32, long j10) {
        invokeItem((MenuItemImpl) getAdapter().getItem(r32));
    }
}
