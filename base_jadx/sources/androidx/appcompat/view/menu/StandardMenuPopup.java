...
final class StandardMenuPopup extends MenuPopup implements PopupWindow.OnDismissListener, View.OnKeyListener {
    ...
    public StandardMenuPopup(Context context, MenuBuilder menuBuilder, View view, int r72, int r82, boolean z10) {
        this.mContext = context;
        this.mMenu = menuBuilder;
        this.mOverflowOnly = z10;
        this.mAdapter = new MenuAdapter(menuBuilder, LayoutInflater.from(context), z10, ITEM_LAYOUT);
        this.mPopupStyleAttr = r72;
        this.mPopupStyleRes = r82;
        Resources resources = context.getResources();
        this.mPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(R.dimen.abc_config_prefDialogWidth));
        this.mAnchorView = view;
        this.mPopup = new MenuPopupWindow(context, null, r72, r82);
    ...
    public void setVerticalOffset(int r22) {
        this.mPopup.setVerticalOffset(r22);
    }
