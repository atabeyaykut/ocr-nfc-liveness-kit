...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public ListMenuItemView(Context context, AttributeSet attributeSet, int r6) {
        ...
        TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getContext(), attributeSet, R.styleable.MenuView, r6, 0);
    ...
    private void addContentView(View view, int r32) {
        LinearLayout linearLayout = this.mContent;
        if (linearLayout != null) {
            linearLayout.addView(view, r32);
        } else {
            addView(view, r32);
        }
    }
    ...
    @Override // androidx.appcompat.view.menu.MenuView.ItemView
    public void initialize(MenuItemImpl menuItemImpl, int r32) {
    ...
    public void onFinishInflate() {
        ...
        int r12 = this.mTextAppearance;
        if (r12 != -1) {
            textView.setTextAppearance(this.mTextAppearanceContext, r12);
        }
    ...
    public void setShortcut(boolean z10, char c10) {
        int r22 = (z10 && this.mItemData.shouldShowShortcut()) ? 0 : 8;
        if (r22 == 0) {
            this.mShortcutView.setText(this.mItemData.getShortcutLabel());
        }
        if (this.mShortcutView.getVisibility() != r22) {
