...
public class ContextThemeWrapper extends ContextWrapper {
    ...
    public ContextThemeWrapper(Context context, @StyleRes int r22) {
        super(context);
        this.mThemeResource = r22;
    }
    ...
    public void onApplyThemeResource(Resources.Theme theme, int r22, boolean z10) {
        theme.applyStyle(r22, true);
    }

    @Override // android.content.ContextWrapper, android.content.Context
    public void setTheme(int r22) {
        if (this.mThemeResource != r22) {
            this.mThemeResource = r22;
            initializeTheme();
        }
    }
