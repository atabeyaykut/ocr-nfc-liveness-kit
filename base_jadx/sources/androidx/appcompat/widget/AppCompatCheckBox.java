...
public class AppCompatCheckBox extends CheckBox implements TintableCompoundButton, TintableBackgroundView, EmojiCompatConfigurationView, TintableCompoundDrawablesView {
    ...
    public AppCompatCheckBox(@NonNull Context context, @Nullable AttributeSet attributeSet, int r32) {
        ...
        appCompatCompoundButtonHelper.loadFromAttributes(attributeSet, r32);
    ...
    public void setButtonDrawable(@DrawableRes int r22) {
        setButtonDrawable(AppCompatResources.getDrawable(getContext(), r22));
    }
