...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public class TabAdapter extends BaseAdapter {
        ...
        public Object getItem(int r22) {
            return ((TabView) ScrollingTabContainerView.this.mTabLayout.getChildAt(r22)).getTab();
        }
        ...
        public View getView(int r12, View view, ViewGroup viewGroup) {
            if (view == null) {
                return ScrollingTabContainerView.this.createTabView((ActionBar.Tab) getItem(r12), true);
            }
            ((TabView) view).bindTab((ActionBar.Tab) getItem(r12));
            return view;
        }
    }
    ...
    public class TabClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            for (int r22 = 0; r22 < childCount; r22++) {
                View childAt = ScrollingTabContainerView.this.mTabLayout.getChildAt(r22);
    ...
    public class TabView extends LinearLayout {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean z10) {
            int r52 = R.attr.actionBarTabStyle;
            super(context, null, r52);
            int[] r12 = {android.R.attr.background};
            this.BG_ATTRS = r12;
            this.mTab = tab;
            TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, r12, r52, 0);
        ...
        public void onMeasure(int r22, int r32) {
            ...
            if (ScrollingTabContainerView.this.mMaxTabWidth > 0) {
                ...
                int r02 = ScrollingTabContainerView.this.mMaxTabWidth;
                if (measuredWidth > r02) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec(r02, 1073741824), r32);
                }
            }
        }
    ...
    public class VisibilityAnimListener extends AnimatorListenerAdapter {
        ...
        public VisibilityAnimListener withFinalVisibility(ViewPropertyAnimator viewPropertyAnimator, int r22) {
            this.mFinalVisibility = r22;
    ...
    public void addTab(ActionBar.Tab tab, int r72, boolean z10) {
        TabView tabViewCreateTabView = createTabView(tab, false);
        this.mTabLayout.addView(tabViewCreateTabView, r72, new LinearLayoutCompat.LayoutParams(0, -1, 1.0f));
        Spinner spinner = this.mTabSpinner;
        if (spinner != null) {
    ...
    public void animateToTab(int r22) {
        final View childAt = this.mTabLayout.getChildAt(r22);
        Runnable runnable = this.mTabSelector;
        if (runnable != null) {
            removeCallbacks(runnable);
        }
    ...
    public void animateToVisibility(int r52) {
        ...
        viewPropertyAnimatorAlpha.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimatorAlpha, r52));
    ...
    */
    ...
    public void removeTabAt(int r22) {
        this.mTabLayout.removeViewAt(r22);
        Spinner spinner = this.mTabSpinner;
        if (spinner != null) {
            ((TabAdapter) spinner.getAdapter()).notifyDataSetChanged();
        }
    ...
    public void setTabSelected(int r6) {
        ...
        while (r22 < childCount) {
            View childAt = this.mTabLayout.getChildAt(r22);
            boolean z10 = r22 == r6;
    ...
    public void updateTab(int r22) {
        ((TabView) this.mTabLayout.getChildAt(r22)).update();
        Spinner spinner = this.mTabSpinner;
        if (spinner != null) {
            ((TabAdapter) spinner.getAdapter()).notifyDataSetChanged();
        }
