...
public final class ViewStubCompat extends View {
    ...
    public ViewStubCompat(@NonNull Context context, @Nullable AttributeSet attributeSet, int r52) {
        super(context, attributeSet, r52);
        this.mLayoutResource = 0;
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ViewStubCompat, r52, 0);
    ...
    public View inflate() {
        ...
        int r22 = this.mInflatedId;
        if (r22 != -1) {
            viewInflate.setId(r22);
        }
        int r23 = viewGroup.indexOfChild(this);
        viewGroup.removeViewInLayout(this);
        ViewGroup.LayoutParams layoutParams = getLayoutParams();
        if (layoutParams != null) {
            viewGroup.addView(viewInflate, r23, layoutParams);
        } else {
            viewGroup.addView(viewInflate, r23);
        }
