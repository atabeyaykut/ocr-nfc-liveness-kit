...
class TooltipCompatHandler implements View.OnLongClickListener, View.OnHoverListener, View.OnAttachStateChangeListener {
    ...
    private final Runnable mShowRunnable = new Runnable() { // from class: androidx.appcompat.widget.x
        @Override // java.lang.Runnable
        public final void run() throws Resources.NotFoundException {
            this.f446a.lambda$new$0();
        }
    };
    private final Runnable mHideRunnable = new Runnable() { // from class: androidx.appcompat.widget.y
        @Override // java.lang.Runnable
    ...
    public void show(boolean z10) throws Resources.NotFoundException {
