...
public class AppCompatRatingBar extends RatingBar {
    ...
    public AppCompatRatingBar(@NonNull Context context, @Nullable AttributeSet attributeSet, int r32) {
        ...
        appCompatProgressBarHelper.loadFromAttributes(attributeSet, r32);
    }
    ...
    public synchronized void onMeasure(int r22, int r32) {
        ...
        if (sampleTile != null) {
            setMeasuredDimension(View.resolveSizeAndState(sampleTile.getWidth() * getNumStars(), r22, 0), getMeasuredHeight());
        }
    }
}
