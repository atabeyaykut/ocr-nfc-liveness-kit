...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean z10, int r6, int r72) {
        Drawable drawable;
    ...
    private void updateToolbarLogo() {
        Drawable drawable;
        int r02 = this.mDisplayOpts;
        if ((r02 & 2) == 0) {
            drawable = null;
        } else if ((r02 & 1) == 0 || (drawable = this.mLogo) == null) {
            drawable = this.mIcon;
        }
    ...
    public void animateToVisibility(int r32) {
        ViewPropertyAnimatorCompat viewPropertyAnimatorCompat = setupAnimatorToVisibility(r32, DEFAULT_FADE_DURATION_MS);
    ...
    @Override // androidx.appcompat.widget.DecorToolbar
    public void setDefaultNavigationContentDescription(int r22) {
        if (r22 == this.mDefaultNavigationContentDescription) {
            return;
        }
        this.mDefaultNavigationContentDescription = r22;
    ...
    @Override // androidx.appcompat.widget.DecorToolbar
    public void setDisplayOptions(int r42) {
        View view;
        CharSequence charSequence;
        Toolbar toolbar;
        int r02 = this.mDisplayOpts ^ r42;
        this.mDisplayOpts = r42;
        if (r02 != 0) {
            if ((r02 & 4) != 0) {
                if ((r42 & 4) != 0) {
            ...
            if ((r02 & 16) == 0 || (view = this.mCustomView) == null) {
                return;
            }
            if ((r42 & 16) != 0) {
                this.mToolbar.addView(view);
    ...
    @Override // androidx.appcompat.widget.DecorToolbar
    public void setDropdownSelectedPosition(int r22) {
        Spinner spinner = this.mSpinner;
        if (spinner == null) {
            throw new IllegalStateException("Can't set dropdown selected position without an adapter");
        }
        spinner.setSelection(r22);
    }
    ...
    public void setLogo(int r22) {
        setLogo(r22 != 0 ? AppCompatResources.getDrawable(getContext(), r22) : null);
    }
    ...
    public void setNavigationContentDescription(int r22) {
        setNavigationContentDescription(r22 == 0 ? null : getContext().getString(r22));
    }
    ...
    public void setNavigationIcon(int r22) {
        setNavigationIcon(r22 != 0 ? AppCompatResources.getDrawable(getContext(), r22) : null);
    }
    ...
    @Override // androidx.appcompat.widget.DecorToolbar
    public void setNavigationMode(int r52) {
        Toolbar toolbar;
        View view;
        View view2;
        int r02 = this.mNavigationMode;
        if (r52 != r02) {
            if (r02 == 1) {
                Spinner spinner = this.mSpinner;
                if (spinner != null) {
            ...
            } else if (r02 == 2 && (view2 = this.mTabView) != null) {
            ...
            if (r52 != 0) {
                if (r52 == 1) {
                    ...
                    if (r52 != 2) {
                        throw new IllegalArgumentException(android.support.v4.media.a.d("Invalid navigation mode ", r52));
                    }
    ...
    public void setVisibility(int r22) {
        this.mToolbar.setVisibility(r22);
    }
    ...
    @Override // androidx.appcompat.widget.DecorToolbar
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int r32, long j10) {
        return ViewCompat.animate(this.mToolbar).alpha(r32 == 0 ? 1.0f : 0.0f).setDuration(j10).setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: androidx.appcompat.widget.ToolbarWidgetWrapper.2
            ...
            public void onAnimationEnd(View view) {
                ...
                ToolbarWidgetWrapper.this.mToolbar.setVisibility(r32);
            }
