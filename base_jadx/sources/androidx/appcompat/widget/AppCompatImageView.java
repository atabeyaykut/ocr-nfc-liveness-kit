...
public class AppCompatImageView extends ImageView implements TintableBackgroundView, TintableImageSourceView {
    ...
    public AppCompatImageView(@NonNull Context context, @Nullable AttributeSet attributeSet, int r32) {
        ...
        appCompatImageHelper.loadFromAttributes(attributeSet, r32);
    }
    ...
    public void setImageResource(@DrawableRes int r22) {
        AppCompatImageHelper appCompatImageHelper = this.mImageHelper;
        if (appCompatImageHelper != null) {
            appCompatImageHelper.setImageResource(r22);
        }
    }
