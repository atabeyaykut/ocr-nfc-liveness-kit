...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public /* bridge */ /* synthetic */ int lookForSelectablePosition(int r12, boolean z10) {
            return super.lookForSelectablePosition(r12, z10);
        }

        @Override // androidx.appcompat.widget.DropDownListView
        public /* bridge */ /* synthetic */ int measureHeightOfChildrenCompat(int r12, int r22, int r32, int r42, int r52) {
            return super.measureHeightOfChildrenCompat(r12, r22, r32, r42, r52);
        }

        @Override // androidx.appcompat.widget.DropDownListView
        public /* bridge */ /* synthetic */ boolean onForwardedEvent(MotionEvent motionEvent, int r22) {
            return super.onForwardedEvent(motionEvent, r22);
        }
        ...
        public boolean onHoverEvent(MotionEvent motionEvent) {
            ...
            if (this.mHoverListener != null) {
                ...
                MenuItemImpl item = (motionEvent.getAction() == 10 || (r22 = pointToPosition((int) motionEvent.getX(), (int) motionEvent.getY())) == -1 || (r23 = r22 - headersCount) < 0 || r23 >= menuAdapter.getCount()) ? null : menuAdapter.getItem(r23);
        ...
        public boolean onKeyDown(int r52, KeyEvent keyEvent) {
            ListMenuItemView listMenuItemView = (ListMenuItemView) getSelectedView();
            if (listMenuItemView != null && r52 == this.mAdvanceKey) {
                if (listMenuItemView.isEnabled() && listMenuItemView.getItemData().hasSubMenu()) {
                    performItemClick(listMenuItemView, getSelectedItemPosition(), getSelectedItemId());
                }
                return true;
            }
            if (listMenuItemView == null || r52 != this.mRetreatKey) {
                return super.onKeyDown(r52, keyEvent);
            }
            setSelection(-1);
            ListAdapter adapter = getAdapter();
            if (adapter instanceof HeaderViewListAdapter) {
    ...
    public MenuPopupWindow(@NonNull Context context, @Nullable AttributeSet attributeSet, int r32, int r42) {
