...
public class DrawableWrapper extends Drawable implements Drawable.Callback {
    ...
    public void setHotspot(float f, float f10) {
        DrawableCompat.setHotspot(this.mDrawable, f, f10);
    }

    @Override // android.graphics.drawable.Drawable
    public void setHotspotBounds(int r22, int r32, int r42, int r52) {
        DrawableCompat.setHotspotBounds(this.mDrawable, r22, r32, r42, r52);
    }

    @Override // android.graphics.drawable.Drawable
    public boolean setState(int[] r22) {
        return this.mDrawable.setState(r22);
    }

    @Override // android.graphics.drawable.Drawable
    public void setTint(int r22) {
        DrawableCompat.setTint(this.mDrawable, r22);
    }
