...
public class DrawerArrowDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        int r32 = this.mDirection;
        boolean z10 = false;
        if (r32 != 0 && (r32 == 1 || (r32 == 3 ? DrawableCompat.getLayoutDirection(this) == 0 : DrawableCompat.getLayoutDirection(this) == 1))) {
            z10 = true;
        }
    ...
    public void setColor(@ColorInt int r22) {
        if (r22 != this.mPaint.getColor()) {
            this.mPaint.setColor(r22);
            invalidateSelf();
        }
    }
    ...
    public void setDirection(int r22) {
        if (r22 != this.mDirection) {
            this.mDirection = r22;
            invalidateSelf();
        }
    }
