...
public class LruCache<K, V> {
    ...
    public final synchronized String toString() {
        ...
        int r12;
        r02 = this.hitCount;
        r12 = this.missCount + r02;
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", Integer.valueOf(this.maxSize), Integer.valueOf(this.hitCount), Integer.valueOf(this.missCount), Integer.valueOf(r12 != 0 ? (r02 * 100) / r12 : 0));
    }
