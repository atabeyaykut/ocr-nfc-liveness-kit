...
public final class LongSparseArrayKt {
    ...
    public static final class C03221<T> implements Iterator<T>, a {
        ...
        public T next() {
            ...
            int r12 = this.index;
            this.index = r12 + 1;
            return (T) longSparseArray.valueAt(r12);
        }
    ...
    public static final <T> void forEach(LongSparseArray<T> receiver$0, p<? super Long, ? super T, m> action) {
        h.g(receiver$0, "receiver$0");
        h.g(action, "action");
        int size = receiver$0.size();
        for (int r12 = 0; r12 < size; r12++) {
            action.mo7invoke(Long.valueOf(receiver$0.keyAt(r12)), receiver$0.valueAt(r12));
        }
    }
    ...
    public static final <T> T getOrElse(LongSparseArray<T> receiver$0, long j10, x9.a<? extends T> defaultValue) {
        h.g(receiver$0, "receiver$0");
    ...
    public static final <T> c0 keyIterator(final LongSparseArray<T> receiver$0) {
        h.g(receiver$0, "receiver$0");
        return new c0() { // from class: androidx.collection.LongSparseArrayKt.keyIterator.1
            private int index;
            ...
            public long nextLong() {
                ...
                int r12 = this.index;
                this.index = r12 + 1;
                return longSparseArray.keyAt(r12);
            }
