...
class UnprecomputeTextOnModificationSpannable implements Spannable {
    ...
    public char charAt(int r22) {
        return this.mDelegate.charAt(r22);
    }
    ...
    @Override // android.text.Spanned
    public <T> T[] getSpans(int r22, int r32, Class<T> cls) {
        return (T[]) this.mDelegate.getSpans(r22, r32, cls);
    }
    ...
    @Override // android.text.Spanned
    public int nextSpanTransition(int r22, int r32, Class cls) {
        return this.mDelegate.nextSpanTransition(r22, r32, cls);
    }
    ...
    @Override // android.text.Spannable
    public void setSpan(Object obj, int r32, int r42, int r52) {
        ensureSafeWrites();
        this.mDelegate.setSpan(obj, r32, r42, r52);
    }

    @Override // java.lang.CharSequence
    @NonNull
    public CharSequence subSequence(int r22, int r32) {
        return this.mDelegate.subSequence(r22, r32);
    }
