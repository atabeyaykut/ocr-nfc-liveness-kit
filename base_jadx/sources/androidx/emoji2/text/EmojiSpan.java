...
public abstract class EmojiSpan extends ReplacementSpan {
    ...
    public int getSize(@NonNull Paint paint, @SuppressLint({"UnknownNullness"}) CharSequence charSequence, int r32, int r42, @Nullable Paint.FontMetricsInt fontMetricsInt) {
