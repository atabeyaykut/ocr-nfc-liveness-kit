...
class SQLiteCopyOpenHelper implements SupportSQLiteOpenHelper {
    ...
    public SQLiteCopyOpenHelper(@NonNull Context context, @Nullable String str, @Nullable File file, int r42, @NonNull SupportSQLiteOpenHelper supportSQLiteOpenHelper) {
        this.mContext = context;
        this.mCopyFromAssetPath = str;
        this.mCopyFromFile = file;
        this.mDatabaseVersion = r42;
    ...
    private void verifyDatabaseFile() throws IOException {
        ...
        try {
            ...
            try {
                ...
                int r72 = this.mDatabaseVersion;
                if (version == r72) {
                    copyLock.unlock();
                    return;
                }
                if (this.mDatabaseConfiguration.isMigrationRequired(version, r72)) {
                    copyLock.unlock();
                    return;
                }
