...
public abstract class RoomDatabase {
    ...
    public static class Builder<T extends RoomDatabase> {
        ...
        */
        ...
        @NonNull
        public Builder<T> fallbackToDestructiveMigrationFrom(int... r52) {
            if (this.mMigrationsNotRequiredFrom == null) {
                this.mMigrationsNotRequiredFrom = new HashSet(r52.length);
            }
            for (int r02 : r52) {
                this.mMigrationsNotRequiredFrom.add(Integer.valueOf(r02));
            }
            return this;
        }
    ...
    public static class MigrationContainer {
        ...
        private void addMigration(Migration migration) {
            int r02 = migration.startVersion;
            int r12 = migration.endVersion;
            TreeMap<Integer, Migration> treeMap = this.mMigrations.get(Integer.valueOf(r02));
            if (treeMap == null) {
                treeMap = new TreeMap<>();
                this.mMigrations.put(Integer.valueOf(r02), treeMap);
            }
            Migration migration2 = treeMap.get(Integer.valueOf(r12));
            if (migration2 != null) {
                Log.w("ROOM", "Overriding migration " + migration2 + " with " + migration);
            }
            treeMap.put(Integer.valueOf(r12), migration);
        }
        ...
        /* JADX WARN: Removed duplicated region for block: B:41:? A[LOOP:1: B:13:0x0026->B:41:?, LOOP_END, SYNTHETIC] */
        ...
        */
        ...
        @Nullable
        public List<Migration> findMigrationPath(int r32, int r42) {
            if (r32 == r42) {
                return Collections.emptyList();
            }
            return findUpMigrationPath(new ArrayList(), r42 > r32, r32, r42);
        }
    }
