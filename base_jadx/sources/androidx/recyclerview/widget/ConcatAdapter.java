...
public final class ConcatAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public boolean addAdapter(int r22, @NonNull RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter) {
        return this.mController.addAdapter(r22, adapter);
    }
    ...
    public int findRelativeAdapterPositionIn(@NonNull RecyclerView.Adapter<? extends RecyclerView.ViewHolder> adapter, @NonNull RecyclerView.ViewHolder viewHolder, int r42) {
        return this.mController.getLocalAdapterPosition(adapter, viewHolder, r42);
    }
    ...
    public long getItemId(int r32) {
        return this.mController.getItemId(r32);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public int getItemViewType(int r22) {
        return this.mController.getItemViewType(r22);
    }

    @NonNull
    public Pair<RecyclerView.Adapter<? extends RecyclerView.ViewHolder>, Integer> getWrappedAdapterAndPosition(int r22) {
        return this.mController.getWrappedAdapterAndPosition(r22);
    }
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int r32) {
        this.mController.onBindViewHolder(viewHolder, r32);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    @NonNull
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int r32) {
        return this.mController.onCreateViewHolder(viewGroup, r32);
    }
