...
class MessageThreadUtil<T> implements ThreadUtil<T> {
    ...
    public class AnonymousClass1 implements ThreadUtil.MainThreadCallback<T> {
        ...
        public void addTile(int r22, TileList.Tile<T> tile) {
            sendMessage(SyncQueueItem.obtainMessage(2, r22, tile));
        }

        @Override // androidx.recyclerview.widget.ThreadUtil.MainThreadCallback
        public void removeTile(int r22, int r32) {
            sendMessage(SyncQueueItem.obtainMessage(3, r22, r32));
        }

        @Override // androidx.recyclerview.widget.ThreadUtil.MainThreadCallback
        public void updateItemCount(int r22, int r32) {
            sendMessage(SyncQueueItem.obtainMessage(1, r22, r32));
        }
    }
    ...
    public class AnonymousClass2 implements ThreadUtil.BackgroundCallback<T> {
        ...
        public void loadTile(int r22, int r32) {
            sendMessage(SyncQueueItem.obtainMessage(3, r22, r32));
        }
        ...
        public void refresh(int r32) {
            sendMessageAtFrontOfQueue(SyncQueueItem.obtainMessage(1, r32, (Object) null));
        }

        @Override // androidx.recyclerview.widget.ThreadUtil.BackgroundCallback
        public void updateRange(int r82, int r92, int r10, int r11, int r12) {
            sendMessageAtFrontOfQueue(SyncQueueItem.obtainMessage(2, r82, r92, r10, r11, r12, null));
        }
    }
        ...
        public void removeMessages(int r6) {
            ...
            synchronized (this.mLock) {
                while (true) {
                    ...
                    if (syncQueueItem == null || syncQueueItem.what != r6) {
                        break;
                    }
                    this.mRoot = syncQueueItem.next;
    ...
    public static class SyncQueueItem {
        ...
        public static SyncQueueItem obtainMessage(int r72, int r82, int r92) {
            return obtainMessage(r72, r82, r92, 0, 0, 0, null);
        }

        public static SyncQueueItem obtainMessage(int r32, int r42, int r52, int r6, int r72, int r82, Object obj) {
            SyncQueueItem syncQueueItem;
            synchronized (sPoolLock) {
                ...
                syncQueueItem.what = r32;
                syncQueueItem.arg1 = r42;
                syncQueueItem.arg2 = r52;
                syncQueueItem.arg3 = r6;
                syncQueueItem.arg4 = r72;
                syncQueueItem.arg5 = r82;
                syncQueueItem.data = obj;
            }
            return syncQueueItem;
        }

        public static SyncQueueItem obtainMessage(int r72, int r82, Object obj) {
            return obtainMessage(r72, r82, 0, 0, 0, 0, obj);
        }
