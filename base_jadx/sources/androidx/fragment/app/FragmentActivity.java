...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    public class HostCallbacks extends FragmentHostCallback<FragmentActivity> implements OnConfigurationChangedProvider, OnTrimMemoryProvider, OnMultiWindowModeChangedProvider, OnPictureInPictureModeChangedProvider, ViewModelStoreOwner, OnBackPressedDispatcherOwner, ActivityResultRegistryOwner, SavedStateRegistryOwner, FragmentOnAttachListener, MenuHost {
        ...
        @Nullable
        public View onFindViewById(int r22) {
            return FragmentActivity.this.findViewById(r22);
        }
    ...
    @ContentView
    public FragmentActivity(@LayoutRes int r12) {
        super(r12);
        this.mFragments = FragmentController.createController(new HostCallbacks());
        this.mFragmentLifecycleRegistry = new LifecycleRegistry(this);
        this.mStopped = true;
    ...
    private void init() {
        getSavedStateRegistry().registerSavedStateProvider(LIFECYCLE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.b
            ...
            public final Bundle saveState() {
                return this.f981a.lambda$init$0();
            }
        });
        addOnConfigurationChangedListener(new Consumer() { // from class: androidx.fragment.app.c
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                this.f982a.lambda$init$1((Configuration) obj);
            }
        });
        addOnNewIntentListener(new Consumer() { // from class: androidx.fragment.app.d
            @Override // androidx.core.util.Consumer
            public final void accept(Object obj) {
                this.f983a.lambda$init$2((Intent) obj);
            }
        });
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: androidx.fragment.app.e
            @Override // androidx.view.contextaware.OnContextAvailableListener
            public final void onContextAvailable(Context context) {
                this.f984a.lambda$init$3(context);
            }
        });
    }
    ...
    @Override // androidx.view.ComponentActivity, android.app.Activity
    @CallSuper
    public void onRequestPermissionsResult(int r22, @NonNull String[] strArr, @NonNull int[] r42) {
        this.mFragments.noteStateNotSaved();
        super.onRequestPermissionsResult(r22, strArr, r42);
    }
    ...
    public void startActivityFromFragment(@NonNull Fragment fragment, @SuppressLint({"UnknownNullness"}) Intent intent, int r42) {
        startActivityFromFragment(fragment, intent, r42, (Bundle) null);
    }

    public void startActivityFromFragment(@NonNull Fragment fragment, @SuppressLint({"UnknownNullness"}) Intent intent, int r42, @Nullable Bundle bundle) {
        if (r42 == -1) {
            ActivityCompat.startActivityForResult(this, intent, -1, bundle);
        } else {
            fragment.startActivityForResult(intent, r42, bundle);
        }
    }

    @Deprecated
    public void startIntentSenderFromFragment(@NonNull Fragment fragment, @SuppressLint({"UnknownNullness"}) IntentSender intentSender, int r12, @Nullable Intent intent, int r14, int r15, int r16, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (r12 == -1) {
    ...
    @Deprecated
    public final void validateRequestPermissionsRequestCode(int r12) {
    }
}
