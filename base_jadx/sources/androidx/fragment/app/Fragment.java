...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    @ContentView
    public Fragment(@LayoutRes int r12) {
        this();
    ...
    public static Fragment instantiate(@NonNull Context context, @NonNull String str, @Nullable Bundle bundle) throws IllegalAccessException, java.lang.InstantiationException, IllegalArgumentException, InvocationTargetException {
        try {
            ...
            throw new InstantiationException(androidx.browser.browseractions.a.a("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e10);
        } catch (java.lang.InstantiationException e11) {
            throw new InstantiationException(androidx.browser.browseractions.a.a("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e11);
        } catch (NoSuchMethodException e12) {
            throw new InstantiationException(androidx.browser.browseractions.a.a("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e12);
        } catch (InvocationTargetException e13) {
            throw new InstantiationException(androidx.browser.browseractions.a.a("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e13);
        }
    }
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(@NonNull final ActivityResultContract<I, O> activityResultContract, @NonNull final Function<Void, ActivityResultRegistry> function, @NonNull final ActivityResultCallback<O> activityResultCallback) {
        if (this.mState > 1) {
            throw new IllegalStateException(a.c("Fragment ", this, " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate())."));
        }
        ...
        return new ActivityResultLauncher<I>() { // from class: androidx.fragment.app.Fragment.10
            ...
            @Override // androidx.view.result.ActivityResultLauncher
            public void launch(I r22, @Nullable ActivityOptionsCompat activityOptionsCompat) {
                ActivityResultLauncher activityResultLauncher = (ActivityResultLauncher) atomicReference.get();
                if (activityResultLauncher == null) {
                    throw new IllegalStateException("Operation cannot be started before fragment is in created state");
                }
                activityResultLauncher.launch(r22, activityOptionsCompat);
            }
    ...
    public FragmentContainer createFragmentContainer() {
        return new FragmentContainer() { // from class: androidx.fragment.app.Fragment.5
            ...
            @Nullable
            public View onFindViewById(int r32) {
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(android.support.v4.media.a.f(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    @NonNull
    public final String getString(@StringRes int r22) {
        return getResources().getString(r22);
    }

    @NonNull
    public final String getString(@StringRes int r22, @Nullable Object... objArr) {
        return getResources().getString(r22, objArr);
    }
    ...
    @NonNull
    public final CharSequence getText(@StringRes int r22) {
        return getResources().getText(r22);
    }
    ...
    @Deprecated
    public void onActivityResult(int r32, int r42, @Nullable Intent intent) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v(FragmentManager.TAG, "Fragment " + this + " received the following in onActivityResult(): requestCode: " + r32 + " resultCode: " + r42 + " data: " + intent);
        }
    }
    ...
    @Nullable
    @MainThread
    public Animation onCreateAnimation(int r12, boolean z10, int r32) {
        return null;
    }

    @Nullable
    @MainThread
    public Animator onCreateAnimator(int r12, boolean z10, int r32) {
        return null;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        int r42 = this.mContentLayoutId;
        if (r42 != 0) {
            return layoutInflater.inflate(r42, viewGroup, false);
        }
        return null;
    }
    ...
    @Deprecated
    public void onRequestPermissionsResult(int r12, @NonNull String[] strArr, @NonNull int[] r32) {
    }
    ...
    public void performAttach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(a.c("Fragment ", this, " did not call through to super.onAttach()"));
        }
    ...
    public void performCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (viewOnCreateView == null) {
            ...
            C0350ViewTreeSavedStateRegistryOwner.set(this.mView, this.mViewLifecycleOwner);
    ...
    public void performSaveInstanceState(Bundle bundle) {
        ...
        Bundle bundleLambda$attachController$4 = this.mChildFragmentManager.lambda$attachController$4();
        if (bundleLambda$attachController$4 != null) {
            bundle.putParcelable("android:support:fragments", bundleLambda$attachController$4);
        }
    }
    ...
    @Deprecated
    public final void requestPermissions(@NonNull String[] strArr, int r32) {
        if (this.mHost == null) {
            throw new IllegalStateException(a.c("Fragment ", this, " not attached to Activity"));
        }
        getParentFragmentManager().launchRequestPermissions(this, strArr, r32);
    }
    ...
    public final Bundle requireArguments() {
        ...
        throw new IllegalStateException(a.c("Fragment ", this, " does not have any arguments."));
    }
    ...
    public final Object requireHost() {
        ...
        throw new IllegalStateException(a.c("Fragment ", this, " not attached to a host."));
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            throw new IllegalStateException(a.c("Fragment ", this, " is not attached to any Fragment or host"));
        }
    ...
    public void setAnimations(@AnimRes int r22, @AnimRes int r32, @AnimRes int r42, @AnimRes int r52) {
        if (this.mAnimationInfo == null && r22 == 0 && r32 == 0 && r42 == 0 && r52 == 0) {
            return;
        }
        ensureAnimationInfo().mEnterAnim = r22;
        ensureAnimationInfo().mExitAnim = r32;
        ensureAnimationInfo().mPopEnterAnim = r42;
        ensureAnimationInfo().mPopExitAnim = r52;
    }
    ...
    public void setNextTransition(int r22) {
        if (this.mAnimationInfo == null && r22 == 0) {
            return;
        }
        ensureAnimationInfo();
        this.mAnimationInfo.mNextTransition = r22;
    }
    ...
    @Deprecated
    public void setTargetFragment(@Nullable Fragment fragment, int r52) {
        if (fragment != null) {
            FragmentStrictMode.onSetTargetFragmentUsage(this, fragment, r52);
        }
        FragmentManager fragmentManager = this.mFragmentManager;
    ...
    @Deprecated
    public void startActivityForResult(@SuppressLint({"UnknownNullness"}) Intent intent, int r32) {
        startActivityForResult(intent, r32, null);
    }

    @Deprecated
    public void startActivityForResult(@SuppressLint({"UnknownNullness"}) Intent intent, int r32, @Nullable Bundle bundle) {
        if (this.mHost == null) {
            throw new IllegalStateException(a.c("Fragment ", this, " not attached to Activity"));
        }
        getParentFragmentManager().launchStartActivityForResult(this, intent, r32, bundle);
    }

    @Deprecated
    public void startIntentSenderForResult(@SuppressLint({"UnknownNullness"}) IntentSender intentSender, int r12, @Nullable Intent intent, int r14, int r15, int r16, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (this.mHost == null) {
            throw new IllegalStateException(a.c("Fragment ", this, " not attached to Activity"));
        }
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v(FragmentManager.TAG, "Fragment " + this + " received the following in startIntentSenderForResult() requestCode: " + r12 + " IntentSender: " + intentSender + " fillInIntent: " + intent + " options: " + bundle);
        }
        getParentFragmentManager().launchStartIntentSenderForResult(this, intentSender, r12, intent, r14, r15, r16, bundle);
    }
