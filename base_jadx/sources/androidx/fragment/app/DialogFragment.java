...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    public DialogFragment(@LayoutRes int r22) {
        super(r22);
        this.mDismissRunnable = new Runnable() { // from class: androidx.fragment.app.DialogFragment.1
            @Override // java.lang.Runnable
            @SuppressLint({"SyntheticAccessor"})
    ...
    public FragmentContainer createFragmentContainer() {
        ...
        return new FragmentContainer() { // from class: androidx.fragment.app.DialogFragment.5
            ...
            public View onFindViewById(int r22) {
                return fragmentContainerCreateFragmentContainer.onHasView() ? fragmentContainerCreateFragmentContainer.onFindViewById(r22) : DialogFragment.this.onFindViewById(r22);
            }
    ...
    public View onFindViewById(int r22) {
        Dialog dialog = this.mDialog;
        if (dialog != null) {
            return dialog.findViewById(r22);
        }
        return null;
    }
    ...
    public LayoutInflater onGetLayoutInflater(@Nullable Bundle bundle) {
        ...
        if (!this.mShowsDialog || this.mCreatingDialog) {
            if (FragmentManager.isLoggingEnabled(2)) {
                ...
                StringBuilder sb2 = !this.mShowsDialog ? new StringBuilder("mShowsDialog = false: ") : new StringBuilder("mCreatingDialog = true: ");
                sb2.append(str);
    ...
    public void onSaveInstanceState(@NonNull Bundle bundle) {
        ...
        int r02 = this.mStyle;
        if (r02 != 0) {
            bundle.putInt(SAVED_STYLE, r02);
        }
        int r03 = this.mTheme;
        if (r03 != 0) {
            bundle.putInt(SAVED_THEME, r03);
        }
        ...
        int r04 = this.mBackStackId;
        if (r04 != -1) {
            bundle.putInt(SAVED_BACK_STACK_ID, r04);
        }
    }
    ...
    public void onStart() {
        ...
        if (dialog != null) {
            ...
            C0350ViewTreeSavedStateRegistryOwner.set(decorView, this);
        }
    }
    ...
    public void setStyle(int r42, @StyleRes int r52) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.d(FragmentManager.TAG, "Setting style and theme for DialogFragment " + this + " to " + r42 + ", " + r52);
        }
        this.mStyle = r42;
        if (r42 == 2 || r42 == 3) {
    ...
    public void setupDialog(@NonNull Dialog dialog, int r42) {
        if (r42 != 1 && r42 != 2) {
            if (r42 != 3) {
                return;
            }
    ...
    public int show(@NonNull FragmentTransaction fragmentTransaction, @Nullable String str) {
        ...
        this.mViewDestroyed = false;
        int r32 = fragmentTransaction.commit();
        this.mBackStackId = r32;
        return r32;
    }
