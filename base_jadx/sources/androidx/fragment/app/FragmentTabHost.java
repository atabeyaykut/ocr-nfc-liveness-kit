...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            ...
            sb2.append(" curTab=");
            return androidx.camera.camera2.internal.c.h(sb2, this.curTab, "}");
        }
    ...
    private TabInfo getTabInfoForTag(String str) {
        ...
        for (int r12 = 0; r12 < size; r12++) {
            TabInfo tabInfo = this.mTabs.get(r12);
    ...
    public void onAttachedToWindow() {
        ...
        for (int r32 = 0; r32 < size; r32++) {
            TabInfo tabInfo = this.mTabs.get(r32);
    ...
    @Deprecated
    public void setup(@NonNull Context context, @NonNull FragmentManager fragmentManager, int r32) {
        ensureHierarchy(context);
        super.setup();
        this.mContext = context;
        this.mFragmentManager = fragmentManager;
        this.mContainerId = r32;
        ensureContent();
        this.mRealTabContent.setId(r32);
        if (getId() == -1) {
            setId(R.id.tabhost);
        }
    }
