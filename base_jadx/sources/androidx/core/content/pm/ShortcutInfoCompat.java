...
public class ShortcutInfoCompat {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @NonNull ShortcutInfo shortcutInfo) {
            ...
            shortcutInfoCompat.mDisabledReason = r42 >= 28 ? shortcutInfo.getDisabledReason() : shortcutInfo.isEnabled() ? 0 : 3;
            ...
            if (this.mCapabilityBindingParams != null) {
                ...
                for (String str : this.mCapabilityBindingParams.keySet()) {
                    ...
                    for (String str2 : map.keySet()) {
                        ...
                        this.mInfo.mExtras.putStringArray(androidx.camera.core.impl.utils.f.g(str, "/", str2), list == null ? new String[0] : (String[]) list.toArray(new String[0]));
                    }
                }
            }
        ...
        @NonNull
        public Builder setExcludedFromSurfaces(int r22) {
            this.mInfo.mExcludedSurfaces = r22;
            return this;
        }
        ...
        @NonNull
        public Builder setRank(int r22) {
            this.mInfo.mRank = r22;
            return this;
        }
    ...
    private PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            int r02 = 0;
            while (r02 < this.mPersons.length) {
                PersistableBundle persistableBundle = this.mExtras;
                StringBuilder sb2 = new StringBuilder(EXTRA_PERSON_);
                int r32 = r02 + 1;
                sb2.append(r32);
                persistableBundle.putPersistableBundle(sb2.toString(), this.mPersons[r02].toPersistableBundle());
                r02 = r32;
            }
        }
    ...
    public static Person[] getPersonsFromExtra(@NonNull PersistableBundle persistableBundle) {
        ...
        int r02 = persistableBundle.getInt(EXTRA_PERSON_COUNT);
        Person[] personArr = new Person[r02];
        int r22 = 0;
        while (r22 < r02) {
            StringBuilder sb2 = new StringBuilder(EXTRA_PERSON_);
            int r42 = r22 + 1;
            sb2.append(r42);
            personArr[r22] = Person.fromPersistableBundle(persistableBundle.getPersistableBundle(sb2.toString()));
            r22 = r42;
        }
        return personArr;
    }
    ...
    public boolean isExcludedFromSurfaces(int r22) {
        return (r22 & this.mExcludedSurfaces) != 0;
    }
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (personArr != null && personArr.length > 0) {
                ...
                for (int r32 = 0; r32 < length; r32++) {
                    personArr2[r32] = this.mPersons[r32].toAndroidPerson();
                }
