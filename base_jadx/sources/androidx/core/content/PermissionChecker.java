...
public final class PermissionChecker {
    ...
    public static int checkPermission(@NonNull Context context, @NonNull String str, int r42, int r52, @Nullable String str2) {
        if (context.checkPermission(str, r42, r52) == -1) {
            return -1;
        }
        ...
        if (str2 == null) {
            String[] packagesForUid = context.getPackageManager().getPackagesForUid(r52);
            if (packagesForUid == null || packagesForUid.length <= 0) {
                return -1;
            }
            str2 = packagesForUid[0];
        }
        return (Process.myUid() == r52 && ObjectsCompat.equals(context.getPackageName(), str2) ? AppOpsManagerCompat.checkOrNoteProxyOp(context, r52, strPermissionToOp, str2) : AppOpsManagerCompat.noteProxyOpNoThrow(context, strPermissionToOp, str2)) == 0 ? 0 : -2;
    }
