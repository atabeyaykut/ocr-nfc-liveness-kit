...
public final class PathSegment {
    ...
    public int hashCode() {
        int r02 = this.mStart.hashCode() * 31;
        float f = this.mStartFraction;
        int r12 = (this.mEnd.hashCode() + ((r02 + (f != 0.0f ? Float.floatToIntBits(f) : 0)) * 31)) * 31;
        float f10 = this.mEndFraction;
        return r12 + (f10 != 0.0f ? Float.floatToIntBits(f10) : 0);
    }
