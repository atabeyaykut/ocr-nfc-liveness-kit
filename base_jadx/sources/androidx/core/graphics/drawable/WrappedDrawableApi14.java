...
class WrappedDrawableApi14 extends Drawable implements Drawable.Callback, WrappedDrawable, TintAwareDrawable {
    ...
    private boolean updateTint(int[] r52) {
        ...
        if (colorStateList == null || mode == null) {
            ...
            int colorForState = colorStateList.getColorForState(r52, colorStateList.getDefaultColor());
    ...
    @Override // android.graphics.drawable.Drawable
    @RequiresApi(23)
    public boolean onLayoutDirectionChanged(int r22) {
        return DrawableCompat.setLayoutDirection(this.mDrawable, r22);
    }

    @Override // android.graphics.drawable.Drawable
    public boolean onLevelChange(int r22) {
        return this.mDrawable.setLevel(r22);
    }
    ...
    public void setChangingConfigurations(int r22) {
        this.mDrawable.setChangingConfigurations(r22);
    }
    ...
    @Override // android.graphics.drawable.Drawable
    public boolean setState(@NonNull int[] r22) {
        return updateTint(r22) || this.mDrawable.setState(r22);
    }

    @Override // android.graphics.drawable.Drawable, androidx.core.graphics.drawable.TintAwareDrawable
    public void setTint(int r12) {
