...
public abstract class RoundedBitmapDrawable extends Drawable {
    ...
    public void gravityCompatApply(int r12, int r22, int r32, Rect rect, Rect rect2) {
    ...
    public void setTargetDensity(int r22) {
        if (this.mTargetDensity != r22) {
            if (r22 == 0) {
                r22 = 160;
            }
            this.mTargetDensity = r22;
    ...
    public void updateDstRect() {
        if (this.mApplyGravity) {
            if (this.mIsCircular) {
                ...
                int r02 = Math.min(this.mDstRect.width(), this.mDstRect.height());
                this.mDstRect.inset(Math.max(0, (this.mDstRect.width() - r02) / 2), Math.max(0, (this.mDstRect.height() - r02) / 2));
                this.mCornerRadius = r02 * 0.5f;
            } else {
