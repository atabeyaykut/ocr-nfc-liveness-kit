...
class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
    ...
    private static boolean addFontWeightStyle(Object obj, String str, int r52, boolean z10) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
        init();
        try {
            return ((Boolean) sAddFontWeightStyle.invoke(obj, str, Integer.valueOf(r52), Boolean.valueOf(z10))).booleanValue();
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamilyFilesResourceEntry, Resources resources, int r11) throws NoSuchMethodException, ClassNotFoundException, SecurityException {
    ...
    @Override // androidx.core.graphics.TypefaceCompatBaseImpl
    public Typeface createFromFontInfo(Context context, CancellationSignal cancellationSignal, @NonNull FontsContractCompat.FontInfo[] fontInfoArr, int r72) throws IOException {
        if (fontInfoArr.length < 1) {
            return null;
        }
        FontsContractCompat.FontInfo fontInfoFindBestInfo = findBestInfo(fontInfoArr, r72);
        try {
    ...
    public Typeface createWeightStyle(@NonNull Context context, @NonNull Typeface typeface, int r42, boolean z10) {
        ...
        try {
            typefaceCreateWeightStyle = WeightTypefaceApi21.createWeightStyle(typeface, r42, z10);
        } catch (RuntimeException unused) {
