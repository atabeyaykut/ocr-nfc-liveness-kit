...
final class WeightTypefaceApi26 {
    ...
    @Nullable
    public static Typeface createWeightStyle(@NonNull Typeface typeface, int r72, boolean z10) {
        if (!isPrivateApiAvailable()) {
            return null;
        }
        int r02 = (r72 << 1) | (z10 ? 1 : 0);
        synchronized (sWeightCacheLock) {
            ...
            Typeface typefaceCreate = create(nativeCreateFromTypefaceWithExactStyle(nativeInstance, r72, z10));
    ...
    private static long nativeCreateFromTypefaceWithExactStyle(long j10, int r42, boolean z10) {
        try {
            return ((Long) sNativeCreateFromTypefaceWithExactStyle.invoke(null, Long.valueOf(j10), Integer.valueOf(r42), Boolean.valueOf(z10))).longValue();
        } catch (IllegalAccessException e10) {
            throw new RuntimeException(e10);
