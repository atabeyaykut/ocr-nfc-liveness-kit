...
public class AccessibilityWindowInfoCompat {
    ...
    public static class Api21Impl {
        ...
        @DoNotInline
        public static AccessibilityWindowInfo getChild(AccessibilityWindowInfo accessibilityWindowInfo, int r12) {
            return accessibilityWindowInfo.getChild(r12);
        }
    ...
    private static String typeToString(int r12) {
        return r12 != 1 ? r12 != 2 ? r12 != 3 ? r12 != 4 ? "<UNKNOWN>" : "TYPE_ACCESSIBILITY_OVERLAY" : "TYPE_SYSTEM" : "TYPE_INPUT_METHOD" : "TYPE_APPLICATION";
    }
    ...
    @Nullable
    public AccessibilityWindowInfoCompat getChild(int r22) {
        return wrapNonNullInstance(Api21Impl.getChild((AccessibilityWindowInfo) this.mInfo, r22));
    }
    ...
    public String toString() {
        ...
        return b.f(sb2, getChildCount() > 0, ']');
    }
