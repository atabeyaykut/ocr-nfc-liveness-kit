...
public class AccessibilityRecordCompat {
    ...
    public static class Api15Impl {
        ...
        @DoNotInline
        public static void setMaxScrollX(AccessibilityRecord accessibilityRecord, int r12) {
            accessibilityRecord.setMaxScrollX(r12);
        }

        @DoNotInline
        public static void setMaxScrollY(AccessibilityRecord accessibilityRecord, int r12) {
            accessibilityRecord.setMaxScrollY(r12);
        }
    }
    ...
    public static class Api16Impl {
        ...
        @DoNotInline
        public static void setSource(AccessibilityRecord accessibilityRecord, View view, int r22) {
            accessibilityRecord.setSource(view, r22);
        }
    }
    ...
    public static void setMaxScrollX(@NonNull AccessibilityRecord accessibilityRecord, int r12) {
        Api15Impl.setMaxScrollX(accessibilityRecord, r12);
    }

    public static void setMaxScrollY(@NonNull AccessibilityRecord accessibilityRecord, int r12) {
        Api15Impl.setMaxScrollY(accessibilityRecord, r12);
    }

    public static void setSource(@NonNull AccessibilityRecord accessibilityRecord, @Nullable View view, int r22) {
        Api16Impl.setSource(accessibilityRecord, view, r22);
    }
    ...
    @Deprecated
    public void setAddedCount(int r22) {
        this.mRecord.setAddedCount(r22);
    }
    ...
    @Deprecated
    public void setCurrentItemIndex(int r22) {
        this.mRecord.setCurrentItemIndex(r22);
    }
    ...
    @Deprecated
    public void setFromIndex(int r22) {
        this.mRecord.setFromIndex(r22);
    }
    ...
    @Deprecated
    public void setItemCount(int r22) {
        this.mRecord.setItemCount(r22);
    }

    @Deprecated
    public void setMaxScrollX(int r22) {
        setMaxScrollX(this.mRecord, r22);
    }

    @Deprecated
    public void setMaxScrollY(int r22) {
        setMaxScrollY(this.mRecord, r22);
    }
    ...
    @Deprecated
    public void setRemovedCount(int r22) {
        this.mRecord.setRemovedCount(r22);
    }

    @Deprecated
    public void setScrollX(int r22) {
        this.mRecord.setScrollX(r22);
    }

    @Deprecated
    public void setScrollY(int r22) {
        this.mRecord.setScrollY(r22);
    }
    ...
    public void setSource(View view, int r32) {
        setSource(this.mRecord, view, r32);
    }

    @Deprecated
    public void setToIndex(int r22) {
        this.mRecord.setToIndex(r22);
    }
}
