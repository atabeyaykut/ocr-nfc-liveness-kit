...
public final class ShareCompat {
    ...
    public static class Api16Impl {
        ...
        public static void migrateExtraStreamToClipData(@NonNull Intent intent, @NonNull ArrayList<Uri> arrayList) {
            ...
            for (int r12 = 1; r12 < size; r12++) {
                clipData.addItem(new ClipData.Item(arrayList.get(r12)));
            }
    ...
    public static class IntentBuilder {
        ...
        */
        ...
        @NonNull
        public IntentBuilder setChooserTitle(@StringRes int r22) {
            return setChooserTitle(this.mContext.getText(r22));
        }
    ...
    public static class IntentReader {
        ...
        private static void withinStyle(StringBuilder sb2, CharSequence charSequence, int r52, int r6) {
            String str;
            while (r52 < r6) {
                ...
                if (cCharAt == '<') {
                    ...
                    if (cCharAt == ' ') {
                        while (true) {
                            int r02 = r52 + 1;
                            if (r02 >= r6 || charSequence.charAt(r02) != ' ') {
                                break;
                            }
                            sb2.append("&nbsp;");
                            r52 = r02;
        ...
        public Uri getStream(int r42) {
            ...
            if (arrayList != null) {
                parcelableExtra = arrayList.get(r42);
            } else {
                if (r42 != 0) {
                    throw new IndexOutOfBoundsException("Stream items available: " + getStreamCount() + " index requested: " + r42);
                }
    ...
    @Deprecated
    public static void configureMenuItem(@NonNull Menu menu, @IdRes int r22, @NonNull IntentBuilder intentBuilder) {
        MenuItem menuItemFindItem = menu.findItem(r22);
        if (menuItemFindItem == null) {
            throw new IllegalArgumentException(androidx.appcompat.graphics.drawable.a.f("Could not find menu item with id ", r22, " in the supplied menu"));
        }
