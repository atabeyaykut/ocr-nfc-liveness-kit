...
public class FrameMetricsAggregator {
    ...
    public static class FrameMetricsApi24Impl extends FrameMetricsBaseImpl {
        ...
        Window.OnFrameMetricsAvailableListener mListener = new Window.OnFrameMetricsAvailableListener() { // from class: androidx.core.app.FrameMetricsAggregator.FrameMetricsApi24Impl.1
            ...
            public void onFrameMetricsAvailable(Window window, FrameMetrics frameMetrics, int r72) {
        ...
        public FrameMetricsApi24Impl(int r22) {
            this.mTrackingFlags = r22;
        }
        ...
        public void add(Activity activity) {
            ...
            for (int r02 = 0; r02 <= 8; r02++) {
                ...
                if (sparseIntArrayArr[r02] == null && (this.mTrackingFlags & (1 << r02)) != 0) {
                    sparseIntArrayArr[r02] = new SparseIntArray();
                }
            }
        ...
        public void addDurationItem(SparseIntArray sparseIntArray, long j10) {
            if (sparseIntArray != null) {
                int r12 = (int) ((500000 + j10) / 1000000);
                if (j10 >= 0) {
                    sparseIntArray.put(r12, sparseIntArray.get(r12) + 1);
                }
            }
        }
    ...
    public FrameMetricsAggregator(int r32) {
        if (Build.VERSION.SDK_INT >= 24) {
            this.mInstance = new FrameMetricsApi24Impl(r32);
        } else {
