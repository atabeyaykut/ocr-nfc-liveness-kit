...
public final class TaskStackBuilder implements Iterable<Intent> {
    ...
    public static class Api16Impl {
        ...
        @DoNotInline
        public static PendingIntent getActivities(Context context, int r12, Intent[] intentArr, int r32, Bundle bundle) {
            return PendingIntent.getActivities(context, r12, intentArr, r32, bundle);
        }
    }
    ...
    @Nullable
    public Intent editIntentAt(int r22) {
        return this.mIntents.get(r22);
    }

    @Deprecated
    public Intent getIntent(int r12) {
        return editIntentAt(r12);
    }
    ...
    public Intent[] getIntents() {
        ...
        for (int r22 = 1; r22 < size; r22++) {
            intentArr[r22] = new Intent(this.mIntents.get(r22));
        }
        return intentArr;
    }

    @Nullable
    public PendingIntent getPendingIntent(int r22, int r32) {
        return getPendingIntent(r22, r32, null);
    }

    @Nullable
    public PendingIntent getPendingIntent(int r52, int r6, @Nullable Bundle bundle) {
        if (this.mIntents.isEmpty()) {
            throw new IllegalStateException("No intents added to TaskStackBuilder; cannot getPendingIntent");
        }
        Intent[] intentArr = (Intent[]) this.mIntents.toArray(new Intent[0]);
        intentArr[0] = new Intent(intentArr[0]).addFlags(268484608);
        return Api16Impl.getActivities(this.mSourceContext, r52, intentArr, r6, bundle);
    }
