...
public final class RemoteInput {
    ...
    public static class Api28Impl {
        ...
        @DoNotInline
        public static void setResultsSource(Intent intent, int r12) {
            android.app.RemoteInput.setResultsSource(intent, r12);
        }
    }
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        public static RemoteInput.Builder setEditChoicesBeforeSending(RemoteInput.Builder builder, int r12) {
            return builder.setEditChoicesBeforeSending(r12);
        }
    }
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setEditChoicesBeforeSending(int r12) {
            this.mEditChoicesBeforeSending = r12;
            return this;
        }
    ...
    public RemoteInput(String str, CharSequence charSequence, CharSequence[] charSequenceArr, boolean z10, int r52, Bundle bundle, Set<String> set) {
        this.mResultKey = str;
        this.mLabel = charSequence;
        this.mChoices = charSequenceArr;
        this.mAllowFreeFormTextInput = z10;
        this.mEditChoicesBeforeSending = r52;
        this.mExtras = bundle;
    ...
    public static android.app.RemoteInput[] fromCompat(RemoteInput[] remoteInputArr) {
        ...
        for (int r12 = 0; r12 < remoteInputArr.length; r12++) {
            remoteInputArr2[r12] = fromCompat(remoteInputArr[r12]);
        }
    ...
    private static String getExtraResultsKeyForData(String str) {
        return androidx.browser.browseractions.b.e(EXTRA_DATA_TYPE_RESULTS_DATA, str);
    }
    ...
    public static void setResultsSource(@NonNull Intent intent, int r32) {
        if (Build.VERSION.SDK_INT >= 28) {
            Api28Impl.setResultsSource(intent, r32);
            return;
        }
        Intent clipDataIntentFromIntent = getClipDataIntentFromIntent(intent);
        if (clipDataIntentFromIntent == null) {
        ...
        clipDataIntentFromIntent.putExtra(EXTRA_RESULTS_SOURCE, r32);
        Api16Impl.setClipData(intent, ClipData.newIntent(RESULTS_CLIP_LABEL, clipDataIntentFromIntent));
    }
