...
public interface SupportMenuItem extends MenuItem {
    ...
    @Override // android.view.MenuItem
    @NonNull
    MenuItem setActionView(int r12);
    ...
    @Override // android.view.MenuItem
    @NonNull
    MenuItem setAlphabeticShortcut(char c10, int r22);
    ...
    @Override // android.view.MenuItem
    @NonNull
    MenuItem setNumericShortcut(char c10, int r22);

    @Override // android.view.MenuItem
    @NonNull
    MenuItem setShortcut(char c10, char c11, int r32, int r42);

    @Override // android.view.MenuItem
    void setShowAsAction(int r12);

    @Override // android.view.MenuItem
    @NonNull
    MenuItem setShowAsActionFlags(int r12);
