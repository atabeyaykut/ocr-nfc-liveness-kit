...
public final class BidiFormatter {
    ...
    public static class DirectionalityEstimator {
        ...
        static {
            for (int r12 = 0; r12 < DIR_TYPE_CACHE_SIZE; r12++) {
                DIR_TYPE_CACHE[r12] = Character.getDirectionality(r12);
            }
        }
        ...
        private byte skipEntityBackward() {
            char cCharAt;
            int r02 = this.charIndex;
            do {
                int r12 = this.charIndex;
                if (r12 <= 0) {
                    break;
                }
                ...
                int r13 = r12 - 1;
                this.charIndex = r13;
                cCharAt = charSequence.charAt(r13);
        ...
        private byte skipEntityForward() {
            ...
            do {
                ...
                CharSequence charSequence = this.text;
                this.charIndex = r02 + 1;
                cCharAt = charSequence.charAt(r02);
                this.lastChar = cCharAt;
            } while (cCharAt != ';');
            return PassportService.SFI_DG12;
        }
        ...
        private byte skipTagBackward() {
            ...
            while (true) {
                ...
                int r13 = r12 - 1;
                this.charIndex = r13;
                char cCharAt2 = charSequence.charAt(r13);
                ...
                if (cCharAt2 == '\"' || cCharAt2 == '\'') {
                    do {
                        ...
                        if (r22 > 0) {
                            ...
                            int r23 = r22 - 1;
                            this.charIndex = r23;
                            cCharAt = charSequence2.charAt(r23);
                            this.lastChar = cCharAt;
                        }
        ...
        public byte dirTypeBackward() {
            ...
            if (Character.isLowSurrogate(cCharAt)) {
                int r02 = Character.codePointBefore(this.text, this.charIndex);
                this.charIndex -= Character.charCount(r02);
                return Character.getDirectionality(r02);
            }
            this.charIndex--;
        ...
        public byte dirTypeForward() {
            ...
            if (Character.isHighSurrogate(cCharAt)) {
                int r02 = Character.codePointAt(this.text, this.charIndex);
                this.charIndex = Character.charCount(r02) + this.charIndex;
                return Character.getDirectionality(r02);
            }
            this.charIndex++;
            byte cachedDirectionality = getCachedDirectionality(this.lastChar);
        ...
        public int getEntryDir() {
            ...
            int r22 = 0;
            int r32 = 0;
            while (this.charIndex < this.length && r12 == 0) {
    ...
    public BidiFormatter(boolean z10, int r22, TextDirectionHeuristicCompat textDirectionHeuristicCompat) {
        this.mIsRtlContext = z10;
        this.mFlags = r22;
