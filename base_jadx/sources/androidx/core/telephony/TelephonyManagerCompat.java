...
public class TelephonyManagerCompat {
    ...
    public static class Api23Impl {
        ...
        @DoNotInline
        public static String getDeviceId(TelephonyManager telephonyManager, int r12) {
            return telephonyManager.getDeviceId(r12);
        }
    }
    ...
    public static String getImei(@NonNull TelephonyManager telephonyManager) throws NoSuchMethodException, SecurityException {
        ...
        if (r02 < 22 || (subscriptionId = getSubscriptionId(telephonyManager)) == Integer.MAX_VALUE || subscriptionId == -1) {
