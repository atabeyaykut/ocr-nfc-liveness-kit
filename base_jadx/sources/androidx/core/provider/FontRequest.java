...
public final class FontRequest {
    ...
    public FontRequest(@NonNull String str, @NonNull String str2, @NonNull String str3, @ArrayRes int r52) {
        ...
        Preconditions.checkArgument(r52 != 0);
        this.mCertificatesArray = r52;
    ...
    public String toString() {
        ...
        for (int r22 = 0; r22 < this.mCertificates.size(); r22++) {
            sb2.append(" [");
            List<byte[]> list = this.mCertificates.get(r22);
            for (int r42 = 0; r42 < list.size(); r42++) {
                sb2.append(" \"");
                sb2.append(Base64.encodeToString(list.get(r42), 0));
                sb2.append("\"");
            }
            sb2.append(" ]");
        }
