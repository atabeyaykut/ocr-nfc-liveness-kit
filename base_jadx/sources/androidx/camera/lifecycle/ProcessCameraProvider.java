...
public final class ProcessCameraProvider implements LifecycleCameraProvider {
    ...
    @GuardedBy("mLock")
    private m5.a<CameraX> mCameraXInitializeFuture;
    ...
    @GuardedBy("mLock")
    private m5.a<Void> mCameraXShutdownFuture = Futures.immediateFuture(null);
    ...
    @NonNull
    public static m5.a<ProcessCameraProvider> getInstance(@NonNull final Context context) {
    ...
    private m5.a<CameraX> getOrCreateCameraXInstance(@NonNull Context context) {
        synchronized (this.mLock) {
            m5.a<CameraX> aVar = this.mCameraXInitializeFuture;
            if (aVar != null) {
                return aVar;
            }
            m5.a<CameraX> future = CallbackToFutureAdapter.getFuture(new d(this, new CameraX(context, this.mCameraXConfigProvider)));
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ m5.a lambda$getOrCreateCameraXInstance$1(CameraX cameraX, Void r12) throws Exception {
    ...
    public Camera bindToLifecycle(@NonNull LifecycleOwner lifecycleOwner, @NonNull CameraSelector cameraSelector, @Nullable ViewPort viewPort, @NonNull UseCase... useCaseArr) {
        ...
        while (true) {
            ...
            CameraSelector cameraSelector2 = useCaseArr[r32].getCurrentConfig().getCameraSelector(null);
    ...
    public m5.a<Void> shutdown() {
        ...
        m5.a<Void> aVarShutdown = cameraX != null ? cameraX.shutdown() : Futures.immediateFuture(null);
        synchronized (this.mLock) {
            this.mCameraXConfigProvider = null;
            this.mCameraXInitializeFuture = null;
            this.mCameraXShutdownFuture = aVarShutdown;
        }
        this.mCameraX = null;
        this.mContext = null;
        return aVarShutdown;
