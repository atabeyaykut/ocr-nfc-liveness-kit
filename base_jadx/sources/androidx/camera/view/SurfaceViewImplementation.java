...
final class SurfaceViewImplementation extends PreviewViewImplementation {
    ...
    public class SurfaceRequestCallback implements SurfaceHolder.Callback {
        ...
        private boolean tryToComplete() throws ExecutionException, InterruptedException {
            ...
            this.mSurfaceRequest.provideSurface(surface, ContextCompat.getMainExecutor(SurfaceViewImplementation.this.mSurfaceView.getContext()), new Consumer() { // from class: androidx.camera.view.p
                ...
                public final void accept(Object obj) {
                    this.f859a.lambda$tryToComplete$0((SurfaceRequest.Result) obj);
                }
            });
        ...
        public void surfaceChanged(@NonNull SurfaceHolder surfaceHolder, int r22, int r32, int r42) throws ExecutionException, InterruptedException {
            Logger.d(SurfaceViewImplementation.TAG, "Surface changed. Size: " + r32 + "x" + r42);
            this.mCurrentSurfaceSize = new Size(r32, r42);
            tryToComplete();
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$getPreviewBitmap$1(int r32) {
        if (r32 == 0) {
            Logger.d(TAG, "PreviewView.SurfaceViewImplementation.getBitmap() succeeded");
            return;
        }
        Logger.e(TAG, "PreviewView.SurfaceViewImplementation.getBitmap() failed with error " + r32);
    }
    ...
    public Bitmap getPreviewBitmap() {
        ...
        Api24Impl.pixelCopyRequest(surfaceView2, bitmapCreateBitmap, new PixelCopy.OnPixelCopyFinishedListener() { // from class: androidx.camera.view.n
            @Override // android.view.PixelCopy.OnPixelCopyFinishedListener
            public final void onPixelCopyFinished(int r12) {
                SurfaceViewImplementation.lambda$getPreviewBitmap$1(r12);
            }
    ...
    public void onSurfaceRequested(@NonNull SurfaceRequest surfaceRequest, @Nullable PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
        ...
        initializePreview();
        surfaceRequest.addRequestCancellationListener(ContextCompat.getMainExecutor(this.mSurfaceView.getContext()), new Runnable() { // from class: androidx.camera.view.l
            @Override // java.lang.Runnable
            public final void run() {
                this.f855a.notifySurfaceNotInUse();
            }
        });
        this.mSurfaceView.post(new m(this, surfaceRequest, 0));
    }
