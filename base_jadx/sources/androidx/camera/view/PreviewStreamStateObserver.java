...
final class PreviewStreamStateObserver implements Observable.Observer<CameraInternal.State> {
    ...
    private void cancelFlow() {
        m5.a<Void> aVar = this.mFlowFuture;
        if (aVar != null) {
            aVar.cancel(false);
    ...
    public /* synthetic */ m5.a lambda$startPreviewStreamStateFlow$0(Void r12) throws Exception {
    ...
    private void startPreviewStreamStateFlow(final CameraInfo cameraInfo) {
        ...
        FutureChain futureChainTransform = FutureChain.from(waitForCaptureResult(cameraInfo, arrayList)).transformAsync(new AsyncFunction() { // from class: androidx.camera.view.d
            @Override // androidx.camera.core.impl.utils.futures.AsyncFunction
            public final m5.a apply(Object obj) {
                return this.f838a.lambda$startPreviewStreamStateFlow$0((Void) obj);
            }
        }, CameraXExecutors.directExecutor()).transform(new Function() { // from class: androidx.camera.view.e
            @Override // androidx.arch.core.util.Function
            public final Object apply(Object obj) {
                return this.f839a.lambda$startPreviewStreamStateFlow$1((Void) obj);
            }
    ...
    private m5.a<Void> waitForCaptureResult(final CameraInfo cameraInfo, final List<CameraCaptureCallback> list) {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.f
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f840a.lambda$waitForCaptureResult$2(cameraInfo, list, completer);
            }
        });
    }
