...
public class AeFpsRangeLegacyQuirk implements Quirk {
    ...
    private Range<Integer> getCorrectedFpsRange(@NonNull Range<Integer> range) {
        int r02 = ((Integer) range.getUpper()).intValue();
        int r12 = ((Integer) range.getLower()).intValue();
        if (((Integer) range.getUpper()).intValue() >= 1000) {
            r02 = ((Integer) range.getUpper()).intValue() / 1000;
        }
        if (((Integer) range.getLower()).intValue() >= 1000) {
            r12 = ((Integer) range.getLower()).intValue() / 1000;
        }
        return new Range<>(Integer.valueOf(r12), Integer.valueOf(r02));
    }
