    ...
    public static final class OutputConfigurationParamsApi21 {
        ...
        private static int getSurfaceFormat(@NonNull Surface surface) throws NoSuchMethodException, SecurityException {
            try {
                ...
                Logger.e(OutputConfigurationCompatBaseImpl.TAG, "Unable to retrieve surface format.", e10);
                return 0;
            }
        }
        ...
        private static int getSurfaceGenerationId(@NonNull Surface surface) {
            try {
                ...
                Logger.e(OutputConfigurationCompatBaseImpl.TAG, "Unable to retrieve surface generation id.", e10);
                return -1;
            }
        }
        ...
        private static Size getSurfaceSize(@NonNull Surface surface) throws NoSuchMethodException, SecurityException {
            try {
                ...
                Logger.e(OutputConfigurationCompatBaseImpl.TAG, "Unable to retrieve surface size.", e10);
                return null;
            }
        }
        ...
        public boolean equals(Object obj) {
            ...
            int r02 = Math.min(this.mSurfaces.size(), outputConfigurationParamsApi21.mSurfaces.size());
            for (int r22 = 0; r22 < r02; r22++) {
                if (this.mSurfaces.get(r22) != outputConfigurationParamsApi21.mSurfaces.get(r22)) {
                    return false;
                }
            }
            return true;
        ...
        public int hashCode() {
            int r02 = this.mSurfaces.hashCode() ^ 31;
            int r03 = this.mConfiguredGenerationId ^ ((r02 << 5) - r02);
            int r04 = this.mConfiguredSize.hashCode() ^ ((r03 << 5) - r03);
            int r05 = this.mConfiguredFormat ^ ((r04 << 5) - r04);
            int r06 = (this.mIsShared ? 1 : 0) ^ ((r05 << 5) - r05);
            int r12 = (r06 << 5) - r06;
