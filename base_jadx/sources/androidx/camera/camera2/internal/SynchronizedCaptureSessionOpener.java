...
final class SynchronizedCaptureSessionOpener {
    ...
    public interface OpenerImpl {
        @NonNull
        SessionConfigurationCompat createSessionConfigurationCompat(int r12, @NonNull List<OutputConfigurationCompat> list, @NonNull SynchronizedCaptureSession.StateCallback stateCallback);

        @NonNull
        Executor getExecutor();

        @NonNull
        m5.a<Void> openCaptureSession(@NonNull CameraDevice cameraDevice, @NonNull SessionConfigurationCompat sessionConfigurationCompat, @NonNull List<DeferrableSurface> list);

        @NonNull
        m5.a<List<Surface>> startWithDeferrableSurface(@NonNull List<DeferrableSurface> list, long j10);
    ...
    @NonNull
    public SessionConfigurationCompat createSessionConfigurationCompat(int r22, @NonNull List<OutputConfigurationCompat> list, @NonNull SynchronizedCaptureSession.StateCallback stateCallback) {
        return this.mImpl.createSessionConfigurationCompat(r22, list, stateCallback);
    }
    ...
    public m5.a<List<Surface>> startWithDeferrableSurface(@NonNull List<DeferrableSurface> list, long j10) {
        return this.mImpl.startWithDeferrableSurface(list, j10);
    }
