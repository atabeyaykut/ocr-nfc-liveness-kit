...
public final class CameraXConfig implements TargetConfig<CameraX> {
    ...
    public static final class Builder implements TargetConfig.Builder<CameraX, Builder> {
        ...
        @NonNull
        public Builder setMinimumLoggingLevel(@IntRange(from = 3, to = 6) int r32) {
            getMutableConfig().insertOption(CameraXConfig.OPTION_MIN_LOGGING_LEVEL, Integer.valueOf(r32));
            return this;
        }
