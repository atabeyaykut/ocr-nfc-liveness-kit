...
public class FutureChain<V> implements m5.a<V> {

    @Nullable
    CallbackToFutureAdapter.Completer<V> mCompleter;

    @NonNull
    private final m5.a<V> mDelegate;
    ...
    public FutureChain(@NonNull m5.a<V> aVar) {
        this.mDelegate = (m5.a) Preconditions.checkNotNull(aVar);
    }

    @NonNull
    public static <V> FutureChain<V> from(@NonNull m5.a<V> aVar) {
    ...
    boolean setException(@NonNull Throwable th2) {
        CallbackToFutureAdapter.Completer<V> completer = this.mCompleter;
        if (completer != null) {
