...
public final /* synthetic */ class w {
    public static int a(ImageOutputConfig imageOutputConfig, int r22) {
        return ((Integer) imageOutputConfig.retrieveOption(ImageOutputConfig.OPTION_APP_TARGET_ROTATION, Integer.valueOf(r22))).intValue();
    }
    ...
    public static int l(ImageOutputConfig imageOutputConfig, int r22) {
        return ((Integer) imageOutputConfig.retrieveOption(ImageOutputConfig.OPTION_TARGET_ROTATION, Integer.valueOf(r22))).intValue();
    }
