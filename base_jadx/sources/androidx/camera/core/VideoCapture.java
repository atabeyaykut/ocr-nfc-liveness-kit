...
public final class VideoCapture extends UseCase {
    ...
    @Nullable
    private m5.a<Void> mRecordingFuture;
    ...
    public static class Api26Impl {
        ...
        @NonNull
        @DoNotInline
        public static MediaMuxer createMediaMuxer(@NonNull FileDescriptor fileDescriptor, int r22) throws IOException {
            return new MediaMuxer(fileDescriptor, r22);
        }
    }
    ...
    public static final class Builder implements UseCaseConfig.Builder<VideoCapture, VideoCaptureConfig, Builder>, ImageOutputConfig.Builder<Builder>, ThreadConfig.Builder<Builder> {
        ...
        @NonNull
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public Builder setAudioBitRate(int r32) {
            getMutableConfig().insertOption(VideoCaptureConfig.OPTION_AUDIO_BIT_RATE, Integer.valueOf(r32));
            return this;
        }

        @NonNull
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public Builder setAudioChannelCount(int r32) {
            getMutableConfig().insertOption(VideoCaptureConfig.OPTION_AUDIO_CHANNEL_COUNT, Integer.valueOf(r32));
            return this;
        }

        @NonNull
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public Builder setAudioMinBufferSize(int r32) {
            getMutableConfig().insertOption(VideoCaptureConfig.OPTION_AUDIO_MIN_BUFFER_SIZE, Integer.valueOf(r32));
            return this;
        }

        @NonNull
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public Builder setAudioSampleRate(int r32) {
            getMutableConfig().insertOption(VideoCaptureConfig.OPTION_AUDIO_SAMPLE_RATE, Integer.valueOf(r32));
            return this;
        }
        ...
        @NonNull
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public Builder setBitRate(int r32) {
            getMutableConfig().insertOption(VideoCaptureConfig.OPTION_BIT_RATE, Integer.valueOf(r32));
            return this;
        }
        ...
        @NonNull
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public Builder setIFrameInterval(int r32) {
            getMutableConfig().insertOption(VideoCaptureConfig.OPTION_INTRA_FRAME_INTERVAL, Integer.valueOf(r32));
            return this;
        }
        ...
        @NonNull
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public Builder setVideoFrameRate(int r32) {
            getMutableConfig().insertOption(VideoCaptureConfig.OPTION_VIDEO_FRAME_RATE, Integer.valueOf(r32));
            return this;
        }
    }
    ...
    public interface OnVideoSavedCallback {
        void onError(int r12, @NonNull String str, @Nullable Throwable th2);
    ...
    public static final class VideoSavedListenerWrapper implements OnVideoSavedCallback {
        ...
        public /* synthetic */ void lambda$onError$1(int r22, String str, Throwable th2) {
            this.mOnVideoSavedCallback.onError(r22, str, th2);
        }
        ...
        public void onError(int r92, @NonNull String str, @Nullable Throwable th2) {
            try {
                this.mExecutor.execute(new h0(this, r92, str, th2, 1));
        ...
        public void onVideoSaved(@NonNull OutputFileResults outputFileResults) {
            try {
                this.mExecutor.execute(new n0(2, this, outputFileResults));
            } catch (RejectedExecutionException unused) {
                Logger.e(VideoCapture.TAG, "Unable to post to the supplied executor.");
            }
        }
    ...
    private AudioRecord autoConfigAudioRecordSource(VideoCaptureConfig videoCaptureConfig) {
        int r32 = this.mAudioChannelCount == 1 ? 16 : 12;
        try {
            int minBufferSize = AudioRecord.getMinBufferSize(this.mAudioSampleRate, r32, 2);
            if (minBufferSize <= 0) {
                minBufferSize = videoCaptureConfig.getAudioMinBufferSize();
            }
            int r13 = minBufferSize;
            AudioRecord audioRecord = new AudioRecord(5, this.mAudioSampleRate, r32, 2, r13 * 2);
            if (audioRecord.getState() != 1) {
                return null;
            }
            this.mAudioBufferSize = r13;
            Logger.i(TAG, "source: 5 audioSampleRate: " + this.mAudioSampleRate + " channelConfig: " + r32 + " audioFormat: 2 bufferSize: " + r13);
            return audioRecord;
        } catch (Exception e10) {
            Logger.e(TAG, "Exception, keep trying.", e10);
            return null;
        }
    }
    ...
    private ByteBuffer getInputBuffer(MediaCodec mediaCodec, int r22) {
        return mediaCodec.getInputBuffer(r22);
    }

    private ByteBuffer getOutputBuffer(MediaCodec mediaCodec, int r22) {
        return mediaCodec.getOutputBuffer(r22);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static /* synthetic */ void lambda$releaseCameraSurface$7(boolean z10, MediaCodec mediaCodec) {
    ...
    @UiThread
    private void releaseCameraSurface(final boolean z10) {
        ...
        this.mDeferrableSurface.getTerminationFuture().addListener(new Runnable() { // from class: androidx.camera.core.c1
            @Override // java.lang.Runnable
            public final void run() {
                VideoCapture.lambda$releaseCameraSurface$7(z10, mediaCodec);
            }
    ...
    private boolean removeRecordingResultIfNoVideoKeyFrameArrived(@NonNull OutputFileOptions outputFileOptions) {
        ...
        } else if (outputFileOptions.isSavingToMediaStore() && !z10) {
            Logger.i(TAG, "Delete file.");
            if (this.mSavedVideoUri != null) {
    ...
    */
    ...
    private boolean writeAudioEncodedBuffer(int r92) {
        ByteBuffer outputBuffer = getOutputBuffer(this.mAudioEncoder, r92);
        ...
        this.mAudioEncoder.releaseOutputBuffer(r92, false);
        return (this.mAudioBufferInfo.flags & 4) != 0;
    }

    private boolean writeVideoEncodedBuffer(int r92) {
        if (r92 < 0) {
            Logger.e(TAG, "Output buffer should not have negative index: " + r92);
            return false;
        }
        ByteBuffer outputBuffer = this.mVideoEncoder.getOutputBuffer(r92);
        ...
        if (this.mMuxerStarted.get()) {
            ...
            if (bufferInfo.size > 0) {
                ...
                Logger.i(TAG, "mVideoBufferInfo.size <= 0, index " + r92);
            }
        }
        this.mVideoEncoder.releaseOutputBuffer(r92, false);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public boolean lambda$startRecording$3(androidx.camera.core.VideoCapture.OnVideoSavedCallback r20) throws java.lang.IllegalStateException, android.media.MediaCodec.CryptoException {
        /*
    ...
    public void onDetached() {
        ...
        m5.a<Void> aVar = this.mRecordingFuture;
        if (aVar != null) {
            aVar.addListener(new f0(1, this), CameraXExecutors.mainThreadExecutor());
        } else {
            lambda$onDetached$6();
        }
    }
    ...
    public void setupEncoder(@NonNull final String str, @NonNull final Size size) {
        ...
        try {
            ...
            Surface surfaceCreateInputSurface = this.mVideoEncoder.createInputSurface();
            ...
            terminationFuture.addListener(new b0(r32, surfaceCreateInputSurface), CameraXExecutors.mainThreadExecutor());
            ...
            if (Build.VERSION.SDK_INT >= 23) {
                int codecExceptionErrorCode = Api23Impl.getCodecExceptionErrorCode(e10);
                ...
                if (codecExceptionErrorCode != 1100) {
                    ...
                    this.mVideoEncoderErrorMessage = e10;
                }
                Logger.i(TAG, "CodecException: code: " + codecExceptionErrorCode + " diagnostic: " + diagnosticInfo);
    ...
    public void lambda$startRecording$0(@NonNull final OutputFileOptions outputFileOptions, @NonNull Executor executor, @NonNull OnVideoSavedCallback onVideoSavedCallback) throws IllegalStateException {
        Location location;
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new m0(this, outputFileOptions, executor, onVideoSavedCallback, 1));
            return;
        }
        ...
        if (this.mIsAudioEnabled.get()) {
            try {
                ...
                Logger.i(TAG, "AudioRecorder cannot start recording, disable audio." + e10.getMessage());
                this.mIsAudioEnabled.set(false);
                releaseAudioInputResource();
            }
        ...
        this.mRecordingFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.z0
        ...
        this.mRecordingFuture.addListener(new a1(r12, this), CameraXExecutors.mainThreadExecutor());
        try {
            ...
            try {
                ...
                notifyUpdated();
                if (this.mIsAudioEnabled.get()) {
                    this.mAudioHandler.post(new t0(r32, this, videoSavedListenerWrapper));
                }
                final String cameraId = getCameraId();
                final Size attachedSurfaceResolution = getAttachedSurfaceResolution();
                this.mVideoHandler.post(new Runnable() { // from class: androidx.camera.core.b1
                    @Override // java.lang.Runnable
                    public final void run() {
                        this.f676a.lambda$startRecording$4(videoSavedListenerWrapper, cameraId, attachedSurfaceResolution, outputFileOptions, completer);
                    }
                });
            } catch (IOException e11) {
                completer.set(null);
                videoSavedListenerWrapper.onError(2, "MediaMuxer creation failed!", e11);
            }
        } catch (IllegalStateException e12) {
            completer.set(null);
            videoSavedListenerWrapper.onError(1, "Audio/Video encoder start fail", e12);
        }
    }
    ...
    public void lambda$stopRecording$5() {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new o(4, this));
            return;
        }
        ...
        if (this.mIsRecording) {
            (this.mIsAudioEnabled.get() ? this.mEndOfAudioStreamSignal : this.mEndOfVideoStreamSignal).set(true);
        }
    }
    ...
    public boolean videoEncode(@NonNull OnVideoSavedCallback onVideoSavedCallback, @NonNull String str, @NonNull Size size, @NonNull OutputFileOptions outputFileOptions) throws IOException {
        ...
        boolean z10 = false;
        while (!zWriteVideoEncodedBuffer && !z10) {
            if (this.mEndOfVideoStreamSignal.get()) {
                this.mVideoEncoder.signalEndOfInputStream();
                this.mEndOfVideoStreamSignal.set(false);
            }
            int r32 = this.mVideoEncoder.dequeueOutputBuffer(this.mVideoBufferInfo, WorkRequest.MIN_BACKOFF_MILLIS);
            if (r32 == -2) {
                if (this.mMuxerStarted.get()) {
                ...
                zWriteVideoEncodedBuffer = writeVideoEncodedBuffer(r32);
            }
        }
        try {
        ...
        if (this.mParcelFileDescriptor != null) {
            try {
                ...
                onVideoSavedCallback.onError(2, "File descriptor close failed!", e12);
                z10 = true;
            }
        }
