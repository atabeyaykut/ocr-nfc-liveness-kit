...
final class AutoValue_ImmutableImageInfo extends ImmutableImageInfo {
    ...
    public AutoValue_ImmutableImageInfo(TagBundle tagBundle, long j10, int r42, Matrix matrix) {
        if (tagBundle == null) {
            throw new NullPointerException("Null tagBundle");
        }
        this.tagBundle = tagBundle;
        this.timestamp = j10;
        this.rotationDegrees = r42;
        if (matrix == null) {
    ...
    public int hashCode() {
        int r02 = (this.tagBundle.hashCode() ^ 1000003) * 1000003;
        long j10 = this.timestamp;
        return ((((r02 ^ ((int) (j10 ^ (j10 >>> 32)))) * 1000003) ^ this.rotationDegrees) * 1000003) ^ this.sensorToBufferTransformMatrix.hashCode();
    }
