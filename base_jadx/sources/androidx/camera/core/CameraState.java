...
public abstract class CameraState {
    ...
    public static abstract class StateError {
        @NonNull
        public static StateError create(int r12) {
            return create(r12, null);
        }

        @NonNull
        public static StateError create(int r12, @Nullable Throwable th2) {
            return new AutoValue_CameraState_StateError(r12, th2);
        }
