    ...
    public static final class Builder {
        ...
        public Builder(@NonNull Menu menu) {
            ...
            for (int r12 = 0; r12 < size; r12++) {
                this.mTopLevelDestinations.add(Integer.valueOf(menu.getItem(r12).getItemId()));
            }
        }
        ...
        public Builder(@NonNull int... r52) {
            this.mTopLevelDestinations = new HashSet();
            for (int r02 : r52) {
                this.mTopLevelDestinations.add(Integer.valueOf(r02));
            }
        }
