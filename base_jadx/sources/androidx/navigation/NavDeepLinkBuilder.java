...
public final class NavDeepLinkBuilder {
    ...
    private void fillInIntent() {
        ...
        if (navDestination != null) {
            ...
            StringBuilder sbL = a.l("Navigation destination ", NavDestination.getDisplayName(this.mContext, this.mDestId), " cannot be found in the navigation graph ");
            sbL.append(this.mGraph);
    ...
    public PendingIntent createPendingIntent() {
        ...
        if (bundle != null) {
            ...
            while (it.hasNext()) {
                ...
                r22 = (r22 * 31) + (obj != null ? obj.hashCode() : 0);
            }
            r12 = r22;
        }
        return createTaskStackBuilder().getPendingIntent((r12 * 31) + this.mDestId, 134217728);
    }
    ...
    public TaskStackBuilder createTaskStackBuilder() {
        ...
        TaskStackBuilder taskStackBuilderAddNextIntentWithParentStack = TaskStackBuilder.create(this.mContext).addNextIntentWithParentStack(new Intent(this.mIntent));
        for (int r12 = 0; r12 < taskStackBuilderAddNextIntentWithParentStack.getIntentCount(); r12++) {
            taskStackBuilderAddNextIntentWithParentStack.editIntentAt(r12).putExtra(NavController.KEY_DEEP_LINK_INTENT, this.mIntent);
        }
    ...
    @NonNull
    public NavDeepLinkBuilder setDestination(@IdRes int r12) {
        this.mDestId = r12;
        if (this.mGraph != null) {
            fillInIntent();
        }
    ...
    @NonNull
    public NavDeepLinkBuilder setGraph(@NavigationRes int r42) {
        return setGraph(new NavInflater(this.mContext, new PermissiveNavigatorProvider()).inflate(r42));
    }
