...
public final class Data {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder putInt(@NonNull String str, int r32) {
            this.mValues.put(str, Integer.valueOf(r32));
            return this;
        }

        @NonNull
        public Builder putIntArray(@NonNull String str, @NonNull int[] r32) {
            this.mValues.put(str, Data.convertPrimitiveIntArray(r32));
            return this;
        }
    ...
    public static Boolean[] convertPrimitiveBooleanArray(@NonNull boolean[] zArr) {
        ...
        for (int r12 = 0; r12 < zArr.length; r12++) {
    ...
    public static Byte[] convertPrimitiveByteArray(@NonNull byte[] bArr) {
        ...
        for (int r12 = 0; r12 < bArr.length; r12++) {
            bArr2[r12] = Byte.valueOf(bArr[r12]);
        }
        return bArr2;
    }
    ...
    public static Double[] convertPrimitiveDoubleArray(@NonNull double[] dArr) {
        ...
        for (int r12 = 0; r12 < dArr.length; r12++) {
            dArr2[r12] = Double.valueOf(dArr[r12]);
        }
        return dArr2;
    }
    ...
    public static Float[] convertPrimitiveFloatArray(@NonNull float[] fArr) {
        ...
        for (int r12 = 0; r12 < fArr.length; r12++) {
            fArr2[r12] = Float.valueOf(fArr[r12]);
        }
        return fArr2;
    }
    ...
    @NonNull
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public static Integer[] convertPrimitiveIntArray(@NonNull int[] r32) {
        Integer[] numArr = new Integer[r32.length];
        for (int r12 = 0; r12 < r32.length; r12++) {
            numArr[r12] = Integer.valueOf(r32[r12]);
        }
        return numArr;
    }
    ...
    public static Long[] convertPrimitiveLongArray(@NonNull long[] jArr) {
        ...
        for (int r12 = 0; r12 < jArr.length; r12++) {
            lArr[r12] = Long.valueOf(jArr[r12]);
        }
        return lArr;
    }
    ...
    public static double[] convertToPrimitiveArray(@NonNull Double[] dArr) {
        double[] dArr2 = new double[dArr.length];
        for (int r12 = 0; r12 < dArr.length; r12++) {
            dArr2[r12] = dArr[r12].doubleValue();
        }
        return dArr2;
    }
    ...
    public static int[] convertToPrimitiveArray(@NonNull Integer[] numArr) {
        int[] r02 = new int[numArr.length];
        for (int r12 = 0; r12 < numArr.length; r12++) {
            r02[r12] = numArr[r12].intValue();
        }
        return r02;
    }
    ...
    public static long[] convertToPrimitiveArray(@NonNull Long[] lArr) {
        ...
        for (int r12 = 0; r12 < lArr.length; r12++) {
            jArr[r12] = lArr[r12].longValue();
        }
        return jArr;
    }
    ...
    public static boolean[] convertToPrimitiveArray(@NonNull Boolean[] boolArr) {
        ...
        for (int r12 = 0; r12 < boolArr.length; r12++) {
            zArr[r12] = boolArr[r12].booleanValue();
        }
        return zArr;
    }
    ...
    */
    ...
    public int getInt(@NonNull String str, int r32) {
        Object obj = this.mValues.get(str);
        return obj instanceof Integer ? ((Integer) obj).intValue() : r32;
    }
