    ...
    public void setupAndRunConstraintTrackingWork() {
        ...
        if (TextUtils.isEmpty(string)) {
            ...
            if (listenableWorkerCreateWorkerWithDefaultFallback != null) {
                ...
                try {
                    final a<ListenableWorker.Result> aVarStartWork = this.mDelegate.startWork();
                    aVarStartWork.addListener(new Runnable() { // from class: androidx.work.impl.workers.ConstraintTrackingWorker.2
                        ...
                        public void run() {
                            synchronized (ConstraintTrackingWorker.this.mLock) {
                                if (ConstraintTrackingWorker.this.mAreConstraintsUnmet) {
                                    ...
                                    ConstraintTrackingWorker.this.mFuture.setFuture(aVarStartWork);
                                }
                            }
                        }
