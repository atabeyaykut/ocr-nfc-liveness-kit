...
public class WorkDatabaseMigrations {
    ...
    public static class RescheduleMigration extends Migration {
        ...
        public RescheduleMigration(@NonNull Context context, int r22, int r32) {
            super(r22, r32);
    ...
    static {
        int r22 = 4;
        MIGRATION_3_4 = new Migration(3, r22) { // from class: androidx.work.impl.WorkDatabaseMigrations.2
            @Override // androidx.room.migration.Migration
            public void migrate(@NonNull SupportSQLiteDatabase supportSQLiteDatabase) throws SQLException {
        ...
        MIGRATION_4_5 = new Migration(r22, 5) { // from class: androidx.work.impl.WorkDatabaseMigrations.3
            @Override // androidx.room.migration.Migration
            public void migrate(@NonNull SupportSQLiteDatabase supportSQLiteDatabase) throws SQLException {
        ...
        int r23 = 7;
        MIGRATION_6_7 = new Migration(6, r23) { // from class: androidx.work.impl.WorkDatabaseMigrations.4
            @Override // androidx.room.migration.Migration
            public void migrate(@NonNull SupportSQLiteDatabase supportSQLiteDatabase) throws SQLException {
        ...
        int r12 = 8;
        MIGRATION_7_8 = new Migration(r23, r12) { // from class: androidx.work.impl.WorkDatabaseMigrations.5
            @Override // androidx.room.migration.Migration
            public void migrate(@NonNull SupportSQLiteDatabase supportSQLiteDatabase) throws SQLException {
                supportSQLiteDatabase.execSQL(WorkDatabaseMigrations.CREATE_INDEX_PERIOD_START_TIME);
            }
        };
        MIGRATION_8_9 = new Migration(r12, 9) { // from class: androidx.work.impl.WorkDatabaseMigrations.6
            @Override // androidx.room.migration.Migration
            public void migrate(@NonNull SupportSQLiteDatabase supportSQLiteDatabase) throws SQLException {
