...
public abstract class WorkManager {
    ...
    @NonNull
    public abstract Operation cancelWorkById(@NonNull UUID r12);

    @NonNull
    public abstract PendingIntent createCancelPendingIntent(@NonNull UUID r12);
    ...
    @NonNull
    public abstract a<WorkInfo> getWorkInfoById(@NonNull UUID r12);

    @NonNull
    public abstract LiveData<WorkInfo> getWorkInfoByIdLiveData(@NonNull UUID r12);
