...
public class ViewModelProvider {
    ...
    public static class AndroidViewModelFactory extends NewInstanceFactory {
        ...
        public static final class Companion {
            ...
            public final Factory defaultFactory$lifecycle_viewmodel_release(ViewModelStoreOwner owner) {
                ...
                kotlin.jvm.internal.h.e(defaultViewModelProviderFactory, "owner.defaultViewModelProviderFactory");
        ...
        private AndroidViewModelFactory(Application application, int r22) {
        ...
        private final <T extends ViewModel> T create(Class<T> modelClass, Application app) throws IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException {
            ...
            try {
                ...
                kotlin.jvm.internal.h.e(tNewInstance, "{\n                try {\n…          }\n            }");
                return tNewInstance;
            } catch (IllegalAccessException e10) {
                throw new RuntimeException(androidx.appcompat.graphics.drawable.a.g("Cannot create an instance of ", modelClass), e10);
            } catch (InstantiationException e11) {
                throw new RuntimeException(androidx.appcompat.graphics.drawable.a.g("Cannot create an instance of ", modelClass), e11);
            } catch (NoSuchMethodException e12) {
                throw new RuntimeException(androidx.appcompat.graphics.drawable.a.g("Cannot create an instance of ", modelClass), e12);
            } catch (InvocationTargetException e13) {
                throw new RuntimeException(androidx.appcompat.graphics.drawable.a.g("Cannot create an instance of ", modelClass), e13);
            }
        }
    ...
    public static class NewInstanceFactory implements Factory {
        ...
        public static final class Companion {
            ...
            public final NewInstanceFactory getInstance() {
                ...
                kotlin.jvm.internal.h.c(newInstanceFactory);
    ...
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0017\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0006\u0010\u0007J\u0010\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016¨\u0006\b"}, d2 = {"Landroidx/lifecycle/ViewModelProvider$OnRequeryFactory;", "", "Landroidx/lifecycle/ViewModel;", "viewModel", "Ll9/m;", "onRequery", "<init>", "()V", "lifecycle-viewmodel_release"}, k = 1, mv = {1, 6, 0})
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    ...
    public /* synthetic */ ViewModelProvider(ViewModelStore viewModelStore, Factory factory, CreationExtras creationExtras, int r42, kotlin.jvm.internal.d dVar) {
        this(viewModelStore, factory, (r42 & 4) != 0 ? CreationExtras.Empty.INSTANCE : creationExtras);
    }
