...
public final class SavedStateViewModelFactoryKt {
    private static final List<Class<?>> ANDROID_VIEWMODEL_SIGNATURE = b8.f.T(Application.class, SavedStateHandle.class);
    private static final List<Class<?>> VIEWMODEL_SIGNATURE = b8.f.S(SavedStateHandle.class);
    ...
    public static final <T> Constructor<T> findMatchingConstructor(Class<T> modelClass, List<? extends Class<?>> signature) throws SecurityException {
        ...
        for (Object obj : constructors) {
            ...
            List listA0 = k.A0(parameterTypes);
            if (kotlin.jvm.internal.h.a(signature, listA0)) {
                return constructor;
            }
            if (signature.size() == listA0.size() && listA0.containsAll(signature)) {
    ...
    public static final <T extends ViewModel> T newInstance(Class<T> modelClass, Constructor<T> constructor, Object... params) {
        ...
        try {
            ...
            throw new RuntimeException(androidx.appcompat.graphics.drawable.a.g("Failed to access ", modelClass), e10);
        } catch (InstantiationException e11) {
            throw new RuntimeException(androidx.camera.camera2.internal.c.f("A ", modelClass, " cannot be instantiated."), e11);
        } catch (InvocationTargetException e12) {
            throw new RuntimeException(androidx.appcompat.graphics.drawable.a.g("An exception happened in constructor of ", modelClass), e12.getCause());
        }
    }
}
