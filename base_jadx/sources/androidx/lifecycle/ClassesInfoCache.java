...
final class ClassesInfoCache {
    ...
    public static final class MethodReference {
        ...
        public MethodReference(int r12, Method method) throws SecurityException {
            this.mCallType = r12;
            this.mMethod = method;
    ...
    private CallbackInfo createInfo(Class<?> cls, @Nullable Method[] methodArr) {
        ...
        for (Method method : methodArr) {
            ...
            if (onLifecycleEvent != null) {
                ...
                verifyAndPutHandler(map, new MethodReference(r72, method), eventValue, cls);
                z10 = true;
            }
        }
