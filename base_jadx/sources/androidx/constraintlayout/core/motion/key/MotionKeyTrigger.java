...
public class MotionKeyTrigger extends MotionKey {
    ...
    */
    ...
    public boolean setValue(int r22, int r32) {
        if (r22 == 307) {
            this.mTriggerCollisionId = r32;
            return true;
        }
        if (r22 == 308) {
            this.mTriggerID = toInt(Integer.valueOf(r32));
            return true;
        }
        if (r22 == 311) {
            this.mTriggerReceiver = r32;
            return true;
        }
        switch (r22) {
            case 301:
                this.mViewTransitionOnCross = r32;
                return true;
            case 302:
                this.mViewTransitionOnPositiveCross = r32;
                return true;
            case 303:
                this.mViewTransitionOnNegativeCross = r32;
                return true;
            default:
    ...
    @Override // androidx.constraintlayout.core.motion.key.MotionKey, androidx.constraintlayout.core.motion.utils.TypedValues
    public boolean setValue(int r22, boolean z10) {
        if (r22 != 304) {
            return super.setValue(r22, z10);
        }
