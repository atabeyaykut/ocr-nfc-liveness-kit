...
public class State {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            int[] r02 = new int[Helper.values().length];
            $SwitchMap$androidx$constraintlayout$core$state$State$Helper = r02;
            try {
                r02[Helper.HORIZONTAL_CHAIN.ordinal()] = 1;
    ...
    private String createHelperKey() {
        ...
        int r12 = this.numHelpers;
        this.numHelpers = r12 + 1;
        return androidx.browser.browseractions.a.b(sb2, r12, "__");
    }
        ...
        while (it4.hasNext()) {
            ...
            if (reference3 != this.mParent && (reference3.getFacade() instanceof HelperReference) && (helperWidget = (helperReference = (HelperReference) reference3.getFacade()).getHelperWidget()) != null) {
                ...
                while (it5.hasNext()) {
                    ...
                    if (reference4 != null) {
                        constraintWidget = reference4.getConstraintWidget();
    ...
    public GuidelineReference guideline(Object obj, int r42) {
        ConstraintReference constraintReferenceConstraints = constraints(obj);
        if (constraintReferenceConstraints.getFacade() == null || !(constraintReferenceConstraints.getFacade() instanceof GuidelineReference)) {
            ...
            guidelineReference.setOrientation(r42);
    ...
    public HelperReference helper(Object obj, Helper helper) {
        ...
        if (helperReference == null) {
            int r02 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Helper[helper.ordinal()];
            if (r02 == 1) {
    ...
    public boolean sameFixedHeight(int r22) {
        return this.mParent.getHeight().equalsFixedValue(r22);
    }

    public boolean sameFixedWidth(int r22) {
        return this.mParent.getWidth().equalsFixedValue(r22);
    }
