...
public class BarrierReference extends HelperReference {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            int[] r02 = new int[State.Direction.values().length];
            $SwitchMap$androidx$constraintlayout$core$state$State$Direction = r02;
            try {
                r02[State.Direction.LEFT.ordinal()] = 1;
    ...
    public void apply() {
        getHelperWidget();
        int r02 = AnonymousClass1.$SwitchMap$androidx$constraintlayout$core$state$State$Direction[this.mDirection.ordinal()];
        int r12 = 3;
        if (r02 == 3 || r02 == 4) {
            r12 = 1;
        } else if (r02 == 5) {
        ...
        this.mBarrierWidget.setBarrierType(r12);
    ...
    public ConstraintReference margin(int r12) {
        this.mMargin = r12;
        return this;
    }
