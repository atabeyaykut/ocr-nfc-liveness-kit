...
public class ConstraintAnchor {
    ...
    private boolean isConnectionToMe(ConstraintWidget constraintWidget, HashSet<ConstraintWidget> hashSet) {
        ...
        for (int r32 = 0; r32 < size; r32++) {
            ConstraintAnchor constraintAnchor = anchors.get(r32);
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int r42) {
        return connect(constraintAnchor, r42, Integer.MIN_VALUE, false);
    }

    public boolean connect(ConstraintAnchor constraintAnchor, int r32, int r42, boolean z10) {
    ...
    public void copyFrom(ConstraintAnchor constraintAnchor, HashMap<ConstraintWidget, ConstraintWidget> map) {
        ...
        this.mTarget = constraintAnchor3 != null ? map.get(constraintAnchor.mTarget.mOwner).getAnchor(constraintAnchor3.getType()) : null;
    ...
    public void findDependents(int r32, ArrayList<WidgetGroup> arrayList, WidgetGroup widgetGroup) {
        HashSet<ConstraintAnchor> hashSet = this.mDependents;
        if (hashSet != null) {
            Iterator<ConstraintAnchor> it = hashSet.iterator();
            while (it.hasNext()) {
                Grouping.findDependents(it.next().mOwner, r32, arrayList, widgetGroup);
            }
        }
    }
    ...
    public void setFinalValue(int r12) {
        this.mFinalValue = r12;
        this.mHasFinalValue = true;
    }

    public void setGoneMargin(int r22) {
        if (isConnected()) {
            this.mGoneMargin = r22;
        }
    }
