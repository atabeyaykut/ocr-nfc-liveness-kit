...
public class Optimizer {
    ...
    public static void checkMatchParent(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, ConstraintWidget constraintWidget) {
        ...
        if (dimensionBehaviour != dimensionBehaviour2 && constraintWidget.mListDimensionBehaviors[0] == ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
            int r02 = constraintWidget.mLeft.mMargin;
            ...
            linearSystem.addEquality(constraintWidget.mLeft.mSolverVariable, r02);
            linearSystem.addEquality(constraintWidget.mRight.mSolverVariable, width);
            constraintWidget.mHorizontalResolution = 2;
            constraintWidget.setHorizontalDimension(r02, width);
        }
        ...
        int r03 = constraintWidget.mTop.mMargin;
        ...
        linearSystem.addEquality(constraintWidget.mTop.mSolverVariable, r03);
        ...
        if (constraintWidget.mBaselineDistance > 0 || constraintWidget.getVisibility() == 8) {
            ...
            linearSystem.addEquality(constraintWidget.mBaseline.mSolverVariable, constraintWidget.mBaselineDistance + r03);
        }
        constraintWidget.mVerticalResolution = 2;
        constraintWidget.setVerticalDimension(r03, height);
    }

    public static final boolean enabled(int r02, int r12) {
        return (r02 & r12) == r12;
    }
}
