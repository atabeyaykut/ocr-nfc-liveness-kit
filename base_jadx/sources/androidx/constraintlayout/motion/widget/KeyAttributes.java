    ...
    public static class Loader {
        ...
        */
        public static void read(androidx.constraintlayout.motion.widget.KeyAttributes r5, android.content.res.TypedArray r6) {
            ...
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.constraintlayout.motion.widget.KeyAttributes.Loader.read(androidx.constraintlayout.motion.widget.KeyAttributes, android.content.res.TypedArray):void");
        }
    }
    ...
    */
    ...
    public void setInterpolation(HashMap<String, Integer> map) {
        ...
        if (this.mCustomConstraints.size() > 0) {
            Iterator<String> it = this.mCustomConstraints.keySet().iterator();
            while (it.hasNext()) {
                map.put(b.e("CUSTOM,", it.next()), Integer.valueOf(this.mCurveFit));
            }
        }
    }
