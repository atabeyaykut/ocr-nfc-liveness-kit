...
public class MockView extends View {
    ...
    public MockView(Context context, AttributeSet attributeSet, int r42) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mDrawDiagonals) {
            ...
            float f = width;
            float f10 = height;
            canvas.drawLine(0.0f, 0.0f, f, f10, this.mPaintDiagonals);
            canvas.drawLine(0.0f, f10, f, 0.0f, this.mPaintDiagonals);
            canvas.drawLine(0.0f, 0.0f, f, 0.0f, this.mPaintDiagonals);
            canvas.drawLine(f, 0.0f, f, f10, this.mPaintDiagonals);
            canvas.drawLine(f, f10, 0.0f, f10, this.mPaintDiagonals);
            canvas.drawLine(0.0f, f10, 0.0f, 0.0f, this.mPaintDiagonals);
        }
        ...
        int r32 = rect.left;
        int r42 = this.mMargin;
        rect.set(r32 - r42, rect.top - r42, rect.right + r42, rect.bottom + r42);
