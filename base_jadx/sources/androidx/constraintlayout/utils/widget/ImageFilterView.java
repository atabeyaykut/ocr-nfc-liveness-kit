...
public class ImageFilterView extends AppCompatImageView {
    ...
    public static class ImageMatrix {
        ...
        public void updateMatrix(ImageView imageView) {
            ...
            if (f != 1.0f) {
                saturation(f);
                this.mColorMatrix.set(this.f888m);
                z10 = true;
            } else {
                z10 = false;
            }
            ...
            if (f10 != 1.0f) {
                this.mTmpColorMatrix.setScale(f10, f10, f10, 1.0f);
            ...
            if (f11 != 1.0f) {
                warmth(f11);
                this.mTmpColorMatrix.set(this.f888m);
                this.mColorMatrix.postConcat(this.mTmpColorMatrix);
                z10 = true;
            }
            float f12 = this.mBrightness;
            if (f12 != 1.0f) {
                brightness(f12);
                this.mTmpColorMatrix.set(this.f888m);
                this.mColorMatrix.postConcat(this.mTmpColorMatrix);
    ...
    public ImageFilterView(Context context, AttributeSet attributeSet, int r42) {
    ...
    private void setMatrix() {
        ...
        float f10 = Float.isNaN(this.mPanY) ? 0.0f : this.mPanY;
    ...
    public void layout(int r12, int r22, int r32, int r42) {
        super.layout(r12, r22, r32, r42);
        setMatrix();
    }

    public void setAltImageResource(int r42) {
        Drawable drawableMutate = AppCompatResources.getDrawable(getContext(), r42).mutate();
    ...
    @Override // androidx.appcompat.widget.AppCompatImageView, android.widget.ImageView
    public void setImageResource(int r32) {
        if (this.mAltDrawable == null) {
            super.setImageResource(r32);
            return;
        }
        Drawable drawableMutate = AppCompatResources.getDrawable(getContext(), r32).mutate();
        this.mDrawable = drawableMutate;
        Drawable[] drawableArr = this.mLayers;
        drawableArr[0] = drawableMutate;
        drawableArr[1] = this.mAltDrawable;
