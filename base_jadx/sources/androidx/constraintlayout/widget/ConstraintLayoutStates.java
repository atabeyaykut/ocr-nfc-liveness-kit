...
public class ConstraintLayoutStates {
    ...
    public ConstraintLayoutStates(Context context, ConstraintLayout constraintLayout, int r42) throws XmlPullParserException, Resources.NotFoundException, IOException, NumberFormatException {
    ...
    */
    ...
    private void parseConstraintSet(Context context, XmlPullParser xmlPullParser) throws NumberFormatException {
        ...
        for (int r22 = 0; r22 < attributeCount; r22++) {
            String attributeName = xmlPullParser.getAttributeName(r22);
            String attributeValue = xmlPullParser.getAttributeValue(r22);
    ...
    public void updateConstraints(int r52, float f, float f10) {
        int r6;
        int r02 = this.mCurrentStateId;
        if (r02 == r52) {
            State stateValueAt = r52 == -1 ? this.mStateList.valueAt(0) : this.mStateList.get(r02);
            int r03 = this.mCurrentConstraintNumber;
            if ((r03 == -1 || !stateValueAt.mVariants.get(r03).match(f, f10)) && this.mCurrentConstraintNumber != (r6 = stateValueAt.findMatch(f, f10))) {
                ConstraintSet constraintSet = r6 == -1 ? this.mDefaultConstraintSet : stateValueAt.mVariants.get(r6).mConstraintSet;
                int r53 = r6 == -1 ? stateValueAt.mConstraintID : stateValueAt.mVariants.get(r6).mConstraintID;
                if (constraintSet == null) {
                    return;
                }
                this.mCurrentConstraintNumber = r6;
                ConstraintsChangedListener constraintsChangedListener = this.mConstraintsChangedListener;
                if (constraintsChangedListener != null) {
                    constraintsChangedListener.preLayoutChange(-1, r53);
                }
                constraintSet.applyTo(this.mConstraintLayout);
                ConstraintsChangedListener constraintsChangedListener2 = this.mConstraintsChangedListener;
                if (constraintsChangedListener2 != null) {
                    constraintsChangedListener2.postLayoutChange(-1, r53);
                    return;
                }
                return;
            }
        ...
        this.mCurrentStateId = r52;
        State state = this.mStateList.get(r52);
        int r22 = state.findMatch(f, f10);
        ConstraintSet constraintSet2 = r22 == -1 ? state.mConstraintSet : state.mVariants.get(r22).mConstraintSet;
        int r04 = r22 == -1 ? state.mConstraintID : state.mVariants.get(r22).mConstraintID;
        if (constraintSet2 == null) {
            Log.v("ConstraintLayoutStates", "NO Constraint set found ! id=" + r52 + ", dim =" + f + ", " + f10);
            return;
        }
        this.mCurrentConstraintNumber = r22;
        ConstraintsChangedListener constraintsChangedListener3 = this.mConstraintsChangedListener;
        if (constraintsChangedListener3 != null) {
            constraintsChangedListener3.preLayoutChange(r52, r04);
        }
        constraintSet2.applyTo(this.mConstraintLayout);
        ConstraintsChangedListener constraintsChangedListener4 = this.mConstraintsChangedListener;
        if (constraintsChangedListener4 != null) {
            constraintsChangedListener4.postLayoutChange(r52, r04);
        }
    }
}
