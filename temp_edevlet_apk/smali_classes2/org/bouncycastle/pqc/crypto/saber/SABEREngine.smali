...
.method public constructor <init>(IIZZ)V
    ...
    iput p2, p0, Lorg/bouncycastle/pqc/crypto/saber/SABEREngine;->SABER_EQ:I
    ...
    iget p2, p0, Lorg/bouncycastle/pqc/crypto/saber/SABEREngine;->SABER_EQ:I

    mul-int/lit16 p3, p2, 0x100

    div-int/2addr p3, v1

    iput p3, p0, Lorg/bouncycastle/pqc/crypto/saber/SABEREngine;->SABER_POLYBYTES:I

    mul-int p3, p3, p1

    iput p3, p0, Lorg/bouncycastle/pqc/crypto/saber/SABEREngine;->SABER_POLYVECBYTES:I

    const/16 p4, 0x140

    iput p4, p0, Lorg/bouncycastle/pqc/crypto/saber/SABEREngine;->SABER_POLYCOMPRESSEDBYTES:I

    mul-int/lit16 p1, p1, 0x140

    iput p1, p0, Lorg/bouncycastle/pqc/crypto/saber/SABEREngine;->SABER_POLYVECCOMPRESSEDBYTES:I

    iget p4, p0, Lorg/bouncycastle/pqc/crypto/saber/SABEREngine;->SABER_ET:I

    mul-int/lit16 v0, p4, 0x100
    ...
    iput p3, p0, Lorg/bouncycastle/pqc/crypto/saber/SABEREngine;->SABER_INDCPA_SECRETKEYBYTES:I
    ...
    invoke-static {p3, v1, v3, v4}, Landroid/support/v4/media/a;->a(IIII)I

    move-result p3

    iput p3, p0, Lorg/bouncycastle/pqc/crypto/saber/SABEREngine;->SABER_SECRETKEYBYTES:I
...
.method private indcpa_kem_enc([B[B[B[B)V
    ...
    invoke-virtual {v1, v2, v3, v10}, Lorg/bouncycastle/pqc/crypto/saber/Utils;->POLT2BS([BI[S)V
...
.method private indcpa_kem_keypair([B[BLjava/security/SecureRandom;)V
    ...
    invoke-static {v7, v5, p1, p2, v6}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
