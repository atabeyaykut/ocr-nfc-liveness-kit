...
.method public static loadDrawable(Landroid/graphics/drawable/Icon;Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p0, p1}, Landroidx/appcompat/view/a;->h(Landroid/graphics/drawable/Icon;Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method public static toIcon(Landroidx/core/graphics/drawable/IconCompat;Landroid/content/Context;)Landroid/graphics/drawable/Icon;
    ...
    invoke-static {p1}, Landroidx/appcompat/view/b;->d(Landroid/graphics/Bitmap;)Landroid/graphics/drawable/Icon;
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/h;->d(Ljava/lang/String;)Landroid/graphics/drawable/Icon;
    ...
    invoke-static {p1, v0, v1}, Landroidx/appcompat/widget/g;->a([BII)Landroid/graphics/drawable/Icon;
    ...
    invoke-static {v0, p1}, Landroidx/appcompat/widget/f;->f(ILjava/lang/String;)Landroid/graphics/drawable/Icon;
    ...
    invoke-static {p1, v0}, Landroid/support/v4/media/h;->j(Landroid/graphics/drawable/Icon;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, p0}, Landroid/support/v4/media/i;->k(Landroid/graphics/drawable/Icon;Landroid/graphics/PorterDuff$Mode;)V
