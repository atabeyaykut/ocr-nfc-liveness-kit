...
.method public constructor <init>(Landroid/app/NotificationChannel;)V
    ...
    invoke-static {p1}, Landroidx/appcompat/view/d;->f(Landroid/app/NotificationChannel;)Ljava/lang/String;

    move-result-object v0

    invoke-static {p1}, Landroidx/browser/trusted/c;->c(Landroid/app/NotificationChannel;)I

    move-result v1

    invoke-direct {p0, v0, v1}, Landroidx/core/app/NotificationChannelCompat;-><init>(Ljava/lang/String;I)V

    invoke-static {p1}, Landroidx/appcompat/app/d;->i(Landroid/app/NotificationChannel;)Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, p0, Landroidx/core/app/NotificationChannelCompat;->mName:Ljava/lang/CharSequence;

    invoke-static {p1}, Landroidx/appcompat/widget/j;->j(Landroid/app/NotificationChannel;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Landroidx/core/app/NotificationChannelCompat;->mDescription:Ljava/lang/String;

    invoke-static {p1}, Landroidx/camera/camera2/internal/compat/params/b;->g(Landroid/app/NotificationChannel;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Landroidx/core/app/NotificationChannelCompat;->mGroupId:Ljava/lang/String;

    invoke-static {p1}, Landroidx/camera/camera2/internal/compat/workaround/a;->r(Landroid/app/NotificationChannel;)Z

    move-result v0

    iput-boolean v0, p0, Landroidx/core/app/NotificationChannelCompat;->mShowBadge:Z

    invoke-static {p1}, Landroidx/appcompat/widget/k;->k(Landroid/app/NotificationChannel;)Landroid/net/Uri;

    move-result-object v0

    iput-object v0, p0, Landroidx/core/app/NotificationChannelCompat;->mSound:Landroid/net/Uri;

    invoke-static {p1}, Landroidx/appcompat/app/d;->g(Landroid/app/NotificationChannel;)Landroid/media/AudioAttributes;

    move-result-object v0

    iput-object v0, p0, Landroidx/core/app/NotificationChannelCompat;->mAudioAttributes:Landroid/media/AudioAttributes;

    invoke-static {p1}, Landroidx/appcompat/app/e;->q(Landroid/app/NotificationChannel;)Z

    move-result v0

    iput-boolean v0, p0, Landroidx/core/app/NotificationChannelCompat;->mLights:Z

    invoke-static {p1}, Landroidx/appcompat/widget/l;->b(Landroid/app/NotificationChannel;)I

    move-result v0

    iput v0, p0, Landroidx/core/app/NotificationChannelCompat;->mLightColor:I

    invoke-static {p1}, Landroidx/browser/trusted/b;->o(Landroid/app/NotificationChannel;)Z

    move-result v0

    iput-boolean v0, p0, Landroidx/core/app/NotificationChannelCompat;->mVibrationEnabled:Z

    invoke-static {p1}, Landroidx/browser/trusted/c;->s(Landroid/app/NotificationChannel;)[J
    ...
    invoke-static {p1}, Landroidx/core/app/k;->d(Landroid/app/NotificationChannel;)Ljava/lang/String;

    move-result-object v2

    iput-object v2, p0, Landroidx/core/app/NotificationChannelCompat;->mParentId:Ljava/lang/String;

    invoke-static {p1}, Landroidx/core/app/l;->d(Landroid/app/NotificationChannel;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p1}, Landroidx/appcompat/widget/j;->o(Landroid/app/NotificationChannel;)Z

    move-result v2

    iput-boolean v2, p0, Landroidx/core/app/NotificationChannelCompat;->mBypassDnd:Z

    invoke-static {p1}, Landroidx/camera/camera2/internal/compat/params/b;->a(Landroid/app/NotificationChannel;)I
    ...
    invoke-static {p1}, Landroidx/core/app/m;->f(Landroid/app/NotificationChannel;)Z
    ...
    invoke-static {p1}, Landroidx/camera/core/impl/utils/c;->i(Landroid/app/NotificationChannel;)Z
...
.method public getNotificationChannel()Landroid/app/NotificationChannel;
    ...
    invoke-static {v1, v0, v2}, Landroidx/core/app/j;->g(Landroid/app/NotificationChannel;Ljava/lang/String;Ljava/lang/String;)V
