...
.method public static getMode(Landroid/content/Context;Landroid/view/Display;)Landroidx/core/view/DisplayCompat$ModeCompat;
    ...
    invoke-static {p1}, Landroidx/appcompat/view/a;->k(Landroid/view/Display;)Landroid/view/Display$Mode;
...
.method public static getSupportedModes(Landroid/content/Context;Landroid/view/Display;)[Landroidx/core/view/DisplayCompat$ModeCompat;
    ...
    invoke-static {p1}, Landroidx/appcompat/view/b;->n(Landroid/view/Display;)[Landroid/view/Display$Mode;
...
.method public static isCurrentModeTheLargestMode(Landroid/view/Display;)Z
    ...
    invoke-static {p0}, Landroidx/appcompat/view/a;->k(Landroid/view/Display;)Landroid/view/Display$Mode;

    move-result-object v0

    invoke-static {p0}, Landroidx/appcompat/view/b;->n(Landroid/view/Display;)[Landroid/view/Display$Mode;
    ...
    invoke-static {v0}, Landroidx/appcompat/widget/e;->b(Landroid/view/Display$Mode;)I

    move-result v5

    invoke-static {v4}, Landroidx/appcompat/widget/e;->b(Landroid/view/Display$Mode;)I

    move-result v6

    if-lt v5, v6, :cond_1

    invoke-static {v0}, Landroidx/appcompat/widget/d;->c(Landroid/view/Display$Mode;)I

    move-result v5

    invoke-static {v4}, Landroidx/appcompat/widget/d;->c(Landroid/view/Display$Mode;)I
...
.method public static physicalSizeEquals(Landroid/view/Display$Mode;Landroid/graphics/Point;)Z
    ...
    invoke-static {p0}, Landroidx/appcompat/widget/d;->c(Landroid/view/Display$Mode;)I
    ...
    invoke-static {p0}, Landroidx/appcompat/widget/e;->b(Landroid/view/Display$Mode;)I
...
.method public static physicalSizeEquals(Landroid/view/Display$Mode;Landroid/view/Display$Mode;)Z
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/d;->c(Landroid/view/Display$Mode;)I
    ...
    invoke-static {p1}, Landroidx/appcompat/widget/e;->b(Landroid/view/Display$Mode;)I
