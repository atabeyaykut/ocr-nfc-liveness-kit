...
.field private final mInitInternalFuture:Lm5/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lm5/a<",
            "Ljava/lang/Void;",
...
.field private mShutdownInternalFuture:Lm5/a;
    .annotation build Landroidx/annotation/GuardedBy;
        value = "mInitializeLock"
    .end annotation
...
.method public constructor <init>(Landroid/content/Context;Landroidx/camera/core/CameraXConfig$Provider;)V
    ...
    iput-object v1, p0, Landroidx/camera/core/CameraX;->mShutdownInternalFuture:Lm5/a;
    ...
    invoke-static {p2, v1, v0}, Landroidx/camera/core/impl/b0;->g(Landroidx/camera/core/impl/ReadableConfig;Landroidx/camera/core/impl/Config$Option;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, p1}, Landroidx/camera/core/CameraX;->initInternal(Landroid/content/Context;)Lm5/a;

    move-result-object p1

    iput-object p1, p0, Landroidx/camera/core/CameraX;->mInitInternalFuture:Lm5/a;
...
.method private initInternal(Landroid/content/Context;)Lm5/a;
    .locals 4
    .param p1    # Landroid/content/Context;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {v1, v3, p0, p1}, Landroidx/camera/camera2/interop/h;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method private synthetic lambda$shutdownInternal$4(Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Landroidx/camera/core/impl/CameraRepository;->deinit()Lm5/a;
    ...
    invoke-direct {v1, v2, p0, p1}, Landroidx/camera/core/i;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    iget-object p1, p0, Landroidx/camera/core/CameraX;->mCameraExecutor:Ljava/util/concurrent/Executor;

    invoke-interface {v0, v1, p1}, Lm5/a;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method private shutdownInternal()Lm5/a;
    .locals 3
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    :goto_0
    iget-object v1, p0, Landroidx/camera/core/CameraX;->mShutdownInternalFuture:Lm5/a;
...
.method public getInitializeFuture()Lm5/a;
    .locals 1
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
    ...
    iget-object v0, p0, Landroidx/camera/core/CameraX;->mInitInternalFuture:Lm5/a;
...
.method public shutdown()Lm5/a;
    ...
    invoke-direct {p0}, Landroidx/camera/core/CameraX;->shutdownInternal()Lm5/a;
