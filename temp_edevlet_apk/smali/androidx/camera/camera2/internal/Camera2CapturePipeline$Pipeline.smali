...
.method public static synthetic a(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;)V
    .locals 0
...
.method public static synthetic b(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;Landroidx/camera/core/impl/CaptureConfig$Builder;Landroidx/concurrent/futures/CallbackToFutureAdapter$Completer;)Ljava/lang/Object;
    .locals 0
...
.method public static synthetic c(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;Landroid/hardware/camera2/TotalCaptureResult;)Z
    .locals 0
...
.method public static synthetic d(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;Ljava/util/List;ILandroid/hardware/camera2/TotalCaptureResult;)Lm5/a;
    .locals 0

    invoke-direct {p0, p1, p2, p3}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;->lambda$executeCapture$2(Ljava/util/List;ILandroid/hardware/camera2/TotalCaptureResult;)Lm5/a;
...
.method public static synthetic e(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;Ljava/lang/Boolean;)Lm5/a;
    .locals 0

    invoke-direct {p0, p1}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;->lambda$executeCapture$1(Ljava/lang/Boolean;)Lm5/a;
...
.method public static synthetic f(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;ILandroid/hardware/camera2/TotalCaptureResult;)Lm5/a;
    .locals 0

    invoke-direct {p0, p1, p2}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;->lambda$executeCapture$0(ILandroid/hardware/camera2/TotalCaptureResult;)Lm5/a;
...
.method private synthetic lambda$executeCapture$0(ILandroid/hardware/camera2/TotalCaptureResult;)Lm5/a;
    .locals 2
    ...
    invoke-interface {p1, p2}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$PipelineTask;->preCapture(Landroid/hardware/camera2/TotalCaptureResult;)Lm5/a;
...
.method private synthetic lambda$executeCapture$1(Ljava/lang/Boolean;)Lm5/a;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-direct {p1, v2, p0}, Landroidx/camera/camera2/internal/t;-><init>(ILjava/lang/Object;)V

    invoke-direct {p0, v0, v1, p1}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;->waitForResult(JLandroidx/camera/camera2/internal/Camera2CapturePipeline$ResultListener$Checker;)Lm5/a;
...
.method private synthetic lambda$executeCapture$2(Ljava/util/List;ILandroid/hardware/camera2/TotalCaptureResult;)Lm5/a;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;->submitConfigsInternal(Ljava/util/List;I)Lm5/a;
...
.method private waitForResult(JLandroidx/camera/camera2/internal/Camera2CapturePipeline$ResultListener$Checker;)Lm5/a;
    .locals 1
    ...
    invoke-virtual {v0}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$ResultListener;->getFuture()Lm5/a;
...
.method public executeCapture(Ljava/util/List;I)Lm5/a;
    .locals 3
    ...
    invoke-direct {p0, v1, v2, v0}, Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;->waitForResult(JLandroidx/camera/camera2/internal/Camera2CapturePipeline$ResultListener$Checker;)Lm5/a;
    ...
    invoke-direct {v1, p0, p2}, Landroidx/camera/camera2/internal/g0;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;I)V
    ...
    invoke-direct {v1, p0}, Landroidx/camera/camera2/internal/h0;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Landroidx/camera/camera2/internal/i0;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;Ljava/util/List;I)V
    ...
    new-instance p2, Landroidx/camera/camera2/internal/b0;

    const/4 v0, 0x1

    invoke-direct {p2, v0, p0}, Landroidx/camera/camera2/internal/b0;-><init>(ILjava/lang/Object;)V
    ...
    invoke-interface {p1, p2, v0}, Lm5/a;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V

    return-object p1
.end method

.method public submitConfigsInternal(Ljava/util/List;I)Lm5/a;
    .locals 6
    .param p1    # Ljava/util/List;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {v2, p0, v3}, Landroidx/camera/camera2/internal/f0;-><init>(Landroidx/camera/camera2/internal/Camera2CapturePipeline$Pipeline;Landroidx/camera/core/impl/CaptureConfig$Builder;)V

    invoke-static {v2}, Landroidx/concurrent/futures/CallbackToFutureAdapter;->getFuture(Landroidx/concurrent/futures/CallbackToFutureAdapter$Resolver;)Lm5/a;
